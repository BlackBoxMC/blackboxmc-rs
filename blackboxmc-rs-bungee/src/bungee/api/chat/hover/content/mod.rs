...
impl<'mc> Item<'mc> {
    ...
    pub fn new(
        ...
        arg1: i32,
        arg2: impl Into<&'mc crate::bungee::api::chat::ItemTag<'mc>>,
    ) -> Result<crate::bungee::api::chat::hover::content::Item<'mc>, Box<dyn std::error::Error>>
    {
        ...
        let res = jni.new_object(
            cls,
            "(Ljava/lang/String;ILnet/md_5/bungee/api/chat/ItemTag;)V",
            &[
    ...
    /*pub fn tag(
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getTag",
            "()Lnet/md_5/bungee/api/chat/ItemTag;",
            &[],
        );
        let res = self.jni_ref().translate_error(res)?;
    ...
    pub fn set_tag(
        &mut self,
        arg0: impl Into<&'mc crate::bungee::api::chat::ItemTag<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "setTag",
            "(Lnet/md_5/bungee/api/chat/ItemTag;)V",
            &[jni::objects::JValueGen::from(&val_0)],
        );
    ...
    pub fn assert_action(
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "assertAction",
            "(Lnet/md_5/bungee/api/chat/HoverEvent$Action;)V",
            &[jni::objects::JValueGen::from(&val_0)],
        );
        self.jni_ref().translate_error(res)?;
        Ok(())
...
impl<'mc> Entity<'mc> {
    ...
    pub fn new(
        ...
        arg2: impl Into<&'mc crate::bungee::api::chat::BaseComponent<'mc>>,
    ...
    pub fn get_type(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getType", "()Ljava/lang/String;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(self
            .jni_ref()
            .get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?
