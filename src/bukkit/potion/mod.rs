...
impl<'mc> Into<crate::bukkit::potion::PotionEffectType<'mc>> for PotionEffectTypeWrapper<'mc> {
    fn into(self) -> crate::bukkit::potion::PotionEffectType<'mc> {
        crate::bukkit::potion::PotionEffectType::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
...
impl<'mc> PotionData<'mc> {
    pub fn new_with_potion_type(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::bukkit::potion::PotionType<'mc>>>,
...
impl<'mc> Potion<'mc> {
    ...
    pub fn set_type(
        &mut self,
        arg0: impl Into<&'mc crate::bukkit::potion::PotionType<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn set_potion_brewer(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::bukkit::potion::PotionBrewer<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let cls = &jni.find_class("void")?;
        let _res = jni.call_static_method(
...
impl<'mc> PotionEffect<'mc> {
    pub fn new_with_map(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::bukkit::potion::PotionEffectType<'mc>>>,
        arg1: std::option::Option<i32>,
