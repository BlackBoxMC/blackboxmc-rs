...
impl<'mc> MapCursorCollection<'mc> {
    ...
    pub fn remove_cursor(
        &mut self,
        arg0: impl Into<&'mc crate::bukkit::map::MapCursor<'mc>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
...
impl<'mc> MapCanvas<'mc> {
    ...
    pub fn set_cursors(
        &mut self,
        arg0: impl Into<&'mc crate::bukkit::map::MapCursorCollection<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn draw_text(
        ...
        arg0: i32,
        arg1: i32,
        arg2: impl Into<&'mc crate::bukkit::map::MapFont<'mc>>,
...
impl<'mc> MapRenderer<'mc> {
    ...
    pub fn render(
        &mut self,
        arg0: impl Into<&'mc crate::bukkit::map::MapView<'mc>>,
        arg1: impl Into<&'mc crate::bukkit::map::MapCanvas<'mc>>,
...
impl<'mc> MapViewScale<'mc> {
    ...
    pub fn value_of_with_string(
        ...
        let ret = {
            let mut obj = res.l()?;
            crate::bukkit::map::MapViewScale(jni, obj)
        };
        Ok(ret)
    }
...
impl<'mc> MapView<'mc> {
    ...
    pub fn set_scale(
        &mut self,
        arg0: impl Into<&'mc crate::bukkit::map::MapViewScale<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn add_renderer(
        &mut self,
        arg0: impl Into<&'mc crate::bukkit::map::MapRenderer<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
...
impl<'mc> MapFont<'mc> {
    ...
    pub fn set_char(
        &mut self,
        arg0: u16,
        arg1: impl Into<&'mc crate::bukkit::map::MapFontCharacterSprite<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = jni::objects::JValueGen::Char(arg0.into());
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().1.clone()) };
        let res = self.jni_ref().call_method(
...
impl<'mc> Into<crate::bukkit::map::MapFont<'mc>> for MinecraftFont<'mc> {
    fn into(self) -> crate::bukkit::map::MapFont<'mc> {
        crate::bukkit::map::MapFont::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
...
impl<'mc> MapPalette<'mc> {
    ...
    pub fn set_map_color_cache(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::bukkit::map::MapPaletteMapColorCache<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
...
impl<'mc> MapCursor<'mc> {
    ...
    pub fn new_with_byte(
        ...
        let ret = { crate::bukkit::map::MapCursor(jni, res) };
        Ok(ret)
    }
    pub fn from_raw(
        env: &crate::SharedJNIEnv<'mc>,
    ...
    pub fn set_type(
        &mut self,
        arg0: impl Into<&'mc crate::bukkit::map::MapCursorType<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
