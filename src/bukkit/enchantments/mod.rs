...
impl<'mc> Into<crate::bukkit::enchantments::Enchantment<'mc>> for EnchantmentWrapper<'mc> {
    fn into(self) -> crate::bukkit::enchantments::Enchantment<'mc> {
        crate::bukkit::enchantments::Enchantment::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
