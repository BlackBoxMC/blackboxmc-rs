...
impl<'mc> ConversationPrefix<'mc> {
    pub fn from_extendable(
        ...
        let obj = jni::objects::JValueGen::Object(env.new_object(
            "net/ioixd/blackbox/extendables/ExtendableConversationPrefix",
    ...
    pub fn from_raw(
        ...
        if !name.ends_with("ConversationPrefix") {
            Err(eyre::eyre!(
    ...
    pub fn get_prefix(
        &mut self,
        arg0: impl Into<crate::bukkit::conversations::ConversationContext<'mc>>,
...
impl<'mc> ConversationFactory<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ConversationFactory") {
            Err(eyre::eyre!(
    ...
    pub fn with_prefix(
        &mut self,
        arg0: impl Into<crate::bukkit::conversations::ConversationPrefix<'mc>>,
    ) -> Result<crate::bukkit::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>
    {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res =
self.jni_ref().call_method(&self.jni_object(),"withPrefix","(Lorg/bukkit/conversations/ConversationPrefix;)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)])?;
        let ret = {
    ...
    pub fn with_conversation_canceller(
        &mut self,
        arg0: impl Into<crate::bukkit::conversations::ConversationCanceller<'mc>>,
    ) -> Result<crate::bukkit::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>
    {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res =
self.jni_ref().call_method(&self.jni_object(),"withConversationCanceller","(Lorg/bukkit/conversations/ConversationCanceller;)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)])?;
        let ret = {
            crate::bukkit::conversations::ConversationFactory(self.jni_ref(), unsafe {
                jni::objects::JObject::from_raw(res.l()?.clone())
            })
    ...
    pub fn with_first_prompt(
        &mut self,
        arg0: impl Into<crate::bukkit::conversations::Prompt<'mc>>,
    ) -> Result<crate::bukkit::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>
    {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res = self.jni_ref().call_method(
    ...
    pub fn add_conversation_abandoned_listener(
        &mut self,
        arg0: impl Into<crate::bukkit::conversations::ConversationAbandonedListener<'mc>>,
    ) -> Result<crate::bukkit::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>
    {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        let res =
self.jni_ref().call_method(&self.jni_object(),"addConversationAbandonedListener","(Lorg/bukkit/conversations/ConversationAbandonedListener;)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)])?;
        let ret = {
            crate::bukkit::conversations::ConversationFactory(self.jni_ref(), unsafe {
                jni::objects::JObject::from_raw(res.l()?.clone())
            })
    ...
    pub fn build_conversation(
        &mut self,
        arg0: impl Into<crate::bukkit::conversations::Conversable<'mc>>,
...
impl<'mc> InactivityConversationCanceller<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("InactivityConversationCanceller") {
            Err(eyre::eyre!(
    ...
    pub fn set_conversation(
        &mut self,
        arg0: impl Into<crate::bukkit::conversations::Conversation<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        self.jni_ref().call_method(
            &self.jni_object(),
...
impl<'mc> ConversationConversationState<'mc> {
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ConversationConversationState") {
            Err(eyre::eyre!(
...
impl<'mc> Conversation<'mc> {
    pub fn new_with_plugin(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: impl Into<crate::bukkit::plugin::Plugin<'mc>>,
        arg1: impl Into<crate::bukkit::conversations::Conversable<'mc>>,
        arg2: std::option::Option<impl Into<crate::bukkit::conversations::Prompt<'mc>>>,
...
"(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/conversations/Conversable;Lorg/bukkit/conversations/Prompt;Ljava/util/Map;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
    ...
    pub fn accept_input(&mut self, arg0: String) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0).unwrap());
        self.jni_ref().call_method(
            &self.jni_object(),
            "acceptInput",
    ...
    pub fn abandon(
        ...
        arg0: std::option::Option<
            impl Into<crate::bukkit::conversations::ConversationAbandonedEvent<'mc>>,
        >,
    ) -> Result<(), Box<dyn std::error::Error>> {
...
impl<'mc> ValidatingPrompt<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ValidatingPrompt") {
            Err(eyre::eyre!(
    ...
    pub fn accept_input(
        ...
        let val_1 = jni::objects::JObject::from(self.jni_ref().new_string(arg1).unwrap());
        let res =
self.jni_ref().call_method(&self.jni_object(),"acceptInput","(Lorg/bukkit/conversations/ConversationContext;Ljava/lang/String;)Lorg/bukkit/conversations/Prompt;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
        let ret = {
...
impl<'mc> ManuallyAbandonedConversationCanceller<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ManuallyAbandonedConversationCanceller") {
            Err(eyre::eyre!(
...
impl<'mc> StringPrompt<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("StringPrompt") {
            Err(eyre::eyre!(
...
impl<'mc> FixedSetPrompt<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("FixedSetPrompt") {
            Err(eyre::eyre!(
...
impl<'mc> NullConversationPrefix<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("NullConversationPrefix") {
            Err(eyre::eyre!(
...
impl<'mc> ConversationAbandonedEvent<'mc> {
    pub fn new_with_conversation(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<crate::bukkit::conversations::Conversation<'mc>>>,
        arg1: std::option::Option<
            impl Into<crate::bukkit::conversations::ConversationCanceller<'mc>>,
        >,
    ) -> Result<
...
"(Lorg/bukkit/conversations/Conversation;Lorg/bukkit/conversations/ConversationCanceller;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ConversationAbandonedEvent") {
            Err(eyre::eyre!(
...
impl<'mc> NumericPrompt<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("NumericPrompt") {
            Err(eyre::eyre!(
...
impl<'mc> ExactMatchConversationCanceller<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ExactMatchConversationCanceller") {
            Err(eyre::eyre!(
...
impl<'mc> ConversationAbandonedListener<'mc> {
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ConversationAbandonedListener") {
            Err(eyre::eyre!(
    ...
    pub fn conversation_abandoned(
        &mut self,
        arg0: impl Into<crate::bukkit::conversations::ConversationAbandonedEvent<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().1.clone()) };
        self.jni_ref().call_method(
            &self.jni_object(),
...
impl<'mc> PluginNameConversationPrefix<'mc> {
    pub fn new_with_plugin(
        ...
        arg1: std::option::Option<String>,
        arg2: std::option::Option<impl Into<crate::bukkit::ChatColor<'mc>>>,
    ) -> Result<
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("PluginNameConversationPrefix") {
            Err(eyre::eyre!(
...
impl<'mc> ConversationCanceller<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ConversationCanceller") {
            Err(eyre::eyre!(
...
impl<'mc> Prompt<'mc> {
    pub fn from_extendable(
        ...
        let obj = jni::objects::JValueGen::Object(env.new_object(
            "net/ioixd/blackbox/extendables/ExtendablePrompt",
            "(Ljava/lang/String;Ljava/lang/String;)V",
            &[
                jni::objects::JValueGen::from(&jni::objects::JObject::from(
                    env.new_string(name).unwrap(),
...
impl<'mc> ConversationContext<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ConversationContext") {
            Err(eyre::eyre!(
...
impl<'mc> PlayerNamePrompt<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("PlayerNamePrompt") {
            Err(eyre::eyre!(
...
impl<'mc> BooleanPrompt<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("BooleanPrompt") {
            Err(eyre::eyre!(
...
impl<'mc> MessagePrompt<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("MessagePrompt") {
            Err(eyre::eyre!(
