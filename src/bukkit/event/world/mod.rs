...
impl<'mc> WorldUnloadEvent<'mc> {
    ...
    pub fn from_raw(
        ...
        if !name.ends_with("WorldUnloadEvent") {
            Err(eyre::eyre!(
...
impl<'mc> Into<crate::bukkit::event::Cancellable<'mc>> for WorldUnloadEvent<'mc> {
...
impl<'mc> SpawnChangeEvent<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("SpawnChangeEvent") {
            Err(eyre::eyre!(
...
impl<'mc> ChunkLoadEvent<'mc> {
    pub fn new(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::bukkit::Chunk<'mc>>,
        arg1: bool,
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ChunkLoadEvent") {
            Err(eyre::eyre!(
...
impl<'mc> PortalCreateEventCreateReason<'mc> {
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("PortalCreateEventCreateReason") {
            Err(eyre::eyre!(
...
impl<'mc> PortalCreateEvent<'mc> {
    pub fn new_with_list(
        ...
        arg2: std::option::Option<impl Into<&'mc crate::bukkit::entity::Entity<'mc>>>,
        arg3: std::option::Option<
            impl Into<&'mc crate::bukkit::event::world::PortalCreateEventCreateReason<'mc>>,
        >,
    ) -> Result<crate::bukkit::event::world::PortalCreateEvent<'mc>, Box<dyn std::error::Error>>
    {
...
"(Ljava/util/List;Lorg/bukkit/World;Lorg/bukkit/entity/Entity;Lorg/bukkit/event/world/PortalCreateEvent$CreateReason;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
        let ret = { crate::bukkit::event::world::PortalCreateEvent(jni, res) };
        Ok(ret)
    }
    pub fn from_raw(
        env: &crate::SharedJNIEnv<'mc>,
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("PortalCreateEvent") {
            Err(eyre::eyre!(
...
impl<'mc> WorldInitEvent<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("WorldInitEvent") {
            Err(eyre::eyre!(
...
impl<'mc> LootGenerateEvent<'mc> {
    pub fn new(
        ...
        arg2: impl Into<&'mc crate::bukkit::inventory::InventoryHolder<'mc>>,
        arg3: impl Into<&'mc crate::bukkit::loot::LootTable<'mc>>,
        arg4: impl Into<&'mc crate::bukkit::loot::LootContext<'mc>>,
        arg5: Vec<impl Into<crate::bukkit::inventory::ItemStack<'mc>>>,
        arg6: bool,
...
"(Lorg/bukkit/World;Lorg/bukkit/entity/Entity;Lorg/bukkit/inventory/InventoryHolder;Lorg/bukkit/loot/LootTable;Lorg/bukkit/loot/LootContext;Ljava/util/List;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6)])?;
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("LootGenerateEvent") {
            Err(eyre::eyre!(
...
impl<'mc> Into<crate::bukkit::event::Cancellable<'mc>> for LootGenerateEvent<'mc> {
    fn into(self) -> crate::bukkit::event::Cancellable<'mc> {
        crate::bukkit::event::Cancellable::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
...
impl<'mc> WorldLoadEvent<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("WorldLoadEvent") {
            Err(eyre::eyre!(
...
impl<'mc> AsyncStructureSpawnEvent<'mc> {
    pub fn new(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::bukkit::World<'mc>>,
        arg1: impl Into<&'mc crate::bukkit::generator::structure::Structure<'mc>>,
        arg2: impl Into<&'mc crate::bukkit::util::BoundingBox<'mc>>,
        arg3: i32,
        arg4: i32,
    ) -> Result<
...
"(Lorg/bukkit/World;Lorg/bukkit/generator/structure/Structure;Lorg/bukkit/util/BoundingBox;II)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("AsyncStructureSpawnEvent") {
            Err(eyre::eyre!(
...
impl<'mc> Into<crate::bukkit::event::Cancellable<'mc>> for AsyncStructureSpawnEvent<'mc> {
    fn into(self) -> crate::bukkit::event::Cancellable<'mc> {
        crate::bukkit::event::Cancellable::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
...
impl<'mc> ChunkPopulateEvent<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ChunkPopulateEvent") {
            Err(eyre::eyre!(
...
impl<'mc> ChunkUnloadEvent<'mc> {
    pub fn new_with_chunk(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::bukkit::Chunk<'mc>>>,
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("ChunkUnloadEvent") {
            Err(eyre::eyre!(
...
impl<'mc> EntitiesUnloadEvent<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("EntitiesUnloadEvent") {
            Err(eyre::eyre!(
...
impl<'mc> EntitiesLoadEvent<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("EntitiesLoadEvent") {
            Err(eyre::eyre!(
...
impl<'mc> GenericGameEvent<'mc> {
    pub fn new(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::bukkit::GameEvent<'mc>>,
        arg1: impl Into<&'mc crate::bukkit::Location<'mc>>,
        arg2: impl Into<&'mc crate::bukkit::entity::Entity<'mc>>,
        arg3: i32,
        arg4: bool,
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("GenericGameEvent") {
            Err(eyre::eyre!(
...
impl<'mc> StructureGrowEvent<'mc> {
    pub fn new(
        ...
        arg1: impl Into<&'mc crate::bukkit::TreeType<'mc>>,
        arg2: bool,
        arg3: impl Into<&'mc crate::bukkit::entity::Player<'mc>>,
        arg4: Vec<impl Into<crate::bukkit::block::BlockState<'mc>>>,
...
"(Lorg/bukkit/Location;Lorg/bukkit/TreeType;ZLorg/bukkit/entity/Player;Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("StructureGrowEvent") {
            Err(eyre::eyre!(
...
impl<'mc> TimeSkipEventSkipReason<'mc> {
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("TimeSkipEventSkipReason") {
            Err(eyre::eyre!(
...
impl<'mc> TimeSkipEvent<'mc> {
    pub fn new(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::bukkit::World<'mc>>,
        arg1: impl Into<&'mc crate::bukkit::event::world::TimeSkipEventSkipReason<'mc>>,
        arg2: i64,
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("TimeSkipEvent") {
            Err(eyre::eyre!(
...
impl<'mc> Into<crate::bukkit::event::Cancellable<'mc>> for TimeSkipEvent<'mc> {
    fn into(self) -> crate::bukkit::event::Cancellable<'mc> {
        crate::bukkit::event::Cancellable::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
...
impl<'mc> WorldSaveEvent<'mc> {
    ...
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("WorldSaveEvent") {
            Err(eyre::eyre!(
