...
impl<'mc> crate::JNIRaw<'mc> for HangingBreakEventRemoveCause<'mc> {
...
impl<'mc> HangingBreakEventRemoveCause<'mc> {
    pub fn from_raw(
        ...
        if !name.ends_with("HangingBreakEventRemoveCause") {
            Err(eyre::eyre!(
...
impl<'mc> crate::JNIRaw<'mc> for HangingBreakEvent<'mc> {
    fn jni_ref(&self) -> crate::SharedJNIEnv<'mc> {
        self.0.clone()
    }
...
impl<'mc> HangingBreakEvent<'mc> {
    pub fn new(
        jni: crate::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::bukkit::entity::Hanging<'mc>>,
        arg1: impl Into<&'mc crate::bukkit::event::hanging::HangingBreakEventRemoveCause<'mc>>,
...
"(Lorg/bukkit/entity/Hanging;Lorg/bukkit/event/hanging/HangingBreakEvent$RemoveCause;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
        let ret = { crate::bukkit::event::hanging::HangingBreakEvent(jni, res) };
        Ok(ret)
    }
    pub fn from_raw(
        env: &crate::SharedJNIEnv<'mc>,
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("HangingBreakEvent") {
            Err(eyre::eyre!(
    ...
    pub fn entity(
        &mut self,
    ) -> Result<crate::bukkit::entity::Hanging<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getEntity",
        ...
        let res = crate::java_error_throw(self.jni_ref(), res)?;
        let ret = {
            crate::bukkit::entity::Hanging(self.jni_ref(), unsafe {
                jni::objects::JObject::from_raw(res.l()?.clone())
            })
        };
        Ok(ret)
...
impl<'mc> crate::JNIRaw<'mc> for HangingBreakByEntityEvent<'mc> {
    fn jni_ref(&self) -> crate::SharedJNIEnv<'mc> {
        self.0.clone()
    }
...
impl<'mc> HangingBreakByEntityEvent<'mc> {
    pub fn new_with_hanging(
        ...
        arg2: std::option::Option<
            impl Into<&'mc crate::bukkit::event::hanging::HangingBreakEventRemoveCause<'mc>>,
        >,
    ) -> Result<
...
"(Lorg/bukkit/entity/Hanging;Lorg/bukkit/entity/Entity;Lorg/bukkit/event/hanging/HangingBreakEvent$RemoveCause;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
        let ret = { crate::bukkit::event::hanging::HangingBreakByEntityEvent(jni, res) };
        Ok(ret)
    }
    pub fn from_raw(
        env: &crate::SharedJNIEnv<'mc>,
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("HangingBreakByEntityEvent") {
            Err(eyre::eyre!(
...
impl<'mc> crate::JNIRaw<'mc> for HangingPlaceEvent<'mc> {
    fn jni_ref(&self) -> crate::SharedJNIEnv<'mc> {
        self.0.clone()
    }
...
impl<'mc> HangingPlaceEvent<'mc> {
    pub fn new_with_hanging(
        ...
        arg5: std::option::Option<impl Into<&'mc crate::bukkit::inventory::ItemStack<'mc>>>,
...
"(Lorg/bukkit/entity/Hanging;Lorg/bukkit/entity/Player;Lorg/bukkit/block/Block;Lorg/bukkit/block/BlockFace;Lorg/bukkit/inventory/EquipmentSlot;Lorg/bukkit/inventory/ItemStack;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
        let ret = { crate::bukkit::event::hanging::HangingPlaceEvent(jni, res) };
        Ok(ret)
    }
    pub fn from_raw(
        env: &crate::SharedJNIEnv<'mc>,
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("HangingPlaceEvent") {
            Err(eyre::eyre!(
...
impl<'mc> crate::JNIRaw<'mc> for HangingEvent<'mc> {
    fn jni_ref(&self) -> crate::SharedJNIEnv<'mc> {
        self.0.clone()
    }
...
impl<'mc> HangingEvent<'mc> {
    pub fn from_raw(
        ...
        let what = env.get_string(&oh)?;
        let name = what.to_string_lossy();
        if !name.ends_with("HangingEvent") {
            Err(eyre::eyre!(
