...
use color_eyre::eyre::Result;/*org/bukkit/advancement/mod.rs*/

#[repr(C)]
pub struct Advancement<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Advancement from null object.")
                .into());
            }
...
impl<'mc> AdvancementTrait<'mc> for Advancement<'mc> {}
pub trait AdvancementTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let res = self.jni_ref().call_method(&self.jni_object(),"getDisplay",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
Some(
crate::advancement::AdvancementDisplay::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)?
)
)}
...
crate::Keyed::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting Advancement into crate::Keyed")

   }
}
impl<'mc> crate::KeyedTrait<'mc> for Advancement<'mc> {}
pub enum AdvancementDisplayType<'mc> {
	Task {inner: AdvancementDisplayTypeStruct<'mc>},
	Challenge {inner: AdvancementDisplayTypeStruct<'mc>},
	Goal {inner: AdvancementDisplayTypeStruct<'mc>},
}
impl<'mc> std::fmt::Display for AdvancementDisplayType<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> AdvancementDisplayTypeTrait<'mc> for AdvancementDisplayType<'mc> {}
        
        pub trait AdvancementDisplayTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
"TASK" => Ok(AdvancementDisplayType::Task { inner: AdvancementDisplayTypeStruct::from_raw(env,obj)?}),
"CHALLENGE" => Ok(AdvancementDisplayType::Challenge { inner: AdvancementDisplayTypeStruct::from_raw(env,obj)?}),
"GOAL" => Ok(AdvancementDisplayType::Goal { inner: AdvancementDisplayTypeStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct AdvancementDisplayTypeStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::Challenge { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for AdvancementDisplayType<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/advancement/AdvancementDisplayType")?;
            if !valid {
                Err(eyre::eyre!(
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "TASK" => Ok(AdvancementDisplayType::Task { inner: AdvancementDisplayTypeStruct::from_raw(env,obj)?}),"CHALLENGE" => Ok(AdvancementDisplayType::Challenge { inner: AdvancementDisplayTypeStruct::from_raw(env,obj)?}),"GOAL" => Ok(AdvancementDisplayType::Goal { inner: AdvancementDisplayTypeStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
let cls = jni.find_class("org/bukkit/advancement/AdvancementDisplayType"); let cls = jni.translate_error_with_class(cls)?;
...
#[repr(C)]
pub struct AdvancementDisplay<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for AdvancementDisplay<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate AdvancementDisplay from null object.")
                .into());
            }
...
impl<'mc> AdvancementDisplayTrait<'mc> for AdvancementDisplay<'mc> {}
pub trait AdvancementDisplayTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let res = self.jni_ref().call_method(&self.jni_object(),"getIcon",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// completed.
	fn should_show_toast(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"shouldShowToast",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// Whether to announce in the chat when this advancement has been completed.
	fn should_announce_chat(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"shouldAnnounceChat",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"isHidden",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
let res = 
self.jni_ref().translate_error(res)?;
crate::advancement::AdvancementDisplayType::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
#[repr(C)]
pub struct AdvancementProgress<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for AdvancementProgress<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate AdvancementProgress from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/advancement/AdvancementProgress")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> AdvancementProgressTrait<'mc> for AdvancementProgress<'mc> {}
pub trait AdvancementProgressTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"isDone",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// Mark the specified criteria as awarded at the current time.
	fn award_criteria(&self,criteria: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/lang/String;)Z");
let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(self.jni_ref().new_string(criteria.into())?));
let res = self.jni_ref().call_method(&self.jni_object(),"awardCriteria",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// Mark the specified criteria as uncompleted.
	fn revoke_criteria(&self,criteria: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/lang/String;)Z");
let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(self.jni_ref().new_string(criteria.into())?));
let res = self.jni_ref().call_method(&self.jni_object(),"revokeCriteria",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// Get the date the specified criteria was awarded.
	fn get_date_awarded(&self,criteria: impl Into<String>) 
...
let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(self.jni_ref().new_string(criteria.into())?));
let res = self.jni_ref().call_method(&self.jni_object(),"getDateAwarded",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// Get the criteria which have not been awarded.
	fn remaining_criteria(&self) 
-> Result<Vec<String>, Box<dyn std::error::Error>>

{let sig = String::from("()Ljava/util/Collection;");
let res = self.jni_ref().call_method(&self.jni_object(),"getRemainingCriteria",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
let mut new_vec = Vec::new();
let col = blackboxmc_java::util::JavaCollection::from_raw(&self.jni_ref(),res.l()?)?;let iter = col.iterator()?;
...
/// Gets the criteria which have been awarded.
	fn awarded_criteria(&self) 
-> Result<Vec<String>, Box<dyn std::error::Error>>

{let sig = String::from("()Ljava/util/Collection;");
let res = self.jni_ref().call_method(&self.jni_object(),"getAwardedCriteria",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
let mut new_vec = Vec::new();
let col = blackboxmc_java::util::JavaCollection::from_raw(&self.jni_ref(),res.l()?)?;let iter = col.iterator()?;
