...
crate::Keyed::from_raw(&self.jni_ref(), self.1).expect("Error converting Advancement into crate::Keyed")
...
res.z()?
	...
	pub fn should_announce_chat(&self) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn award_criteria(&self,criteria: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn revoke_criteria(&self,criteria: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn get_date_awarded(&self,criteria: impl Into<String>) 
...
blackboxmc_java::util::JavaDate::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn remaining_criteria(&self) 
-> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>
