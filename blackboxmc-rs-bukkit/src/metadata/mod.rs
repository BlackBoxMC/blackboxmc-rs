...
impl<'mc> MetadataStore<'mc> {
    pub fn set_metadata(
        ...
        let sig = String::from(
            "(Ljava/lang/Object;Ljava/lang/String;Lorg/bukkit/metadata/MetadataValue;)L();",
        );
    ...
    pub fn remove_metadata(
        ...
        let sig =
            String::from("(Ljava/lang/Object;Ljava/lang/String;Lorg/bukkit/plugin/Plugin;)L();");
        let val_1 = jni::objects::JValueGen::Object(subject);
        let val_2 = jni::objects::JValueGen::Object(jni::objects::JObject::from(
            self.jni_ref().new_string(metadata_key.into())?,
        ));
...
impl<'mc> MetadataValueAdapter<'mc> {
    pub fn owning_plugin(
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getOwningPlugin", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {
            return Ok(None);
        }
    ...
    pub fn as_int(&self) -> Result<i32, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "asInt", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i()?)
    }
    pub fn as_float(&self) -> Result<f32, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "asFloat", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.f()?)
    }
    pub fn as_double(&self) -> Result<f64, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "asDouble", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.d()?)
    }
    pub fn as_long(&self) -> Result<i64, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "asLong", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j()?)
    }
    pub fn as_short(&self) -> Result<i16, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "asShort", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.s()?)
    }
    pub fn as_byte(&self) -> Result<i8, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "asByte", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.b()?)
    }
    pub fn as_boolean(&self) -> Result<bool, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "asBoolean", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn as_string(&self) -> Result<String, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "asString", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(self
            .jni_ref()
