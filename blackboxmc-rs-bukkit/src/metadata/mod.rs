...
impl<'mc> std::ops::Deref for LazyMetadataValueCacheStrategy<'mc> {
    type Target = LazyMetadataValueCacheStrategyStruct<'mc>;
    fn deref(&self) -> &<LazyMetadataValueCacheStrategy<'mc> as std::ops::Deref>::Target {
        match self {
            LazyMetadataValueCacheStrategy::CacheAfterFirstEval { inner } => inner,
            LazyMetadataValueCacheStrategy::NeverCache { inner } => inner,
            LazyMetadataValueCacheStrategy::CacheEternally { inner } => inner,
        }
    }
}
