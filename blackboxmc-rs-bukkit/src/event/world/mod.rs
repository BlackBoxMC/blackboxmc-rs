...
impl<'mc> LootGenerateEvent<'mc> {
    ...
    pub fn loot(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
...
impl<'mc> AsyncStructureGenerateEvent<'mc> {
    ...
    pub fn set_block_transformer(
        ...
        let sig =
            String::from("(Lorg/bukkit/NamespacedKey;Lorg/bukkit/util/BlockTransformer;)L();");
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(key.into().jni_object().clone())
        });
        let val_2 = jni::objects::JValueGen::Object(unsafe {
    ...
    pub fn set_entity_transformer(
        ...
        let sig =
            String::from("(Lorg/bukkit/NamespacedKey;Lorg/bukkit/util/EntityTransformer;)L();");
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(key.into().jni_object().clone())
        });
        let val_2 = jni::objects::JValueGen::Object(unsafe {
