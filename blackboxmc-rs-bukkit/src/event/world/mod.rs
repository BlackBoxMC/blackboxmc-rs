...
"(Lorg/bukkit/World;)V",&[jni::objects::JValueGen::from(&val_1)])?;
...
let res = jni.new_object(cls,
"(Lorg/bukkit/World;Lorg/bukkit/Location;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Chunk;Z)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setLoot","(Ljava/util/Collection;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Chunk;)V",&[jni::objects::JValueGen::from(&val_1)])?;
...
{// -2
let val_1 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSaveChunk","(Z)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn chunk(&mut self) 
-> Result<crate::Chunk<'mc>, Box<dyn std::error::Error>>
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Chunk;Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
let res = jni.new_object(cls,
"(Lorg/bukkit/GameEvent;Lorg/bukkit/Location;Lorg/bukkit/entity/Entity;IZ)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"setRadius","(I)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
let res = jni.new_object(cls,
"(Lorg/bukkit/World;Z)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
let res = jni.new_object(cls,
"(Lorg/bukkit/World;Lorg/bukkit/event/world/TimeSkipEvent$SkipReason;J)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"setSkipAmount","(J)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn world(&mut self) 
-> Result<crate::World<'mc>, Box<dyn std::error::Error>>
