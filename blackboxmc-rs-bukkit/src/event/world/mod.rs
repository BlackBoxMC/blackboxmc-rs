...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::World<'mc>>) 
...
"(Lorg/bukkit/World;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::World<'mc>>,arg1: impl Into<&'mc crate::Location<'mc>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/World;Lorg/bukkit/Location;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getPreviousLocation","()Lorg/bukkit/Location;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Chunk<'mc>>,arg1: bool) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Chunk;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
crate::event::HandlerList::from_raw(&jni,obj
	...
	pub fn is_new_chunk(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isNewChunk","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
pub struct PortalCreateEventCreateReason<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
if !valid {
	...
	pub fn new_with_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc blackboxmc_java::JavaList<'mc, orgBlockState>>,arg1: impl Into<&'mc crate::World<'mc>>,arg2: std::option::Option<impl Into<&'mc crate::entity::Entity<'mc>>>,arg3: std::option::Option<impl Into<&'mc crate::event::world::PortalCreateEventCreateReason<'mc>>>) 
...
let res = jni.new_object(cls,
"(Ljava/util/List;Lorg/bukkit/World;Lorg/bukkit/entity/Entity;Lorg/bukkit/event/world/PortalCreateEvent$CreateReason;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getReason","()Lorg/bukkit/event/world/PortalCreateEvent$CreateReason;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::World<'mc>>,arg1: impl Into<&'mc crate::entity::Entity<'mc>>,arg2: impl Into<&'mc crate::inventory::InventoryHolder<'mc>>,arg3: impl Into<&'mc crate::loot::LootTable<'mc>>,arg4: impl Into<&'mc crate::loot::LootContext<'mc>>,arg5: impl Into<&'mc blackboxmc_java::JavaList<'mc, orgItemStack>>,arg6: bool) 
...
crate::event::HandlerList::from_raw(&jni,obj
	...
	pub fn inventory_holder(&mut self) 
-> Result<crate::inventory::InventoryHolder<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getInventoryHolder","()Lorg/bukkit/inventory/InventoryHolder;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::inventory::InventoryHolder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn loot_context(&mut self) 
-> Result<crate::loot::LootContext<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getLootContext","()Lorg/bukkit/loot/LootContext;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::loot::LootContext::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn set_loot(&mut self,arg0: impl Into<&'mc blackboxmc_java::JavaCollection<'mc, orgItemStack>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setLoot","(Ljava/util/Collection;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn loot(&mut self) 
-> Result<blackboxmc_java::JavaList<'mc, orgItemStack>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getLoot","()Ljava/util/List;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaList::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn is_plugin(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isPlugin","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn world(&mut self) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::World<'mc>>,arg1: impl Into<&'mc crate::generator::structure::Structure<'mc>>,arg2: impl Into<&'mc crate::util::BoundingBox<'mc>>,arg3: i32,arg4: i32) 
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getStructure","()Lorg/bukkit/generator/structure/Structure;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::event::HandlerList::from_raw(&jni,obj
	...
	pub fn chunk_x(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getChunkX","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn chunk_z(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getChunkZ","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn world(&mut self) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Chunk<'mc>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Chunk;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
if !valid {
	...
	pub fn new_with_chunk(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::Chunk<'mc>>>,arg1: std::option::Option<bool>) 
...
crate::event::HandlerList::from_raw(&jni,obj
	...
	pub fn is_save_chunk(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isSaveChunk","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_save_chunk(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSaveChunk","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn chunk(&mut self) 
-> Result<crate::Chunk<'mc>, Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Chunk<'mc>>,arg1: impl Into<&'mc blackboxmc_java::JavaList<'mc, orgEntity>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Chunk;Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getEntities","()Ljava/util/List;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaList::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::GameEvent<'mc>>,arg1: impl Into<&'mc crate::Location<'mc>>,arg2: impl Into<&'mc crate::entity::Entity<'mc>>,arg3: i32,arg4: bool) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/GameEvent;Lorg/bukkit/Location;Lorg/bukkit/entity/Entity;IZ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getRadius","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn set_radius(&mut self,arg0: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setRadius","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
if !valid {
	...
	pub fn new_with_world(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::World<'mc>>>,arg1: std::option::Option<bool>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/World;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Location<'mc>>,arg1: impl Into<&'mc crate::TreeType<'mc>>,arg2: bool,arg3: impl Into<&'mc crate::entity::Player<'mc>>,arg4: impl Into<&'mc blackboxmc_java::JavaList<'mc, orgBlockState>>) 
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getSpecies","()Lorg/bukkit/TreeType;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
, crate::TreeType::from_string(variant_str).unwrap()
	...
	pub fn is_from_bonemeal(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isFromBonemeal","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn world(&mut self) 
...
pub struct TimeSkipEventSkipReason<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::World<'mc>>,arg1: impl Into<&'mc crate::event::world::TimeSkipEventSkipReason<'mc>>,arg2: i64) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/World;Lorg/bukkit/event/world/TimeSkipEvent$SkipReason;J)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
crate::event::HandlerList::from_raw(&jni,obj
	...
	pub fn skip_reason(&mut self) 
-> Result<crate::event::world::TimeSkipEventSkipReason<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getSkipReason","()Lorg/bukkit/event/world/TimeSkipEvent$SkipReason;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::event::world::TimeSkipEventSkipReason::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn skip_amount(&mut self) 
-> Result<i64, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getSkipAmount","()J",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
	pub fn set_skip_amount(&mut self,arg0: i64) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSkipAmount","(J)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn world(&mut self) 
-> Result<crate::World<'mc>, Box<dyn std::error::Error>>
