...
use color_eyre::eyre::Result;/*org/bukkit/event/world/mod.rs*/
...
impl<'mc> WorldSaveEventTrait<'mc> for WorldSaveEvent<'mc> {}
pub trait WorldSaveEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>) 
...
crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WorldSaveEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for WorldSaveEvent<'mc> {}
#[repr(C)]
...
impl<'mc> ChunkUnloadEventTrait<'mc> for ChunkUnloadEvent<'mc> {}
pub trait ChunkUnloadEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,chunk: impl Into<crate::Chunk<'mc>>,save: std::option::Option<bool>) 
...
/// Set whether this chunk will be saved to disk.
	fn set_save_chunk(&self,save_chunk: bool) 
...
crate::event::world::ChunkEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ChunkUnloadEvent into crate::event::world::ChunkEvent")

   }
}
impl<'mc> crate::event::world::ChunkEventTrait<'mc> for ChunkUnloadEvent<'mc> {}
#[repr(C)]
...
impl<'mc> ChunkEventTrait<'mc> for ChunkEvent<'mc> {}
pub trait ChunkEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ChunkEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for ChunkEvent<'mc> {}
#[repr(C)]
...
impl<'mc> PortalCreateEventTrait<'mc> for PortalCreateEvent<'mc> {}
pub trait PortalCreateEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,blocks: Vec<jni::objects::JObject<'mc>>,world: impl Into<crate::World<'mc>>,entity: impl Into<crate::entity::Entity<'mc>>,reason: std::option::Option<impl Into<crate::event::world::PortalCreateEventCreateReason<'mc>>>) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PortalCreateEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for PortalCreateEvent<'mc> {}
impl<'mc> Into<crate::event::world::WorldEvent<'mc>> for PortalCreateEvent<'mc>{

fn into(self) -> crate::event::world::WorldEvent<'mc> {

crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PortalCreateEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for PortalCreateEvent<'mc> {}
#[repr(C)]
...
impl<'mc> ChunkLoadEventTrait<'mc> for ChunkLoadEvent<'mc> {}
pub trait ChunkLoadEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,chunk: impl Into<crate::Chunk<'mc>>,new_chunk: bool) 
...
crate::event::world::ChunkEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ChunkLoadEvent into crate::event::world::ChunkEvent")

   }
}
impl<'mc> crate::event::world::ChunkEventTrait<'mc> for ChunkLoadEvent<'mc> {}
#[repr(C)]
...
impl<'mc> AsyncStructureGenerateEventTrait<'mc> for AsyncStructureGenerateEvent<'mc> {}
pub trait AsyncStructureGenerateEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,val_async: bool,cause: impl Into<crate::event::world::AsyncStructureGenerateEventCause<'mc>>,structure: impl Into<crate::generator::structure::Structure<'mc>>,bounding_box: impl Into<crate::util::BoundingBox<'mc>>,chunk_x: i32,chunk_z: i32) 
...
/// Gets a block transformer by key.
	fn get_block_transformer(&self,key: impl Into<crate::NamespacedKey<'mc>>) 
...
/// Sets a block transformer to a key.
	fn set_block_transformer(&self,key: impl Into<crate::NamespacedKey<'mc>>,transformer: impl Into<crate::util::BlockTransformer<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Removes a block transformer.
	fn remove_block_transformer(&self,key: impl Into<crate::NamespacedKey<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Removes all block transformers.
	fn clear_block_transformers(&self) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Gets a entity transformer by key.
	fn get_entity_transformer(&self,key: impl Into<crate::NamespacedKey<'mc>>) 
...
/// Sets a entity transformer to a key.
	fn set_entity_transformer(&self,key: impl Into<crate::NamespacedKey<'mc>>,transformer: impl Into<crate::util::EntityTransformer<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Removes a entity transformer.
	fn remove_entity_transformer(&self,key: impl Into<crate::NamespacedKey<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Removes all entity transformers.
	fn clear_entity_transformers(&self) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting AsyncStructureGenerateEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for AsyncStructureGenerateEvent<'mc> {}
#[repr(C)]
...
impl<'mc> WorldEventTrait<'mc> for WorldEvent<'mc> {}
pub trait WorldEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,is_async: std::option::Option<bool>) 
...
crate::event::Event::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WorldEvent into crate::event::Event")

   }
}
impl<'mc> crate::event::EventTrait<'mc> for WorldEvent<'mc> {}
#[repr(C)]
...
impl<'mc> StructureGrowEventTrait<'mc> for StructureGrowEvent<'mc> {}
pub trait StructureGrowEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,location: impl Into<crate::Location<'mc>>,species: impl Into<crate::TreeType<'mc>>,bonemeal: bool,player: impl Into<crate::entity::Player<'mc>>,blocks: Vec<jni::objects::JObject<'mc>>) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting StructureGrowEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for StructureGrowEvent<'mc> {}
impl<'mc> Into<crate::event::world::WorldEvent<'mc>> for StructureGrowEvent<'mc>{

fn into(self) -> crate::event::world::WorldEvent<'mc> {

crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting StructureGrowEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for StructureGrowEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntitiesUnloadEventTrait<'mc> for EntitiesUnloadEvent<'mc> {}
pub trait EntitiesUnloadEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,chunk: impl Into<crate::Chunk<'mc>>,entities: Vec<jni::objects::JObject<'mc>>) 
...
crate::event::world::ChunkEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntitiesUnloadEvent into crate::event::world::ChunkEvent")

   }
}
impl<'mc> crate::event::world::ChunkEventTrait<'mc> for EntitiesUnloadEvent<'mc> {}
#[repr(C)]
...
impl<'mc> WorldLoadEventTrait<'mc> for WorldLoadEvent<'mc> {}
pub trait WorldLoadEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WorldLoadEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for WorldLoadEvent<'mc> {}
#[repr(C)]
...
impl<'mc> TimeSkipEventTrait<'mc> for TimeSkipEvent<'mc> {}
pub trait TimeSkipEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,skip_reason: impl Into<crate::event::world::TimeSkipEventSkipReason<'mc>>,skip_amount: i64) 
...
/// Sets the amount of time to skip.
	fn set_skip_amount(&self,skip_amount: i64) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting TimeSkipEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for TimeSkipEvent<'mc> {}
impl<'mc> Into<crate::event::world::WorldEvent<'mc>> for TimeSkipEvent<'mc>{

fn into(self) -> crate::event::world::WorldEvent<'mc> {

crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting TimeSkipEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for TimeSkipEvent<'mc> {}
...
impl<'mc> std::fmt::Display for AsyncStructureGenerateEventCause<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> AsyncStructureGenerateEventCauseTrait<'mc> for AsyncStructureGenerateEventCause<'mc> {}
        
        pub trait AsyncStructureGenerateEventCauseTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
impl<'mc> ChunkPopulateEventTrait<'mc> for ChunkPopulateEvent<'mc> {}
pub trait ChunkPopulateEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,chunk: impl Into<crate::Chunk<'mc>>) 
...
crate::event::world::ChunkEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ChunkPopulateEvent into crate::event::world::ChunkEvent")

   }
}
impl<'mc> crate::event::world::ChunkEventTrait<'mc> for ChunkPopulateEvent<'mc> {}
#[repr(C)]
...
impl<'mc> AsyncStructureSpawnEventTrait<'mc> for AsyncStructureSpawnEvent<'mc> {}
pub trait AsyncStructureSpawnEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,structure: impl Into<crate::generator::structure::Structure<'mc>>,bounding_box: impl Into<crate::util::BoundingBox<'mc>>,chunk_x: i32,chunk_z: i32) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting AsyncStructureSpawnEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for AsyncStructureSpawnEvent<'mc> {}
impl<'mc> Into<crate::event::world::WorldEvent<'mc>> for AsyncStructureSpawnEvent<'mc>{

fn into(self) -> crate::event::world::WorldEvent<'mc> {

crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting AsyncStructureSpawnEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for AsyncStructureSpawnEvent<'mc> {}
...
impl<'mc> std::fmt::Display for PortalCreateEventCreateReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> PortalCreateEventCreateReasonTrait<'mc> for PortalCreateEventCreateReason<'mc> {}
        
        pub trait PortalCreateEventCreateReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
impl<'mc> SpawnChangeEventTrait<'mc> for SpawnChangeEvent<'mc> {}
pub trait SpawnChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,previous_location: impl Into<crate::Location<'mc>>) 
...
crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SpawnChangeEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for SpawnChangeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> WorldInitEventTrait<'mc> for WorldInitEvent<'mc> {}
pub trait WorldInitEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WorldInitEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for WorldInitEvent<'mc> {}
...
impl<'mc> std::fmt::Display for TimeSkipEventSkipReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> TimeSkipEventSkipReasonTrait<'mc> for TimeSkipEventSkipReason<'mc> {}
        
        pub trait TimeSkipEventSkipReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
impl<'mc> GenericGameEventTrait<'mc> for GenericGameEvent<'mc> {}
pub trait GenericGameEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,event: impl Into<crate::GameEvent<'mc>>,location: impl Into<crate::Location<'mc>>,entity: impl Into<crate::entity::Entity<'mc>>,radius: i32,is_async: bool) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting GenericGameEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for GenericGameEvent<'mc> {}
impl<'mc> Into<crate::event::world::WorldEvent<'mc>> for GenericGameEvent<'mc>{

fn into(self) -> crate::event::world::WorldEvent<'mc> {

crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting GenericGameEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for GenericGameEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntitiesLoadEventTrait<'mc> for EntitiesLoadEvent<'mc> {}
pub trait EntitiesLoadEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::event::world::ChunkEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntitiesLoadEvent into crate::event::world::ChunkEvent")

   }
}
impl<'mc> crate::event::world::ChunkEventTrait<'mc> for EntitiesLoadEvent<'mc> {}
#[repr(C)]
...
impl<'mc> LootGenerateEventTrait<'mc> for LootGenerateEvent<'mc> {}
pub trait LootGenerateEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting LootGenerateEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for LootGenerateEvent<'mc> {}
impl<'mc> Into<crate::event::world::WorldEvent<'mc>> for LootGenerateEvent<'mc>{

fn into(self) -> crate::event::world::WorldEvent<'mc> {

crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting LootGenerateEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for LootGenerateEvent<'mc> {}
#[repr(C)]
...
impl<'mc> WorldUnloadEventTrait<'mc> for WorldUnloadEvent<'mc> {}
pub trait WorldUnloadEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WorldUnloadEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for WorldUnloadEvent<'mc> {}
impl<'mc> Into<crate::event::world::WorldEvent<'mc>> for WorldUnloadEvent<'mc>{

fn into(self) -> crate::event::world::WorldEvent<'mc> {

crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WorldUnloadEvent into crate::event::world::WorldEvent")

   }
}
impl<'mc> crate::event::world::WorldEventTrait<'mc> for WorldUnloadEvent<'mc> {}
