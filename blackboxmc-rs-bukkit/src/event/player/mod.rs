...
impl<'mc> PlayerToggleFlightEvent<'mc> {
    ...
    //PlayerEvent
    //crate::event::player::PlayerEvent
...
impl<'mc> AsyncPlayerChatPreviewEvent<'mc> {
    ...
    //crate::event::player::AsyncPlayerChatEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
...
impl<'mc> PlayerPortalEvent<'mc> {
    ...
    //PlayerTeleportEvent
    //crate::event::player::PlayerTeleportEvent
    pub fn cause(
        &self,
    ) -> Result<
    ...
    //PlayerMoveEvent
    //crate::event::player::PlayerMoveEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
...
impl<'mc> PlayerArmorStandManipulateEvent<'mc> {
    ...
    //crate::event::player::PlayerInteractEntityEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
        let temp_clone =
...
impl<'mc> PlayerBucketFillEvent<'mc> {
    ...
    //PlayerBucketEvent
    //crate::event::player::PlayerBucketEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
...
impl<'mc> PlayerUnleashEntityEvent<'mc> {
    ...
    //EntityUnleashEvent
    //crate::event::entity::EntityUnleashEvent
    pub fn handlers(&self) -> Result<crate::event::HandlerList<'mc>, Box<dyn std::error::Error>> {
        let sig = String::from("()Lorg/bukkit/event/HandlerList;");
        let res =
            self.jni_ref()
...
impl<'mc> PlayerPickupArrowEvent<'mc> {
    ...
    //crate::event::player::PlayerPickupItemEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
...
impl<'mc> PlayerBucketFishEvent<'mc> {
    ...
    //crate::event::player::PlayerBucketEntityEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
        let temp_clone =
