...
impl<'mc> PlayerLoginEvent<'mc> {
    ...
    pub fn disallow(
        ...
        let sig = String::from(
            "(Lorg/bukkit/event/player/PlayerLoginEvent/Result;Ljava/lang/String;)L();",
        );
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(result.into().jni_object().clone())
        });
...
impl<'mc> PlayerRespawnEvent<'mc> {
    pub fn new_with_respawn_player(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
...
impl<'mc> PlayerExpCooldownChangeEvent<'mc> {
    ...
    > {
        let sig =
            String::from("()Lcrate::event::player::PlayerExpCooldownChangeEventChangeReason;");
        let res = self
            .jni_ref()
...
impl<'mc> PlayerPreLoginEvent<'mc> {
    ...
    pub fn disallow(
        ...
        let sig = String::from(
            "(Lorg/bukkit/event/player/PlayerPreLoginEvent/Result;Ljava/lang/String;)L();",
        );
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(result.into().jni_object().clone())
        });
...
impl<'mc> PlayerRecipeBookSettingsChangeEvent<'mc> {
    ...
    > {
        let sig = String::from(
            "()Lcrate::event::player::PlayerRecipeBookSettingsChangeEventRecipeBookType;",
        );
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getRecipeBookType",
