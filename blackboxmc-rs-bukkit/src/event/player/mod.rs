...
impl<'mc> AsyncPlayerPreLoginEvent<'mc> {
    ...
    // SUPER CLASS: org.bukkit.event.Event ( ['getLoginResult', 'getResult', 'setLoginResult', 'setResult', 'getKickMessage', 'setKickMessage', 'allow', 'disallow', 'getName', 'getAddress', 'getUniqueId', 'getHandlers', 'getHandlerList'])
