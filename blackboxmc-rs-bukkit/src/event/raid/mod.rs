...
if !valid {
	...
	pub fn raid(&mut self) 
-> Result<crate::Raid<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getRaid","()Lorg/bukkit/Raid;",&[]);
let res = 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Raid<'mc>>,arg1: impl Into<&'mc crate::World<'mc>>,arg2: impl Into<&'mc crate::entity::Raider<'mc>>,arg3: impl Into<&'mc blackboxmc_java::JavaList<'mc, orgRaider>>) 
...
"(Lorg/bukkit/Raid;Lorg/bukkit/World;Lorg/bukkit/entity/Raider;Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
...
crate::event::HandlerList::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn raiders(&mut self) 
-> Result<blackboxmc_java::JavaList<'mc, orgRaider>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getRaiders","()Ljava/util/List;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::event::HandlerList::from_raw(&jni,obj
	...
	pub fn patrol_leader(&mut self) 
-> Result<crate::entity::Raider<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getPatrolLeader","()Lorg/bukkit/entity/Raider;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Raid<'mc>>,arg1: impl Into<&'mc crate::World<'mc>>,arg2: impl Into<&'mc crate::entity::Player<'mc>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Raid;Lorg/bukkit/World;Lorg/bukkit/entity/Player;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Raid<'mc>>,arg1: impl Into<&'mc crate::World<'mc>>,arg2: impl Into<&'mc blackboxmc_java::JavaList<'mc, orgPlayer>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Raid;Lorg/bukkit/World;Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
crate::event::HandlerList::from_raw(&jni,obj
	...
	pub fn winners(&mut self) 
-> Result<blackboxmc_java::JavaList<'mc, orgPlayer>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getWinners","()Ljava/util/List;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaList::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
pub struct RaidStopEventReason<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Raid<'mc>>,arg1: impl Into<&'mc crate::World<'mc>>,arg2: impl Into<&'mc crate::event::raid::RaidStopEventReason<'mc>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Raid;Lorg/bukkit/World;Lorg/bukkit/event/raid/RaidStopEvent$Reason;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getReason","()Lorg/bukkit/event/raid/RaidStopEvent$Reason;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
