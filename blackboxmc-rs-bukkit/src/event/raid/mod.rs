...
crate::event::world::WorldEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting RaidEvent into crate::event::world::WorldEvent")
...
impl<'mc> RaidFinishEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,raid: impl Into<crate::Raid<'mc>>,world: impl Into<crate::World<'mc>>,winners: Vec<jni::objects::JObject<'mc>>) 
...
crate::event::raid::RaidEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting RaidFinishEvent into crate::event::raid::RaidEvent")
...
impl<'mc> RaidTriggerEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,raid: impl Into<crate::Raid<'mc>>,world: impl Into<crate::World<'mc>>,player: impl Into<crate::entity::Player<'mc>>) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting RaidTriggerEvent into crate::event::Cancellable")
...
crate::event::raid::RaidEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting RaidTriggerEvent into crate::event::raid::RaidEvent")
...
impl<'mc> RaidStopEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,raid: impl Into<crate::Raid<'mc>>,world: impl Into<crate::World<'mc>>,reason: impl Into<crate::event::raid::RaidStopEventReason<'mc>>) 
...
{let sig = String::from("()Lcrate::event::raid::RaidStopEventReason;");
...
crate::event::raid::RaidEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting RaidStopEvent into crate::event::raid::RaidEvent")
...
impl<'mc> RaidSpawnWaveEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,raid: impl Into<crate::Raid<'mc>>,world: impl Into<crate::World<'mc>>,leader: impl Into<crate::entity::Raider<'mc>>,raiders: Vec<jni::objects::JObject<'mc>>) 
...
crate::event::raid::RaidSpawnWaveEvent::from_raw(&jni,res
	...
	pub fn patrol_leader(&self) 
-> Result<Option<crate::entity::Raider<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("()Lcrate::entity::Raider;");
...
crate::event::raid::RaidEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting RaidSpawnWaveEvent into crate::event::raid::RaidEvent")
