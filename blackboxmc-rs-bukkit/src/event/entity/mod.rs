...
use color_eyre::eyre::Result;/*org/bukkit/event/entity/mod.rs*/
...
impl<'mc> JNIInstantiatable<'mc> for FoodLevelChangeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/FoodLevelChangeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> FoodLevelChangeEventTrait<'mc> for FoodLevelChangeEvent<'mc> {}
pub trait FoodLevelChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::HumanEntity<'mc>>,level: i32,item: std::option::Option<impl Into<crate::inventory::ItemStack<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/FoodLevelChangeEvent"); let cls = jni.translate_error_with_class(cls)?;
...
/// should be set to
	fn set_food_level(&self,level: i32) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting FoodLevelChangeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for FoodLevelChangeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for FoodLevelChangeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting FoodLevelChangeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for FoodLevelChangeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityTransformEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityTransformEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityTransformEventTrait<'mc> for EntityTransformEvent<'mc> {}
pub trait EntityTransformEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,original: impl Into<crate::entity::Entity<'mc>>,converted_list: Vec<jni::objects::JObject<'mc>>,transform_reason: impl Into<crate::event::entity::EntityTransformEventTransformReason<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(original.into().jni_object().clone())});
...
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(transform_reason.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityTransformEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
/// This returns the first entity in the transformed entity list.
	fn transformed_entity(&self) 
-> Result<crate::entity::Entity<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/entity/Entity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getTransformedEntity",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// Gets the entities that the original entity was transformed to.
	fn transformed_entities(&self) 
-> Result<Vec<crate::entity::Entity<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("()Ljava/util/List;");
let res = self.jni_ref().call_method(&self.jni_object(),"getTransformedEntities",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getTransformReason",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTransformEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityTransformEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityTransformEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTransformEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityTransformEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityCreatePortalEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityCreatePortalEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityCreatePortalEventTrait<'mc> for EntityCreatePortalEvent<'mc> {}
pub trait EntityCreatePortalEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::LivingEntity<'mc>>,blocks: Vec<jni::objects::JObject<'mc>>,val_type: impl Into<crate::PortalType<'mc>>) 
-> Result<crate::event::entity::EntityCreatePortalEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/LivingEntity;Ljava/util/List;Lorg/bukkit/PortalType;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let raw_val_2 = jni.new_object("java/util/ArrayList", "()V", vec![])?;
for v in blocks{
let map_val_0 = jni::objects::JValueGen::Object(v);
...
let cls = jni.find_class("org/bukkit/event/entity/EntityCreatePortalEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getPortalType",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::PortalType::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityCreatePortalEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityCreatePortalEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityCreatePortalEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityCreatePortalEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityCreatePortalEvent<'mc> {}
pub enum EntityDamageEventDamageModifier<'mc> {
	Base {inner: EntityDamageEventDamageModifierStruct<'mc>},
	HardHat {inner: EntityDamageEventDamageModifierStruct<'mc>},
	Blocking {inner: EntityDamageEventDamageModifierStruct<'mc>},
	Armor {inner: EntityDamageEventDamageModifierStruct<'mc>},
	Resistance {inner: EntityDamageEventDamageModifierStruct<'mc>},
	Magic {inner: EntityDamageEventDamageModifierStruct<'mc>},
	Absorption {inner: EntityDamageEventDamageModifierStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityDamageEventDamageModifier<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> EntityDamageEventDamageModifierTrait<'mc> for EntityDamageEventDamageModifier<'mc> {}
        
        pub trait EntityDamageEventDamageModifierTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
"BASE" => Ok(EntityDamageEventDamageModifier::Base { inner: EntityDamageEventDamageModifierStruct::from_raw(env,obj)?}),
"HARD_HAT" => Ok(EntityDamageEventDamageModifier::HardHat { inner: EntityDamageEventDamageModifierStruct::from_raw(env,obj)?}),
"BLOCKING" => Ok(EntityDamageEventDamageModifier::Blocking { inner: EntityDamageEventDamageModifierStruct::from_raw(env,obj)?}),
"ARMOR" => Ok(EntityDamageEventDamageModifier::Armor { inner: EntityDamageEventDamageModifierStruct::from_raw(env,obj)?}),
"RESISTANCE" => Ok(EntityDamageEventDamageModifier::Resistance { inner: EntityDamageEventDamageModifierStruct::from_raw(env,obj)?}),
"MAGIC" => Ok(EntityDamageEventDamageModifier::Magic { inner: EntityDamageEventDamageModifierStruct::from_raw(env,obj)?}),
"ABSORPTION" => Ok(EntityDamageEventDamageModifier::Absorption { inner: EntityDamageEventDamageModifierStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityDamageEventDamageModifierStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::Resistance { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Magic { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Absorption { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
}
}
}
impl<'mc> JNIInstantiatable<'mc> for EntityDamageEventDamageModifier<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityDamageEvent/DamageModifier")?;
            if !valid {
                Err(eyre::eyre!(
...
-> Result<crate::event::entity::EntityDamageEventDamageModifier<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/event/entity/EntityDamageEvent/DamageModifier;");
let cls = jni.find_class("org/bukkit/event/entity/EntityDamageEvent/DamageModifier"); let cls = jni.translate_error_with_class(cls)?;
...
impl<'mc> JNIInstantiatable<'mc> for EntityExplodeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityExplodeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityExplodeEventTrait<'mc> for EntityExplodeEvent<'mc> {}
pub trait EntityExplodeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,location: impl Into<crate::Location<'mc>>,blocks: Vec<jni::objects::JObject<'mc>>,val_yield: f32) 
-> Result<crate::event::entity::EntityExplodeEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;Lorg/bukkit/Location;Ljava/util/List;F)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
...
let cls = jni.find_class("org/bukkit/event/entity/EntityExplodeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityExplodeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityExplodeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityExplodeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityExplodeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityExplodeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityPortalEnterEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityPortalEnterEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityPortalEnterEventTrait<'mc> for EntityPortalEnterEvent<'mc> {}
pub trait EntityPortalEnterEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,location: impl Into<crate::Location<'mc>>) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(location.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityPortalEnterEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPortalEnterEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityPortalEnterEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityChangeBlockEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityChangeBlockEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityChangeBlockEventTrait<'mc> for EntityChangeBlockEvent<'mc> {}
pub trait EntityChangeBlockEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,block: impl Into<crate::block::Block<'mc>>,to: impl Into<crate::block::data::BlockData<'mc>>) 
...
let cls = jni.find_class("org/bukkit/event/entity/EntityChangeBlockEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityChangeBlockEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityChangeBlockEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityChangeBlockEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityChangeBlockEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityChangeBlockEvent<'mc> {}
#[repr(C)]
pub struct EntityMountEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EntityMountEvent<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EntityMountEvent from null object.")
                .into());
            }
...
impl<'mc> EntityMountEventTrait<'mc> for EntityMountEvent<'mc> {}
pub trait EntityMountEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,mount: impl Into<crate::entity::Entity<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(mount.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityMountEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Lorg/bukkit/entity/Entity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getMount",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::Entity::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityMountEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityMountEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityMountEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityMountEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityMountEvent<'mc> {}
pub enum VillagerCareerChangeEventChangeReason<'mc> {
	LosingJob {inner: VillagerCareerChangeEventChangeReasonStruct<'mc>},
	Employed {inner: VillagerCareerChangeEventChangeReasonStruct<'mc>},
}
impl<'mc> std::fmt::Display for VillagerCareerChangeEventChangeReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> VillagerCareerChangeEventChangeReasonTrait<'mc> for VillagerCareerChangeEventChangeReason<'mc> {}
        
        pub trait VillagerCareerChangeEventChangeReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"LOSING_JOB" => Ok(VillagerCareerChangeEventChangeReason::LosingJob { inner: VillagerCareerChangeEventChangeReasonStruct::from_raw(env,obj)?}),
"EMPLOYED" => Ok(VillagerCareerChangeEventChangeReason::Employed { inner: VillagerCareerChangeEventChangeReasonStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct VillagerCareerChangeEventChangeReasonStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
fn jni_object(&self) -> jni::objects::JObject<'mc> {
match self {
Self::LosingJob { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for VillagerCareerChangeEventChangeReason<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/VillagerCareerChangeEvent/ChangeReason")?;
            if !valid {
                Err(eyre::eyre!(
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "LOSING_JOB" => Ok(VillagerCareerChangeEventChangeReason::LosingJob { inner: VillagerCareerChangeEventChangeReasonStruct::from_raw(env,obj)?}),"EMPLOYED" => Ok(VillagerCareerChangeEventChangeReason::Employed { inner: VillagerCareerChangeEventChangeReasonStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
{let sig = String::from("()Lorg/bukkit/event/entity/VillagerCareerChangeEvent/ChangeReason;");
let cls = jni.find_class("org/bukkit/event/entity/VillagerCareerChangeEvent/ChangeReason"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> JNIInstantiatable<'mc> for EntityShootBowEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityShootBowEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityShootBowEventTrait<'mc> for EntityShootBowEvent<'mc> {}
pub trait EntityShootBowEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,shooter: impl Into<crate::entity::LivingEntity<'mc>>,bow: impl Into<crate::inventory::ItemStack<'mc>>,consumable: impl Into<crate::inventory::ItemStack<'mc>>,projectile: impl Into<crate::entity::Entity<'mc>>,hand: impl Into<crate::inventory::EquipmentSlot<'mc>>,force: f32,consume_item: bool) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(shooter.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(bow.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(consumable.into().jni_object().clone())});
let val_4 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(projectile.into().jni_object().clone())});
...
let cls = jni.find_class("org/bukkit/event/entity/EntityShootBowEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
{let sig = String::from("()Lorg/bukkit/inventory/ItemStack;");
let res = self.jni_ref().call_method(&self.jni_object(),"getBow",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
{let sig = String::from("()Lorg/bukkit/inventory/ItemStack;");
let res = self.jni_ref().call_method(&self.jni_object(),"getConsumable",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
{let sig = String::from("()Lorg/bukkit/entity/Entity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getProjectile",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::Entity::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// Replaces the projectile which will be launched
	fn set_projectile(&self,projectile: impl Into<crate::entity::Entity<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(projectile.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"setProjectile",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
{let sig = String::from("()F");
let res = self.jni_ref().call_method(&self.jni_object(),"getForce",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.f()?
...
/// consumed).
	fn set_consume_item(&self,consume_item: bool) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Z)V");
let val_1 = jni::objects::JValueGen::Bool(consume_item.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setConsumeItem",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
/// Get whether or not the consumable item should be consumed in this event.
	fn should_consume_item(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"shouldConsumeItem",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityShootBowEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityShootBowEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityShootBowEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityShootBowEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityShootBowEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityEnterLoveModeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityEnterLoveModeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityEnterLoveModeEventTrait<'mc> for EntityEnterLoveModeEvent<'mc> {}
pub trait EntityEnterLoveModeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,animal_in_love: impl Into<crate::entity::Animals<'mc>>,human_entity: impl Into<crate::entity::HumanEntity<'mc>>,ticks_in_love: i32) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(animal_in_love.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(human_entity.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Int(ticks_in_love);
let cls = jni.find_class("org/bukkit/event/entity/EntityEnterLoveModeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Gets the Human Entity that caused the animal to enter love mode.
	fn human_entity(&self) 
-> Result<Option<crate::entity::HumanEntity<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/entity/HumanEntity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getHumanEntity",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// Gets the amount of ticks that the animal will fall in love for.
	fn ticks_in_love(&self) 
-> Result<i32, Box<dyn std::error::Error>>

{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getTicksInLove",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
/// Sets the amount of ticks that the animal will fall in love for.
	fn set_ticks_in_love(&self,ticks_in_love: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(I)V");
let val_1 = jni::objects::JValueGen::Int(ticks_in_love);
let res = self.jni_ref().call_method(&self.jni_object(),"setTicksInLove",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityEnterLoveModeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityEnterLoveModeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityEnterLoveModeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityEnterLoveModeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityEnterLoveModeEvent<'mc> {}
pub enum EntityPotionEffectEventAction<'mc> {
	Added {inner: EntityPotionEffectEventActionStruct<'mc>},
	Changed {inner: EntityPotionEffectEventActionStruct<'mc>},
	Cleared {inner: EntityPotionEffectEventActionStruct<'mc>},
	Removed {inner: EntityPotionEffectEventActionStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityPotionEffectEventAction<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> EntityPotionEffectEventActionTrait<'mc> for EntityPotionEffectEventAction<'mc> {}
        
        pub trait EntityPotionEffectEventActionTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"ADDED" => Ok(EntityPotionEffectEventAction::Added { inner: EntityPotionEffectEventActionStruct::from_raw(env,obj)?}),
"CHANGED" => Ok(EntityPotionEffectEventAction::Changed { inner: EntityPotionEffectEventActionStruct::from_raw(env,obj)?}),
"CLEARED" => Ok(EntityPotionEffectEventAction::Cleared { inner: EntityPotionEffectEventActionStruct::from_raw(env,obj)?}),
"REMOVED" => Ok(EntityPotionEffectEventAction::Removed { inner: EntityPotionEffectEventActionStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityPotionEffectEventActionStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EntityPotionEffectEventAction<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityPotionEffectEvent/Action")?;
            if !valid {
                Err(eyre::eyre!(
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "ADDED" => Ok(EntityPotionEffectEventAction::Added { inner: EntityPotionEffectEventActionStruct::from_raw(env,obj)?}),"CHANGED" => Ok(EntityPotionEffectEventAction::Changed { inner: EntityPotionEffectEventActionStruct::from_raw(env,obj)?}),"CLEARED" => Ok(EntityPotionEffectEventAction::Cleared { inner: EntityPotionEffectEventActionStruct::from_raw(env,obj)?}),"REMOVED" => Ok(EntityPotionEffectEventAction::Removed { inner: EntityPotionEffectEventActionStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
let cls = jni.find_class("org/bukkit/event/entity/EntityPotionEffectEvent/Action"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> EntityPlaceEventTrait<'mc> for EntityPlaceEvent<'mc> {}
pub trait EntityPlaceEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,player: impl Into<crate::entity::Player<'mc>>,block: impl Into<crate::block::Block<'mc>>,block_face: impl Into<crate::block::BlockFace<'mc>>,hand: std::option::Option<impl Into<crate::inventory::EquipmentSlot<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/EntityPlaceEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPlaceEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityPlaceEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityPlaceEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPlaceEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityPlaceEvent<'mc> {}
#[repr(C)]
...
impl<'mc> PlayerDeathEventTrait<'mc> for PlayerDeathEvent<'mc> {}
pub trait PlayerDeathEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,player: impl Into<crate::entity::Player<'mc>>,drops: Vec<jni::objects::JObject<'mc>>,dropped_exp: i32,new_exp: i32,new_total_exp: std::option::Option<i32>,new_level: std::option::Option<i32>,death_message: std::option::Option<impl Into<String>>) 
...
let val_7 = jni::objects::JValueGen::Object(jni::objects::JObject::from(jni.new_string(a.into())?));
args.push(val_7);
}
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/PlayerDeathEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Set the death message that will appear to everyone on the server.
	fn set_death_message(&self,death_message: impl Into<String>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/lang/String;)V");
let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(self.jni_ref().new_string(death_message.into())?));
let res = self.jni_ref().call_method(&self.jni_object(),"setDeathMessage",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"getDeathMessage",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getNewExp",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
/// {@link #setDroppedExp(int)} for that.
	fn set_new_exp(&self,exp: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(I)V");
let val_1 = jni::objects::JValueGen::Int(exp);
let res = self.jni_ref().call_method(&self.jni_object(),"setNewExp",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// Sets the Level the Player should have at respawn.
	fn set_new_level(&self,level: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Gets the Total EXP the Player should have at respawn.
	fn new_total_exp(&self) 
-> Result<i32, Box<dyn std::error::Error>>

{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getNewTotalExp",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
/// Sets the Total EXP the Player should have at respawn.
	fn set_new_total_exp(&self,total_exp: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(I)V");
let val_1 = jni::objects::JValueGen::Int(total_exp);
let res = self.jni_ref().call_method(&self.jni_object(),"setNewTotalExp",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"getKeepLevel",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// EXP from dropping.</b>
	fn set_keep_level(&self,keep_level: bool) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Z)V");
let val_1 = jni::objects::JValueGen::Bool(keep_level.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setKeepLevel",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// items from dropping.</b>
	fn set_keep_inventory(&self,keep_inventory: bool) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Z)V");
let val_1 = jni::objects::JValueGen::Bool(keep_inventory.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setKeepInventory",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
/// Gets if the Player keeps inventory on death.
	fn keep_inventory(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"getKeepInventory",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
crate::event::entity::EntityDeathEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PlayerDeathEvent into crate::event::entity::EntityDeathEvent")

   }
}
impl<'mc> crate::event::entity::EntityDeathEventTrait<'mc> for PlayerDeathEvent<'mc> {}
pub enum EntityTransformEventTransformReason<'mc> {
	Cured {inner: EntityTransformEventTransformReasonStruct<'mc>},
	Frozen {inner: EntityTransformEventTransformReasonStruct<'mc>},
	Infection {inner: EntityTransformEventTransformReasonStruct<'mc>},
	Drowned {inner: EntityTransformEventTransformReasonStruct<'mc>},
	Sheared {inner: EntityTransformEventTransformReasonStruct<'mc>},
	Lightning {inner: EntityTransformEventTransformReasonStruct<'mc>},
	Split {inner: EntityTransformEventTransformReasonStruct<'mc>},
	PiglinZombified {inner: EntityTransformEventTransformReasonStruct<'mc>},
	Metamorphosis {inner: EntityTransformEventTransformReasonStruct<'mc>},
	Unknown {inner: EntityTransformEventTransformReasonStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityTransformEventTransformReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           EntityTransformEventTransformReason::PiglinZombified { .. } => f.write_str("PIGLIN_ZOMBIFIED"),
           EntityTransformEventTransformReason::Metamorphosis { .. } => f.write_str("METAMORPHOSIS"),
           EntityTransformEventTransformReason::Unknown { .. } => f.write_str("UNKNOWN"),
       }
   }
}

        impl<'mc> EntityTransformEventTransformReasonTrait<'mc> for EntityTransformEventTransformReason<'mc> {}
        
        pub trait EntityTransformEventTransformReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"CURED" => Ok(EntityTransformEventTransformReason::Cured { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"FROZEN" => Ok(EntityTransformEventTransformReason::Frozen { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"INFECTION" => Ok(EntityTransformEventTransformReason::Infection { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"DROWNED" => Ok(EntityTransformEventTransformReason::Drowned { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"SHEARED" => Ok(EntityTransformEventTransformReason::Sheared { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"LIGHTNING" => Ok(EntityTransformEventTransformReason::Lightning { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"SPLIT" => Ok(EntityTransformEventTransformReason::Split { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"PIGLIN_ZOMBIFIED" => Ok(EntityTransformEventTransformReason::PiglinZombified { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"METAMORPHOSIS" => Ok(EntityTransformEventTransformReason::Metamorphosis { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
"UNKNOWN" => Ok(EntityTransformEventTransformReason::Unknown { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityTransformEventTransformReasonStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::Infection { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::PiglinZombified { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Metamorphosis { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for EntityTransformEventTransformReason<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityTransformEvent/TransformReason")?;
            if !valid {
                Err(eyre::eyre!(
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "CURED" => Ok(EntityTransformEventTransformReason::Cured { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"FROZEN" => Ok(EntityTransformEventTransformReason::Frozen { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"INFECTION" => Ok(EntityTransformEventTransformReason::Infection { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"DROWNED" => Ok(EntityTransformEventTransformReason::Drowned { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"SHEARED" => Ok(EntityTransformEventTransformReason::Sheared { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"LIGHTNING" => Ok(EntityTransformEventTransformReason::Lightning { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"SPLIT" => Ok(EntityTransformEventTransformReason::Split { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"PIGLIN_ZOMBIFIED" => Ok(EntityTransformEventTransformReason::PiglinZombified { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"METAMORPHOSIS" => Ok(EntityTransformEventTransformReason::Metamorphosis { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),"UNKNOWN" => Ok(EntityTransformEventTransformReason::Unknown { inner: EntityTransformEventTransformReasonStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
{let sig = String::from("()Lorg/bukkit/event/entity/EntityTransformEvent/TransformReason;");
let cls = jni.find_class("org/bukkit/event/entity/EntityTransformEvent/TransformReason"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> JNIInstantiatable<'mc> for SheepRegrowWoolEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/SheepRegrowWoolEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> SheepRegrowWoolEventTrait<'mc> for SheepRegrowWoolEvent<'mc> {}
pub trait SheepRegrowWoolEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,sheep: impl Into<crate::entity::Sheep<'mc>>) 
-> Result<crate::event::entity::SheepRegrowWoolEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Sheep;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(sheep.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/SheepRegrowWoolEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SheepRegrowWoolEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for SheepRegrowWoolEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for SheepRegrowWoolEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SheepRegrowWoolEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for SheepRegrowWoolEvent<'mc> {}
pub enum CreeperPowerEventPowerCause<'mc> {
	Lightning {inner: CreeperPowerEventPowerCauseStruct<'mc>},
	SetOn {inner: CreeperPowerEventPowerCauseStruct<'mc>},
	SetOff {inner: CreeperPowerEventPowerCauseStruct<'mc>},
}
impl<'mc> std::fmt::Display for CreeperPowerEventPowerCause<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> CreeperPowerEventPowerCauseTrait<'mc> for CreeperPowerEventPowerCause<'mc> {}
        
        pub trait CreeperPowerEventPowerCauseTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"LIGHTNING" => Ok(CreeperPowerEventPowerCause::Lightning { inner: CreeperPowerEventPowerCauseStruct::from_raw(env,obj)?}),
"SET_ON" => Ok(CreeperPowerEventPowerCause::SetOn { inner: CreeperPowerEventPowerCauseStruct::from_raw(env,obj)?}),
"SET_OFF" => Ok(CreeperPowerEventPowerCause::SetOff { inner: CreeperPowerEventPowerCauseStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct CreeperPowerEventPowerCauseStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for CreeperPowerEventPowerCause<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/CreeperPowerEvent/PowerCause")?;
            if !valid {
                Err(eyre::eyre!(
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "LIGHTNING" => Ok(CreeperPowerEventPowerCause::Lightning { inner: CreeperPowerEventPowerCauseStruct::from_raw(env,obj)?}),"SET_ON" => Ok(CreeperPowerEventPowerCause::SetOn { inner: CreeperPowerEventPowerCauseStruct::from_raw(env,obj)?}),"SET_OFF" => Ok(CreeperPowerEventPowerCause::SetOff { inner: CreeperPowerEventPowerCauseStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
let cls = jni.find_class("org/bukkit/event/entity/CreeperPowerEvent/PowerCause"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> HorseJumpEventTrait<'mc> for HorseJumpEvent<'mc> {}
pub trait HorseJumpEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,horse: impl Into<crate::entity::AbstractHorse<'mc>>,power: f32) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(horse.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Float(power);
let cls = jni.find_class("org/bukkit/event/entity/HorseJumpEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting HorseJumpEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for HorseJumpEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for HorseJumpEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting HorseJumpEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for HorseJumpEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityDamageByEntityEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityDamageByEntityEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityDamageByEntityEventTrait<'mc> for EntityDamageByEntityEvent<'mc> {}
pub trait EntityDamageByEntityEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,damager: impl Into<crate::entity::Entity<'mc>>,damagee: impl Into<crate::entity::Entity<'mc>>,cause: impl Into<crate::event::entity::EntityDamageEventDamageCause<'mc>>,damage_source: impl Into<crate::damage::DamageSource<'mc>>,modifiers: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>,modifier_functions: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>) 
-> Result<crate::event::entity::EntityDamageByEntityEvent<'mc>, Box<dyn std::error::Error>>

{let mut args = Vec::new();
let mut sig = String::from("(");
sig += "Lorg/bukkit/entity/Entity;";
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(damager.into().jni_object().clone())});
args.push(val_1);
sig += "Lorg/bukkit/entity/Entity;";
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(damagee.into().jni_object().clone())});
args.push(val_2);
...
let val_4 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(damage_source.into().jni_object().clone())});
args.push(val_4);
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/EntityDamageByEntityEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Lorg/bukkit/entity/Entity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDamager",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::Entity::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::entity::EntityDamageEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDamageByEntityEvent into crate::event::entity::EntityDamageEvent")

   }
}
impl<'mc> crate::event::entity::EntityDamageEventTrait<'mc> for EntityDamageByEntityEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityAirChangeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityAirChangeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityAirChangeEventTrait<'mc> for EntityAirChangeEvent<'mc> {}
pub trait EntityAirChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,amount: i32) 
...
let cls = jni.find_class("org/bukkit/event/entity/EntityAirChangeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityAirChangeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityAirChangeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityAirChangeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityAirChangeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityAirChangeEvent<'mc> {}
pub enum EntityRemoveEventCause<'mc> {
	Death {inner: EntityRemoveEventCauseStruct<'mc>},
	...
	Hit {inner: EntityRemoveEventCauseStruct<'mc>},
...
impl<'mc> std::fmt::Display for EntityRemoveEventCause<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> EntityRemoveEventCauseTrait<'mc> for EntityRemoveEventCause<'mc> {}
        
        pub trait EntityRemoveEventCauseTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"DEATH" => Ok(EntityRemoveEventCause::Death { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"DESPAWN" => Ok(EntityRemoveEventCause::Despawn { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"DROP" => Ok(EntityRemoveEventCause::Drop { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"ENTER_BLOCK" => Ok(EntityRemoveEventCause::EnterBlock { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"EXPLODE" => Ok(EntityRemoveEventCause::Explode { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"HIT" => Ok(EntityRemoveEventCause::Hit { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"MERGE" => Ok(EntityRemoveEventCause::Merge { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"OUT_OF_WORLD" => Ok(EntityRemoveEventCause::OutOfWorld { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"PICKUP" => Ok(EntityRemoveEventCause::Pickup { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"PLAYER_QUIT" => Ok(EntityRemoveEventCause::PlayerQuit { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"PLUGIN" => Ok(EntityRemoveEventCause::Plugin { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"TRANSFORMATION" => Ok(EntityRemoveEventCause::Transformation { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
"UNLOAD" => Ok(EntityRemoveEventCause::Unload { inner: EntityRemoveEventCauseStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityRemoveEventCauseStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::EnterBlock { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::OutOfWorld { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Pickup { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::PlayerQuit { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Plugin { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Transformation { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for EntityRemoveEventCause<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityRemoveEvent/Cause")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/event/entity/EntityRemoveEvent/Cause"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> JNIInstantiatable<'mc> for EntitySpellCastEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntitySpellCastEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntitySpellCastEventTrait<'mc> for EntitySpellCastEvent<'mc> {}
pub trait EntitySpellCastEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Spellcaster<'mc>>,spell: impl Into<crate::entity::SpellcasterSpell<'mc>>) 
-> Result<crate::event::entity::EntitySpellCastEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Spellcaster;Lorg/bukkit/entity/Spellcaster/Spell;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(spell.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntitySpellCastEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntitySpellCastEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntitySpellCastEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntitySpellCastEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntitySpellCastEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntitySpellCastEvent<'mc> {}
pub enum EntityTargetEventTargetReason<'mc> {
	TargetDied {inner: EntityTargetEventTargetReasonStruct<'mc>},
	ClosestPlayer {inner: EntityTargetEventTargetReasonStruct<'mc>},
	TargetAttackedEntity {inner: EntityTargetEventTargetReasonStruct<'mc>},
	PigZombieTarget {inner: EntityTargetEventTargetReasonStruct<'mc>},
	ForgotTarget {inner: EntityTargetEventTargetReasonStruct<'mc>},
	TargetAttackedOwner {inner: EntityTargetEventTargetReasonStruct<'mc>},
	OwnerAttackedTarget {inner: EntityTargetEventTargetReasonStruct<'mc>},
	RandomTarget {inner: EntityTargetEventTargetReasonStruct<'mc>},
	DefendVillage {inner: EntityTargetEventTargetReasonStruct<'mc>},
	TargetAttackedNearbyEntity {inner: EntityTargetEventTargetReasonStruct<'mc>},
	ReinforcementTarget {inner: EntityTargetEventTargetReasonStruct<'mc>},
	Collision {inner: EntityTargetEventTargetReasonStruct<'mc>},
	Custom {inner: EntityTargetEventTargetReasonStruct<'mc>},
	ClosestEntity {inner: EntityTargetEventTargetReasonStruct<'mc>},
	FollowLeader {inner: EntityTargetEventTargetReasonStruct<'mc>},
	Tempt {inner: EntityTargetEventTargetReasonStruct<'mc>},
	Unknown {inner: EntityTargetEventTargetReasonStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityTargetEventTargetReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           EntityTargetEventTargetReason::TargetAttackedEntity { .. } => f.write_str("TARGET_ATTACKED_ENTITY"),
           EntityTargetEventTargetReason::PigZombieTarget { .. } => f.write_str("PIG_ZOMBIE_TARGET"),
           EntityTargetEventTargetReason::ForgotTarget { .. } => f.write_str("FORGOT_TARGET"),
           EntityTargetEventTargetReason::TargetAttackedOwner { .. } => f.write_str("TARGET_ATTACKED_OWNER"),
           EntityTargetEventTargetReason::OwnerAttackedTarget { .. } => f.write_str("OWNER_ATTACKED_TARGET"),
           ...
           EntityTargetEventTargetReason::TargetAttackedNearbyEntity { .. } => f.write_str("TARGET_ATTACKED_NEARBY_ENTITY"),
           EntityTargetEventTargetReason::ReinforcementTarget { .. } => f.write_str("REINFORCEMENT_TARGET"),
        ...
        impl<'mc> EntityTargetEventTargetReasonTrait<'mc> for EntityTargetEventTargetReason<'mc> {}
        
        pub trait EntityTargetEventTargetReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"TARGET_DIED" => Ok(EntityTargetEventTargetReason::TargetDied { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"CLOSEST_PLAYER" => Ok(EntityTargetEventTargetReason::ClosestPlayer { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"TARGET_ATTACKED_ENTITY" => Ok(EntityTargetEventTargetReason::TargetAttackedEntity { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"PIG_ZOMBIE_TARGET" => Ok(EntityTargetEventTargetReason::PigZombieTarget { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"FORGOT_TARGET" => Ok(EntityTargetEventTargetReason::ForgotTarget { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"TARGET_ATTACKED_OWNER" => Ok(EntityTargetEventTargetReason::TargetAttackedOwner { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"OWNER_ATTACKED_TARGET" => Ok(EntityTargetEventTargetReason::OwnerAttackedTarget { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"RANDOM_TARGET" => Ok(EntityTargetEventTargetReason::RandomTarget { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"DEFEND_VILLAGE" => Ok(EntityTargetEventTargetReason::DefendVillage { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"TARGET_ATTACKED_NEARBY_ENTITY" => Ok(EntityTargetEventTargetReason::TargetAttackedNearbyEntity { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"REINFORCEMENT_TARGET" => Ok(EntityTargetEventTargetReason::ReinforcementTarget { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"COLLISION" => Ok(EntityTargetEventTargetReason::Collision { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"CUSTOM" => Ok(EntityTargetEventTargetReason::Custom { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"CLOSEST_ENTITY" => Ok(EntityTargetEventTargetReason::ClosestEntity { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"FOLLOW_LEADER" => Ok(EntityTargetEventTargetReason::FollowLeader { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"TEMPT" => Ok(EntityTargetEventTargetReason::Tempt { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
"UNKNOWN" => Ok(EntityTargetEventTargetReason::Unknown { inner: EntityTargetEventTargetReasonStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityTargetEventTargetReasonStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
fn jni_object(&self) -> jni::objects::JObject<'mc> {
match self {
Self::TargetDied { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ClosestPlayer { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TargetAttackedEntity { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::PigZombieTarget { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ForgotTarget { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TargetAttackedOwner { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::OwnerAttackedTarget { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::RandomTarget { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::DefendVillage { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TargetAttackedNearbyEntity { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ReinforcementTarget { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Collision { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Custom { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ClosestEntity { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FollowLeader { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for EntityTargetEventTargetReason<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityTargetEvent/TargetReason")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/event/entity/EntityTargetEvent/TargetReason"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> CreeperPowerEventTrait<'mc> for CreeperPowerEvent<'mc> {}
pub trait CreeperPowerEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,creeper: impl Into<crate::entity::Creeper<'mc>>,bolt: impl Into<crate::entity::LightningStrike<'mc>>,cause: std::option::Option<impl Into<crate::event::entity::CreeperPowerEventPowerCause<'mc>>>) 
-> Result<crate::event::entity::CreeperPowerEvent<'mc>, Box<dyn std::error::Error>>

{let mut args = Vec::new();
let mut sig = String::from("(");
sig += "Lorg/bukkit/entity/Creeper;";
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(creeper.into().jni_object().clone())});
args.push(val_1);
sig += "Lorg/bukkit/entity/LightningStrike;";
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(bolt.into().jni_object().clone())});
args.push(val_2);
if let Some(a) = cause {
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/CreeperPowerEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getLightning",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting CreeperPowerEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for CreeperPowerEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for CreeperPowerEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting CreeperPowerEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for CreeperPowerEvent<'mc> {}
pub enum EntityDamageEventDamageCause<'mc> {
	Kill {inner: EntityDamageEventDamageCauseStruct<'mc>},
	WorldBorder {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Contact {inner: EntityDamageEventDamageCauseStruct<'mc>},
	EntityAttack {inner: EntityDamageEventDamageCauseStruct<'mc>},
	EntitySweepAttack {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Projectile {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Suffocation {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Fall {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Fire {inner: EntityDamageEventDamageCauseStruct<'mc>},
	FireTick {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Melting {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Lava {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Drowning {inner: EntityDamageEventDamageCauseStruct<'mc>},
	BlockExplosion {inner: EntityDamageEventDamageCauseStruct<'mc>},
	EntityExplosion {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Void {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Lightning {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Suicide {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Starvation {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Poison {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Magic {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Wither {inner: EntityDamageEventDamageCauseStruct<'mc>},
	FallingBlock {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Thorns {inner: EntityDamageEventDamageCauseStruct<'mc>},
	DragonBreath {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Custom {inner: EntityDamageEventDamageCauseStruct<'mc>},
	FlyIntoWall {inner: EntityDamageEventDamageCauseStruct<'mc>},
	HotFloor {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Cramming {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Dryout {inner: EntityDamageEventDamageCauseStruct<'mc>},
	Freeze {inner: EntityDamageEventDamageCauseStruct<'mc>},
	SonicBoom {inner: EntityDamageEventDamageCauseStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityDamageEventDamageCause<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           EntityDamageEventDamageCause::EntitySweepAttack { .. } => f.write_str("ENTITY_SWEEP_ATTACK"),
        ...
        impl<'mc> EntityDamageEventDamageCauseTrait<'mc> for EntityDamageEventDamageCause<'mc> {}
        
        pub trait EntityDamageEventDamageCauseTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"KILL" => Ok(EntityDamageEventDamageCause::Kill { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"WORLD_BORDER" => Ok(EntityDamageEventDamageCause::WorldBorder { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"CONTACT" => Ok(EntityDamageEventDamageCause::Contact { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"ENTITY_ATTACK" => Ok(EntityDamageEventDamageCause::EntityAttack { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"ENTITY_SWEEP_ATTACK" => Ok(EntityDamageEventDamageCause::EntitySweepAttack { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"PROJECTILE" => Ok(EntityDamageEventDamageCause::Projectile { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"SUFFOCATION" => Ok(EntityDamageEventDamageCause::Suffocation { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"FALL" => Ok(EntityDamageEventDamageCause::Fall { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"FIRE" => Ok(EntityDamageEventDamageCause::Fire { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"FIRE_TICK" => Ok(EntityDamageEventDamageCause::FireTick { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"MELTING" => Ok(EntityDamageEventDamageCause::Melting { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"LAVA" => Ok(EntityDamageEventDamageCause::Lava { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"DROWNING" => Ok(EntityDamageEventDamageCause::Drowning { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"BLOCK_EXPLOSION" => Ok(EntityDamageEventDamageCause::BlockExplosion { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"ENTITY_EXPLOSION" => Ok(EntityDamageEventDamageCause::EntityExplosion { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"VOID" => Ok(EntityDamageEventDamageCause::Void { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"LIGHTNING" => Ok(EntityDamageEventDamageCause::Lightning { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"SUICIDE" => Ok(EntityDamageEventDamageCause::Suicide { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"STARVATION" => Ok(EntityDamageEventDamageCause::Starvation { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"POISON" => Ok(EntityDamageEventDamageCause::Poison { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"MAGIC" => Ok(EntityDamageEventDamageCause::Magic { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"WITHER" => Ok(EntityDamageEventDamageCause::Wither { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"FALLING_BLOCK" => Ok(EntityDamageEventDamageCause::FallingBlock { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"THORNS" => Ok(EntityDamageEventDamageCause::Thorns { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"DRAGON_BREATH" => Ok(EntityDamageEventDamageCause::DragonBreath { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"CUSTOM" => Ok(EntityDamageEventDamageCause::Custom { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"FLY_INTO_WALL" => Ok(EntityDamageEventDamageCause::FlyIntoWall { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"HOT_FLOOR" => Ok(EntityDamageEventDamageCause::HotFloor { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"CRAMMING" => Ok(EntityDamageEventDamageCause::Cramming { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"DRYOUT" => Ok(EntityDamageEventDamageCause::Dryout { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"FREEZE" => Ok(EntityDamageEventDamageCause::Freeze { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
"SONIC_BOOM" => Ok(EntityDamageEventDamageCause::SonicBoom { inner: EntityDamageEventDamageCauseStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityDamageEventDamageCauseStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::WorldBorder { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Contact { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::EntityAttack { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::EntitySweepAttack { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Projectile { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Suffocation { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::BlockExplosion { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::EntityExplosion { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::Starvation { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::Custom { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FlyIntoWall { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for EntityDamageEventDamageCause<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityDamageEvent/DamageCause")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/event/entity/EntityDamageEvent/DamageCause"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> SheepDyeWoolEventTrait<'mc> for SheepDyeWoolEvent<'mc> {}
pub trait SheepDyeWoolEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,sheep: impl Into<crate::entity::Sheep<'mc>>,color: impl Into<crate::DyeColor<'mc>>,player: std::option::Option<impl Into<crate::entity::Player<'mc>>>) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(color.into().jni_object().clone())});
args.push(val_2);
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/SheepDyeWoolEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SheepDyeWoolEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for SheepDyeWoolEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for SheepDyeWoolEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SheepDyeWoolEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for SheepDyeWoolEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntityBreedEventTrait<'mc> for EntityBreedEvent<'mc> {}
pub trait EntityBreedEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,child: impl Into<crate::entity::LivingEntity<'mc>>,mother: impl Into<crate::entity::LivingEntity<'mc>>,father: impl Into<crate::entity::LivingEntity<'mc>>,breeder: impl Into<crate::entity::LivingEntity<'mc>>,bred_with: impl Into<crate::inventory::ItemStack<'mc>>,experience: i32) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(child.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(mother.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(father.into().jni_object().clone())});
let val_4 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(breeder.into().jni_object().clone())});
let val_5 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(bred_with.into().jni_object().clone())});
let val_6 = jni::objects::JValueGen::Int(experience);
let cls = jni.find_class("org/bukkit/event/entity/EntityBreedEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
{let sig = String::from("()Lorg/bukkit/entity/LivingEntity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getMother",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::LivingEntity::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let sig = String::from("()Lorg/bukkit/entity/LivingEntity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getFather",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::LivingEntity::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let sig = String::from("()Lorg/bukkit/entity/LivingEntity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getBreeder",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
{let sig = String::from("()Lorg/bukkit/inventory/ItemStack;");
let res = self.jni_ref().call_method(&self.jni_object(),"getBredWith",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// Set the amount of experience granted by breeding.
	fn set_experience(&self,experience: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityBreedEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityBreedEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityBreedEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityBreedEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityBreedEvent<'mc> {}
#[repr(C)]
...
impl<'mc> SpawnerSpawnEventTrait<'mc> for SpawnerSpawnEvent<'mc> {}
pub trait SpawnerSpawnEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,spawnee: impl Into<crate::entity::Entity<'mc>>,spawner: impl Into<crate::block::CreatureSpawner<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(spawnee.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(spawner.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/SpawnerSpawnEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getSpawner",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::event::entity::EntitySpawnEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SpawnerSpawnEvent into crate::event::entity::EntitySpawnEvent")

   }
}
impl<'mc> crate::event::entity::EntitySpawnEventTrait<'mc> for SpawnerSpawnEvent<'mc> {}
#[repr(C)]
...
impl<'mc> ItemMergeEventTrait<'mc> for ItemMergeEvent<'mc> {}
pub trait ItemMergeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,item: impl Into<crate::entity::Item<'mc>>,target: impl Into<crate::entity::Item<'mc>>) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(target.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/ItemMergeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ItemMergeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for ItemMergeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for ItemMergeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ItemMergeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for ItemMergeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for VillagerCareerChangeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/VillagerCareerChangeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> VillagerCareerChangeEventTrait<'mc> for VillagerCareerChangeEvent<'mc> {}
pub trait VillagerCareerChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Villager<'mc>>,profession: impl Into<crate::entity::VillagerProfession<'mc>>,reason: impl Into<crate::event::entity::VillagerCareerChangeEventChangeReason<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(profession.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(reason.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/VillagerCareerChangeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
crate::event::entity::VillagerCareerChangeEvent::from_raw(&jni,res
	...
	fn entity(&self) 
-> Result<crate::entity::Villager<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/entity/Villager;");
let res = self.jni_ref().call_method(&self.jni_object(),"getEntity",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::Villager::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
/// Sets the profession the villager will become from this event.
	fn set_profession(&self,profession: impl Into<crate::entity::VillagerProfession<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting VillagerCareerChangeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for VillagerCareerChangeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for VillagerCareerChangeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting VillagerCareerChangeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for VillagerCareerChangeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityPickupItemEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityPickupItemEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityPickupItemEventTrait<'mc> for EntityPickupItemEvent<'mc> {}
pub trait EntityPickupItemEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::LivingEntity<'mc>>,item: impl Into<crate::entity::Item<'mc>>,remaining: i32) 
...
let cls = jni.find_class("org/bukkit/event/entity/EntityPickupItemEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPickupItemEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityPickupItemEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityPickupItemEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPickupItemEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityPickupItemEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityExhaustionEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityExhaustionEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityExhaustionEventTrait<'mc> for EntityExhaustionEvent<'mc> {}
pub trait EntityExhaustionEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,who: impl Into<crate::entity::HumanEntity<'mc>>,exhaustion_reason: impl Into<crate::event::entity::EntityExhaustionEventExhaustionReason<'mc>>,exhaustion: f32) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(exhaustion_reason.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Float(exhaustion);
let cls = jni.find_class("org/bukkit/event/entity/EntityExhaustionEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Gets the {@link ExhaustionReason} for this event
	fn exhaustion_reason(&self) 
-> Result<crate::event::entity::EntityExhaustionEventExhaustionReason<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/event/entity/EntityExhaustionEvent/ExhaustionReason;");
let res = self.jni_ref().call_method(&self.jni_object(),"getExhaustionReason",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// unknown behavior for when exhaustion is below 0.
	fn set_exhaustion(&self,exhaustion: f32) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityExhaustionEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityExhaustionEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityExhaustionEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityExhaustionEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityExhaustionEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityPotionEffectEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityPotionEffectEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityPotionEffectEventTrait<'mc> for EntityPotionEffectEvent<'mc> {}
pub trait EntityPotionEffectEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,living_entity: impl Into<crate::entity::LivingEntity<'mc>>,old_effect: impl Into<crate::potion::PotionEffect<'mc>>,new_effect: impl Into<crate::potion::PotionEffect<'mc>>,cause: impl Into<crate::event::entity::EntityPotionEffectEventCause<'mc>>,action: impl Into<crate::event::entity::EntityPotionEffectEventAction<'mc>>,val_override: bool) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(old_effect.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(new_effect.into().jni_object().clone())});
...
let cls = jni.find_class("org/bukkit/event/entity/EntityPotionEffectEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3),jni::objects::JValueGen::from(val_4),jni::objects::JValueGen::from(val_5),jni::objects::JValueGen::from(val_6)]);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getOldEffect",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
{let sig = String::from("()Lorg/bukkit/potion/PotionEffect;");
let res = self.jni_ref().call_method(&self.jni_object(),"getNewEffect",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"isOverride",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// applicable for the CHANGED action).
	fn set_override(&self,val_override: bool) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Z)V");
let val_1 = jni::objects::JValueGen::Bool(val_override.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setOverride",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPotionEffectEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityPotionEffectEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityPotionEffectEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPotionEffectEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityPotionEffectEvent<'mc> {}
#[repr(C)]
pub struct EntityKnockbackByEntityEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EntityKnockbackByEntityEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityKnockbackByEntityEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityKnockbackByEntityEventTrait<'mc> for EntityKnockbackByEntityEvent<'mc> {}
pub trait EntityKnockbackByEntityEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::LivingEntity<'mc>>,source: impl Into<crate::entity::Entity<'mc>>,cause: impl Into<crate::event::entity::EntityKnockbackEventKnockbackCause<'mc>>,force: f64,raw_knockback: impl Into<crate::util::Vector<'mc>>,knockback: impl Into<crate::util::Vector<'mc>>) 
...
let val_5 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(raw_knockback.into().jni_object().clone())});
let val_6 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(knockback.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityKnockbackByEntityEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3),jni::objects::JValueGen::from(val_4),jni::objects::JValueGen::from(val_5),jni::objects::JValueGen::from(val_6)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Get the entity that has caused knockback to the defender.
	fn source_entity(&self) 
-> Result<crate::entity::Entity<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/entity/Entity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getSourceEntity",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::Entity::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
impl<'mc> Into<crate::event::entity::EntityKnockbackEvent<'mc>> for EntityKnockbackByEntityEvent<'mc>{

fn into(self) -> crate::event::entity::EntityKnockbackEvent<'mc> {

crate::event::entity::EntityKnockbackEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityKnockbackByEntityEvent into crate::event::entity::EntityKnockbackEvent")

   }
}
impl<'mc> crate::event::entity::EntityKnockbackEventTrait<'mc> for EntityKnockbackByEntityEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityToggleSwimEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityToggleSwimEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityToggleSwimEventTrait<'mc> for EntityToggleSwimEvent<'mc> {}
pub trait EntityToggleSwimEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,who: impl Into<crate::entity::LivingEntity<'mc>>,is_swimming: bool) 
...
let cls = jni.find_class("org/bukkit/event/entity/EntityToggleSwimEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityToggleSwimEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityToggleSwimEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityToggleSwimEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityToggleSwimEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityToggleSwimEvent<'mc> {}
#[repr(C)]
...
impl<'mc> PigZapEventTrait<'mc> for PigZapEvent<'mc> {}
pub trait PigZapEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,pig: impl Into<crate::entity::Pig<'mc>>,bolt: impl Into<crate::entity::LightningStrike<'mc>>,pigzombie: impl Into<crate::entity::PigZombie<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(pig.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(bolt.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(pigzombie.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/PigZapEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getPigZombie",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PigZapEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for PigZapEvent<'mc> {}
...
crate::event::entity::EntityTransformEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PigZapEvent into crate::event::entity::EntityTransformEvent")

   }
}
impl<'mc> crate::event::entity::EntityTransformEventTrait<'mc> for PigZapEvent<'mc> {}
pub enum EntityRegainHealthEventRegainReason<'mc> {
	Regen {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
	Satiated {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
	Eating {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
	EnderCrystal {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
	Magic {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
	MagicRegen {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
	WitherSpawn {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
	Wither {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
	Custom {inner: EntityRegainHealthEventRegainReasonStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityRegainHealthEventRegainReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           EntityRegainHealthEventRegainReason::EnderCrystal { .. } => f.write_str("ENDER_CRYSTAL"),
        ...
        impl<'mc> EntityRegainHealthEventRegainReasonTrait<'mc> for EntityRegainHealthEventRegainReason<'mc> {}
        
        pub trait EntityRegainHealthEventRegainReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"REGEN" => Ok(EntityRegainHealthEventRegainReason::Regen { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
"SATIATED" => Ok(EntityRegainHealthEventRegainReason::Satiated { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
"EATING" => Ok(EntityRegainHealthEventRegainReason::Eating { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
"ENDER_CRYSTAL" => Ok(EntityRegainHealthEventRegainReason::EnderCrystal { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
"MAGIC" => Ok(EntityRegainHealthEventRegainReason::Magic { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
"MAGIC_REGEN" => Ok(EntityRegainHealthEventRegainReason::MagicRegen { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
"WITHER_SPAWN" => Ok(EntityRegainHealthEventRegainReason::WitherSpawn { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
"WITHER" => Ok(EntityRegainHealthEventRegainReason::Wither { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
"CUSTOM" => Ok(EntityRegainHealthEventRegainReason::Custom { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityRegainHealthEventRegainReasonStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::Magic { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::MagicRegen { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::WitherSpawn { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Wither { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Custom { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
}
}
...
impl<'mc> JNIInstantiatable<'mc> for EntityRegainHealthEventRegainReason<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityRegainHealthEvent/RegainReason")?;
            if !valid {
                Err(eyre::eyre!(
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "REGEN" => Ok(EntityRegainHealthEventRegainReason::Regen { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),"SATIATED" => Ok(EntityRegainHealthEventRegainReason::Satiated { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),"EATING" => Ok(EntityRegainHealthEventRegainReason::Eating { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),"ENDER_CRYSTAL" => Ok(EntityRegainHealthEventRegainReason::EnderCrystal { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),"MAGIC" => Ok(EntityRegainHealthEventRegainReason::Magic { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),"MAGIC_REGEN" => Ok(EntityRegainHealthEventRegainReason::MagicRegen { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),"WITHER_SPAWN" => Ok(EntityRegainHealthEventRegainReason::WitherSpawn { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),"WITHER" => Ok(EntityRegainHealthEventRegainReason::Wither { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),"CUSTOM" => Ok(EntityRegainHealthEventRegainReason::Custom { inner: EntityRegainHealthEventRegainReasonStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
let cls = jni.find_class("org/bukkit/event/entity/EntityRegainHealthEvent/RegainReason"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
#[repr(C)]
pub struct EntityKnockbackEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EntityKnockbackEvent<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EntityKnockbackEvent from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityKnockbackEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityKnockbackEventTrait<'mc> for EntityKnockbackEvent<'mc> {}
pub trait EntityKnockbackEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::LivingEntity<'mc>>,cause: impl Into<crate::event::entity::EntityKnockbackEventKnockbackCause<'mc>>,force: f64,raw_knockback: impl Into<crate::util::Vector<'mc>>,knockback: impl Into<crate::util::Vector<'mc>>) 
...
let val_4 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(raw_knockback.into().jni_object().clone())});
let val_5 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(knockback.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityKnockbackEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
/// Gets the cause of the knockback.
	fn cause(&self) 
-> Result<crate::event::entity::EntityKnockbackEventKnockbackCause<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/event/entity/EntityKnockbackEvent/KnockbackCause;");
let res = self.jni_ref().call_method(&self.jni_object(),"getCause",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::event::entity::EntityKnockbackEventKnockbackCause::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"getKnockback",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// {@link #setFinalKnockback(Vector)}.
	fn final_knockback(&self) 
-> Result<crate::util::Vector<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/util/Vector;");
let res = self.jni_ref().call_method(&self.jni_object(),"getFinalKnockback",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::util::Vector::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// Sets the force that will be applied to the entity.
	fn set_final_knockback(&self,knockback: impl Into<crate::util::Vector<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/util/Vector;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(knockback.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"setFinalKnockback",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityKnockbackEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityKnockbackEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityKnockbackEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityKnockbackEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityKnockbackEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for StriderTemperatureChangeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/StriderTemperatureChangeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> StriderTemperatureChangeEventTrait<'mc> for StriderTemperatureChangeEvent<'mc> {}
pub trait StriderTemperatureChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Strider<'mc>>,shivering: bool) 
...
let cls = jni.find_class("org/bukkit/event/entity/StriderTemperatureChangeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting StriderTemperatureChangeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for StriderTemperatureChangeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for StriderTemperatureChangeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting StriderTemperatureChangeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for StriderTemperatureChangeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityPoseChangeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityPoseChangeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityPoseChangeEventTrait<'mc> for EntityPoseChangeEvent<'mc> {}
pub trait EntityPoseChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,who: impl Into<crate::entity::Entity<'mc>>,pose: impl Into<crate::entity::Pose<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(who.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(pose.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityPoseChangeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPoseChangeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityPoseChangeEvent<'mc> {}
#[repr(C)]
pub struct EntityRemoveEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EntityRemoveEvent<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EntityRemoveEvent from null object.")
                .into());
            }
...
impl<'mc> EntityRemoveEventTrait<'mc> for EntityRemoveEvent<'mc> {}
pub trait EntityRemoveEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,cause: impl Into<crate::event::entity::EntityRemoveEventCause<'mc>>) 
-> Result<crate::event::entity::EntityRemoveEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;Lorg/bukkit/event/entity/EntityRemoveEvent/Cause;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(cause.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityRemoveEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = 
self.jni_ref().translate_error(res)?;
crate::event::entity::EntityRemoveEventCause::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityRemoveEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityRemoveEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for AreaEffectCloudApplyEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/AreaEffectCloudApplyEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> AreaEffectCloudApplyEventTrait<'mc> for AreaEffectCloudApplyEvent<'mc> {}
pub trait AreaEffectCloudApplyEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::AreaEffectCloud<'mc>>,affected_entities: Vec<jni::objects::JObject<'mc>>) 
...
let val_2 = jni::objects::JValueGen::Object(raw_val_2);
let cls = jni.find_class("org/bukkit/event/entity/AreaEffectCloudApplyEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// or {@link AreaEffectCloud#getRadiusOnUse()}
	fn affected_entities(&self) 
-> Result<Vec<crate::entity::LivingEntity<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("()Ljava/util/List;");
let res = self.jni_ref().call_method(&self.jni_object(),"getAffectedEntities",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
let mut new_vec = Vec::new();
let list = blackboxmc_java::util::JavaList::from_raw(&self.jni_ref(), res.l()?)?;let iter = list.iterator()?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting AreaEffectCloudApplyEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for AreaEffectCloudApplyEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for AreaEffectCloudApplyEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting AreaEffectCloudApplyEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for AreaEffectCloudApplyEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityCombustEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityCombustEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityCombustEventTrait<'mc> for EntityCombustEvent<'mc> {}
pub trait EntityCombustEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,combustee: impl Into<crate::entity::Entity<'mc>>,duration: i32) 
-> Result<crate::event::entity::EntityCombustEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;I)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(combustee.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Int(duration);
let cls = jni.find_class("org/bukkit/event/entity/EntityCombustEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityCombustEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityCombustEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityCombustEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityCombustEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityCombustEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityBreakDoorEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityBreakDoorEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityBreakDoorEventTrait<'mc> for EntityBreakDoorEvent<'mc> {}
pub trait EntityBreakDoorEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::LivingEntity<'mc>>,target_block: impl Into<crate::block::Block<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(target_block.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityBreakDoorEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::entity::EntityChangeBlockEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityBreakDoorEvent into crate::event::entity::EntityChangeBlockEvent")

   }
}
impl<'mc> crate::event::entity::EntityChangeBlockEventTrait<'mc> for EntityBreakDoorEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for ProjectileHitEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/ProjectileHitEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> ProjectileHitEventTrait<'mc> for ProjectileHitEvent<'mc> {}
pub trait ProjectileHitEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,projectile: impl Into<crate::entity::Projectile<'mc>>,hit_entity: std::option::Option<impl Into<crate::entity::Entity<'mc>>>,hit_block: std::option::Option<impl Into<crate::block::Block<'mc>>>,hit_face: std::option::Option<impl Into<crate::block::BlockFace<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/ProjectileHitEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ProjectileHitEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for ProjectileHitEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for ProjectileHitEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ProjectileHitEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for ProjectileHitEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for ExplosionPrimeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/ExplosionPrimeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> ExplosionPrimeEventTrait<'mc> for ExplosionPrimeEvent<'mc> {}
pub trait ExplosionPrimeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,radius: std::option::Option<f32>,fire: std::option::Option<bool>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/ExplosionPrimeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"getFire",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// Sets whether this explosion will create fire or not
	fn set_fire(&self,fire: bool) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Z)V");
let val_1 = jni::objects::JValueGen::Bool(fire.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setFire",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ExplosionPrimeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for ExplosionPrimeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for ExplosionPrimeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ExplosionPrimeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for ExplosionPrimeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> SlimeSplitEventTrait<'mc> for SlimeSplitEvent<'mc> {}
pub trait SlimeSplitEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,slime: impl Into<crate::entity::Slime<'mc>>,count: i32) 
-> Result<crate::event::entity::SlimeSplitEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Slime;I)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(slime.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Int(count);
let cls = jni.find_class("org/bukkit/event/entity/SlimeSplitEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SlimeSplitEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for SlimeSplitEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for SlimeSplitEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SlimeSplitEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for SlimeSplitEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for PlayerLeashEntityEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/PlayerLeashEntityEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> PlayerLeashEntityEventTrait<'mc> for PlayerLeashEntityEvent<'mc> {}
pub trait PlayerLeashEntityEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,leash_holder: impl Into<crate::entity::Entity<'mc>>,leasher: impl Into<crate::entity::Player<'mc>>,hand: std::option::Option<impl Into<crate::inventory::EquipmentSlot<'mc>>>) 
...
args.push(val_1);
sig += "Lorg/bukkit/entity/Entity;";
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(leash_holder.into().jni_object().clone())});
args.push(val_2);
sig += "Lorg/bukkit/entity/Player;";
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(leasher.into().jni_object().clone())});
args.push(val_3);
if let Some(a) = hand {
sig += "Lorg/bukkit/inventory/EquipmentSlot;";
let val_4 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(a.into().jni_object().clone())});
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/PlayerLeashEntityEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PlayerLeashEntityEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for PlayerLeashEntityEvent<'mc> {}
impl<'mc> Into<crate::event::Event<'mc>> for PlayerLeashEntityEvent<'mc>{

fn into(self) -> crate::event::Event<'mc> {

crate::event::Event::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PlayerLeashEntityEvent into crate::event::Event")

   }
}
impl<'mc> crate::event::EventTrait<'mc> for PlayerLeashEntityEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityDamageByBlockEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityDamageByBlockEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityDamageByBlockEventTrait<'mc> for EntityDamageByBlockEvent<'mc> {}
pub trait EntityDamageByBlockEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,damager: impl Into<crate::block::Block<'mc>>,damagee: impl Into<crate::entity::Entity<'mc>>,cause: impl Into<crate::event::entity::EntityDamageEventDamageCause<'mc>>,damage_source: impl Into<crate::damage::DamageSource<'mc>>,modifiers: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>,modifier_functions: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/EntityDamageByBlockEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::entity::EntityDamageEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDamageByBlockEvent into crate::event::entity::EntityDamageEvent")

   }
}
impl<'mc> crate::event::entity::EntityDamageEventTrait<'mc> for EntityDamageByBlockEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityEnterBlockEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityEnterBlockEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityEnterBlockEventTrait<'mc> for EntityEnterBlockEvent<'mc> {}
pub trait EntityEnterBlockEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,block: impl Into<crate::block::Block<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(block.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityEnterBlockEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityEnterBlockEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityEnterBlockEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityEnterBlockEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityEnterBlockEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityEnterBlockEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityTargetLivingEntityEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityTargetLivingEntityEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityTargetLivingEntityEventTrait<'mc> for EntityTargetLivingEntityEvent<'mc> {}
pub trait EntityTargetLivingEntityEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,target: impl Into<crate::entity::LivingEntity<'mc>>,reason: impl Into<crate::event::entity::EntityTargetEventTargetReason<'mc>>) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(target.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(reason.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityTargetLivingEntityEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Must be a LivingEntity, or null.
	fn set_target(&self,target: impl Into<crate::entity::Entity<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::entity::EntityTargetEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTargetLivingEntityEvent into crate::event::entity::EntityTargetEvent")

   }
}
impl<'mc> crate::event::entity::EntityTargetEventTrait<'mc> for EntityTargetLivingEntityEvent<'mc> {}
pub enum EntityUnleashEventUnleashReason<'mc> {
	HolderGone {inner: EntityUnleashEventUnleashReasonStruct<'mc>},
	PlayerUnleash {inner: EntityUnleashEventUnleashReasonStruct<'mc>},
	Distance {inner: EntityUnleashEventUnleashReasonStruct<'mc>},
	Unknown {inner: EntityUnleashEventUnleashReasonStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityUnleashEventUnleashReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> EntityUnleashEventUnleashReasonTrait<'mc> for EntityUnleashEventUnleashReason<'mc> {}
        
        pub trait EntityUnleashEventUnleashReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"HOLDER_GONE" => Ok(EntityUnleashEventUnleashReason::HolderGone { inner: EntityUnleashEventUnleashReasonStruct::from_raw(env,obj)?}),
"PLAYER_UNLEASH" => Ok(EntityUnleashEventUnleashReason::PlayerUnleash { inner: EntityUnleashEventUnleashReasonStruct::from_raw(env,obj)?}),
"DISTANCE" => Ok(EntityUnleashEventUnleashReason::Distance { inner: EntityUnleashEventUnleashReasonStruct::from_raw(env,obj)?}),
"UNKNOWN" => Ok(EntityUnleashEventUnleashReason::Unknown { inner: EntityUnleashEventUnleashReasonStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityUnleashEventUnleashReasonStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
fn jni_object(&self) -> jni::objects::JObject<'mc> {
match self {
Self::HolderGone { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::PlayerUnleash { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for EntityUnleashEventUnleashReason<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityUnleashEvent/UnleashReason")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/event/entity/EntityUnleashEvent/UnleashReason"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> JNIInstantiatable<'mc> for EnderDragonChangePhaseEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EnderDragonChangePhaseEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EnderDragonChangePhaseEventTrait<'mc> for EnderDragonChangePhaseEvent<'mc> {}
pub trait EnderDragonChangePhaseEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,ender_dragon: impl Into<crate::entity::EnderDragon<'mc>>,current_phase: impl Into<crate::entity::EnderDragonPhase<'mc>>,new_phase: impl Into<crate::entity::EnderDragonPhase<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(ender_dragon.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(current_phase.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(new_phase.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EnderDragonChangePhaseEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getCurrentPhase",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
{let sig = String::from("()Lorg/bukkit/entity/EnderDragon/Phase;");
let res = self.jni_ref().call_method(&self.jni_object(),"getNewPhase",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::EnderDragonPhase::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// Sets the new phase for the ender dragon.
	fn set_new_phase(&self,new_phase: impl Into<crate::entity::EnderDragonPhase<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/EnderDragon/Phase;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(new_phase.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"setNewPhase",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EnderDragonChangePhaseEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EnderDragonChangePhaseEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EnderDragonChangePhaseEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EnderDragonChangePhaseEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EnderDragonChangePhaseEvent<'mc> {}
#[repr(C)]
...
impl<'mc> ExpBottleEventTrait<'mc> for ExpBottleEvent<'mc> {}
pub trait ExpBottleEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,bottle: impl Into<crate::entity::ThrownExpBottle<'mc>>,hit_entity: impl Into<crate::entity::Entity<'mc>>,hit_block: std::option::Option<impl Into<crate::block::Block<'mc>>>,hit_face: std::option::Option<impl Into<crate::block::BlockFace<'mc>>>,exp: std::option::Option<i32>) 
-> Result<crate::event::entity::ExpBottleEvent<'mc>, Box<dyn std::error::Error>>

{let mut args = Vec::new();
let mut sig = String::from("(");
sig += "Lorg/bukkit/entity/ThrownExpBottle;";
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(bottle.into().jni_object().clone())});
args.push(val_1);
sig += "Lorg/bukkit/entity/Entity;";
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(hit_entity.into().jni_object().clone())});
args.push(val_2);
if let Some(a) = hit_block {
sig += "Lorg/bukkit/block/Block;";
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(a.into().jni_object().clone())});
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/ExpBottleEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"getShowEffect",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// This does not change the experience created.
	fn set_show_effect(&self,show_effect: bool) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Z)V");
let val_1 = jni::objects::JValueGen::Bool(show_effect.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setShowEffect",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// 
/// The number indicates a total amount to be divided into orbs.
	fn set_experience(&self,exp: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::entity::ProjectileHitEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ExpBottleEvent into crate::event::entity::ProjectileHitEvent")

   }
}
impl<'mc> crate::event::entity::ProjectileHitEventTrait<'mc> for ExpBottleEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityToggleGlideEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityToggleGlideEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityToggleGlideEventTrait<'mc> for EntityToggleGlideEvent<'mc> {}
pub trait EntityToggleGlideEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,who: impl Into<crate::entity::LivingEntity<'mc>>,is_gliding: bool) 
...
let cls = jni.find_class("org/bukkit/event/entity/EntityToggleGlideEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityToggleGlideEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityToggleGlideEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityToggleGlideEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityToggleGlideEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityToggleGlideEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for BatToggleSleepEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/BatToggleSleepEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> BatToggleSleepEventTrait<'mc> for BatToggleSleepEvent<'mc> {}
pub trait BatToggleSleepEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Bat<'mc>>,awake: bool) 
...
let cls = jni.find_class("org/bukkit/event/entity/BatToggleSleepEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting BatToggleSleepEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for BatToggleSleepEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for BatToggleSleepEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting BatToggleSleepEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for BatToggleSleepEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for PigZombieAngerEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/PigZombieAngerEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> PigZombieAngerEventTrait<'mc> for PigZombieAngerEvent<'mc> {}
pub trait PigZombieAngerEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,pig_zombie: impl Into<crate::entity::PigZombie<'mc>>,target: impl Into<crate::entity::Entity<'mc>>,new_anger: i32) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(pig_zombie.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(target.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Int(new_anger);
let cls = jni.find_class("org/bukkit/event/entity/PigZombieAngerEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getNewAnger",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
/// Sets the new anger resulting from this event.
	fn set_new_anger(&self,new_anger: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(I)V");
let val_1 = jni::objects::JValueGen::Int(new_anger);
let res = self.jni_ref().call_method(&self.jni_object(),"setNewAnger",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PigZombieAngerEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for PigZombieAngerEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for PigZombieAngerEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PigZombieAngerEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for PigZombieAngerEvent<'mc> {}
pub enum EntityPotionEffectEventCause<'mc> {
	AreaEffectCloud {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Arrow {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Attack {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Axolotl {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Beacon {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Command {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Conduit {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Conversion {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Death {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Dolphin {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Expiration {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Food {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Illusion {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Milk {inner: EntityPotionEffectEventCauseStruct<'mc>},
	PatrolCaptain {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Plugin {inner: EntityPotionEffectEventCauseStruct<'mc>},
	PotionDrink {inner: EntityPotionEffectEventCauseStruct<'mc>},
	PotionSplash {inner: EntityPotionEffectEventCauseStruct<'mc>},
	SpiderSpawn {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Totem {inner: EntityPotionEffectEventCauseStruct<'mc>},
	TurtleHelmet {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Unknown {inner: EntityPotionEffectEventCauseStruct<'mc>},
	VillagerTrade {inner: EntityPotionEffectEventCauseStruct<'mc>},
	Warden {inner: EntityPotionEffectEventCauseStruct<'mc>},
	WitherRose {inner: EntityPotionEffectEventCauseStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityPotionEffectEventCause<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           EntityPotionEffectEventCause::AreaEffectCloud { .. } => f.write_str("AREA_EFFECT_CLOUD"),
        ...
        impl<'mc> EntityPotionEffectEventCauseTrait<'mc> for EntityPotionEffectEventCause<'mc> {}
        
        pub trait EntityPotionEffectEventCauseTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"AREA_EFFECT_CLOUD" => Ok(EntityPotionEffectEventCause::AreaEffectCloud { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"ARROW" => Ok(EntityPotionEffectEventCause::Arrow { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"ATTACK" => Ok(EntityPotionEffectEventCause::Attack { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"AXOLOTL" => Ok(EntityPotionEffectEventCause::Axolotl { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"BEACON" => Ok(EntityPotionEffectEventCause::Beacon { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"COMMAND" => Ok(EntityPotionEffectEventCause::Command { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"CONDUIT" => Ok(EntityPotionEffectEventCause::Conduit { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"CONVERSION" => Ok(EntityPotionEffectEventCause::Conversion { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"DEATH" => Ok(EntityPotionEffectEventCause::Death { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"DOLPHIN" => Ok(EntityPotionEffectEventCause::Dolphin { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"EXPIRATION" => Ok(EntityPotionEffectEventCause::Expiration { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"FOOD" => Ok(EntityPotionEffectEventCause::Food { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"ILLUSION" => Ok(EntityPotionEffectEventCause::Illusion { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"MILK" => Ok(EntityPotionEffectEventCause::Milk { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"PATROL_CAPTAIN" => Ok(EntityPotionEffectEventCause::PatrolCaptain { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"PLUGIN" => Ok(EntityPotionEffectEventCause::Plugin { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"POTION_DRINK" => Ok(EntityPotionEffectEventCause::PotionDrink { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"POTION_SPLASH" => Ok(EntityPotionEffectEventCause::PotionSplash { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"SPIDER_SPAWN" => Ok(EntityPotionEffectEventCause::SpiderSpawn { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"TOTEM" => Ok(EntityPotionEffectEventCause::Totem { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"TURTLE_HELMET" => Ok(EntityPotionEffectEventCause::TurtleHelmet { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"UNKNOWN" => Ok(EntityPotionEffectEventCause::Unknown { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"VILLAGER_TRADE" => Ok(EntityPotionEffectEventCause::VillagerTrade { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"WARDEN" => Ok(EntityPotionEffectEventCause::Warden { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
"WITHER_ROSE" => Ok(EntityPotionEffectEventCause::WitherRose { inner: EntityPotionEffectEventCauseStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityPotionEffectEventCauseStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::Conversion { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Death { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Dolphin { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Expiration { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::PatrolCaptain { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Plugin { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::PotionDrink { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::PotionSplash { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SpiderSpawn { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::Unknown { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillagerTrade { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for EntityPotionEffectEventCause<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityPotionEffectEvent/Cause")?;
            if !valid {
                Err(eyre::eyre!(
...
{let sig = String::from("()Lorg/bukkit/event/entity/EntityPotionEffectEvent/Cause;");
let cls = jni.find_class("org/bukkit/event/entity/EntityPotionEffectEvent/Cause"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> JNIInstantiatable<'mc> for EntityDropItemEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityDropItemEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityDropItemEventTrait<'mc> for EntityDropItemEvent<'mc> {}
pub trait EntityDropItemEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,drop: impl Into<crate::entity::Item<'mc>>) 
...
let cls = jni.find_class("org/bukkit/event/entity/EntityDropItemEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDropItemEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityDropItemEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityDropItemEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDropItemEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityDropItemEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityResurrectEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityResurrectEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityResurrectEventTrait<'mc> for EntityResurrectEvent<'mc> {}
pub trait EntityResurrectEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::LivingEntity<'mc>>,hand: std::option::Option<impl Into<crate::inventory::EquipmentSlot<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/EntityResurrectEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityResurrectEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityResurrectEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityResurrectEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityResurrectEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityResurrectEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for LingeringPotionSplashEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/LingeringPotionSplashEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> LingeringPotionSplashEventTrait<'mc> for LingeringPotionSplashEvent<'mc> {}
pub trait LingeringPotionSplashEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,potion: impl Into<crate::entity::ThrownPotion<'mc>>,hit_entity: impl Into<crate::entity::Entity<'mc>>,hit_block: std::option::Option<impl Into<crate::block::Block<'mc>>>,hit_face: std::option::Option<impl Into<crate::block::BlockFace<'mc>>>,entity: std::option::Option<impl Into<crate::entity::AreaEffectCloud<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/LingeringPotionSplashEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Gets the AreaEffectCloud spawned
	fn area_effect_cloud(&self) 
-> Result<crate::entity::AreaEffectCloud<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/entity/AreaEffectCloud;");
let res = self.jni_ref().call_method(&self.jni_object(),"getAreaEffectCloud",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::AreaEffectCloud::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting LingeringPotionSplashEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for LingeringPotionSplashEvent<'mc> {}
impl<'mc> Into<crate::event::entity::ProjectileHitEvent<'mc>> for LingeringPotionSplashEvent<'mc>{

fn into(self) -> crate::event::entity::ProjectileHitEvent<'mc> {

crate::event::entity::ProjectileHitEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting LingeringPotionSplashEvent into crate::event::entity::ProjectileHitEvent")

   }
}
impl<'mc> crate::event::entity::ProjectileHitEventTrait<'mc> for LingeringPotionSplashEvent<'mc> {}
pub enum CreatureSpawnEventSpawnReason<'mc> {
	Natural {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Jockey {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	ChunkGen {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Spawner {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Egg {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	SpawnerEgg {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Lightning {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	BuildSnowman {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	BuildIrongolem {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	BuildWither {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	VillageDefense {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	VillageInvasion {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Breeding {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	SlimeSplit {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Reinforcements {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	NetherPortal {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	DispenseEgg {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Infection {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Cured {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	OcelotBaby {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	SilverfishBlock {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Mount {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Trap {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	EnderPearl {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	ShoulderEntity {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Drowned {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Sheared {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Explosion {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Raid {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Patrol {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Beehive {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	PiglinZombified {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Spell {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Frozen {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Metamorphosis {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Duplication {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Command {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Custom {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
	Default {inner: CreatureSpawnEventSpawnReasonStruct<'mc>},
}
impl<'mc> std::fmt::Display for CreatureSpawnEventSpawnReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           CreatureSpawnEventSpawnReason::VillageInvasion { .. } => f.write_str("VILLAGE_INVASION"),
           ...
           CreatureSpawnEventSpawnReason::SilverfishBlock { .. } => f.write_str("SILVERFISH_BLOCK"),
           ...
           CreatureSpawnEventSpawnReason::PiglinZombified { .. } => f.write_str("PIGLIN_ZOMBIFIED"),
        ...
        impl<'mc> CreatureSpawnEventSpawnReasonTrait<'mc> for CreatureSpawnEventSpawnReason<'mc> {}
        
        pub trait CreatureSpawnEventSpawnReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"NATURAL" => Ok(CreatureSpawnEventSpawnReason::Natural { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"JOCKEY" => Ok(CreatureSpawnEventSpawnReason::Jockey { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"CHUNK_GEN" => Ok(CreatureSpawnEventSpawnReason::ChunkGen { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"SPAWNER" => Ok(CreatureSpawnEventSpawnReason::Spawner { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"EGG" => Ok(CreatureSpawnEventSpawnReason::Egg { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"SPAWNER_EGG" => Ok(CreatureSpawnEventSpawnReason::SpawnerEgg { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"LIGHTNING" => Ok(CreatureSpawnEventSpawnReason::Lightning { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"BUILD_SNOWMAN" => Ok(CreatureSpawnEventSpawnReason::BuildSnowman { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"BUILD_IRONGOLEM" => Ok(CreatureSpawnEventSpawnReason::BuildIrongolem { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"BUILD_WITHER" => Ok(CreatureSpawnEventSpawnReason::BuildWither { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"VILLAGE_DEFENSE" => Ok(CreatureSpawnEventSpawnReason::VillageDefense { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"VILLAGE_INVASION" => Ok(CreatureSpawnEventSpawnReason::VillageInvasion { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"BREEDING" => Ok(CreatureSpawnEventSpawnReason::Breeding { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"SLIME_SPLIT" => Ok(CreatureSpawnEventSpawnReason::SlimeSplit { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"REINFORCEMENTS" => Ok(CreatureSpawnEventSpawnReason::Reinforcements { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"NETHER_PORTAL" => Ok(CreatureSpawnEventSpawnReason::NetherPortal { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"DISPENSE_EGG" => Ok(CreatureSpawnEventSpawnReason::DispenseEgg { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"INFECTION" => Ok(CreatureSpawnEventSpawnReason::Infection { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"CURED" => Ok(CreatureSpawnEventSpawnReason::Cured { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"OCELOT_BABY" => Ok(CreatureSpawnEventSpawnReason::OcelotBaby { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"SILVERFISH_BLOCK" => Ok(CreatureSpawnEventSpawnReason::SilverfishBlock { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"MOUNT" => Ok(CreatureSpawnEventSpawnReason::Mount { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"TRAP" => Ok(CreatureSpawnEventSpawnReason::Trap { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"ENDER_PEARL" => Ok(CreatureSpawnEventSpawnReason::EnderPearl { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"SHOULDER_ENTITY" => Ok(CreatureSpawnEventSpawnReason::ShoulderEntity { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"DROWNED" => Ok(CreatureSpawnEventSpawnReason::Drowned { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"SHEARED" => Ok(CreatureSpawnEventSpawnReason::Sheared { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"EXPLOSION" => Ok(CreatureSpawnEventSpawnReason::Explosion { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"RAID" => Ok(CreatureSpawnEventSpawnReason::Raid { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"PATROL" => Ok(CreatureSpawnEventSpawnReason::Patrol { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"BEEHIVE" => Ok(CreatureSpawnEventSpawnReason::Beehive { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"PIGLIN_ZOMBIFIED" => Ok(CreatureSpawnEventSpawnReason::PiglinZombified { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"SPELL" => Ok(CreatureSpawnEventSpawnReason::Spell { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"FROZEN" => Ok(CreatureSpawnEventSpawnReason::Frozen { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"METAMORPHOSIS" => Ok(CreatureSpawnEventSpawnReason::Metamorphosis { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"DUPLICATION" => Ok(CreatureSpawnEventSpawnReason::Duplication { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"COMMAND" => Ok(CreatureSpawnEventSpawnReason::Command { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"CUSTOM" => Ok(CreatureSpawnEventSpawnReason::Custom { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
"DEFAULT" => Ok(CreatureSpawnEventSpawnReason::Default { inner: CreatureSpawnEventSpawnReasonStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct CreatureSpawnEventSpawnReasonStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::SpawnerEgg { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Lightning { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::BuildSnowman { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::BuildIrongolem { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::BuildWither { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageDefense { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageInvasion { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Breeding { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SlimeSplit { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Reinforcements { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::NetherPortal { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::DispenseEgg { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Infection { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Cured { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::OcelotBaby { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SilverfishBlock { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::ShoulderEntity { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Drowned { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Sheared { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::Frozen { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Metamorphosis { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Duplication { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Command { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Custom { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for CreatureSpawnEventSpawnReason<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/CreatureSpawnEvent/SpawnReason")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/event/entity/CreatureSpawnEvent/SpawnReason"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> JNIInstantiatable<'mc> for EntityTeleportEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityTeleportEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityTeleportEventTrait<'mc> for EntityTeleportEvent<'mc> {}
pub trait EntityTeleportEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,from: impl Into<crate::Location<'mc>>,to: impl Into<crate::Location<'mc>>) 
-> Result<crate::event::entity::EntityTeleportEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;Lorg/bukkit/Location;Lorg/bukkit/Location;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(from.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(to.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityTeleportEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTeleportEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityTeleportEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityTeleportEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTeleportEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityTeleportEvent<'mc> {}
#[repr(C)]
...
impl<'mc> ItemSpawnEventTrait<'mc> for ItemSpawnEvent<'mc> {}
pub trait ItemSpawnEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
#[deprecated]

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,spawnee: impl Into<crate::entity::Item<'mc>>,loc: std::option::Option<impl Into<crate::Location<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/ItemSpawnEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::entity::EntitySpawnEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ItemSpawnEvent into crate::event::entity::EntitySpawnEvent")

   }
}
impl<'mc> crate::event::entity::EntitySpawnEventTrait<'mc> for ItemSpawnEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntitySpawnEventTrait<'mc> for EntitySpawnEvent<'mc> {}
pub trait EntitySpawnEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,spawnee: impl Into<crate::entity::Entity<'mc>>) 
-> Result<crate::event::entity::EntitySpawnEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(spawnee.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntitySpawnEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntitySpawnEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntitySpawnEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntitySpawnEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntitySpawnEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntitySpawnEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntityPortalEventTrait<'mc> for EntityPortalEvent<'mc> {}
pub trait EntityPortalEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,from: impl Into<crate::Location<'mc>>,to: impl Into<crate::Location<'mc>>,search_radius: std::option::Option<i32>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/EntityPortalEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::entity::EntityTeleportEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPortalEvent into crate::event::entity::EntityTeleportEvent")

   }
}
impl<'mc> crate::event::entity::EntityTeleportEventTrait<'mc> for EntityPortalEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntityTameEventTrait<'mc> for EntityTameEvent<'mc> {}
pub trait EntityTameEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::LivingEntity<'mc>>,owner: impl Into<crate::entity::AnimalTamer<'mc>>) 
-> Result<crate::event::entity::EntityTameEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/LivingEntity;Lorg/bukkit/entity/AnimalTamer;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(owner.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityTameEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTameEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityTameEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityTameEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTameEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityTameEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for CreatureSpawnEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/CreatureSpawnEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> CreatureSpawnEventTrait<'mc> for CreatureSpawnEvent<'mc> {}
pub trait CreatureSpawnEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,spawnee: impl Into<crate::entity::LivingEntity<'mc>>,spawn_reason: impl Into<crate::event::entity::CreatureSpawnEventSpawnReason<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(spawnee.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(spawn_reason.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/CreatureSpawnEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Gets the reason for why the creature is being spawned.
	fn spawn_reason(&self) 
-> Result<crate::event::entity::CreatureSpawnEventSpawnReason<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/event/entity/CreatureSpawnEvent/SpawnReason;");
let res = self.jni_ref().call_method(&self.jni_object(),"getSpawnReason",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::event::entity::EntitySpawnEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting CreatureSpawnEvent into crate::event::entity::EntitySpawnEvent")

   }
}
impl<'mc> crate::event::entity::EntitySpawnEventTrait<'mc> for CreatureSpawnEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for VillagerReplenishTradeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/VillagerReplenishTradeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> VillagerReplenishTradeEventTrait<'mc> for VillagerReplenishTradeEvent<'mc> {}
pub trait VillagerReplenishTradeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::AbstractVillager<'mc>>,recipe: impl Into<crate::inventory::MerchantRecipe<'mc>>) 
-> Result<crate::event::entity::VillagerReplenishTradeEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/AbstractVillager;Lorg/bukkit/inventory/MerchantRecipe;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(recipe.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/VillagerReplenishTradeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Set the recipe to replenish.
	fn set_recipe(&self,recipe: impl Into<crate::inventory::MerchantRecipe<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getBonus",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
/// Set the bonus uses added.
	fn set_bonus(&self,bonus: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(I)V");
let val_1 = jni::objects::JValueGen::Int(bonus);
let res = self.jni_ref().call_method(&self.jni_object(),"setBonus",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting VillagerReplenishTradeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for VillagerReplenishTradeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for VillagerReplenishTradeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting VillagerReplenishTradeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for VillagerReplenishTradeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> ItemDespawnEventTrait<'mc> for ItemDespawnEvent<'mc> {}
pub trait ItemDespawnEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,despawnee: impl Into<crate::entity::Item<'mc>>,loc: impl Into<crate::Location<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(despawnee.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(loc.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/ItemDespawnEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ItemDespawnEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for ItemDespawnEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for ItemDespawnEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ItemDespawnEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for ItemDespawnEvent<'mc> {}
#[repr(C)]
...
impl<'mc> PiglinBarterEventTrait<'mc> for PiglinBarterEvent<'mc> {}
pub trait PiglinBarterEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Piglin<'mc>>,input: impl Into<crate::inventory::ItemStack<'mc>>,outcome: Vec<jni::objects::JObject<'mc>>) 
-> Result<crate::event::entity::PiglinBarterEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Piglin;Lorg/bukkit/inventory/ItemStack;Ljava/util/List;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(input.into().jni_object().clone())});
let raw_val_3 = jni.new_object("java/util/ArrayList", "()V", vec![])?;
for v in outcome{
let map_val_0 = jni::objects::JValueGen::Object(v);
jni.call_method(&raw_val_3,"add","(Ljava/lang/Object;)Z",vec![jni::objects::JValueGen::from(map_val_0)])?;
...
let val_3 = jni::objects::JValueGen::Object(raw_val_3);
let cls = jni.find_class("org/bukkit/event/entity/PiglinBarterEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Ljava/util/List;");
let res = self.jni_ref().call_method(&self.jni_object(),"getOutcome",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
let mut new_vec = Vec::new();
let list = blackboxmc_java::util::JavaList::from_raw(&self.jni_ref(), res.l()?)?;let iter = list.iterator()?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PiglinBarterEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for PiglinBarterEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for PiglinBarterEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PiglinBarterEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for PiglinBarterEvent<'mc> {}
#[repr(C)]
...
impl<'mc> PotionSplashEventTrait<'mc> for PotionSplashEvent<'mc> {}
pub trait PotionSplashEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,potion: impl Into<crate::entity::ThrownPotion<'mc>>,hit_entity: impl Into<crate::entity::Entity<'mc>>,hit_block: std::option::Option<impl Into<crate::block::Block<'mc>>>,hit_face: std::option::Option<impl Into<crate::block::BlockFace<'mc>>>,affected_entities: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/PotionSplashEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Lorg/bukkit/entity/ThrownPotion;");
let res = self.jni_ref().call_method(&self.jni_object(),"getPotion",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::ThrownPotion::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
/// depends on the distance to the impact center
	fn get_intensity(&self,entity: impl Into<crate::entity::LivingEntity<'mc>>) 
-> Result<f64, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/LivingEntity;)D");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"getIntensity",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.d()?
...
/// Overwrites the intensity for a given entity
	fn set_intensity(&self,entity: impl Into<crate::entity::LivingEntity<'mc>>,intensity: f64) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/LivingEntity;D)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Double(intensity);
let res = self.jni_ref().call_method(&self.jni_object(),"setIntensity",sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PotionSplashEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for PotionSplashEvent<'mc> {}
impl<'mc> Into<crate::event::entity::ProjectileHitEvent<'mc>> for PotionSplashEvent<'mc>{

fn into(self) -> crate::event::entity::ProjectileHitEvent<'mc> {

crate::event::entity::ProjectileHitEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PotionSplashEvent into crate::event::entity::ProjectileHitEvent")

   }
}
impl<'mc> crate::event::entity::ProjectileHitEventTrait<'mc> for PotionSplashEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntityDamageEventTrait<'mc> for EntityDamageEvent<'mc> {}
pub trait EntityDamageEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,damagee: impl Into<crate::entity::Entity<'mc>>,cause: impl Into<crate::event::entity::EntityDamageEventDamageCause<'mc>>,damage_source: impl Into<crate::damage::DamageSource<'mc>>,modifiers: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>,modifier_functions: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>) 
-> Result<crate::event::entity::EntityDamageEvent<'mc>, Box<dyn std::error::Error>>

{let mut args = Vec::new();
let mut sig = String::from("(");
sig += "Lorg/bukkit/entity/Entity;";
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(damagee.into().jni_object().clone())});
args.push(val_1);
sig += "Lorg/bukkit/event/entity/EntityDamageEvent/DamageCause;";
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(cause.into().jni_object().clone())});
args.push(val_2);
sig += "Lorg/bukkit/damage/DamageSource;";
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(damage_source.into().jni_object().clone())});
args.push(val_3);
if let Some(a) = modifiers {
sig += "Ljava/util/Map;";
let val_4 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(a.into().jni_object().clone())});
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/EntityDamageEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
/// event's construction.
	fn get_original_damage(&self,val_type: impl Into<crate::event::entity::EntityDamageEventDamageModifier<'mc>>) 
-> Result<f64, Box<dyn std::error::Error>>
...
let res = self.jni_ref().call_method(&self.jni_object(),"getOriginalDamage",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.d()?
...
/// Sets the damage for the specified modifier.
	fn set_damage(&self,val_type: impl Into<crate::event::entity::EntityDamageEventDamageModifier<'mc>>,damage: std::option::Option<f64>) 
-> Result<(), Box<dyn std::error::Error>>
...
sig += ")V";
let res = self.jni_ref().call_method(&self.jni_object(),"setDamage",sig.as_str(),args);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// {@link DamageModifier#BASE} is always applicable.
	fn is_applicable(&self,val_type: impl Into<crate::event::entity::EntityDamageEventDamageModifier<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/event/entity/EntityDamageEvent/DamageModifier;)Z");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(val_type.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"isApplicable",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// reduction is applied.
	fn final_damage(&self) 
-> Result<f64, Box<dyn std::error::Error>>

{let sig = String::from("()D");
let res = self.jni_ref().call_method(&self.jni_object(),"getFinalDamage",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.d()?
...
/// Get the source of damage.
	fn damage_source(&self) 
-> Result<crate::damage::DamageSource<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/damage/DamageSource;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDamageSource",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::damage::DamageSource::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDamageEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityDamageEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityDamageEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDamageEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityDamageEvent<'mc> {}
pub enum EntityKnockbackEventKnockbackCause<'mc> {
	Damage {inner: EntityKnockbackEventKnockbackCauseStruct<'mc>},
	EntityAttack {inner: EntityKnockbackEventKnockbackCauseStruct<'mc>},
	Explosion {inner: EntityKnockbackEventKnockbackCauseStruct<'mc>},
	ShieldBlock {inner: EntityKnockbackEventKnockbackCauseStruct<'mc>},
	SweepAttack {inner: EntityKnockbackEventKnockbackCauseStruct<'mc>},
	Unknown {inner: EntityKnockbackEventKnockbackCauseStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityKnockbackEventKnockbackCause<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> EntityKnockbackEventKnockbackCauseTrait<'mc> for EntityKnockbackEventKnockbackCause<'mc> {}
        
        pub trait EntityKnockbackEventKnockbackCauseTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"DAMAGE" => Ok(EntityKnockbackEventKnockbackCause::Damage { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),
"ENTITY_ATTACK" => Ok(EntityKnockbackEventKnockbackCause::EntityAttack { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),
"EXPLOSION" => Ok(EntityKnockbackEventKnockbackCause::Explosion { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),
"SHIELD_BLOCK" => Ok(EntityKnockbackEventKnockbackCause::ShieldBlock { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),
"SWEEP_ATTACK" => Ok(EntityKnockbackEventKnockbackCause::SweepAttack { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),
"UNKNOWN" => Ok(EntityKnockbackEventKnockbackCause::Unknown { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityKnockbackEventKnockbackCauseStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EntityKnockbackEventKnockbackCause<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityKnockbackEvent/KnockbackCause")?;
            if !valid {
                Err(eyre::eyre!(
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "DAMAGE" => Ok(EntityKnockbackEventKnockbackCause::Damage { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),"ENTITY_ATTACK" => Ok(EntityKnockbackEventKnockbackCause::EntityAttack { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),"EXPLOSION" => Ok(EntityKnockbackEventKnockbackCause::Explosion { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),"SHIELD_BLOCK" => Ok(EntityKnockbackEventKnockbackCause::ShieldBlock { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),"SWEEP_ATTACK" => Ok(EntityKnockbackEventKnockbackCause::SweepAttack { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),"UNKNOWN" => Ok(EntityKnockbackEventKnockbackCause::Unknown { inner: EntityKnockbackEventKnockbackCauseStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
{let sig = String::from("()Lorg/bukkit/event/entity/EntityKnockbackEvent/KnockbackCause;");
let cls = jni.find_class("org/bukkit/event/entity/EntityKnockbackEvent/KnockbackCause"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> JNIInstantiatable<'mc> for VillagerAcquireTradeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/VillagerAcquireTradeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> VillagerAcquireTradeEventTrait<'mc> for VillagerAcquireTradeEvent<'mc> {}
pub trait VillagerAcquireTradeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(recipe.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/VillagerAcquireTradeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting VillagerAcquireTradeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for VillagerAcquireTradeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for VillagerAcquireTradeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting VillagerAcquireTradeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for VillagerAcquireTradeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityInteractEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityInteractEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityInteractEventTrait<'mc> for EntityInteractEvent<'mc> {}
pub trait EntityInteractEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(block.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityInteractEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityInteractEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityInteractEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityInteractEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityInteractEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityInteractEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntityDeathEventTrait<'mc> for EntityDeathEvent<'mc> {}
pub trait EntityDeathEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::LivingEntity<'mc>>,drops: Vec<jni::objects::JObject<'mc>>,dropped_exp: std::option::Option<i32>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/entity/EntityDeathEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getDroppedExp",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
/// This does not indicate how much EXP should be taken from the entity in
/// question, merely how much should be created after its death.
	fn set_dropped_exp(&self,exp: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(I)V");
let val_1 = jni::objects::JValueGen::Int(exp);
let res = self.jni_ref().call_method(&self.jni_object(),"setDroppedExp",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
{let sig = String::from("()Ljava/util/List;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDrops",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
let mut new_vec = Vec::new();
let list = blackboxmc_java::util::JavaList::from_raw(&self.jni_ref(), res.l()?)?;let iter = list.iterator()?;
...
crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDeathEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityDeathEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for FireworkExplodeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/FireworkExplodeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> FireworkExplodeEventTrait<'mc> for FireworkExplodeEvent<'mc> {}
pub trait FireworkExplodeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Firework<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/FireworkExplodeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting FireworkExplodeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for FireworkExplodeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for FireworkExplodeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting FireworkExplodeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for FireworkExplodeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityCombustByEntityEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityCombustByEntityEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityCombustByEntityEventTrait<'mc> for EntityCombustByEntityEvent<'mc> {}
pub trait EntityCombustByEntityEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,combuster: impl Into<crate::entity::Entity<'mc>>,combustee: impl Into<crate::entity::Entity<'mc>>,duration: i32) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(combuster.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(combustee.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Int(duration);
let cls = jni.find_class("org/bukkit/event/entity/EntityCombustByEntityEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Lorg/bukkit/entity/Entity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getCombuster",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::Entity::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::entity::EntityCombustEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityCombustByEntityEvent into crate::event::entity::EntityCombustEvent")

   }
}
impl<'mc> crate::event::entity::EntityCombustEventTrait<'mc> for EntityCombustByEntityEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntityEventTrait<'mc> for EntityEvent<'mc> {}
pub trait EntityEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>) 
-> Result<crate::event::entity::EntityEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Event::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityEvent into crate::event::Event")

   }
}
impl<'mc> crate::event::EventTrait<'mc> for EntityEvent<'mc> {}
pub enum EntityExhaustionEventExhaustionReason<'mc> {
	BlockMined {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	HungerEffect {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Damaged {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Attack {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	JumpSprint {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Jump {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Swim {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	WalkUnderwater {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	WalkOnWater {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Sprint {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Crouch {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Walk {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Regen {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
	Unknown {inner: EntityExhaustionEventExhaustionReasonStruct<'mc>},
}
impl<'mc> std::fmt::Display for EntityExhaustionEventExhaustionReason<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           EntityExhaustionEventExhaustionReason::HungerEffect { .. } => f.write_str("HUNGER_EFFECT"),
           ...
           EntityExhaustionEventExhaustionReason::WalkUnderwater { .. } => f.write_str("WALK_UNDERWATER"),
           EntityExhaustionEventExhaustionReason::WalkOnWater { .. } => f.write_str("WALK_ON_WATER"),
        ...
        impl<'mc> EntityExhaustionEventExhaustionReasonTrait<'mc> for EntityExhaustionEventExhaustionReason<'mc> {}
        
        pub trait EntityExhaustionEventExhaustionReasonTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"BLOCK_MINED" => Ok(EntityExhaustionEventExhaustionReason::BlockMined { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"HUNGER_EFFECT" => Ok(EntityExhaustionEventExhaustionReason::HungerEffect { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"DAMAGED" => Ok(EntityExhaustionEventExhaustionReason::Damaged { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"ATTACK" => Ok(EntityExhaustionEventExhaustionReason::Attack { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"JUMP_SPRINT" => Ok(EntityExhaustionEventExhaustionReason::JumpSprint { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"JUMP" => Ok(EntityExhaustionEventExhaustionReason::Jump { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"SWIM" => Ok(EntityExhaustionEventExhaustionReason::Swim { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"WALK_UNDERWATER" => Ok(EntityExhaustionEventExhaustionReason::WalkUnderwater { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"WALK_ON_WATER" => Ok(EntityExhaustionEventExhaustionReason::WalkOnWater { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"SPRINT" => Ok(EntityExhaustionEventExhaustionReason::Sprint { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"CROUCH" => Ok(EntityExhaustionEventExhaustionReason::Crouch { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"WALK" => Ok(EntityExhaustionEventExhaustionReason::Walk { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"REGEN" => Ok(EntityExhaustionEventExhaustionReason::Regen { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
"UNKNOWN" => Ok(EntityExhaustionEventExhaustionReason::Unknown { inner: EntityExhaustionEventExhaustionReasonStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EntityExhaustionEventExhaustionReasonStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
fn jni_object(&self) -> jni::objects::JObject<'mc> {
match self {
Self::BlockMined { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::HungerEffect { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Damaged { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Attack { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::JumpSprint { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::WalkUnderwater { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::WalkOnWater { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for EntityExhaustionEventExhaustionReason<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityExhaustionEvent/ExhaustionReason")?;
            if !valid {
                Err(eyre::eyre!(
...
{let sig = String::from("()Lorg/bukkit/event/entity/EntityExhaustionEvent/ExhaustionReason;");
let cls = jni.find_class("org/bukkit/event/entity/EntityExhaustionEvent/ExhaustionReason"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
#[repr(C)]
pub struct EntityDismountEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EntityDismountEvent<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EntityDismountEvent from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityDismountEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityDismountEventTrait<'mc> for EntityDismountEvent<'mc> {}
pub trait EntityDismountEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,what: impl Into<crate::entity::Entity<'mc>>,dismounted: impl Into<crate::entity::Entity<'mc>>) 
-> Result<crate::event::entity::EntityDismountEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;Lorg/bukkit/entity/Entity;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(dismounted.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityDismountEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Lorg/bukkit/entity/Entity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDismounted",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::Entity::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDismountEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityDismountEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityDismountEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityDismountEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityDismountEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for ArrowBodyCountChangeEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/ArrowBodyCountChangeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> ArrowBodyCountChangeEventTrait<'mc> for ArrowBodyCountChangeEvent<'mc> {}
pub trait ArrowBodyCountChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::LivingEntity<'mc>>,old_amount: i32,new_amount: i32,is_reset: bool) 
...
let cls = jni.find_class("org/bukkit/event/entity/ArrowBodyCountChangeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3),jni::objects::JValueGen::from(val_4)]);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"isReset",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getOldAmount",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getNewAmount",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
/// Sets the final amount of arrows in the entity's body.
	fn set_new_amount(&self,new_amount: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(I)V");
let val_1 = jni::objects::JValueGen::Int(new_amount);
let res = self.jni_ref().call_method(&self.jni_object(),"setNewAmount",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ArrowBodyCountChangeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for ArrowBodyCountChangeEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for ArrowBodyCountChangeEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ArrowBodyCountChangeEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for ArrowBodyCountChangeEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityCombustByBlockEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityCombustByBlockEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityCombustByBlockEventTrait<'mc> for EntityCombustByBlockEvent<'mc> {}
pub trait EntityCombustByBlockEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,combuster: impl Into<crate::block::Block<'mc>>,combustee: impl Into<crate::entity::Entity<'mc>>,duration: i32) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(combustee.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Int(duration);
let cls = jni.find_class("org/bukkit/event/entity/EntityCombustByBlockEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::entity::EntityCombustEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityCombustByBlockEvent into crate::event::entity::EntityCombustEvent")

   }
}
impl<'mc> crate::event::entity::EntityCombustEventTrait<'mc> for EntityCombustByBlockEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for ProjectileLaunchEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/ProjectileLaunchEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> ProjectileLaunchEventTrait<'mc> for ProjectileLaunchEvent<'mc> {}
pub trait ProjectileLaunchEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
{let sig = String::from("(Lorg/bukkit/entity/Entity;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(what.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/ProjectileLaunchEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ProjectileLaunchEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for ProjectileLaunchEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntitySpawnEvent<'mc>> for ProjectileLaunchEvent<'mc>{

fn into(self) -> crate::event::entity::EntitySpawnEvent<'mc> {

crate::event::entity::EntitySpawnEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ProjectileLaunchEvent into crate::event::entity::EntitySpawnEvent")

   }
}
impl<'mc> crate::event::entity::EntitySpawnEventTrait<'mc> for ProjectileLaunchEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EntityTargetEventTrait<'mc> for EntityTargetEvent<'mc> {}
pub trait EntityTargetEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,target: impl Into<crate::entity::Entity<'mc>>,reason: impl Into<crate::event::entity::EntityTargetEventTargetReason<'mc>>) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(target.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(reason.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityTargetEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTargetEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityTargetEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityTargetEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityTargetEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityTargetEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityUnleashEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityUnleashEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityUnleashEventTrait<'mc> for EntityUnleashEvent<'mc> {}
pub trait EntityUnleashEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,reason: impl Into<crate::event::entity::EntityUnleashEventUnleashReason<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(reason.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityUnleashEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityUnleashEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityUnleashEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityPortalExitEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityPortalExitEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityPortalExitEventTrait<'mc> for EntityPortalExitEvent<'mc> {}
pub trait EntityPortalExitEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,from: impl Into<crate::Location<'mc>>,to: impl Into<crate::Location<'mc>>,before: impl Into<crate::util::Vector<'mc>>,after: impl Into<crate::util::Vector<'mc>>) 
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(from.into().jni_object().clone())});
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(to.into().jni_object().clone())});
let val_4 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(before.into().jni_object().clone())});
let val_5 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(after.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityPortalExitEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3),jni::objects::JValueGen::from(val_4),jni::objects::JValueGen::from(val_5)]);
let res = 
jni.translate_error_no_gen(res)?;
...
{let sig = String::from("()Lorg/bukkit/util/Vector;");
let res = self.jni_ref().call_method(&self.jni_object(),"getBefore",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::util::Vector::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let sig = String::from("()Lorg/bukkit/util/Vector;");
let res = self.jni_ref().call_method(&self.jni_object(),"getAfter",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::util::Vector::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// Sets the velocity that the entity will have after exiting the portal.
	fn set_after(&self,after: impl Into<crate::util::Vector<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/util/Vector;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(after.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"setAfter",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::event::entity::EntityTeleportEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityPortalExitEvent into crate::event::entity::EntityTeleportEvent")

   }
}
impl<'mc> crate::event::entity::EntityTeleportEventTrait<'mc> for EntityPortalExitEvent<'mc> {}
#[repr(C)]
...
impl<'mc> JNIInstantiatable<'mc> for EntityRegainHealthEvent<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/entity/EntityRegainHealthEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> EntityRegainHealthEventTrait<'mc> for EntityRegainHealthEvent<'mc> {}
pub trait EntityRegainHealthEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,entity: impl Into<crate::entity::Entity<'mc>>,amount: f64,regain_reason: impl Into<crate::event::entity::EntityRegainHealthEventRegainReason<'mc>>) 
...
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(regain_reason.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/entity/EntityRegainHealthEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Gets the reason for why the entity is regaining health
	fn regain_reason(&self) 
-> Result<crate::event::entity::EntityRegainHealthEventRegainReason<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/event/entity/EntityRegainHealthEvent/RegainReason;");
let res = self.jni_ref().call_method(&self.jni_object(),"getRegainReason",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityRegainHealthEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EntityRegainHealthEvent<'mc> {}
impl<'mc> Into<crate::event::entity::EntityEvent<'mc>> for EntityRegainHealthEvent<'mc>{

fn into(self) -> crate::event::entity::EntityEvent<'mc> {

crate::event::entity::EntityEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EntityRegainHealthEvent into crate::event::entity::EntityEvent")

   }
}
impl<'mc> crate::event::entity::EntityEventTrait<'mc> for EntityRegainHealthEvent<'mc> {}
