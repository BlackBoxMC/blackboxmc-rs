...
use color_eyre::eyre::Result;/*org/bukkit/event/weather/mod.rs*/

#[repr(C)]
pub struct WeatherEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate WeatherEvent from null object.")
                .into());
            }
...
impl<'mc> WeatherEventTrait<'mc> for WeatherEvent<'mc> {}
pub trait WeatherEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,val_where: impl Into<crate::World<'mc>>) 
-> Result<crate::event::weather::WeatherEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/World;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(val_where.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/weather/WeatherEvent"); let cls = jni.translate_error_with_class(cls)?;
...
crate::event::Event::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WeatherEvent into crate::event::Event")

   }
}
impl<'mc> crate::event::EventTrait<'mc> for WeatherEvent<'mc> {}
#[repr(C)]
pub struct ThunderChangeEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for ThunderChangeEvent<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate ThunderChangeEvent from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/weather/ThunderChangeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> ThunderChangeEventTrait<'mc> for ThunderChangeEvent<'mc> {}
pub trait ThunderChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,to: bool) 
...
let cls = jni.find_class("org/bukkit/event/weather/ThunderChangeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
/// Gets the state of thunder that the world is being set to
	fn to_thunder_state(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"toThunderState",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ThunderChangeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for ThunderChangeEvent<'mc> {}
...
crate::event::weather::WeatherEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ThunderChangeEvent into crate::event::weather::WeatherEvent")

   }
}
impl<'mc> crate::event::weather::WeatherEventTrait<'mc> for ThunderChangeEvent<'mc> {}
#[repr(C)]
pub struct WeatherChangeEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for WeatherChangeEvent<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate WeatherChangeEvent from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/weather/WeatherChangeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> WeatherChangeEventTrait<'mc> for WeatherChangeEvent<'mc> {}
pub trait WeatherChangeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(world.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Bool(to.into());
let cls = jni.find_class("org/bukkit/event/weather/WeatherChangeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
jni.translate_error_no_gen(res)?;
...
/// Gets the state of weather that the world is being set to
	fn to_weather_state(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"toWeatherState",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WeatherChangeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for WeatherChangeEvent<'mc> {}
impl<'mc> Into<crate::event::weather::WeatherEvent<'mc>> for WeatherChangeEvent<'mc>{

fn into(self) -> crate::event::weather::WeatherEvent<'mc> {

crate::event::weather::WeatherEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting WeatherChangeEvent into crate::event::weather::WeatherEvent")

   }
}
impl<'mc> crate::event::weather::WeatherEventTrait<'mc> for WeatherChangeEvent<'mc> {}
pub enum LightningStrikeEventCause<'mc> {
	Command {inner: LightningStrikeEventCauseStruct<'mc>},
	Custom {inner: LightningStrikeEventCauseStruct<'mc>},
	Spawner {inner: LightningStrikeEventCauseStruct<'mc>},
	Trident {inner: LightningStrikeEventCauseStruct<'mc>},
	Trap {inner: LightningStrikeEventCauseStruct<'mc>},
	Weather {inner: LightningStrikeEventCauseStruct<'mc>},
	Unknown {inner: LightningStrikeEventCauseStruct<'mc>},
}
impl<'mc> std::fmt::Display for LightningStrikeEventCause<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> LightningStrikeEventCauseTrait<'mc> for LightningStrikeEventCause<'mc> {}
        
        pub trait LightningStrikeEventCauseTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
"COMMAND" => Ok(LightningStrikeEventCause::Command { inner: LightningStrikeEventCauseStruct::from_raw(env,obj)?}),
"CUSTOM" => Ok(LightningStrikeEventCause::Custom { inner: LightningStrikeEventCauseStruct::from_raw(env,obj)?}),
"SPAWNER" => Ok(LightningStrikeEventCause::Spawner { inner: LightningStrikeEventCauseStruct::from_raw(env,obj)?}),
"TRIDENT" => Ok(LightningStrikeEventCause::Trident { inner: LightningStrikeEventCauseStruct::from_raw(env,obj)?}),
"TRAP" => Ok(LightningStrikeEventCause::Trap { inner: LightningStrikeEventCauseStruct::from_raw(env,obj)?}),
"WEATHER" => Ok(LightningStrikeEventCause::Weather { inner: LightningStrikeEventCauseStruct::from_raw(env,obj)?}),
"UNKNOWN" => Ok(LightningStrikeEventCause::Unknown { inner: LightningStrikeEventCauseStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct LightningStrikeEventCauseStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for LightningStrikeEventCause<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/weather/LightningStrikeEvent/Cause")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/event/weather/LightningStrikeEvent/Cause"); let cls = jni.translate_error_with_class(cls)?;
...
#[repr(C)]
pub struct LightningStrikeEvent<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for LightningStrikeEvent<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate LightningStrikeEvent from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/weather/LightningStrikeEvent")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> LightningStrikeEventTrait<'mc> for LightningStrikeEvent<'mc> {}
pub trait LightningStrikeEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,bolt: impl Into<crate::entity::LightningStrike<'mc>>,cause: std::option::Option<impl Into<crate::event::weather::LightningStrikeEventCause<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/weather/LightningStrikeEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = 
self.jni_ref().translate_error(res)?;
crate::event::weather::LightningStrikeEventCause::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting LightningStrikeEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for LightningStrikeEvent<'mc> {}
impl<'mc> Into<crate::event::weather::WeatherEvent<'mc>> for LightningStrikeEvent<'mc>{

fn into(self) -> crate::event::weather::WeatherEvent<'mc> {

crate::event::weather::WeatherEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting LightningStrikeEvent into crate::event::weather::WeatherEvent")

   }
}
impl<'mc> crate::event::weather::WeatherEventTrait<'mc> for LightningStrikeEvent<'mc> {}
