...
impl<'mc> WeatherEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,val_where: impl Into<crate::World<'mc>>) 
...
crate::event::Event::from_raw(&self.jni_ref(), self.1).expect("Error converting WeatherEvent into crate::event::Event")
...
impl<'mc> ThunderChangeEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,to: bool) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting ThunderChangeEvent into crate::event::Cancellable")
...
crate::event::weather::WeatherEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting ThunderChangeEvent into crate::event::weather::WeatherEvent")
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting WeatherChangeEvent into crate::event::Cancellable")
...
crate::event::weather::WeatherEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting WeatherChangeEvent into crate::event::weather::WeatherEvent")
...
{let sig = String::from("()Lcrate::event::weather::LightningStrikeEventCause;");
...
impl<'mc> LightningStrikeEvent<'mc> {
	pub fn new_with_world(jni: &blackboxmc_general::SharedJNIEnv<'mc>,world: impl Into<crate::World<'mc>>,bolt: impl Into<crate::entity::LightningStrike<'mc>>,cause: std::option::Option<impl Into<crate::event::weather::LightningStrikeEventCause<'mc>>>) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting LightningStrikeEvent into crate::event::Cancellable")
...
crate::event::weather::WeatherEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting LightningStrikeEvent into crate::event::weather::WeatherEvent")
