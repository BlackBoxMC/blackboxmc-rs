...
impl<'mc> BlockMultiPlaceEvent<'mc> {
    ...
    //BlockPlaceEvent
    //crate::event::block::BlockPlaceEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
...
impl<'mc> BlockSpreadEvent<'mc> {
    ...
    //BlockFormEvent
    //crate::event::block::BlockFormEvent
    //BlockGrowEvent
    //crate::event::block::BlockGrowEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
...
impl<'mc> BlockPistonRetractEvent<'mc> {
    ...
    //BlockPistonEvent
    //crate::event::block::BlockPistonEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
...
impl<'mc> BlockDispenseArmorEvent<'mc> {
    ...
    //BlockDispenseEvent
    //crate::event::block::BlockDispenseEvent
    pub fn is_cancelled(&self) -> Result<bool, Box<dyn std::error::Error>> {
