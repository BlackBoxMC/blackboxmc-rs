...
impl<'mc> HangingBreakByEntityEvent<'mc> {
	pub fn new_with_hanging(jni: &blackboxmc_general::SharedJNIEnv<'mc>,hanging: impl Into<crate::entity::Hanging<'mc>>,remover: impl Into<crate::entity::Entity<'mc>>,cause: std::option::Option<impl Into<crate::event::hanging::HangingBreakEventRemoveCause<'mc>>>) 
...
{let sig = String::from("()Lcrate::entity::Hanging;");
...
crate::event::Event::from_raw(&self.jni_ref(), self.1).expect("Error converting HangingEvent into crate::event::Event")
...
{let sig = String::from("()Lcrate::event::hanging::HangingBreakEventRemoveCause;");
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting HangingPlaceEvent into crate::event::Cancellable")
...
crate::event::hanging::HangingEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting HangingPlaceEvent into crate::event::hanging::HangingEvent")
...
impl<'mc> HangingBreakEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,hanging: impl Into<crate::entity::Hanging<'mc>>,cause: impl Into<crate::event::hanging::HangingBreakEventRemoveCause<'mc>>) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting HangingBreakEvent into crate::event::Cancellable")
...
crate::event::hanging::HangingEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting HangingBreakEvent into crate::event::hanging::HangingEvent")
