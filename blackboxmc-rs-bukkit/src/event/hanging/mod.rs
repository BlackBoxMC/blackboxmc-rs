...
impl<'mc> HangingBreakEventRemoveCause<'mc> {
    pub fn from_raw(
        ...
        let (valid, name) = env.validate_name(
            &obj,
            "org/bukkit/event/hanging/HangingBreakEventRemoveCause",
        )?;
        if !valid {
            Err(eyre::eyre!(
...
impl<'mc> HangingBreakEvent<'mc> {
    ...
    pub fn new(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::entity::Hanging<'mc>>,
        arg1: impl Into<&'mc crate::event::hanging::HangingBreakEventRemoveCause<'mc>>,
...
impl<'mc> HangingBreakByEntityEvent<'mc> {
    ...
    pub fn new_with_hanging(
        ...
        arg2: std::option::Option<
            impl Into<&'mc crate::event::hanging::HangingBreakEventRemoveCause<'mc>>,
        >,
...
impl<'mc> HangingPlaceEvent<'mc> {
    ...
    pub fn new_with_hanging(
        ...
        arg5: std::option::Option<impl Into<&'mc crate::inventory::ItemStack<'mc>>>,
