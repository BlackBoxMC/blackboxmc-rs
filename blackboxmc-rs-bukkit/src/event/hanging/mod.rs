...
pub struct HangingBreakEventRemoveCause<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::entity::Hanging<'mc>>,arg1: impl Into<&'mc crate::event::hanging::HangingBreakEventRemoveCause<'mc>>) 
...
"(Lorg/bukkit/entity/Hanging;Lorg/bukkit/event/hanging/HangingBreakEvent$RemoveCause;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getCause","()Lorg/bukkit/event/hanging/HangingBreakEvent$RemoveCause;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getEntity","()Lorg/bukkit/entity/Hanging;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn new_with_hanging(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::entity::Hanging<'mc>>,arg1: std::option::Option<impl Into<&'mc crate::entity::Entity<'mc>>>,arg2: std::option::Option<impl Into<&'mc crate::event::hanging::HangingBreakEventRemoveCause<'mc>>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/entity/Hanging;Lorg/bukkit/entity/Entity;Lorg/bukkit/event/hanging/HangingBreakEvent$RemoveCause;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
crate::event::hanging::HangingBreakByEntityEvent::from_raw(&jni,res
)}
	pub fn remover(&mut self) 
-> Result<crate::entity::Entity<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getRemover","()Lorg/bukkit/entity/Entity;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn new_with_hanging(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::entity::Hanging<'mc>>,arg1: impl Into<&'mc crate::entity::Player<'mc>>,arg2: impl Into<&'mc crate::block::Block<'mc>>,arg3: impl Into<&'mc crate::block::BlockFace<'mc>>,arg4: std::option::Option<impl Into<&'mc crate::inventory::EquipmentSlot<'mc>>>,arg5: std::option::Option<impl Into<&'mc crate::inventory::ItemStack<'mc>>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/entity/Hanging;Lorg/bukkit/entity/Player;Lorg/bukkit/block/Block;Lorg/bukkit/block/BlockFace;Lorg/bukkit/inventory/EquipmentSlot;Lorg/bukkit/inventory/ItemStack;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6)])?;
