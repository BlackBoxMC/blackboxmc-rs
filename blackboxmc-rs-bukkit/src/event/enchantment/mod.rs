...
use color_eyre::eyre::Result;/*org/bukkit/event/enchantment/mod.rs*/
...
impl<'mc> PrepareItemEnchantEventTrait<'mc> for PrepareItemEnchantEvent<'mc> {}
pub trait PrepareItemEnchantEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,enchanter: impl Into<crate::entity::Player<'mc>>,view: impl Into<crate::inventory::InventoryView<'mc>>,table: impl Into<crate::block::Block<'mc>>,item: impl Into<crate::inventory::ItemStack<'mc>>,offers: impl Into<crate::enchantments::EnchantmentOffer<'mc>>,bonus: i32) 
...
/// Get a list of offered experience level costs of the enchantment.
	fn exp_level_costs_offered(&self) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PrepareItemEnchantEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for PrepareItemEnchantEvent<'mc> {}
...
crate::event::inventory::InventoryEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PrepareItemEnchantEvent into crate::event::inventory::InventoryEvent")

   }
}
impl<'mc> crate::event::inventory::InventoryEventTrait<'mc> for PrepareItemEnchantEvent<'mc> {}
#[repr(C)]
...
impl<'mc> EnchantItemEventTrait<'mc> for EnchantItemEvent<'mc> {}
pub trait EnchantItemEventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
/// hand side of the enchantment offer.
	fn set_exp_level_cost(&self,level: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EnchantItemEvent into crate::event::Cancellable")

   }
}
impl<'mc> crate::event::CancellableTrait<'mc> for EnchantItemEvent<'mc> {}
impl<'mc> Into<crate::event::inventory::InventoryEvent<'mc>> for EnchantItemEvent<'mc>{

fn into(self) -> crate::event::inventory::InventoryEvent<'mc> {

crate::event::inventory::InventoryEvent::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EnchantItemEvent into crate::event::inventory::InventoryEvent")

   }
}
impl<'mc> crate::event::inventory::InventoryEventTrait<'mc> for EnchantItemEvent<'mc> {}
