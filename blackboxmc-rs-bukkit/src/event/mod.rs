...
crate::event::HandlerList::from_raw(&jni,res
	...
	pub fn bake_all(jni: &blackboxmc_general::SharedJNIEnv<'mc>) 
...
()
	...
	pub fn unregister_all_with_listener(jni: &blackboxmc_general::SharedJNIEnv<'mc>,listener: std::option::Option<impl Into<crate::event::Listener<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn register(&self,listener: impl Into<crate::plugin::RegisteredListener<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/plugin/RegisteredListener;)L();");
...
()
	...
	pub fn unregister_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn unregister_with_listener(&self,listener: impl Into<crate::event::Listener<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn get_registered_listeners(jni: &blackboxmc_general::SharedJNIEnv<'mc>,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
-> Result<blackboxmc_java::util::JavaArrayList<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/plugin/Plugin;)Lblackboxmc_java::util::ArrayList;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(plugin.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/HandlerList"); let cls = jni.translate_error_with_class(cls)?;
...
blackboxmc_java::util::JavaArrayList::from_raw(&jni,obj
	...
	pub fn handler_lists(jni: &blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<blackboxmc_java::util::JavaArrayList<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lblackboxmc_java::util::ArrayList;");
let cls = jni.find_class("org/bukkit/event/HandlerList"); let cls = jni.translate_error_with_class(cls)?;
...
{let sig = String::from("()Lcrate::event::EventPriority;");
let res = self.jni_ref().call_method(&self.jni_object(),"priority",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::event::EventPriority::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn ignore_cancelled(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Lbool;");
let res = self.jni_ref().call_method(&self.jni_object(),"ignoreCancelled",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
impl<'mc> Event<'mc> {
	pub fn new_with_is_async(jni: &blackboxmc_general::SharedJNIEnv<'mc>,is_async: std::option::Option<bool>) 
...
-> Result<crate::event::EventException<'mc>, Box<dyn std::error::Error>>
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/EventException"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
crate::event::EventException::from_raw(&jni,res
)}
