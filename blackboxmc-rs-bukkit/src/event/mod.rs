...
crate::event::HandlerList::from_raw(&jni,res
	...
	pub fn register(&mut self,arg0: impl Into<&'mc crate::plugin::RegisteredListener<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"register","(Lorg/bukkit/plugin/RegisteredListener;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn unregister_with_registered_listener(&mut self,arg0: std::option::Option<impl Into<&'mc crate::event::Listener<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"unregister","(Lorg/bukkit/event/Listener;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn unregister_with_plugin(&mut self,arg0: std::option::Option<impl Into<&'mc crate::plugin::Plugin<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"unregister","(Lorg/bukkit/plugin/Plugin;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn register_all(&mut self,arg0: impl Into<&'mc blackboxmc_java::JavaCollection<'mc, orgRegisteredListener>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"registerAll","(Ljava/util/Collection;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn unregister_all(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::event::Listener<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"unregisterAll",
"(Lorg/bukkit/event/Listener;)V",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"bake","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn get_registered_listeners(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::plugin::Plugin<'mc>>) 
-> Result<blackboxmc_java::JavaArrayList<'mc, orgRegisteredListener>, Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/ArrayList")?;
let res = jni.call_static_method(cls,"getRegisteredListeners",
"(Lorg/bukkit/plugin/Plugin;)Ljava/util/ArrayList;",&[jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
blackboxmc_java::JavaArrayList::from_raw(&jni,obj
)}
	pub fn handler_lists(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<blackboxmc_java::JavaArrayList<'mc, orgHandlerList>, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"priority","()Lorg/bukkit/event/EventPriority;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
, crate::event::EventPriority::from_string(variant_str).unwrap()
	...
	pub fn ignore_cancelled(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"ignoreCancelled","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn annotation_type(&mut self) 
-> Result<jni::objects::JClass<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"annotationType","()Ljava/lang/Class;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(unsafe {jni::objects::JClass::from_raw(res.as_jni().l)})}
}
...
pub struct EventResult<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
pub struct EventPriority<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>, pub EventPriorityEnum);
...
let res = jni.call_static_method(cls,"valueOf",
"(Ljava/lang/String;)Lorg/bukkit/event/EventPriority;",&[jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
...
crate::event::EventPriority::from_raw(&jni,raw_obj
, crate::event::EventPriority::from_string(variant_str).unwrap()
)}
