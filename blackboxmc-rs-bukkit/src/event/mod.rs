...
use color_eyre::eyre::Result;/*org/bukkit/event/mod.rs*/
...
impl<'mc> std::fmt::Display for EventPriority<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> EventPriorityTrait<'mc> for EventPriority<'mc> {}
        
        pub trait EventPriorityTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
...
"LOWEST" => Ok(EventPriority::Lowest { inner: EventPriorityStruct::from_raw(env,obj)?}),
"LOW" => Ok(EventPriority::Low { inner: EventPriorityStruct::from_raw(env,obj)?}),
"NORMAL" => Ok(EventPriority::Normal { inner: EventPriorityStruct::from_raw(env,obj)?}),
"HIGH" => Ok(EventPriority::High { inner: EventPriorityStruct::from_raw(env,obj)?}),
"HIGHEST" => Ok(EventPriority::Highest { inner: EventPriorityStruct::from_raw(env,obj)?}),
"MONITOR" => Ok(EventPriority::Monitor { inner: EventPriorityStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EventPriorityStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EventPriority from null object.")
                .into());
            }
            ...
            if !valid {
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "LOWEST" => Ok(EventPriority::Lowest { inner: EventPriorityStruct::from_raw(env,obj)?}),"LOW" => Ok(EventPriority::Low { inner: EventPriorityStruct::from_raw(env,obj)?}),"NORMAL" => Ok(EventPriority::Normal { inner: EventPriorityStruct::from_raw(env,obj)?}),"HIGH" => Ok(EventPriority::High { inner: EventPriorityStruct::from_raw(env,obj)?}),"HIGHEST" => Ok(EventPriority::Highest { inner: EventPriorityStruct::from_raw(env,obj)?}),"MONITOR" => Ok(EventPriority::Monitor { inner: EventPriorityStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
impl<'mc> JNIInstantiatable<'mc> for EventPriorityStruct<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EventPriorityStruct from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/EventPriority")?;
            if !valid {
...
let cls = jni.find_class("org/bukkit/event/EventPriority"); let cls = jni.translate_error_with_class(cls)?;
...
impl<'mc> std::fmt::Display for EventResult<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> EventResultTrait<'mc> for EventResult<'mc> {}
        
        pub trait EventResultTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"DENY" => Ok(EventResult::Deny { inner: EventResultStruct::from_raw(env,obj)?}),
"DEFAULT" => Ok(EventResult::Default { inner: EventResultStruct::from_raw(env,obj)?}),
"ALLOW" => Ok(EventResult::Allow { inner: EventResultStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct EventResultStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EventResult<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EventResult from null object.")
                .into());
            }
            ...
            if !valid {
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "DENY" => Ok(EventResult::Deny { inner: EventResultStruct::from_raw(env,obj)?}),"DEFAULT" => Ok(EventResult::Default { inner: EventResultStruct::from_raw(env,obj)?}),"ALLOW" => Ok(EventResult::Allow { inner: EventResultStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
impl<'mc> JNIInstantiatable<'mc> for EventResultStruct<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EventResultStruct from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/event/Event/Result")?;
            if !valid {
...
let cls = jni.find_class("org/bukkit/event/Event/Result"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
#[repr(C)]
pub struct HandlerList<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for HandlerList<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate HandlerList from null object.")
                .into());
            }
...
impl<'mc> HandlerListTrait<'mc> for HandlerList<'mc> {}
pub trait HandlerListTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let cls = jni.find_class("org/bukkit/event/HandlerList"); let cls = jni.translate_error_with_class(cls)?;
...
/// you're using fevents in a plugin system.
	fn bake_all(jni: &blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("()V");
let cls = jni.find_class("org/bukkit/event/HandlerList"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"bakeAll",
sig.as_str(),vec![]);
jni.translate_error(res)?;
Ok(
()
...
/// Unregister a specific listener from all handler lists.
	fn unregister_all(jni: &blackboxmc_general::SharedJNIEnv<'mc>,listener: std::option::Option<impl Into<crate::event::Listener<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/HandlerList"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"unregisterAll",
sig.as_str(),args);
jni.translate_error(res)?;
Ok(
()
...
/// Register a new listener in this handler list
	fn register(&self,listener: impl Into<crate::plugin::RegisteredListener<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Remove a specific listener from this handler
	fn unregister(&self,listener: impl Into<crate::event::Listener<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
{let sig = String::from("()V");
let res = self.jni_ref().call_method(&self.jni_object(),"bake",sig.as_str(),vec![]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// handler list
	fn get_registered_listeners(jni: &blackboxmc_general::SharedJNIEnv<'mc>,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
...
let cls = jni.find_class("org/bukkit/event/HandlerList"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"getRegisteredListeners",
...
/// Get a list of all handler lists for every event type
	fn handler_lists(jni: &blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<blackboxmc_java::util::JavaArrayList<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Ljava/util/ArrayList;");
let cls = jni.find_class("org/bukkit/event/HandlerList"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"getHandlerLists",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
let obj = res.l()?;
...
#[repr(C)]
pub struct EventHandler<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EventHandler<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EventHandler from null object.")
                .into());
            }
...
impl<'mc> EventHandlerTrait<'mc> for EventHandler<'mc> {}
pub trait EventHandlerTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
#[repr(C)]
pub struct Cancellable<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for Cancellable<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Cancellable from null object.")
                .into());
            }
...
impl<'mc> CancellableTrait<'mc> for Cancellable<'mc> {}
pub trait CancellableTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
#[repr(C)]
pub struct Event<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for Event<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Event from null object.")
                .into());
            }
...
impl<'mc> EventTrait<'mc> for Event<'mc> {}
pub trait EventTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
sig += ")V";
let cls = jni.find_class("org/bukkit/event/Event"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getEventName",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
...
/// </ul>
	fn is_asynchronous(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"isAsynchronous",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
#[repr(C)]
pub struct EventException<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for EventException<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate EventException from null object.")
                .into());
            }
...
impl<'mc> EventExceptionTrait<'mc> for EventException<'mc> {}
pub trait EventExceptionTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
#[repr(C)]
pub struct Listener<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for Listener<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Listener from null object.")
                .into());
            }
...
impl<'mc> ListenerTrait<'mc> for Listener<'mc> {}
pub trait ListenerTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
