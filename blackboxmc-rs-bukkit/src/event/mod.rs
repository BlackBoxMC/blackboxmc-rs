...
let res = self.jni_ref().call_method(&self.jni_object(),"register","(Lorg/bukkit/plugin/RegisteredListener;)V",&[jni::objects::JValueGen::from(&val_0)]);
...
let res = self.jni_ref().call_method(&self.jni_object(),"unregister","(Lorg/bukkit/event/Listener;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"unregister","(Lorg/bukkit/plugin/Plugin;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"registerAll","(Ljava/util/Collection;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
"(Lorg/bukkit/event/Listener;)V",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(())}
...
"(Lorg/bukkit/plugin/Plugin;)Ljava/util/ArrayList;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
let res = jni.call_static_method(cls,"valueOf",
"(Ljava/lang/String;)Lorg/bukkit/event/EventPriority;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
