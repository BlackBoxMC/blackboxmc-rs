...
impl<'mc> ServiceRegisterEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,registered_provider: impl Into<crate::plugin::RegisteredServiceProvider<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(registered_provider.into().jni_object().clone())});
...
crate::event::server::ServiceEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting ServiceRegisterEvent into crate::event::server::ServiceEvent")
...
impl<'mc> RemoteServerCommandEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,sender: impl Into<crate::command::CommandSender<'mc>>,command: impl Into<String>) 
...
impl<'mc> ServiceUnregisterEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,service_provider: impl Into<crate::plugin::RegisteredServiceProvider<'mc>>) 
-> Result<crate::event::server::ServiceUnregisterEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/plugin/RegisteredServiceProvider;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(service_provider.into().jni_object().clone())});
...
crate::event::server::ServiceEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting ServiceUnregisterEvent into crate::event::server::ServiceEvent")
...
impl<'mc> ServerListPingEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,hostname: impl Into<String>,address: jni::objects::JObject<'mc>,motd: impl Into<String>,num_players: i32,max_players: i32) 
...
#[deprecated]
	...
	pub fn should_send_chat_previews(&self) 
...
res.z()?
	...
	pub fn set_max_players(&self,max_players: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn set_server_icon(&self,icon: impl Into<crate::util::CachedServerIcon<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::server::ServerEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting ServerListPingEvent into crate::event::server::ServerEvent")
...
crate::event::Event::from_raw(&self.jni_ref(), self.1).expect("Error converting ServerEvent into crate::event::Event")
...
impl<'mc> ServerLoadEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,val_type: impl Into<crate::event::server::ServerLoadEventLoadType<'mc>>) 
...
crate::event::server::ServerEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting ServerLoadEvent into crate::event::server::ServerEvent")
...
impl<'mc> TabCompleteEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,sender: impl Into<crate::command::CommandSender<'mc>>,buffer: impl Into<String>,completions: Vec<jni::objects::JObject<'mc>>) 
...
new_vec
	...
	pub fn set_completions(&self,completions: Vec<jni::objects::JObject<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting TabCompleteEvent into crate::event::Cancellable")
...
crate::event::Event::from_raw(&self.jni_ref(), self.1).expect("Error converting TabCompleteEvent into crate::event::Event")
...
self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string()
	...
	pub fn set_command(&self,message: impl Into<String>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting ServerCommandEvent into crate::event::Cancellable")
...
crate::event::server::ServerEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting ServerCommandEvent into crate::event::server::ServerEvent")
...
impl<'mc> ServiceEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,provider: impl Into<crate::plugin::RegisteredServiceProvider<'mc>>) 
-> Result<crate::event::server::ServiceEvent<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/plugin/RegisteredServiceProvider;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(provider.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/event/server/ServiceEvent"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
jni.translate_error_no_gen(res)?;
...
crate::event::server::ServerEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting ServiceEvent into crate::event::server::ServerEvent")
...
crate::event::server::PluginEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting PluginEnableEvent into crate::event::server::PluginEvent")
...
crate::event::server::ServerEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting PluginEvent into crate::event::server::ServerEvent")
...
crate::event::server::PluginEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting PluginDisableEvent into crate::event::server::PluginEvent")
...
impl<'mc> BroadcastMessageEvent<'mc> {
	pub fn new_with_is_async(jni: &blackboxmc_general::SharedJNIEnv<'mc>,is_async: bool,message: impl Into<String>,recipients: std::option::Option<impl Into<blackboxmc_java::util::JavaSet<'mc>>>) 
...
crate::event::Cancellable::from_raw(&self.jni_ref(), self.1).expect("Error converting BroadcastMessageEvent into crate::event::Cancellable")
...
crate::event::server::ServerEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting BroadcastMessageEvent into crate::event::server::ServerEvent")
...
impl<'mc> MapInitializeEvent<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,map_view: impl Into<crate::map::MapView<'mc>>) 
...
crate::event::server::ServerEvent::from_raw(&self.jni_ref(), self.1).expect("Error converting MapInitializeEvent into crate::event::server::ServerEvent")
