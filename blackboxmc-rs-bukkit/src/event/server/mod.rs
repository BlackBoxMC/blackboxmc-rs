...
"(Lorg/bukkit/command/CommandSender;Ljava/lang/String;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
let res = jni.new_object(cls,
"(Lorg/bukkit/plugin/RegisteredServiceProvider;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let res = jni.new_object(cls,
"(ZLjava/lang/String;Ljava/util/Set;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
let res = jni.new_object(cls,
"(Lorg/bukkit/command/CommandSender;Ljava/lang/String;Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setCompletions","(Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn event_name(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
let res = jni.new_object(cls,
"(Lorg/bukkit/map/MapView;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let res = jni.new_object(cls,
"(Lorg/bukkit/event/server/ServerLoadEvent$LoadType;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"setMaxPlayers","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setMotd","(Ljava/lang/String;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn handler_list(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::event::HandlerList<'mc>, Box<dyn std::error::Error>>
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setServerIcon","(Lorg/bukkit/util/CachedServerIcon;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn event_name(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
