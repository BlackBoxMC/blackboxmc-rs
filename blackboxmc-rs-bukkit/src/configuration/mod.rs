...
impl<'mc> MemoryConfiguration<'mc> {
    ...
    // SUPER CLASS: org.bukkit.configuration.MemorySection ( ['addDefaults', 'setDefaults', 'getDefaults', 'getParent', 'options', 'addDefault', 'getKeys', 'getValues', 'contains', 'isSet', 'getCurrentPath', 'getName', 'getRoot', 'get', 'set', 'createSection', 'getString', 'isString', 'getInt', 'isInt', 'getBoolean', 'isBoolean', 'getDouble', 'isDouble', 'getLong', 'isLong', 'getList', 'isList', 'getStringList', 'getIntegerList', 'getBooleanList', 'getDoubleList', 'getFloatList', 'getLongList', 'getByteList', 'getCharacterList', 'getShortList', 'getMapList', 'getObject', 'getSerializable', 'getVector', 'isVector', 'getOfflinePlayer', 'isOfflinePlayer', 'getItemStack', 'isItemStack', 'getColor', 'isColor', 'getLocation', 'isLocation', 'getConfigurationSection', 'isConfigurationSection', 'getDefaultSection', 'getComments', 'getInlineComments', 'setComments', 'setInlineComments'])
