...
impl<'mc> MemoryConfiguration<'mc> {
    ...
    pub fn add_default_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "addDefault", sig.as_str(), args);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    pub fn add_defaults_with_defaults(
        &self,
    ...
    pub fn set_defaults_with_defaults(
        &self,
        defaults: impl Into<crate::configuration::Configuration<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "setDefaults", sig.as_str(), args);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    pub fn defaults(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getDefaults", sig.as_str(), args);
...
impl<'mc> MemorySection<'mc> {
    pub fn get_keys_with_deep(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getKeys", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        blackboxmc_java::util::JavaSet::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn get_values_with_deep(
        &self,
        deep: bool,
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getValues", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        blackboxmc_java::util::JavaMap::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn contains_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_set_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isSet", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn current_path(&self) -> Result<Option<String>, Box<dyn std::error::Error>> {
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getCurrentPath", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {
            return Ok(None);
        }
    ...
    pub fn root(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getRoot", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {
            return Ok(None);
        }
    ...
    ) -> Result<Option<crate::configuration::ConfigurationSection<'mc>>, Box<dyn std::error::Error>>
    {
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getDefaultSection", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {
            return Ok(None);
        }
    ...
    pub fn set_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "set", sig.as_str(), args);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    ...
    pub fn create_section_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_string_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isString", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_int_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_int_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isInt", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_boolean_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_boolean_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isBoolean", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_double_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_double_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isDouble", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_long_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_long_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isLong", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_list_with_path(
        &self,
        path: impl Into<String>,
        def: std::option::Option<Vec<jni::objects::JObject<'mc>>>,
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {
            return Ok(None);
        }
    ...
    pub fn is_list_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_string_list_with_path(
        &self,
        path: impl Into<String>,
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getStringList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_integer_list_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getIntegerList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_boolean_list_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getBooleanList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_double_list_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getDoubleList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_float_list_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getFloatList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_long_list_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getLongList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_byte_list_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getByteList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_character_list_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getCharacterList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_short_list_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getShortList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_map_list_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getMapList", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_serializable_with_path(
        &self,
        path: impl Into<String>,
        clazz: jni::objects::JClass<'mc>,
        def: std::option::Option<
    ...
    pub fn is_vector_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isVector", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_offline_player_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_offline_player_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "isOfflinePlayer", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_item_stack_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_item_stack_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isItemStack", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_color_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_color_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isColor", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_location_with_path(
        &self,
        path: impl Into<String>,
    ...
    pub fn is_location_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isLocation", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn get_configuration_section_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Option<crate::configuration::ConfigurationSection<'mc>>, Box<dyn std::error::Error>>
    {
    ...
    pub fn is_configuration_section_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn create_path_with_section(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
    ...
    pub fn get_comments_with_path(
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getComments", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn get_inline_comments_with_path(
        &self,
        path: impl Into<String>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getInlineComments", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        let mut new_vec = Vec::new();
        let list = blackboxmc_java::util::JavaList::from_raw(&self.0, res.l()?)?;
        let iter = list.iterator()?;
    ...
    pub fn set_comments_with_path(
        ...
        let raw_val_2 = self
            ...
            .new_object("java/util/ArrayList", "()V", vec![])?;
        for v in comments {
            sig += "Lcomments/jni::objects::JObject;";
            let map_val_0 = jni::objects::JValueGen::Object(v);
            self.jni_ref().call_method(
                &raw_val_2,
                "add",
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "setComments", sig.as_str(), args);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    pub fn set_inline_comments_with_path(
        &self,
        path: impl Into<String>,
        comments: Vec<jni::objects::JObject<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "setInlineComments", sig.as_str(), args);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    #[doc(hidden)]
...
impl<'mc> ConfigurationOptions<'mc> {
    ...
    pub fn path_separator_with_value(
        &self,
    ...
    pub fn copy_defaults_with_value(
        &self,
