...
impl<'mc> ConfigurationSerialization<'mc> {
	pub fn deserialize(&self,val_args: impl Into<blackboxmc_java::util::JavaMap<'mc>>) 
-> Result<Option<crate::configuration::serialization::ConfigurationSerializable<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/util/Map;)Lcrate::configuration::serialization::ConfigurationSerializable;");
...
crate::configuration::serialization::ConfigurationSerializable::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn deserialize_object_with_args(jni: &blackboxmc_general::SharedJNIEnv<'mc>,val_args: impl Into<blackboxmc_java::util::JavaMap<'mc>>,clazz: std::option::Option<jni::objects::JClass<'mc>>) 
-> Result<Option<crate::configuration::serialization::ConfigurationSerializable<'mc>>, Box<dyn std::error::Error>>
...
crate::configuration::serialization::ConfigurationSerializable::from_raw(&jni,obj
	...
	pub fn register_class_with_clazz(jni: &blackboxmc_general::SharedJNIEnv<'mc>,clazz: jni::objects::JClass<'mc>,alias: std::option::Option<impl Into<String>>) 
...
()
	...
	pub fn unregister_class_with_clazz(jni: &blackboxmc_general::SharedJNIEnv<'mc>,clazz: jni::objects::JClass<'mc>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn get_class_by_alias(jni: &blackboxmc_general::SharedJNIEnv<'mc>,alias: impl Into<String>) 
...
unsafe {jni::objects::JClass::from_raw(res.as_jni().l)}
	...
	pub fn get_alias(jni: &blackboxmc_general::SharedJNIEnv<'mc>,clazz: jni::objects::JClass<'mc>) 
-> Result<String, Box<dyn std::error::Error>>
