...
#[deprecated]
	...
	pub fn schedule_sync_delayed_task_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,task: impl Into<crate::scheduler::BukkitRunnable<'mc>>,delay: std::option::Option<i64>) 
...
#[deprecated]
	...
	pub fn schedule_sync_repeating_task_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,task: impl Into<crate::scheduler::BukkitRunnable<'mc>>,delay: i64,period: i64) 
-> Result<i32, Box<dyn std::error::Error>>
...
()
	...
	pub fn cancel_tasks(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn is_currently_running(&self,task_id: i32) 
...
res.z()?
	...
	pub fn is_queued(&self,task_id: i32) 
-> Result<bool, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn run_task_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,task: impl Into<crate::scheduler::BukkitRunnable<'mc>>) 
...
#[deprecated]
	...
	pub fn run_task_asynchronously_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,task: impl Into<crate::scheduler::BukkitRunnable<'mc>>) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn run_task_later_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,task: impl Into<crate::scheduler::BukkitRunnable<'mc>>,delay: i64) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn run_task_later_asynchronously_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,task: impl Into<crate::scheduler::BukkitRunnable<'mc>>,delay: i64) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn run_task_timer_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,task: impl Into<crate::scheduler::BukkitRunnable<'mc>>,delay: i64,period: i64) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn run_task_timer_asynchronously_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,task: impl Into<crate::scheduler::BukkitRunnable<'mc>>,delay: i64,period: i64) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
()
	...
	pub fn run_task(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
crate::scheduler::BukkitTask::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn run_task_asynchronously(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
crate::scheduler::BukkitTask::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn run_task_later(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,delay: i64) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
crate::scheduler::BukkitTask::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn run_task_later_asynchronously(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,delay: i64) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
crate::scheduler::BukkitTask::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn run_task_timer(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,delay: i64,period: i64) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
...
crate::scheduler::BukkitTask::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn run_task_timer_asynchronously(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,delay: i64,period: i64) 
-> Result<crate::scheduler::BukkitTask<'mc>, Box<dyn std::error::Error>>
