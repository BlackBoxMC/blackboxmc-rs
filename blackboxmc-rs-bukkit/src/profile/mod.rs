...
{let sig = String::from("()Lcrate::profile::PlayerTexturesSkinModel;");
...
res.l()?
	...
	pub fn set_skin_with_skin_url(&self,skin_url: jni::objects::JObject<'mc>,skin_model: std::option::Option<impl Into<crate::profile::PlayerTexturesSkinModel<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
res.l()?
	...
	pub fn set_cape(&self,cape_url: jni::objects::JObject<'mc>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/net/URL;)L();");
...
{let sig = String::from("()Lcrate::profile::PlayerTextures;");
...
crate::profile::PlayerTextures::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_textures(&self,textures: impl Into<crate::profile::PlayerTextures<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/profile/PlayerTextures;)L();");
