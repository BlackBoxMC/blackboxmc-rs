...
use color_eyre::eyre::Result;/*org/bukkit/profile/mod.rs*/

pub enum PlayerTexturesSkinModel<'mc> {
	Classic {inner: PlayerTexturesSkinModelStruct<'mc>},
	Slim {inner: PlayerTexturesSkinModelStruct<'mc>},
}
impl<'mc> std::fmt::Display for PlayerTexturesSkinModel<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> PlayerTexturesSkinModelTrait<'mc> for PlayerTexturesSkinModel<'mc> {}
        
        pub trait PlayerTexturesSkinModelTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
...
"CLASSIC" => Ok(PlayerTexturesSkinModel::Classic { inner: PlayerTexturesSkinModelStruct::from_raw(env,obj)?}),
"SLIM" => Ok(PlayerTexturesSkinModel::Slim { inner: PlayerTexturesSkinModelStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct PlayerTexturesSkinModelStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for PlayerTexturesSkinModel<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/profile/PlayerTextures/SkinModel")?;
            if !valid {
                Err(eyre::eyre!(
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "CLASSIC" => Ok(PlayerTexturesSkinModel::Classic { inner: PlayerTexturesSkinModelStruct::from_raw(env,obj)?}),"SLIM" => Ok(PlayerTexturesSkinModel::Slim { inner: PlayerTexturesSkinModelStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
let cls = jni.find_class("org/bukkit/profile/PlayerTextures/SkinModel"); let cls = jni.translate_error_with_class(cls)?;
...
#[repr(C)]
pub struct PlayerTextures<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for PlayerTextures<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate PlayerTextures from null object.")
                .into());
            }
...
impl<'mc> PlayerTexturesTrait<'mc> for PlayerTextures<'mc> {}
pub trait PlayerTexturesTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let res = self.jni_ref().call_method(&self.jni_object(),"getSkin",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// be used.
	fn set_skin(&self,skin_url: jni::objects::JObject<'mc>,skin_model: std::option::Option<impl Into<crate::profile::PlayerTexturesSkinModel<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
sig += ")V";
let res = self.jni_ref().call_method(&self.jni_object(),"setSkin",sig.as_str(),args);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
{let sig = String::from("()Lorg/bukkit/profile/PlayerTextures/SkinModel;");
let res = self.jni_ref().call_method(&self.jni_object(),"getSkinModel",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::profile::PlayerTexturesSkinModel::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let sig = String::from("()Ljava/net/URL;");
let res = self.jni_ref().call_method(&self.jni_object(),"getCape",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// </pre>
	fn set_cape(&self,cape_url: jni::objects::JObject<'mc>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/net/URL;)V");
let val_1 = jni::objects::JValueGen::Object(cape_url);
let res = self.jni_ref().call_method(&self.jni_object(),"setCape",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"isSigned",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
#[repr(C)]
pub struct PlayerProfile<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for PlayerProfile<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate PlayerProfile from null object.")
                .into());
            }
...
impl<'mc> PlayerProfileTrait<'mc> for PlayerProfile<'mc> {}
pub trait PlayerProfileTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let res = 
self.jni_ref().translate_error(res)?;
crate::profile::PlayerTextures::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// Copies the given textures.
	fn set_textures(&self,textures: impl Into<crate::profile::PlayerTextures<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/profile/PlayerTextures;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(textures.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"setTextures",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"isComplete",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
impl<'mc> Into<crate::configuration::serialization::ConfigurationSerializable<'mc>> for PlayerProfile<'mc>{

fn into(self) -> crate::configuration::serialization::ConfigurationSerializable<'mc> {

crate::configuration::serialization::ConfigurationSerializable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PlayerProfile into crate::configuration::serialization::ConfigurationSerializable")

   }
}
impl<'mc> crate::configuration::serialization::ConfigurationSerializableTrait<'mc> for PlayerProfile<'mc> {}
