...
if !valid {
	...
	pub fn is_signed(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isSigned","()Z",&[]);
let res = 
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn skin_model(&mut self) 
-> Result<crate::profile::PlayerTexturesSkinModel<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getSkinModel","()Lorg/bukkit/profile/PlayerTextures$SkinModel;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getTimestamp","()J",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
}
...
pub struct PlayerTexturesSkinModel<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
-> Result<blackboxmc_java::concurrent::JavaCompletableFuture<'mc, orgPlayerProfile>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"update","()Ljava/util/concurrent/CompletableFuture;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::concurrent::JavaCompletableFuture::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn textures(&mut self) 
-> Result<crate::profile::PlayerTextures<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getTextures","()Lorg/bukkit/profile/PlayerTextures;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::profile::PlayerTextures::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn set_textures(&mut self,arg0: impl Into<&'mc crate::profile::PlayerTextures<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setTextures","(Lorg/bukkit/profile/PlayerTextures;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_complete(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isComplete","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
