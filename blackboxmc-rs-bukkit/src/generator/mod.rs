...
impl<'mc> ChunkGeneratorChunkData<'mc> {
    ...
    pub fn set_region_with_int(
        ...
        arg4: i32,
        arg5: i32,
        arg6: std::option::Option<impl Into<&'mc crate::material::MaterialData<'mc>>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let val_2 = jni::objects::JValueGen::Int(arg1.into());
        let val_3 = jni::objects::JValueGen::Int(arg2.into());
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "setRegion",
            "(IIIIIILorg/bukkit/material/MaterialData;)V",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
                jni::objects::JValueGen::from(&val_3),
...
impl<'mc> BiomeProvider<'mc> {
    ...
    pub fn get_biomes(
        &mut self,
        arg0: impl Into<&'mc crate::generator::WorldInfo<'mc>>,
    ) -> Result<blackboxmc_java::JavaList<'mc, orgBiome>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getBiomes",
...
impl<'mc> LimitedRegion<'mc> {
    ...
    pub fn generate_tree_with_location(
        ...
        let val_4 =
            unsafe { jni::objects::JObject::from_raw(arg3.unwrap().into().jni_object().clone()) };
        let res = self.jni_ref().call_method(&self.jni_object(),"generateTree","(Lorg/bukkit/Location;Ljava/util/Random;Lorg/bukkit/TreeType;Ljava/util/function/Predicate;)Z",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    ...
    ) -> Result<blackboxmc_java::JavaCollection<'mc, T>, Box<dyn std::error::Error>> {
        let val_1 = arg0;
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getEntitiesByClass",
    ...
    ) -> Result<blackboxmc_java::JavaCollection<'mc, orgEntity>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
...
impl<'mc> ChunkGenerator<'mc> {
    ...
    pub fn get_default_populators(
        &mut self,
        arg0: impl Into<&'mc crate::World<'mc>>,
    ) -> Result<blackboxmc_java::JavaList<'mc, orgBlockPopulator>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
