...
unsafe {jni::objects::JClass::from_raw(res.as_jni().l)}
	...
	pub fn get_by_key(jni: &blackboxmc_general::SharedJNIEnv<'mc>,namespaced_key: impl Into<crate::NamespacedKey<'mc>>) 
...
crate::Keyed::from_raw(&self.jni_ref(), self.1).expect("Error converting MemoryKey into crate::Keyed")
