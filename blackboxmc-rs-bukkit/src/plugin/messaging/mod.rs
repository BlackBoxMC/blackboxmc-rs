...
impl<'mc> StandardMessenger<'mc> {
    ...
    pub fn is_reserved_channel_with_channel(
        &self,
        channel: impl Into<String>,
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "isReservedChannel", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn register_outgoing_plugin_channel_with_plugin(
        &self,
    ...
    pub fn register_incoming_plugin_channel_with_plugin(
        &self,
        plugin: impl Into<crate::plugin::Plugin<'mc>>,
        channel: impl Into<String>,
    ...
    > {
        ...
        args.push(val_3);
        sig += ")Lorg/bukkit/plugin/messaging/PluginMessageListenerRegistration;";
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn get_outgoing_channels_with_plugin(
        &self,
        plugin: impl Into<crate::plugin::Plugin<'mc>>,
    ) -> Result<blackboxmc_java::util::JavaSet<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn get_incoming_channels_with_plugin(
        &self,
        plugin: impl Into<crate::plugin::Plugin<'mc>>,
    ) -> Result<blackboxmc_java::util::JavaSet<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn get_incoming_channel_registrations_with_channel(
        &self,
        channel: impl Into<String>,
    ) -> Result<blackboxmc_java::util::JavaSet<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn is_registration_valid_with_registration(
        &self,
    ...
    pub fn is_incoming_channel_registered_with_plugin(
        &self,
        plugin: impl Into<crate::plugin::Plugin<'mc>>,
        channel: impl Into<String>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
    ...
    pub fn is_outgoing_channel_registered_with_plugin(
        &self,
        plugin: impl Into<crate::plugin::Plugin<'mc>>,
        channel: impl Into<String>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
    ...
    pub fn dispatch_incoming_message_with_source(
        &self,
