...
use color_eyre::eyre::Result;/*org/bukkit/plugin/messaging/mod.rs*/
...
impl<'mc> MessengerTrait<'mc> for Messenger<'mc> {}
pub trait MessengerTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Checks if the specified channel is a reserved name.
/// 
/// All channels within the "minecraft" namespace except for
/// "minecraft:brand" are reserved.
	fn is_reserved_channel(&self,channel: impl Into<String>) 
...
/// allowing it to send messages through that channel to any clients.
	fn register_outgoing_plugin_channel(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,channel: impl Into<String>) 
...
/// any clients.
	fn unregister_outgoing_plugin_channel(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,channel: std::option::Option<impl Into<String>>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// plugin channel, allowing it to act upon any plugin messages.
	fn register_incoming_plugin_channel(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,channel: impl Into<String>,listener: impl Into<crate::plugin::messaging::PluginMessageListener<'mc>>) 
...
/// any plugin messages.
	fn unregister_incoming_plugin_channel(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,channel: std::option::Option<impl Into<String>>,listener: std::option::Option<impl Into<crate::plugin::messaging::PluginMessageListener<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// specified plugin is registered to.
	fn get_outgoing_channels(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
...
/// specified plugin is registered for.
	fn get_incoming_channels(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
-> Result<blackboxmc_java::util::JavaSet<'mc>, Box<dyn std::error::Error>>
...
/// that the specified plugin has on the requested channel.
	fn get_incoming_channel_registrations(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,channel: std::option::Option<impl Into<String>>) 
-> Result<blackboxmc_java::util::JavaSet<'mc>, Box<dyn std::error::Error>>
...
/// that the plugin is still enabled.
	fn is_registration_valid(&self,registration: impl Into<crate::plugin::messaging::PluginMessageListenerRegistration<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/plugin/messaging/PluginMessageListenerRegistration;)Z");
...
/// messages through the requested channel.
	fn is_incoming_channel_registered(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,channel: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>
...
/// through the requested channel.
	fn is_outgoing_channel_registered(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,channel: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>
...
/// Dispatches the specified incoming message to any registered listeners.
	fn dispatch_incoming_message(&self,source: impl Into<crate::entity::Player<'mc>>,channel: impl Into<String>,message: i8) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> PluginMessageListenerTrait<'mc> for PluginMessageListener<'mc> {}
pub trait PluginMessageListenerTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// A method that will be thrown when a PluginMessageSource sends a plugin
/// message on a registered channel.
	fn on_plugin_message_received(&self,channel: impl Into<String>,player: impl Into<crate::entity::Player<'mc>>,message: i8) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> PluginMessageRecipientTrait<'mc> for PluginMessageRecipient<'mc> {}
pub trait PluginMessageRecipientTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
/// specified channel.
	fn send_plugin_message(&self,source: impl Into<crate::plugin::Plugin<'mc>>,channel: impl Into<String>,message: i8) 
-> Result<(), Box<dyn std::error::Error>>
...
/// listening on.
	fn listening_plugin_channels(&self) 
-> Result<blackboxmc_java::util::JavaSet<'mc>, Box<dyn std::error::Error>>
...
impl<'mc> ChannelNotRegisteredExceptionTrait<'mc> for ChannelNotRegisteredException<'mc> {}
pub trait ChannelNotRegisteredExceptionTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,channel: std::option::Option<impl Into<String>>) 
...
impl<'mc> ReservedChannelExceptionTrait<'mc> for ReservedChannelException<'mc> {}
pub trait ReservedChannelExceptionTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,name: std::option::Option<impl Into<String>>) 
...
impl<'mc> ChannelNameTooLongExceptionTrait<'mc> for ChannelNameTooLongException<'mc> {}
pub trait ChannelNameTooLongExceptionTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
impl<'mc> MessageTooLargeExceptionTrait<'mc> for MessageTooLargeException<'mc> {}
pub trait MessageTooLargeExceptionTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
impl<'mc> std::fmt::Display for PluginChannelDirection<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> PluginChannelDirectionTrait<'mc> for PluginChannelDirection<'mc> {}
        
        pub trait PluginChannelDirectionTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
impl<'mc> PluginMessageListenerRegistrationTrait<'mc> for PluginMessageListenerRegistration<'mc> {}
pub trait PluginMessageListenerRegistrationTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,messenger: impl Into<crate::plugin::messaging::Messenger<'mc>>,plugin: impl Into<crate::plugin::Plugin<'mc>>,channel: impl Into<String>,listener: impl Into<crate::plugin::messaging::PluginMessageListener<'mc>>) 
-> Result<crate::plugin::messaging::PluginMessageListenerRegistration<'mc>, Box<dyn std::error::Error>>
...
impl<'mc> StandardMessengerTrait<'mc> for StandardMessenger<'mc> {}
pub trait StandardMessengerTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
/// Validates a Plugin Channel name.
	fn validate_channel(jni: &blackboxmc_general::SharedJNIEnv<'mc>,channel: impl Into<String>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Validates and corrects a Plugin Channel name. Method is not reentrant / idempotent.
	fn validate_and_correct_channel(jni: &blackboxmc_general::SharedJNIEnv<'mc>,channel: impl Into<String>) 
-> Result<String, Box<dyn std::error::Error>>
...
/// valid.
	fn validate_plugin_message(jni: &blackboxmc_general::SharedJNIEnv<'mc>,messenger: impl Into<crate::plugin::messaging::Messenger<'mc>>,source: impl Into<crate::plugin::Plugin<'mc>>,channel: impl Into<String>,message: i8) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::plugin::messaging::Messenger::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting StandardMessenger into crate::plugin::messaging::Messenger")

   }
}
impl<'mc> crate::plugin::messaging::MessengerTrait<'mc> for StandardMessenger<'mc> {}
