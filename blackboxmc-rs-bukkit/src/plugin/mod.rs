...
impl<'mc> InvalidDescriptionException<'mc> {
    pub fn new_with_message(
        ...
        sig += ")V";
        let cls = jni.find_class("org/bukkit/plugin/InvalidDescriptionException");
...
impl<'mc> PluginDescriptionFile<'mc> {
    ...
    pub fn provides(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
    ...
    pub fn authors(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let sig = String::from("()LVec;");
        let res =
            self.jni_ref()
    ...
    pub fn depend(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let sig = String::from("()LVec;");
        let res = self
            .jni_ref()
    ...
    pub fn libraries(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let sig = String::from("()LVec;");
        let res =
            self.jni_ref()
...
impl<'mc> UnknownDependencyException<'mc> {
    pub fn new_with_message(
        ...
        sig += ")V";
        let cls = jni.find_class("org/bukkit/plugin/UnknownDependencyException");
        let cls = jni.translate_error_with_class(cls)?;
        let res = jni.new_object(cls, sig.as_str(), args);
        let res = jni.translate_error_no_gen(res)?;
...
impl<'mc> PluginLoader<'mc> {
    ...
    pub fn create_registered_listeners(
        ...
        let sig = String::from(
            "(Lorg/bukkit/event/Listener;Lorg/bukkit/plugin/Plugin;)Lblackboxmc_java::util::Map;",
        );
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(listener.into().jni_object().clone())
        });
...
impl<'mc> Plugin<'mc> {
    ...
    pub fn get_default_world_generator(
        ...
        let sig = String::from(
            "(Ljava/lang/String;Ljava/lang/String;)Lcrate::generator::ChunkGenerator;",
        );
        let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(
    ...
    pub fn get_default_biome_provider(
        ...
        let sig =
            String::from("(Ljava/lang/String;Ljava/lang/String;)Lcrate::generator::BiomeProvider;");
        let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(
            self.jni_ref().new_string(world_name.into())?,
        ));
        let val_2 = jni::objects::JValueGen::Object(jni::objects::JObject::from(
...
impl<'mc> PluginManager<'mc> {
    ...
    pub fn register_event_with_event(
        &self,
    ...
    pub fn remove_permission_with_name(
        &self,
        name: impl Into<String>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
...
impl<'mc> ServicesManager<'mc> {
    ...
    pub fn unregister_with_service(
        &self,
        service: jni::objects::JClass<'mc>,
    ...
    pub fn get_registrations_with_service(
        &self,
        service: jni::objects::JClass<'mc>,
    ) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
