...
use color_eyre::eyre::Result;/*org/bukkit/plugin/java/mod.rs*/
...
impl<'mc> JavaPluginTrait<'mc> for JavaPlugin<'mc> {}
pub trait JavaPluginTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
/// {@inheritDoc}
	fn on_tab_complete(&self,sender: impl Into<crate::command::CommandSender<'mc>>,command: impl Into<crate::command::Command<'mc>>,alias: impl Into<String>,val_args: impl Into<String>) 
...
/// resided in a different jar / classloader.
	fn get_plugin(jni: &blackboxmc_general::SharedJNIEnv<'mc>,clazz: jni::objects::JClass<'mc>) 
...
/// given class.
	fn get_providing_plugin(jni: &blackboxmc_general::SharedJNIEnv<'mc>,clazz: jni::objects::JClass<'mc>) 
-> Result<crate::plugin::java::JavaPlugin<'mc>, Box<dyn std::error::Error>>
    ...
    fn instance_of(&self, other: impl Into<String>) -> Result<bool, jni::errors::Error>  {
        ...
        impl<'mc> std::string::ToString for JavaPlugin<'mc> {
            fn to_string(&self) -> String {
                match JavaPluginTrait::internal_to_string(self) {
                    Ok(a) => a.clone(),
                    Err(err) => format!(
...
crate::plugin::PluginBase::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting JavaPlugin into crate::plugin::PluginBase")

   }
}
impl<'mc> crate::plugin::PluginBaseTrait<'mc> for JavaPlugin<'mc> {}
#[repr(C)]
...
impl<'mc> JavaPluginLoaderTrait<'mc> for JavaPluginLoader<'mc> {}
pub trait JavaPluginLoaderTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
#[deprecated]
/// This class was not meant to be constructed explicitly
	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,instance: impl Into<crate::Server<'mc>>) 
...
crate::plugin::PluginLoader::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting JavaPluginLoader into crate::plugin::PluginLoader")

   }
}
impl<'mc> crate::plugin::PluginLoaderTrait<'mc> for JavaPluginLoader<'mc> {}
