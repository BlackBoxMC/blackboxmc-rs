...
impl<'mc> JavaPluginLoader<'mc> {
    ...
    pub fn create_registered_listeners_with_listener(
        &self,
    ...
    pub fn enable_plugin_with_plugin(
        &self,
        plugin: impl Into<crate::plugin::Plugin<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "enablePlugin", sig.as_str(), args);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    pub fn disable_plugin_with_plugin(
        &self,
        plugin: impl Into<crate::plugin::Plugin<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "disablePlugin", sig.as_str(), args);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    // SUPER CLASS: Object
