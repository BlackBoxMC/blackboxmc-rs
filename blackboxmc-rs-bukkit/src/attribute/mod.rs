...
let res = self.jni_ref().call_method(&self.jni_object(),"getAttribute","(Lorg/bukkit/attribute/Attribute;)Lorg/bukkit/attribute/AttributeInstance;",&[jni::objects::JValueGen::from(&val_1)]);
let res = 
...
"(Ljava/lang/String;)Lorg/bukkit/attribute/Attribute;",&[jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"setBaseValue","(D)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"addModifier","(Lorg/bukkit/attribute/AttributeModifier;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"removeModifier","(Lorg/bukkit/attribute/AttributeModifier;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
}
...
let val_1 = jni::objects::JValueGen::Object(jni.new_object("java/util/UUID", "(JJ)V", &[upper.into(), lower.into()]).unwrap());
let val_2 = jni::objects::JObject::from(jni.new_string(arg1.unwrap().into()).unwrap());
...
"(Ljava/util/Map;)Lorg/bukkit/attribute/AttributeModifier;",&[jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
