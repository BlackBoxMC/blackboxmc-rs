...
use color_eyre::eyre::Result;/*org/bukkit/attribute/mod.rs*/

#[repr(C)]
pub struct Attributable<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Attributable from null object.")
                .into());
            }
...
impl<'mc> AttributableTrait<'mc> for Attributable<'mc> {}
pub trait AttributableTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
/// be backed directly to the object and any changes will be visible at once.
	fn get_attribute(&self,attribute: impl Into<crate::attribute::Attribute<'mc>>) 
-> Result<Option<crate::attribute::AttributeInstance<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/attribute/Attribute;)Lorg/bukkit/attribute/AttributeInstance;");
...
impl<'mc> std::fmt::Display for Attribute<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           Attribute::GenericKnockbackResistance { .. } => f.write_str("GENERIC_KNOCKBACK_RESISTANCE"),
           ...
           Attribute::ZombieSpawnReinforcements { .. } => f.write_str("ZOMBIE_SPAWN_REINFORCEMENTS"),
       }
   }
}

        impl<'mc> AttributeTrait<'mc> for Attribute<'mc> {}
        
        pub trait AttributeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
"GENERIC_MAX_HEALTH" => Ok(Attribute::GenericMaxHealth { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_FOLLOW_RANGE" => Ok(Attribute::GenericFollowRange { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_KNOCKBACK_RESISTANCE" => Ok(Attribute::GenericKnockbackResistance { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_MOVEMENT_SPEED" => Ok(Attribute::GenericMovementSpeed { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_FLYING_SPEED" => Ok(Attribute::GenericFlyingSpeed { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_ATTACK_DAMAGE" => Ok(Attribute::GenericAttackDamage { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_ATTACK_KNOCKBACK" => Ok(Attribute::GenericAttackKnockback { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_ATTACK_SPEED" => Ok(Attribute::GenericAttackSpeed { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_ARMOR" => Ok(Attribute::GenericArmor { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_ARMOR_TOUGHNESS" => Ok(Attribute::GenericArmorToughness { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_LUCK" => Ok(Attribute::GenericLuck { inner: AttributeStruct::from_raw(env,obj)?}),
"GENERIC_MAX_ABSORPTION" => Ok(Attribute::GenericMaxAbsorption { inner: AttributeStruct::from_raw(env,obj)?}),
"HORSE_JUMP_STRENGTH" => Ok(Attribute::HorseJumpStrength { inner: AttributeStruct::from_raw(env,obj)?}),
"ZOMBIE_SPAWN_REINFORCEMENTS" => Ok(Attribute::ZombieSpawnReinforcements { inner: AttributeStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct AttributeStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
fn jni_object(&self) -> jni::objects::JObject<'mc> {
match self {
Self::GenericMaxHealth { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericFollowRange { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericKnockbackResistance { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericMovementSpeed { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericFlyingSpeed { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericAttackDamage { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericAttackKnockback { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericAttackSpeed { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericArmor { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericArmorToughness { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericLuck { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::GenericMaxAbsorption { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::HorseJumpStrength { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ZombieSpawnReinforcements { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
}
}
}
impl<'mc> JNIInstantiatable<'mc> for Attribute<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Attribute from null object.")
                .into());
            }
...
impl<'mc> JNIInstantiatable<'mc> for AttributeStruct<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate AttributeStruct from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/attribute/Attribute")?;
            if !valid {
...
let cls = jni.find_class("org/bukkit/attribute/Attribute"); let cls = jni.translate_error_with_class(cls)?;
...
#[repr(C)]
pub struct AttributeModifier<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for AttributeModifier<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate AttributeModifier from null object.")
                .into());
            }
...
impl<'mc> AttributeModifierTrait<'mc> for AttributeModifier<'mc> {}
pub trait AttributeModifierTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,uuid: impl Into<blackboxmc_java::util::JavaUUID<'mc>>,name: impl Into<String>,amount: f64,operation: std::option::Option<impl Into<crate::attribute::AttributeModifierOperation<'mc>>>,slot: std::option::Option<impl Into<crate::inventory::EquipmentSlot<'mc>>>) 
...
args.push(val_2);
sig += "D";
let val_3 = jni::objects::JValueGen::Double(amount);
args.push(val_3);
if let Some(a) = operation {
...
sig += ")V";
let cls = jni.find_class("org/bukkit/attribute/AttributeModifier"); let cls = jni.translate_error_with_class(cls)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getOperation",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::attribute::AttributeModifierOperation::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
    ...
    fn instance_of(&self, other: impl Into<String>) -> Result<bool, jni::errors::Error>  {
        ...
        impl<'mc> std::string::ToString for AttributeModifier<'mc> {
            fn to_string(&self) -> String {
                match AttributeModifierTrait::internal_to_string(self) {
                    Ok(a) => a.clone(),
                    Err(err) => format!(
                        "Error calling AttributeModifier.toString: {}",
                        err
                    ),
                }
            }
...
impl<'mc> Into<crate::configuration::serialization::ConfigurationSerializable<'mc>> for AttributeModifier<'mc>{

fn into(self) -> crate::configuration::serialization::ConfigurationSerializable<'mc> {

crate::configuration::serialization::ConfigurationSerializable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting AttributeModifier into crate::configuration::serialization::ConfigurationSerializable")

   }
}
impl<'mc> crate::configuration::serialization::ConfigurationSerializableTrait<'mc> for AttributeModifier<'mc> {}
pub enum AttributeModifierOperation<'mc> {
	AddNumber {inner: AttributeModifierOperationStruct<'mc>},
	AddScalar {inner: AttributeModifierOperationStruct<'mc>},
	MultiplyScalar1 {inner: AttributeModifierOperationStruct<'mc>},
}
impl<'mc> std::fmt::Display for AttributeModifierOperation<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> AttributeModifierOperationTrait<'mc> for AttributeModifierOperation<'mc> {}
        
        pub trait AttributeModifierOperationTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"ADD_NUMBER" => Ok(AttributeModifierOperation::AddNumber { inner: AttributeModifierOperationStruct::from_raw(env,obj)?}),
"ADD_SCALAR" => Ok(AttributeModifierOperation::AddScalar { inner: AttributeModifierOperationStruct::from_raw(env,obj)?}),
"MULTIPLY_SCALAR_1" => Ok(AttributeModifierOperation::MultiplyScalar1 { inner: AttributeModifierOperationStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct AttributeModifierOperationStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
fn jni_object(&self) -> jni::objects::JObject<'mc> {
match self {
Self::AddNumber { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::AddScalar { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::MultiplyScalar1 { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
}
}
}
impl<'mc> JNIInstantiatable<'mc> for AttributeModifierOperation<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/attribute/AttributeModifier/Operation")?;
            if !valid {
                Err(eyre::eyre!(
...
{let sig = String::from("()Lorg/bukkit/attribute/AttributeModifier/Operation;");
let cls = jni.find_class("org/bukkit/attribute/AttributeModifier/Operation"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
#[repr(C)]
pub struct AttributeInstance<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for AttributeInstance<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate AttributeInstance from null object.")
                .into());
            }
...
impl<'mc> AttributeInstanceTrait<'mc> for AttributeInstance<'mc> {}
pub trait AttributeInstanceTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// The attribute pertaining to this instance.
	fn attribute(&self) 
-> Result<crate::attribute::Attribute<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/attribute/Attribute;");
let res = self.jni_ref().call_method(&self.jni_object(),"getAttribute",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::attribute::Attribute::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let sig = String::from("()D");
let res = self.jni_ref().call_method(&self.jni_object(),"getBaseValue",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.d()?
...
/// Set the base value of this instance.
	fn set_base_value(&self,value: f64) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(D)V");
let val_1 = jni::objects::JValueGen::Double(value);
let res = self.jni_ref().call_method(&self.jni_object(),"setBaseValue",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"getModifiers",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// Add a modifier to this instance.
	fn add_modifier(&self,modifier: impl Into<crate::attribute::AttributeModifier<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/attribute/AttributeModifier;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(modifier.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"addModifier",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
/// Remove a modifier from this instance.
	fn remove_modifier(&self,modifier: impl Into<crate::attribute::AttributeModifier<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/attribute/AttributeModifier;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(modifier.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"removeModifier",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
{let sig = String::from("()D");
let res = self.jni_ref().call_method(&self.jni_object(),"getDefaultValue",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.d()?
