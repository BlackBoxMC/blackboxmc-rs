...
if !valid {
	...
	pub fn get_attribute(&mut self,arg0: impl Into<&'mc crate::attribute::Attribute<'mc>>) 
...
let res = self.jni_ref().call_method(&self.jni_object(),"getAttribute","(Lorg/bukkit/attribute/Attribute;)Lorg/bukkit/attribute/AttributeInstance;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
...
impl std::fmt::Display for AttributeEnum {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match &self {
           ...
           AttributeEnum::GenericKnockbackResistance => f.write_str("GENERIC_KNOCKBACK_RESISTANCE"),
...
pub struct Attribute<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>, pub AttributeEnum);
...
pub const GENERIC_KNOCKBACK_RESISTANCE: AttributeEnum = AttributeEnum::GenericKnockbackResistance;
...
"(Ljava/lang/String;)Lorg/bukkit/attribute/Attribute;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
crate::attribute::Attribute::from_raw(&jni,raw_obj
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getAttribute","()Lorg/bukkit/attribute/Attribute;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::attribute::Attribute::from_raw(&self.jni_ref(),raw_obj
, crate::attribute::Attribute::from_string(variant_str).unwrap()
)}
	pub fn modifiers(&mut self) 
-> Result<blackboxmc_java::JavaCollection<'mc, orgAttributeModifier>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getModifiers","()Ljava/util/Collection;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getValue","()D",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getDefaultValue","()D",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
	pub fn base_value(&mut self) 
-> Result<f64, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getBaseValue","()D",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
	pub fn set_base_value(&mut self,arg0: f64) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Double(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setBaseValue","(D)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn add_modifier(&mut self,arg0: impl Into<&'mc crate::attribute::AttributeModifier<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"addModifier","(Lorg/bukkit/attribute/AttributeModifier;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove_modifier(&mut self,arg0: impl Into<&'mc crate::attribute::AttributeModifier<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"removeModifier","(Lorg/bukkit/attribute/AttributeModifier;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
}
...
pub struct AttributeModifierOperation<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
if !valid {
	...
	pub fn new_with_string(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: u128,arg1: impl Into<&'mc String>,arg2: std::option::Option<f64>,arg3: std::option::Option<impl Into<&'mc crate::attribute::AttributeModifierOperation<'mc>>>) 
...
let val_0 = jni::objects::JValueGen::Object(jni.new_object("java/util/UUID", "(JJ)V", &[upper.into(), lower.into()]).unwrap());
...
"(Ljava/util/UUID;Ljava/lang/String;DLorg/bukkit/attribute/AttributeModifier$Operation;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
crate::attribute::AttributeModifier::from_raw(&jni,res
)}
	pub fn new_with_uuid(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: u128,arg1: impl Into<&'mc String>,arg2: f64,arg3: impl Into<&'mc crate::attribute::AttributeModifierOperation<'mc>>,arg4: std::option::Option<impl Into<&'mc crate::inventory::EquipmentSlot<'mc>>>) 
-> Result<crate::attribute::AttributeModifier<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/attribute/AttributeModifier")?;
let res = jni.new_object(cls,
"(Ljava/util/UUID;Ljava/lang/String;DLorg/bukkit/attribute/AttributeModifier$Operation;Lorg/bukkit/inventory/EquipmentSlot;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
crate::attribute::AttributeModifier::from_raw(&jni,res
)}
	pub fn name(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
"(Ljava/util/Map;)Lorg/bukkit/attribute/AttributeModifier;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getOperation","()Lorg/bukkit/attribute/AttributeModifier$Operation;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
