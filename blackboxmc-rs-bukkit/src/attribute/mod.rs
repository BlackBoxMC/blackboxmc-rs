...
{let sig = String::from("()Lcrate::attribute::Attribute;");
...
impl<'mc> AttributeModifier<'mc> {
	pub fn new_with_uuid(jni: &blackboxmc_general::SharedJNIEnv<'mc>,uuid: impl Into<blackboxmc_java::util::JavaUUID<'mc>>,name: impl Into<String>,amount: f64,operation: std::option::Option<impl Into<crate::attribute::AttributeModifierOperation<'mc>>>,slot: std::option::Option<impl Into<crate::inventory::EquipmentSlot<'mc>>>) 
...
{let sig = String::from("()Lcrate::attribute::AttributeModifierOperation;");
...
blackboxmc_java::util::JavaMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn equals(&self,other: jni::objects::JObject<'mc>) 
...
{let sig = String::from("(Ljava/util/Map;)Lcrate::attribute::AttributeModifier;");
...
new_vec
	...
	pub fn add_modifier(&self,modifier: impl Into<crate::attribute::AttributeModifier<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/attribute/AttributeModifier;)L();");
...
()
	...
	pub fn remove_modifier(&self,modifier: impl Into<crate::attribute::AttributeModifier<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
