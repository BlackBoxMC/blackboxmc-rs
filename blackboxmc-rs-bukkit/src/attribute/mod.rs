...
impl<'mc> AttributeInstance<'mc> {
    ...
    pub fn modifiers(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
...
impl<'mc> Attributable<'mc> {
    pub fn get_attribute(
        ...
        let sig =
            String::from("(Lorg/bukkit/attribute/Attribute;)Lcrate::attribute::AttributeInstance;");
        let val_1 = jni::objects::JValueGen::Object(unsafe {
