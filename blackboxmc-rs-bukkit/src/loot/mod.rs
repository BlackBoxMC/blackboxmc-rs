...
use color_eyre::eyre::Result;/*org/bukkit/loot/mod.rs*/

#[repr(C)]
pub struct LootContext<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate LootContext from null object.")
                .into());
            }
...
impl<'mc> LootContextTrait<'mc> for LootContext<'mc> {}
pub trait LootContextTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let res = self.jni_ref().call_method(&self.jni_object(),"getLuck",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.f()?
...
/// {@link #getKiller()} entity's looting level will be used instead.
	fn looting_modifier(&self) 
-> Result<i32, Box<dyn std::error::Error>>

{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getLootingModifier",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
#[repr(C)]
pub struct LootContextBuilder<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for LootContextBuilder<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate LootContextBuilder from null object.")
                .into());
            }
...
impl<'mc> LootContextBuilderTrait<'mc> for LootContextBuilder<'mc> {}
pub trait LootContextBuilderTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Creates a new LootContext.Builder instance to facilitate easy
/// creation of {@link LootContext}s.
	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,location: impl Into<crate::Location<'mc>>) 
...
let cls = jni.find_class("org/bukkit/loot/LootContext/Builder"); let cls = jni.translate_error_with_class(cls)?;
...
/// Set how much luck to have when generating loot.
	fn luck(&self,luck: f32) 
-> Result<crate::loot::LootContextBuilder<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(F)Lorg/bukkit/loot/LootContext/Builder;");
let val_1 = jni::objects::JValueGen::Float(luck);
let res = self.jni_ref().call_method(&self.jni_object(),"luck",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::loot::LootContextBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
/// {@link org.bukkit.inventory.ItemStack} per pool.
	fn looting_modifier(&self,modifier: i32) 
-> Result<crate::loot::LootContextBuilder<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(I)Lorg/bukkit/loot/LootContext/Builder;");
let val_1 = jni::objects::JValueGen::Int(modifier);
let res = self.jni_ref().call_method(&self.jni_object(),"lootingModifier",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::loot::LootContextBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// The entity that was killed.
	fn looted_entity(&self,looted_entity: impl Into<crate::entity::Entity<'mc>>) 
-> Result<crate::loot::LootContextBuilder<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;)Lorg/bukkit/loot/LootContext/Builder;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(looted_entity.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"lootedEntity",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::loot::LootContextBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
/// looting level if {@link #lootingModifier(int)} is not set.
	fn killer(&self,killer: impl Into<crate::entity::HumanEntity<'mc>>) 
-> Result<crate::loot::LootContextBuilder<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/HumanEntity;)Lorg/bukkit/loot/LootContext/Builder;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(killer.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"killer",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::loot::LootContextBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
impl<'mc> std::fmt::Display for LootTables<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           LootTables::TrialChambersIntersection { .. } => f.write_str("TRIAL_CHAMBERS_INTERSECTION"),
           LootTables::TrialChambersIntersectionBarrel { .. } => f.write_str("TRIAL_CHAMBERS_INTERSECTION_BARREL"),
           LootTables::TrialChambersEntrance { .. } => f.write_str("TRIAL_CHAMBERS_ENTRANCE"),
           LootTables::TrialChambersCorridorDispenser { .. } => f.write_str("TRIAL_CHAMBERS_CORRIDOR_DISPENSER"),
           LootTables::TrialChambersChamberDispenser { .. } => f.write_str("TRIAL_CHAMBERS_CHAMBER_DISPENSER"),
           LootTables::TrialChambersWaterDispenser { .. } => f.write_str("TRIAL_CHAMBERS_WATER_DISPENSER"),
           LootTables::TrialChambersCorridorPot { .. } => f.write_str("TRIAL_CHAMBERS_CORRIDOR_POT"),
           ...
           LootTables::DesertPyramidArchaeology { .. } => f.write_str("DESERT_PYRAMID_ARCHAEOLOGY"),
           LootTables::TrailRuinsArchaeologyCommon { .. } => f.write_str("TRAIL_RUINS_ARCHAEOLOGY_COMMON"),
           LootTables::TrailRuinsArchaeologyRare { .. } => f.write_str("TRAIL_RUINS_ARCHAEOLOGY_RARE"),
           LootTables::OceanRuinWarmArchaeology { .. } => f.write_str("OCEAN_RUIN_WARM_ARCHAEOLOGY"),
           LootTables::OceanRuinColdArchaeology { .. } => f.write_str("OCEAN_RUIN_COLD_ARCHAEOLOGY"),
        ...
        impl<'mc> LootTablesTrait<'mc> for LootTables<'mc> {}
        
        pub trait LootTablesTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
"EMPTY" => Ok(LootTables::Empty { inner: LootTablesStruct::from_raw(env,obj)?}),
"ABANDONED_MINESHAFT" => Ok(LootTables::AbandonedMineshaft { inner: LootTablesStruct::from_raw(env,obj)?}),
"BURIED_TREASURE" => Ok(LootTables::BuriedTreasure { inner: LootTablesStruct::from_raw(env,obj)?}),
"DESERT_PYRAMID" => Ok(LootTables::DesertPyramid { inner: LootTablesStruct::from_raw(env,obj)?}),
"END_CITY_TREASURE" => Ok(LootTables::EndCityTreasure { inner: LootTablesStruct::from_raw(env,obj)?}),
"IGLOO_CHEST" => Ok(LootTables::IglooChest { inner: LootTablesStruct::from_raw(env,obj)?}),
"JUNGLE_TEMPLE" => Ok(LootTables::JungleTemple { inner: LootTablesStruct::from_raw(env,obj)?}),
"JUNGLE_TEMPLE_DISPENSER" => Ok(LootTables::JungleTempleDispenser { inner: LootTablesStruct::from_raw(env,obj)?}),
"NETHER_BRIDGE" => Ok(LootTables::NetherBridge { inner: LootTablesStruct::from_raw(env,obj)?}),
"PILLAGER_OUTPOST" => Ok(LootTables::PillagerOutpost { inner: LootTablesStruct::from_raw(env,obj)?}),
"BASTION_TREASURE" => Ok(LootTables::BastionTreasure { inner: LootTablesStruct::from_raw(env,obj)?}),
"BASTION_OTHER" => Ok(LootTables::BastionOther { inner: LootTablesStruct::from_raw(env,obj)?}),
"BASTION_BRIDGE" => Ok(LootTables::BastionBridge { inner: LootTablesStruct::from_raw(env,obj)?}),
"BASTION_HOGLIN_STABLE" => Ok(LootTables::BastionHoglinStable { inner: LootTablesStruct::from_raw(env,obj)?}),
"ANCIENT_CITY" => Ok(LootTables::AncientCity { inner: LootTablesStruct::from_raw(env,obj)?}),
"ANCIENT_CITY_ICE_BOX" => Ok(LootTables::AncientCityIceBox { inner: LootTablesStruct::from_raw(env,obj)?}),
"RUINED_PORTAL" => Ok(LootTables::RuinedPortal { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_REWARD" => Ok(LootTables::TrialChambersReward { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_SUPPLY" => Ok(LootTables::TrialChambersSupply { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_CORRIDOR" => Ok(LootTables::TrialChambersCorridor { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_INTERSECTION" => Ok(LootTables::TrialChambersIntersection { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_INTERSECTION_BARREL" => Ok(LootTables::TrialChambersIntersectionBarrel { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_ENTRANCE" => Ok(LootTables::TrialChambersEntrance { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_CORRIDOR_DISPENSER" => Ok(LootTables::TrialChambersCorridorDispenser { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_CHAMBER_DISPENSER" => Ok(LootTables::TrialChambersChamberDispenser { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_WATER_DISPENSER" => Ok(LootTables::TrialChambersWaterDispenser { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBERS_CORRIDOR_POT" => Ok(LootTables::TrialChambersCorridorPot { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHIPWRECK_MAP" => Ok(LootTables::ShipwreckMap { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHIPWRECK_SUPPLY" => Ok(LootTables::ShipwreckSupply { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHIPWRECK_TREASURE" => Ok(LootTables::ShipwreckTreasure { inner: LootTablesStruct::from_raw(env,obj)?}),
"SIMPLE_DUNGEON" => Ok(LootTables::SimpleDungeon { inner: LootTablesStruct::from_raw(env,obj)?}),
"SPAWN_BONUS_CHEST" => Ok(LootTables::SpawnBonusChest { inner: LootTablesStruct::from_raw(env,obj)?}),
"STRONGHOLD_CORRIDOR" => Ok(LootTables::StrongholdCorridor { inner: LootTablesStruct::from_raw(env,obj)?}),
"STRONGHOLD_CROSSING" => Ok(LootTables::StrongholdCrossing { inner: LootTablesStruct::from_raw(env,obj)?}),
"STRONGHOLD_LIBRARY" => Ok(LootTables::StrongholdLibrary { inner: LootTablesStruct::from_raw(env,obj)?}),
"UNDERWATER_RUIN_BIG" => Ok(LootTables::UnderwaterRuinBig { inner: LootTablesStruct::from_raw(env,obj)?}),
"UNDERWATER_RUIN_SMALL" => Ok(LootTables::UnderwaterRuinSmall { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_ARMORER" => Ok(LootTables::VillageArmorer { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_BUTCHER" => Ok(LootTables::VillageButcher { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_CARTOGRAPHER" => Ok(LootTables::VillageCartographer { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_DESERT_HOUSE" => Ok(LootTables::VillageDesertHouse { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_FISHER" => Ok(LootTables::VillageFisher { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_FLETCHER" => Ok(LootTables::VillageFletcher { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_MASON" => Ok(LootTables::VillageMason { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_PLAINS_HOUSE" => Ok(LootTables::VillagePlainsHouse { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_SAVANNA_HOUSE" => Ok(LootTables::VillageSavannaHouse { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_SHEPHERD" => Ok(LootTables::VillageShepherd { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_SNOWY_HOUSE" => Ok(LootTables::VillageSnowyHouse { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_TAIGA_HOUSE" => Ok(LootTables::VillageTaigaHouse { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_TANNERY" => Ok(LootTables::VillageTannery { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_TEMPLE" => Ok(LootTables::VillageTemple { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_TOOLSMITH" => Ok(LootTables::VillageToolsmith { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGE_WEAPONSMITH" => Ok(LootTables::VillageWeaponsmith { inner: LootTablesStruct::from_raw(env,obj)?}),
"WOODLAND_MANSION" => Ok(LootTables::WoodlandMansion { inner: LootTablesStruct::from_raw(env,obj)?}),
"ARMOR_STAND" => Ok(LootTables::ArmorStand { inner: LootTablesStruct::from_raw(env,obj)?}),
"AXOLOTL" => Ok(LootTables::Axolotl { inner: LootTablesStruct::from_raw(env,obj)?}),
"BAT" => Ok(LootTables::Bat { inner: LootTablesStruct::from_raw(env,obj)?}),
"BEE" => Ok(LootTables::Bee { inner: LootTablesStruct::from_raw(env,obj)?}),
"BLAZE" => Ok(LootTables::Blaze { inner: LootTablesStruct::from_raw(env,obj)?}),
"CAT" => Ok(LootTables::Cat { inner: LootTablesStruct::from_raw(env,obj)?}),
"CAVE_SPIDER" => Ok(LootTables::CaveSpider { inner: LootTablesStruct::from_raw(env,obj)?}),
"CHICKEN" => Ok(LootTables::Chicken { inner: LootTablesStruct::from_raw(env,obj)?}),
"COD" => Ok(LootTables::Cod { inner: LootTablesStruct::from_raw(env,obj)?}),
"COW" => Ok(LootTables::Cow { inner: LootTablesStruct::from_raw(env,obj)?}),
"CREEPER" => Ok(LootTables::Creeper { inner: LootTablesStruct::from_raw(env,obj)?}),
"DOLPHIN" => Ok(LootTables::Dolphin { inner: LootTablesStruct::from_raw(env,obj)?}),
"DONKEY" => Ok(LootTables::Donkey { inner: LootTablesStruct::from_raw(env,obj)?}),
"DROWNED" => Ok(LootTables::Drowned { inner: LootTablesStruct::from_raw(env,obj)?}),
"ELDER_GUARDIAN" => Ok(LootTables::ElderGuardian { inner: LootTablesStruct::from_raw(env,obj)?}),
"ENDER_DRAGON" => Ok(LootTables::EnderDragon { inner: LootTablesStruct::from_raw(env,obj)?}),
"ENDERMAN" => Ok(LootTables::Enderman { inner: LootTablesStruct::from_raw(env,obj)?}),
"ENDERMITE" => Ok(LootTables::Endermite { inner: LootTablesStruct::from_raw(env,obj)?}),
"EVOKER" => Ok(LootTables::Evoker { inner: LootTablesStruct::from_raw(env,obj)?}),
"FOX" => Ok(LootTables::Fox { inner: LootTablesStruct::from_raw(env,obj)?}),
"GHAST" => Ok(LootTables::Ghast { inner: LootTablesStruct::from_raw(env,obj)?}),
"GIANT" => Ok(LootTables::Giant { inner: LootTablesStruct::from_raw(env,obj)?}),
"GLOW_SQUID" => Ok(LootTables::GlowSquid { inner: LootTablesStruct::from_raw(env,obj)?}),
"GOAT" => Ok(LootTables::Goat { inner: LootTablesStruct::from_raw(env,obj)?}),
"GUARDIAN" => Ok(LootTables::Guardian { inner: LootTablesStruct::from_raw(env,obj)?}),
"HOGLIN" => Ok(LootTables::Hoglin { inner: LootTablesStruct::from_raw(env,obj)?}),
"HORSE" => Ok(LootTables::Horse { inner: LootTablesStruct::from_raw(env,obj)?}),
"HUSK" => Ok(LootTables::Husk { inner: LootTablesStruct::from_raw(env,obj)?}),
"ILLUSIONER" => Ok(LootTables::Illusioner { inner: LootTablesStruct::from_raw(env,obj)?}),
"IRON_GOLEM" => Ok(LootTables::IronGolem { inner: LootTablesStruct::from_raw(env,obj)?}),
"LLAMA" => Ok(LootTables::Llama { inner: LootTablesStruct::from_raw(env,obj)?}),
"MAGMA_CUBE" => Ok(LootTables::MagmaCube { inner: LootTablesStruct::from_raw(env,obj)?}),
"MOOSHROOM" => Ok(LootTables::Mooshroom { inner: LootTablesStruct::from_raw(env,obj)?}),
"MULE" => Ok(LootTables::Mule { inner: LootTablesStruct::from_raw(env,obj)?}),
"OCELOT" => Ok(LootTables::Ocelot { inner: LootTablesStruct::from_raw(env,obj)?}),
"PANDA" => Ok(LootTables::Panda { inner: LootTablesStruct::from_raw(env,obj)?}),
"PARROT" => Ok(LootTables::Parrot { inner: LootTablesStruct::from_raw(env,obj)?}),
"PHANTOM" => Ok(LootTables::Phantom { inner: LootTablesStruct::from_raw(env,obj)?}),
"PIG" => Ok(LootTables::Pig { inner: LootTablesStruct::from_raw(env,obj)?}),
"PIGLIN" => Ok(LootTables::Piglin { inner: LootTablesStruct::from_raw(env,obj)?}),
"PIGLIN_BRUTE" => Ok(LootTables::PiglinBrute { inner: LootTablesStruct::from_raw(env,obj)?}),
"PILLAGER" => Ok(LootTables::Pillager { inner: LootTablesStruct::from_raw(env,obj)?}),
"PLAYER" => Ok(LootTables::Player { inner: LootTablesStruct::from_raw(env,obj)?}),
"POLAR_BEAR" => Ok(LootTables::PolarBear { inner: LootTablesStruct::from_raw(env,obj)?}),
"PUFFERFISH" => Ok(LootTables::Pufferfish { inner: LootTablesStruct::from_raw(env,obj)?}),
"RABBIT" => Ok(LootTables::Rabbit { inner: LootTablesStruct::from_raw(env,obj)?}),
"RAVAGER" => Ok(LootTables::Ravager { inner: LootTablesStruct::from_raw(env,obj)?}),
"SALMON" => Ok(LootTables::Salmon { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHULKER" => Ok(LootTables::Shulker { inner: LootTablesStruct::from_raw(env,obj)?}),
"SILVERFISH" => Ok(LootTables::Silverfish { inner: LootTablesStruct::from_raw(env,obj)?}),
"SKELETON" => Ok(LootTables::Skeleton { inner: LootTablesStruct::from_raw(env,obj)?}),
"SKELETON_HORSE" => Ok(LootTables::SkeletonHorse { inner: LootTablesStruct::from_raw(env,obj)?}),
"SLIME" => Ok(LootTables::Slime { inner: LootTablesStruct::from_raw(env,obj)?}),
"SNOW_GOLEM" => Ok(LootTables::SnowGolem { inner: LootTablesStruct::from_raw(env,obj)?}),
"SPIDER" => Ok(LootTables::Spider { inner: LootTablesStruct::from_raw(env,obj)?}),
"SQUID" => Ok(LootTables::Squid { inner: LootTablesStruct::from_raw(env,obj)?}),
"STRAY" => Ok(LootTables::Stray { inner: LootTablesStruct::from_raw(env,obj)?}),
"STRIDER" => Ok(LootTables::Strider { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRADER_LLAMA" => Ok(LootTables::TraderLlama { inner: LootTablesStruct::from_raw(env,obj)?}),
"TROPICAL_FISH" => Ok(LootTables::TropicalFish { inner: LootTablesStruct::from_raw(env,obj)?}),
"TURTLE" => Ok(LootTables::Turtle { inner: LootTablesStruct::from_raw(env,obj)?}),
"VEX" => Ok(LootTables::Vex { inner: LootTablesStruct::from_raw(env,obj)?}),
"VILLAGER" => Ok(LootTables::Villager { inner: LootTablesStruct::from_raw(env,obj)?}),
"VINDICATOR" => Ok(LootTables::Vindicator { inner: LootTablesStruct::from_raw(env,obj)?}),
"WANDERING_TRADER" => Ok(LootTables::WanderingTrader { inner: LootTablesStruct::from_raw(env,obj)?}),
"WITCH" => Ok(LootTables::Witch { inner: LootTablesStruct::from_raw(env,obj)?}),
"WITHER" => Ok(LootTables::Wither { inner: LootTablesStruct::from_raw(env,obj)?}),
"WITHER_SKELETON" => Ok(LootTables::WitherSkeleton { inner: LootTablesStruct::from_raw(env,obj)?}),
"WOLF" => Ok(LootTables::Wolf { inner: LootTablesStruct::from_raw(env,obj)?}),
"ZOGLIN" => Ok(LootTables::Zoglin { inner: LootTablesStruct::from_raw(env,obj)?}),
"ZOMBIE" => Ok(LootTables::Zombie { inner: LootTablesStruct::from_raw(env,obj)?}),
"ZOMBIE_HORSE" => Ok(LootTables::ZombieHorse { inner: LootTablesStruct::from_raw(env,obj)?}),
"ZOMBIE_VILLAGER" => Ok(LootTables::ZombieVillager { inner: LootTablesStruct::from_raw(env,obj)?}),
"ZOMBIFIED_PIGLIN" => Ok(LootTables::ZombifiedPiglin { inner: LootTablesStruct::from_raw(env,obj)?}),
"ARMORER_GIFT" => Ok(LootTables::ArmorerGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"BUTCHER_GIFT" => Ok(LootTables::ButcherGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"CARTOGRAPHER_GIFT" => Ok(LootTables::CartographerGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"CAT_MORNING_GIFT" => Ok(LootTables::CatMorningGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"CLERIC_GIFT" => Ok(LootTables::ClericGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"FARMER_GIFT" => Ok(LootTables::FarmerGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"FISHERMAN_GIFT" => Ok(LootTables::FishermanGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"FISHING" => Ok(LootTables::Fishing { inner: LootTablesStruct::from_raw(env,obj)?}),
"FISHING_FISH" => Ok(LootTables::FishingFish { inner: LootTablesStruct::from_raw(env,obj)?}),
"FISHING_JUNK" => Ok(LootTables::FishingJunk { inner: LootTablesStruct::from_raw(env,obj)?}),
"FISHING_TREASURE" => Ok(LootTables::FishingTreasure { inner: LootTablesStruct::from_raw(env,obj)?}),
"FLETCHER_GIFT" => Ok(LootTables::FletcherGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"LEATHERWORKER_GIFT" => Ok(LootTables::LeatherworkerGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"LIBRARIAN_GIFT" => Ok(LootTables::LibrarianGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"MASON_GIFT" => Ok(LootTables::MasonGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEPHERD_GIFT" => Ok(LootTables::ShepherdGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"TOOLSMITH_GIFT" => Ok(LootTables::ToolsmithGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"WEAPONSMITH_GIFT" => Ok(LootTables::WeaponsmithGift { inner: LootTablesStruct::from_raw(env,obj)?}),
"SNIFFER_DIGGING" => Ok(LootTables::SnifferDigging { inner: LootTablesStruct::from_raw(env,obj)?}),
"PIGLIN_BARTERING" => Ok(LootTables::PiglinBartering { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBER_KEY" => Ok(LootTables::TrialChamberKey { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRIAL_CHAMBER_CONSUMABLES" => Ok(LootTables::TrialChamberConsumables { inner: LootTablesStruct::from_raw(env,obj)?}),
"DESERT_WELL_ARCHAEOLOGY" => Ok(LootTables::DesertWellArchaeology { inner: LootTablesStruct::from_raw(env,obj)?}),
"DESERT_PYRAMID_ARCHAEOLOGY" => Ok(LootTables::DesertPyramidArchaeology { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRAIL_RUINS_ARCHAEOLOGY_COMMON" => Ok(LootTables::TrailRuinsArchaeologyCommon { inner: LootTablesStruct::from_raw(env,obj)?}),
"TRAIL_RUINS_ARCHAEOLOGY_RARE" => Ok(LootTables::TrailRuinsArchaeologyRare { inner: LootTablesStruct::from_raw(env,obj)?}),
"OCEAN_RUIN_WARM_ARCHAEOLOGY" => Ok(LootTables::OceanRuinWarmArchaeology { inner: LootTablesStruct::from_raw(env,obj)?}),
"OCEAN_RUIN_COLD_ARCHAEOLOGY" => Ok(LootTables::OceanRuinColdArchaeology { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP" => Ok(LootTables::Sheep { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_BLACK" => Ok(LootTables::SheepBlack { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_BLUE" => Ok(LootTables::SheepBlue { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_BROWN" => Ok(LootTables::SheepBrown { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_CYAN" => Ok(LootTables::SheepCyan { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_GRAY" => Ok(LootTables::SheepGray { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_GREEN" => Ok(LootTables::SheepGreen { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_LIGHT_BLUE" => Ok(LootTables::SheepLightBlue { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_LIGHT_GRAY" => Ok(LootTables::SheepLightGray { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_LIME" => Ok(LootTables::SheepLime { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_MAGENTA" => Ok(LootTables::SheepMagenta { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_ORANGE" => Ok(LootTables::SheepOrange { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_PINK" => Ok(LootTables::SheepPink { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_PURPLE" => Ok(LootTables::SheepPurple { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_RED" => Ok(LootTables::SheepRed { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_WHITE" => Ok(LootTables::SheepWhite { inner: LootTablesStruct::from_raw(env,obj)?}),
"SHEEP_YELLOW" => Ok(LootTables::SheepYellow { inner: LootTablesStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct LootTablesStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::AbandonedMineshaft { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::BuriedTreasure { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::DesertPyramid { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::EndCityTreasure { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::IglooChest { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::JungleTemple { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::JungleTempleDispenser { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::NetherBridge { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::PillagerOutpost { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::BastionTreasure { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::BastionOther { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::BastionBridge { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::BastionHoglinStable { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::AncientCity { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::AncientCityIceBox { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::RuinedPortal { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersReward { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersSupply { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersCorridor { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersIntersection { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersIntersectionBarrel { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersEntrance { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersCorridorDispenser { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersChamberDispenser { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersWaterDispenser { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChambersCorridorPot { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ShipwreckMap { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ShipwreckSupply { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ShipwreckTreasure { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SimpleDungeon { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SpawnBonusChest { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::StrongholdCorridor { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::StrongholdCrossing { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::StrongholdLibrary { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::UnderwaterRuinBig { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::UnderwaterRuinSmall { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageArmorer { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageButcher { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageCartographer { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageDesertHouse { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageFisher { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageFletcher { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageMason { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillagePlainsHouse { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageSavannaHouse { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageShepherd { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageSnowyHouse { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageTaigaHouse { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageTannery { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageTemple { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageToolsmith { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VillageWeaponsmith { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::WoodlandMansion { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::Mooshroom { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::SnowGolem { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
Self::ArmorerGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ButcherGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::CartographerGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::CatMorningGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ClericGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FarmerGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FishermanGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Fishing { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FishingFish { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FishingJunk { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FishingTreasure { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FletcherGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::LeatherworkerGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::LibrarianGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::MasonGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ShepherdGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::ToolsmithGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::WeaponsmithGift { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SnifferDigging { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::PiglinBartering { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChamberKey { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrialChamberConsumables { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::DesertWellArchaeology { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::DesertPyramidArchaeology { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrailRuinsArchaeologyCommon { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::TrailRuinsArchaeologyRare { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::OceanRuinWarmArchaeology { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::OceanRuinColdArchaeology { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Sheep { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepBlack { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepBlue { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepBrown { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepCyan { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepGray { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepGreen { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepLightBlue { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepLightGray { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepLime { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepMagenta { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepOrange { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepPink { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepPurple { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepRed { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepWhite { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::SheepYellow { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
}
}
}
impl<'mc> JNIInstantiatable<'mc> for LootTables<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate LootTables from null object.")
                .into());
            }
...
impl<'mc> JNIInstantiatable<'mc> for LootTablesStruct<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate LootTablesStruct from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/loot/LootTables")?;
            if !valid {
...
let cls = jni.find_class("org/bukkit/loot/LootTables"); let cls = jni.translate_error_with_class(cls)?;
...
#[repr(C)]
pub struct LootTable<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for LootTable<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate LootTable from null object.")
                .into());
            }
...
impl<'mc> LootTableTrait<'mc> for LootTable<'mc> {}
pub trait LootTableTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Returns a mutable list of loot generated by this LootTable.
	fn populate_loot(&self,random: impl Into<blackboxmc_java::util::JavaRandom<'mc>>,context: impl Into<crate::loot::LootContext<'mc>>) 
-> Result<Vec<crate::inventory::ItemStack<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/util/Random;Lorg/bukkit/loot/LootContext;)Ljava/util/Collection;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(random.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(context.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"populateLoot",sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// Attempt to fill an inventory with this LootTable's loot.
	fn fill_inventory(&self,inventory: impl Into<crate::inventory::Inventory<'mc>>,random: impl Into<blackboxmc_java::util::JavaRandom<'mc>>,context: impl Into<crate::loot::LootContext<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/inventory/Inventory;Ljava/util/Random;Lorg/bukkit/loot/LootContext;)V");
...
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(context.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"fillInventory",sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::Keyed::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting LootTable into crate::Keyed")

   }
}
impl<'mc> crate::KeyedTrait<'mc> for LootTable<'mc> {}
#[repr(C)]
pub struct Lootable<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for Lootable<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Lootable from null object.")
                .into());
            }
...
impl<'mc> LootableTrait<'mc> for Lootable<'mc> {}
pub trait LootableTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Set the loot table for a container or entity.
/// 
/// To remove a loot table use null. Do not use {@link LootTables#EMPTY} to
/// clear a LootTable.
	fn set_loot_table(&self,table: impl Into<crate::loot::LootTable<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
