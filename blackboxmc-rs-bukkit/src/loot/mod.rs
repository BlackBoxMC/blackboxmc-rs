...
impl<'mc> LootContextBuilder<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,location: impl Into<crate::Location<'mc>>) 
...
crate::loot::LootContextBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn looting_modifier(&self,modifier: i32) 
-> Result<crate::loot::LootContextBuilder<'mc>, Box<dyn std::error::Error>>
...
crate::loot::LootContextBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn looted_entity(&self,looted_entity: impl Into<crate::entity::Entity<'mc>>) 
-> Result<crate::loot::LootContextBuilder<'mc>, Box<dyn std::error::Error>>
...
crate::loot::LootContextBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn killer(&self,killer: impl Into<crate::entity::HumanEntity<'mc>>) 
-> Result<crate::loot::LootContextBuilder<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/HumanEntity;)Lcrate::loot::LootContextBuilder;");
...
impl<'mc> LootTable<'mc> {
	pub fn populate_loot(&self,random: impl Into<blackboxmc_java::util::JavaRandom<'mc>>,context: impl Into<crate::loot::LootContext<'mc>>) 
...
new_vec
	...
	pub fn fill_inventory(&self,inventory: impl Into<crate::inventory::Inventory<'mc>>,random: impl Into<blackboxmc_java::util::JavaRandom<'mc>>,context: impl Into<crate::loot::LootContext<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/inventory/Inventory;Ljava/util/Random;Lorg/bukkit/loot/LootContext;)L();");
...
crate::Keyed::from_raw(&self.jni_ref(), self.1).expect("Error converting LootTable into crate::Keyed")
