...
/// Represents a <a title="interface in org.bukkit.block" href="../block/Container.html"><code>Container</code></a> or a <a title="interface in org.bukkit.entity" href="../entity/Mob.html"><code>Mob</code></a> that can have a loot table.
///
...
impl<'mc> Lootable<'mc> {
    ...
    ///
    /// To remove a loot table use null. Do not use <a href="LootTables.html#EMPTY"><code>LootTables.EMPTY</code></a> to clear a LootTable.
...
impl<'mc> LootContextBuilder<'mc> {
    pub fn from_raw(
        ...
        let (valid, name) = env.validate_name(&obj, "org/bukkit/loot/LootContextBuilder")?;
        if !valid {
            Err(eyre::eyre!(
...
impl<'mc> LootContext<'mc> {
    ...
    /// Get the <a href="../entity/HumanEntity.html" title="interface in org.bukkit.entity"><code>HumanEntity</code></a> who killed the <a href="#getLootedEntity()"><code>getLootedEntity()</code></a>. Can be null.
    pub fn killer(
        &mut self,
    ...
    /// Represents the <a href="../potion/PotionEffectType.html#LUCK"><code>PotionEffectType.LUCK</code></a> that an entity can have. The higher the value the better chance of receiving more loot.
    ...
    /// Represents the <a href="../enchantments/Enchantment.html#LOOT_BONUS_MOBS"><code>Enchantment.LOOT_BONUS_MOBS</code></a> the <a href="#getKiller()"><code>getKiller()</code></a> entity has on their equipped item. This value is only set via <a href="LootContext.Builder.html#lootingModifier(int)"><code>LootContext.Builder.lootingModifier(int)</code></a>. If not set, the <a href="#getKiller()"><code>getKiller()</code></a> entity's looting level will be used instead.
    ...
    /// Get the <a title="interface in org.bukkit.entity" href="../entity/Entity.html"><code>Entity</code></a> that was killed. Can be null.
    pub fn looted_entity(
        &mut self,
    ...
    /// The <a href="../Location.html" title="class in org.bukkit"><code>Location</code></a> to store where the loot will be generated.
