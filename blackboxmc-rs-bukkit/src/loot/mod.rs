...
impl<'mc> LootTable<'mc> {
    ...
    pub fn populate_loot(
        &mut self,
        arg0: impl Into<&'mc blackboxmc_javautil::JavaRandom<'mc>>,
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "populateLoot",
            "(Ljava/util/Random;Lorg/bukkit/loot/LootContext;)Ljava/util/Collection;",
            &[
    ...
    pub fn fill_inventory(
        ...
        arg2: impl Into<&'mc crate::loot::LootContext<'mc>>,
...
impl<'mc> LootTables<'mc> {
    ...
    pub fn value_of(
        ...
        let variant_str = jni
            ...
            .to_string_lossy()
            .to_string();
        crate::loot::LootTables::from_raw(
            &jni,
            raw_obj,
            crate::loot::LootTables::from_string(variant_str).unwrap(),
        )
    }
    pub fn key(&mut self) -> Result<crate::NamespacedKey<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
