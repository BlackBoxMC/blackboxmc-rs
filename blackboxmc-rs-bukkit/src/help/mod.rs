...
crate::help::HelpTopic::from_raw(&jni,res
	...
	pub fn amend_can_see(&self,amended_permission: impl Into<String>) 
...
self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string()
	...
	pub fn get_full_text(&self,for_who: impl Into<crate::command::CommandSender<'mc>>) 
-> Result<String, Box<dyn std::error::Error>>
...
self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string()
	...
	pub fn amend_topic(&self,amended_short_text: impl Into<String>,amended_full_text: impl Into<String>) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> HelpMap<'mc> {
	pub fn get_help_topic(&self,topic_name: impl Into<String>) 
...
new_vec
	...
	pub fn add_topic(&self,topic: impl Into<crate::help::HelpTopic<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn register_help_topic_factory(&self,command_class: jni::objects::JClass<'mc>,factory: impl Into<crate::help::HelpTopicFactory<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> HelpTopicComparator<'mc> {
	pub fn topic_name_comparator_instance(jni: &blackboxmc_general::SharedJNIEnv<'mc>) 
...
crate::help::HelpTopicComparatorTopicNameComparator::from_raw(&jni,obj
	...
	pub fn help_topic_comparator_instance(jni: &blackboxmc_general::SharedJNIEnv<'mc>) 
...
crate::help::HelpTopicComparator::from_raw(&jni,obj
	...
	pub fn compare(&self,lhs: impl Into<crate::help::HelpTopic<'mc>>,rhs: impl Into<crate::help::HelpTopic<'mc>>) 
...
blackboxmc_java::util::JavaComparator::from_raw(&self.jni_ref(), self.1).expect("Error converting HelpTopicComparator into blackboxmc_java::util::JavaComparator")
...
impl<'mc> IndexHelpTopic<'mc> {
	pub fn can_see(&self,sender: impl Into<crate::command::CommandSender<'mc>>) 
...
()
	...
	pub fn get_full_text(&self,sender: impl Into<crate::command::CommandSender<'mc>>) 
-> Result<String, Box<dyn std::error::Error>>
...
crate::help::HelpTopic::from_raw(&self.jni_ref(), self.1).expect("Error converting IndexHelpTopic into crate::help::HelpTopic")
...
impl<'mc> GenericCommandHelpTopic<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,command: impl Into<crate::command::Command<'mc>>) 
...
crate::help::HelpTopic::from_raw(&self.jni_ref(), self.1).expect("Error converting GenericCommandHelpTopic into crate::help::HelpTopic")
...
impl<'mc> HelpTopicComparatorTopicNameComparator<'mc> {
	pub fn compare(&self,lhs: impl Into<String>,rhs: impl Into<String>) 
-> Result<i32, Box<dyn std::error::Error>>
...
pub fn from_extendable(
	...
	pub fn create_topic(&self,command: impl Into<crate::command::Command<'mc>>) 
-> Result<Option<crate::help::HelpTopic<'mc>>, Box<dyn std::error::Error>>
