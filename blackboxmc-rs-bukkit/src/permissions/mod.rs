...
impl<'mc> Permissible<'mc> {
	pub fn is_permission_set_with_perm(&self,perm: impl Into<crate::permissions::Permission<'mc>>) 
...
res.z()?
	...
	pub fn has_permission_with_perm(&self,perm: impl Into<crate::permissions::Permission<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn add_attachment_with_plugin(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,name: std::option::Option<impl Into<String>>,value: std::option::Option<bool>,ticks: std::option::Option<i32>) 
...
crate::permissions::PermissionAttachment::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn remove_attachment(&self,attachment: impl Into<crate::permissions::PermissionAttachment<'mc>>) 
...
()
	...
	pub fn recalculate_permissions(&self) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn effective_permissions(&self) 
...
crate::permissions::ServerOperator::from_raw(&self.jni_ref(), self.1).expect("Error converting Permissible into crate::permissions::ServerOperator")
...
impl<'mc> PermissionAttachmentInfo<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,permissible: impl Into<crate::permissions::Permissible<'mc>>,permission: impl Into<String>,attachment: impl Into<crate::permissions::PermissionAttachment<'mc>>,value: bool) 
...
impl<'mc> Permission<'mc> {
	pub fn new_with_name(jni: &blackboxmc_general::SharedJNIEnv<'mc>,name: impl Into<String>,description: std::option::Option<impl Into<String>>,default_value: std::option::Option<impl Into<crate::permissions::PermissionDefault<'mc>>>,children: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>) 
...
crate::permissions::PermissionDefault::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_default(&self,value: impl Into<crate::permissions::PermissionDefault<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
blackboxmc_java::util::JavaSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn recalculate_permissibles(&self) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn add_parent_with_perm(&self,perm: impl Into<crate::permissions::Permission<'mc>>,value: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn load_permissions(jni: &blackboxmc_general::SharedJNIEnv<'mc>,data: impl Into<blackboxmc_java::util::JavaMap<'mc>>,error: impl Into<String>,def: impl Into<crate::permissions::PermissionDefault<'mc>>) 
-> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/util/Map;Ljava/lang/String;Lorg/bukkit/permissions/PermissionDefault;)LVec;");
...
new_vec
	...
	pub fn load_permission_with_name(jni: &blackboxmc_general::SharedJNIEnv<'mc>,name: impl Into<String>,data: impl Into<blackboxmc_java::util::JavaMap<'mc>>,def: std::option::Option<impl Into<crate::permissions::PermissionDefault<'mc>>>,output: std::option::Option<Vec<jni::objects::JObject<'mc>>>) 
-> Result<crate::permissions::Permission<'mc>, Box<dyn std::error::Error>>
...
impl<'mc> PermissionAttachment<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,plugin: impl Into<crate::plugin::Plugin<'mc>>,permissible: impl Into<crate::permissions::Permissible<'mc>>) 
...
crate::plugin::Plugin::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_removal_callback(&self,ex: impl Into<crate::permissions::PermissionRemovedExecutor<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
blackboxmc_java::util::JavaMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_permission_with_perm(&self,perm: impl Into<crate::permissions::Permission<'mc>>,value: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn unset_permission_with_perm(&self,perm: impl Into<crate::permissions::Permission<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> PermissionRemovedExecutor<'mc> {
	pub fn attachment_removed(&self,attachment: impl Into<crate::permissions::PermissionAttachment<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> PermissibleBase<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,opable: impl Into<crate::permissions::ServerOperator<'mc>>) 
...
crate::permissions::Permissible::from_raw(&self.jni_ref(), self.1).expect("Error converting PermissibleBase into crate::permissions::Permissible")
