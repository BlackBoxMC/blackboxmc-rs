...
use color_eyre::eyre::Result;/*org/bukkit/permissions/mod.rs*/

#[repr(C)]
pub struct Permissible<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Permissible from null object.")
                .into());
            }
...
impl<'mc> PermissibleTrait<'mc> for Permissible<'mc> {}
pub trait PermissibleTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Checks if this object contains an override for the specified {@link
/// Permission}
	fn is_permission_set(&self,perm: impl Into<crate::permissions::Permission<'mc>>) 
...
args.push(val_1);
sig += ")Z";
let res = self.jni_ref().call_method(&self.jni_object(),"isPermissionSet",sig.as_str(),args);
let res = 
...
/// of the permission will be returned
	fn has_permission(&self,perm: impl Into<crate::permissions::Permission<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
args.push(val_1);
sig += ")Z";
let res = self.jni_ref().call_method(&self.jni_object(),"hasPermission",sig.as_str(),args);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// permission by name and value
	fn add_attachment(&self,plugin: impl Into<crate::plugin::Plugin<'mc>>,name: std::option::Option<impl Into<String>>,value: std::option::Option<bool>,ticks: std::option::Option<i32>) 
...
let res = self.jni_ref().call_method(&self.jni_object(),"addAttachment",sig.as_str(),args);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
Some(
crate::permissions::PermissionAttachment::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)?
)
)}
/// Removes the given {@link PermissionAttachment} from this object
	fn remove_attachment(&self,attachment: impl Into<crate::permissions::PermissionAttachment<'mc>>) 
...
let res = self.jni_ref().call_method(&self.jni_object(),"removeAttachment",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// This should very rarely need to be called from a plugin.
	fn recalculate_permissions(&self) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("()V");
let res = self.jni_ref().call_method(&self.jni_object(),"recalculatePermissions",sig.as_str(),vec![]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// this object
	fn effective_permissions(&self) 
-> Result<blackboxmc_java::util::JavaSet<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Ljava/util/Set;");
let res = self.jni_ref().call_method(&self.jni_object(),"getEffectivePermissions",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::permissions::ServerOperator::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting Permissible into crate::permissions::ServerOperator")

   }
}
impl<'mc> crate::permissions::ServerOperatorTrait<'mc> for Permissible<'mc> {}
#[repr(C)]
pub struct PermissionAttachmentInfo<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for PermissionAttachmentInfo<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/permissions/PermissionAttachmentInfo")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> PermissionAttachmentInfoTrait<'mc> for PermissionAttachmentInfo<'mc> {}
pub trait PermissionAttachmentInfoTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,permissible: impl Into<crate::permissions::Permissible<'mc>>,permission: impl Into<String>,attachment: impl Into<crate::permissions::PermissionAttachment<'mc>>,value: bool) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(permissible.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(jni::objects::JObject::from(jni.new_string(permission.into())?));
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(attachment.into().jni_object().clone())});
let val_4 = jni::objects::JValueGen::Bool(value.into());
let cls = jni.find_class("org/bukkit/permissions/PermissionAttachmentInfo"); let cls = jni.translate_error_with_class(cls)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getPermissible",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::permissions::Permissible::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
#[repr(C)]
pub struct Permission<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for Permission<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Permission from null object.")
                .into());
            }
...
impl<'mc> PermissionTrait<'mc> for Permission<'mc> {}
pub trait PermissionTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,name: impl Into<String>,description: std::option::Option<impl Into<String>>,default_value: std::option::Option<impl Into<crate::permissions::PermissionDefault<'mc>>>,children: std::option::Option<impl Into<blackboxmc_java::util::JavaMap<'mc>>>) 
...
sig += ")V";
let cls = jni.find_class("org/bukkit/permissions/Permission"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
sig.as_str(),args);
let res = 
jni.translate_error_no_gen(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getChildren",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"getDefault",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// permissions
	fn set_default(&self,value: impl Into<crate::permissions::PermissionDefault<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/permissions/PermissionDefault;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(value.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"setDefault",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// server reloads permissions.
	fn set_description(&self,value: impl Into<String>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// This set cannot be modified.
	fn permissibles(&self) 
-> Result<blackboxmc_java::util::JavaSet<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Ljava/util/Set;");
let res = self.jni_ref().call_method(&self.jni_object(),"getPermissibles",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::util::JavaSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
/// automatically called after modifying the default value
	fn recalculate_permissibles(&self) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("()V");
let res = self.jni_ref().call_method(&self.jni_object(),"recalculatePermissibles",sig.as_str(),vec![]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
/// Adds this permission to the specified parent permission.
	fn add_parent(&self,perm: impl Into<crate::permissions::Permission<'mc>>,value: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
args.push(val_2);
sig += ")V";
let res = self.jni_ref().call_method(&self.jni_object(),"addParent",sig.as_str(),args);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// </ul>
	fn load_permissions(jni: &blackboxmc_general::SharedJNIEnv<'mc>,data: impl Into<blackboxmc_java::util::JavaMap<'mc>>,error: impl Into<String>,def: impl Into<crate::permissions::PermissionDefault<'mc>>) 
...
let val_2 = jni::objects::JValueGen::Object(jni::objects::JObject::from(jni.new_string(error.into())?));
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(def.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/permissions/Permission"); let cls = jni.translate_error_with_class(cls)?;
...
/// this description. If not specified, empty string.
/// </ul>
	fn load_permission(jni: &blackboxmc_general::SharedJNIEnv<'mc>,name: impl Into<String>,data: impl Into<blackboxmc_java::util::JavaMap<'mc>>,def: std::option::Option<impl Into<crate::permissions::PermissionDefault<'mc>>>,output: std::option::Option<Vec<jni::objects::JObject<'mc>>>) 
-> Result<crate::permissions::Permission<'mc>, Box<dyn std::error::Error>>
...
args.push(val_1);
sig += "Ljava/util/Map;";
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(data.into().jni_object().clone())});
args.push(val_2);
if let Some(a) = def {
sig += "Lorg/bukkit/permissions/PermissionDefault;";
let val_3 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(a.into().jni_object().clone())});
...
#[repr(C)]
pub struct PermissionAttachment<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for PermissionAttachment<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate PermissionAttachment from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/permissions/PermissionAttachment")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> PermissionAttachmentTrait<'mc> for PermissionAttachment<'mc> {}
pub trait PermissionAttachmentTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,plugin: impl Into<crate::plugin::Plugin<'mc>>,permissible: impl Into<crate::permissions::Permissible<'mc>>) 
...
let cls = jni.find_class("org/bukkit/permissions/PermissionAttachment"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
/// {@link Permissible}. May be null.
	fn set_removal_callback(&self,ex: impl Into<crate::permissions::PermissionRemovedExecutor<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/permissions/PermissionRemovedExecutor;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(ex.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"setRemovalCallback",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// attachment was removed from a {@link Permissible}. May be null.
	fn removal_callback(&self) 
-> Result<Option<crate::permissions::PermissionRemovedExecutor<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/permissions/PermissionRemovedExecutor;");
let res = self.jni_ref().call_method(&self.jni_object(),"getRemovalCallback",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
Some(
crate::permissions::PermissionRemovedExecutor::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)?
)
)}
...
/// Sets a permission to the given value
	fn set_permission(&self,perm: impl Into<crate::permissions::Permission<'mc>>,value: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
args.push(val_2);
sig += ")V";
let res = self.jni_ref().call_method(&self.jni_object(),"setPermission",sig.as_str(),args);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
/// happen.
	fn unset_permission(&self,perm: impl Into<crate::permissions::Permission<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
args.push(val_1);
sig += ")V";
let res = self.jni_ref().call_method(&self.jni_object(),"unsetPermission",sig.as_str(),args);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
#[repr(C)]
pub struct PermissionRemovedExecutor<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for PermissionRemovedExecutor<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/permissions/PermissionRemovedExecutor")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> PermissionRemovedExecutorTrait<'mc> for PermissionRemovedExecutor<'mc> {}
pub trait PermissionRemovedExecutorTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Called when a {@link PermissionAttachment} is removed from a {@link
/// Permissible}
	fn attachment_removed(&self,attachment: impl Into<crate::permissions::PermissionAttachment<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/permissions/PermissionAttachment;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(attachment.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"attachmentRemoved",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
#[repr(C)]
pub struct PermissibleBase<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for PermissibleBase<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate PermissibleBase from null object.")
                .into());
            }
...
impl<'mc> PermissibleBaseTrait<'mc> for PermissibleBase<'mc> {}
pub trait PermissibleBaseTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,opable: impl Into<crate::permissions::ServerOperator<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(opable.into().jni_object().clone())});
let cls = jni.find_class("org/bukkit/permissions/PermissibleBase"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.new_object(cls,
...
()
	...
	fn clear_permissions(&self) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("()V");
let res = self.jni_ref().call_method(&self.jni_object(),"clearPermissions",sig.as_str(),vec![]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::permissions::Permissible::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PermissibleBase into crate::permissions::Permissible")

   }
}
impl<'mc> crate::permissions::PermissibleTrait<'mc> for PermissibleBase<'mc> {}
...
impl<'mc> std::fmt::Display for PermissionDefault<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> PermissionDefaultTrait<'mc> for PermissionDefault<'mc> {}
        
        pub trait PermissionDefaultTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
"TRUE" => Ok(PermissionDefault::VariantTrue { inner: PermissionDefaultStruct::from_raw(env,obj)?}),
"FALSE" => Ok(PermissionDefault::VariantFalse { inner: PermissionDefaultStruct::from_raw(env,obj)?}),
"OP" => Ok(PermissionDefault::Op { inner: PermissionDefaultStruct::from_raw(env,obj)?}),
"NOT_OP" => Ok(PermissionDefault::NotOp { inner: PermissionDefaultStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct PermissionDefaultStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
fn jni_object(&self) -> jni::objects::JObject<'mc> {
match self {
Self::VariantTrue { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::VariantFalse { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for PermissionDefault<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate PermissionDefault from null object.")
                .into());
            }
            ...
            if !valid {
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "TRUE" => Ok(PermissionDefault::VariantTrue { inner: PermissionDefaultStruct::from_raw(env,obj)?}),"FALSE" => Ok(PermissionDefault::VariantFalse { inner: PermissionDefaultStruct::from_raw(env,obj)?}),"OP" => Ok(PermissionDefault::Op { inner: PermissionDefaultStruct::from_raw(env,obj)?}),"NOT_OP" => Ok(PermissionDefault::NotOp { inner: PermissionDefaultStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
{let sig = String::from("()Lorg/bukkit/permissions/PermissionDefault;");
let cls = jni.find_class("org/bukkit/permissions/PermissionDefault"); let cls = jni.translate_error_with_class(cls)?;
...
/// value
	fn get_value(&self,op: bool) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("(Z)Z");
let val_1 = jni::objects::JValueGen::Bool(op.into());
let res = self.jni_ref().call_method(&self.jni_object(),"getValue",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
#[repr(C)]
pub struct ServerOperator<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for ServerOperator<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate ServerOperator from null object.")
                .into());
            }
...
impl<'mc> ServerOperatorTrait<'mc> for ServerOperator<'mc> {}
pub trait ServerOperatorTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
