...
impl<'mc> EntityTransformer<'mc> {
    pub fn transform(
        ...
        let sig = String::from(
            "(Lorg/bukkit/generator/LimitedRegion;IIILorg/bukkit/entity/Entity;Z)Lbool;",
        );
...
impl<'mc> BoundingBox<'mc> {
    ...
    pub fn of_with_corner1(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        corner1: impl Into<crate::block::Block<'mc>>,
        corner2: std::option::Option<impl Into<crate::block::Block<'mc>>>,
    ) -> Result<crate::util::BoundingBox<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "Lorg/bukkit/block/Block;";
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(corner1.into().jni_object().clone())
        });
        args.push(val_1);
    ...
    pub fn expand_with_direction(
        &self,
        direction: impl Into<crate::util::Vector<'mc>>,
        expansion: std::option::Option<f64>,
    ) -> Result<crate::util::BoundingBox<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
    ...
    pub fn expand_directional_with_dir_x(
        &self,
        dir_x: f64,
        dir_y: std::option::Option<f64>,
        dir_z: std::option::Option<f64>,
    ...
    pub fn ray_trace(
        ...
        let sig = String::from(
            "(Lorg/bukkit/util/Vector;Lorg/bukkit/util/Vector;D)Lcrate::util::RayTraceResult;",
        );
        let val_1 = jni::objects::JValueGen::Object(unsafe {
...
impl<'mc> ChatPaginator<'mc> {
    ...
    pub fn paginate_with_unpaginated_string(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
...
impl<'mc> Vector<'mc> {
    ...
    pub fn to_vector3i_with_rounding_mode(
        &self,
    ...
    pub fn get_minimum(
        ...
        let sig =
            String::from("(Lorg/bukkit/util/Vector;Lorg/bukkit/util/Vector;)Lcrate::util::Vector;");
        let val_1 = jni::objects::JValueGen::Object(unsafe {
