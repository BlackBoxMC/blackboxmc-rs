...
impl<'mc> Vector<'mc> {
    ...
    pub fn add(
        &self,
        vec: impl Into<crate::util::Vector<'mc>>,
    ) -> Result<crate::util::Vector<'mc>, Box<dyn std::error::Error>> {
        let sig = String::from("(Lorg/bukkit/util/Vector;)Lorg/bukkit/util/Vector;");
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(vec.into().jni_object().clone())
        });
    ...
    /// scalar.
    pub fn multiply(&self, m: f32) -> Result<crate::util::Vector<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "F";
    ...
    pub fn distance(
        &self,
        o: impl Into<crate::util::Vector<'mc>>,
    ...
    pub fn angle(
        &self,
        other: impl Into<crate::util::Vector<'mc>>,
    ...
    pub fn is_in_aabb(
        &self,
        min: impl Into<crate::util::Vector<'mc>>,
        max: impl Into<crate::util::Vector<'mc>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let sig = String::from("(Lorg/bukkit/util/Vector;Lorg/bukkit/util/Vector;)Z");
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(min.into().jni_object().clone())
        });
        let val_2 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(max.into().jni_object().clone())
        });
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "isInAABB",
    ...
    pub fn is_in_sphere(
        &self,
        origin: impl Into<crate::util::Vector<'mc>>,
        radius: f64,
    ) -> Result<bool, Box<dyn std::error::Error>> {
    ...
    pub fn rotate_around_axis(
        &self,
        axis: impl Into<crate::util::Vector<'mc>>,
        angle: f64,
    ) -> Result<crate::util::Vector<'mc>, Box<dyn std::error::Error>> {
    ...
    /// Set the X component.
    pub fn set_x(&self, x: f32) -> Result<crate::util::Vector<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "F";
    ...
    /// Set the Y component.
    pub fn set_y(&self, y: f32) -> Result<crate::util::Vector<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "F";
    ...
    /// Set the Z component.
    pub fn set_z(&self, z: f32) -> Result<crate::util::Vector<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "F";
    ...
    pub fn to_vector3i(
        &self,
        rounding_mode: std::option::Option<i32>,
    ...
    pub fn get_minimum(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        v1: impl Into<crate::util::Vector<'mc>>,
        v2: impl Into<crate::util::Vector<'mc>>,
    ) -> Result<crate::util::Vector<'mc>, Box<dyn std::error::Error>> {
        let sig = String::from(
            "(Lorg/bukkit/util/Vector;Lorg/bukkit/util/Vector;)Lorg/bukkit/util/Vector;",
        );
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(v1.into().jni_object().clone())
        });
        let val_2 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(v2.into().jni_object().clone())
        });
        let cls = jni.find_class("org/bukkit/util/Vector");
        let cls = jni.translate_error_with_class(cls)?;
...
impl<'mc> Transformation<'mc> {
    pub fn new(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        translation: jni::objects::JObject<'mc>,
        left_rotation: jni::objects::JObject<'mc>,
        scale: jni::objects::JObject<'mc>,
        right_rotation: jni::objects::JObject<'mc>,
...
impl<'mc> NumberConversions<'mc> {
    pub fn floor(
        ...
        let cls = jni.find_class("org/bukkit/util/NumberConversions");
        let cls = jni.translate_error_with_class(cls)?;
        let res = jni.call_static_method(
            cls,
            "floor",
...
impl<'mc> ChatPaginator<'mc> {
    ...
    pub fn paginate(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        unpaginated_string: impl Into<String>,
        page_number: i32,
        line_length: std::option::Option<i32>,
        page_height: std::option::Option<i32>,
    ) -> Result<crate::util::ChatPaginatorChatPage<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "Ljava/lang/String;";
        let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(
            jni.new_string(unpaginated_string.into())?,
        ));
        args.push(val_1);
        sig += "I";
    ...
    pub fn word_wrap(
        ...
        let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(
            jni.new_string(raw_string.into())?,
        ));
...
impl<'mc> BoundingBox<'mc> {
    ...
    pub fn new(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        x1: std::option::Option<f64>,
        y1: std::option::Option<f64>,
        z1: std::option::Option<f64>,
        x2: std::option::Option<f64>,
        y2: std::option::Option<f64>,
        z2: std::option::Option<f64>,
    ...
    pub fn of(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        center: impl Into<crate::Location<'mc>>,
        ...
        sig += "Lorg/bukkit/Location;";
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(center.into().jni_object().clone())
        });
        args.push(val_1);
        if let Some(a) = x {
            sig += "D";
    ...
    pub fn copy(
        &self,
        other: impl Into<crate::util::BoundingBox<'mc>>,
    ) -> Result<crate::util::BoundingBox<'mc>, Box<dyn std::error::Error>> {
    ...
    pub fn expand(
        &self,
        negative_x: f64,
        negative_y: std::option::Option<f64>,
        negative_z: std::option::Option<f64>,
        positive_x: std::option::Option<f64>,
        positive_y: std::option::Option<f64>,
        positive_z: std::option::Option<f64>,
    ) -> Result<crate::util::BoundingBox<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "D";
    ...
    pub fn expand_directional(
        &self,
        dir_x: f64,
        dir_y: std::option::Option<f64>,
        dir_z: std::option::Option<f64>,
    ) -> Result<crate::util::BoundingBox<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "D";
    ...
    pub fn union(
        &self,
        pos_x: f64,
        pos_y: std::option::Option<f64>,
        pos_z: std::option::Option<f64>,
    ) -> Result<crate::util::BoundingBox<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "D";
    ...
    pub fn shift(
        &self,
        shift_x: f64,
        shift_y: std::option::Option<f64>,
        shift_z: std::option::Option<f64>,
    ) -> Result<crate::util::BoundingBox<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "D";
    ...
    pub fn overlaps(
        &self,
        min: impl Into<crate::util::Vector<'mc>>,
        max: std::option::Option<impl Into<crate::util::Vector<'mc>>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "Lorg/bukkit/util/Vector;";
    ...
    pub fn ray_trace(
        &self,
        start: impl Into<crate::util::Vector<'mc>>,
...
impl<'mc> BlockVector<'mc> {
    ...
    // SUPER CLASS: org.bukkit.util.Vector ( ['equals', 'hashCode', 'clone', 'deserialize'])
    /// Adds a vector to this one
    pub fn add(
        &self,
        vec: impl Into<crate::util::Vector<'mc>>,
    ...
    pub fn is_in_sphere(
        ...
        let real: crate::util::Vector = temp_clone.into();
        real.is_in_sphere(origin, radius)
    }
    /// Returns if a vector is normalized
    pub fn is_normalized(&self) -> Result<bool, Box<dyn std::error::Error>> {
        let temp_clone = crate::util::Vector::from_raw(&self.0, unsafe {
    ...
    pub fn to_location(
        ...
        let real: crate::util::Vector = temp_clone.into();
        real.to_location(world, yaw, pitch)
    }
    /// Get the block vector of this vector.
    pub fn to_block_vector(
        &self,
    ...
    pub fn to_vector3i(
        ...
        let real: crate::util::Vector = temp_clone.into();
        real.to_vector3i(rounding_mode)
    }
    /// Check if each component of this Vector is finite.
    pub fn check_finite(&self) -> Result<(), Box<dyn std::error::Error>> {
        let temp_clone = crate::util::Vector::from_raw(&self.0, unsafe {
    ...
    pub fn get_minimum(
        ...
        crate::util::Vector::get_minimum(jni, v1, v2)
    }
    /// Gets the maximum components of two vectors.
    pub fn get_maximum(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        ...
        crate::util::Vector::get_maximum(jni, v1, v2)
    }
    /// Gets a random vector with components having a random value between 0
    /// and 1.
    pub fn random(
    ...
    pub fn from_joml(
        ...
        crate::util::Vector::from_joml(jni, vector)
    }
...
impl<'mc> BlockIterator<'mc> {
    ...
    pub fn new(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        world: impl Into<crate::World<'mc>>,
        start: std::option::Option<impl Into<crate::util::Vector<'mc>>>,
        direction: std::option::Option<impl Into<crate::util::Vector<'mc>>>,
        y_offset: std::option::Option<f64>,
        max_distance: std::option::Option<i32>,
...
#[repr(C)]
pub struct EntityTransformer<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JNIInstantiatable<'mc> for EntityTransformer<'mc> {
    fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate EntityTransformer from null object.").into(),
            );
        }
...
impl<'mc> EntityTransformer<'mc> {
    ...
    pub fn transform(
        &self,
        region: impl Into<crate::generator::LimitedRegion<'mc>>,
        x: i32,
        y: i32,
        z: i32,
        ...
        let sig =
            String::from("(Lorg/bukkit/generator/LimitedRegion;IIILorg/bukkit/entity/Entity;Z)Z");
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(region.into().jni_object().clone())
        });
...
#[repr(C)]
pub struct OldEnum<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);

impl<'mc> JNIRaw<'mc> for OldEnum<'mc> {
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
        self.0.clone()
    }
    fn jni_object(&self) -> jni::objects::JObject<'mc> {
...
impl<'mc> JNIInstantiatable<'mc> for OldEnum<'mc> {
    fn from_raw(
        env: &blackboxmc_general::SharedJNIEnv<'mc>,
        obj: jni::objects::JObject<'mc>,
    ) -> Result<Self, Box<dyn std::error::Error>> {
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate OldEnum from null object.").into());
        }
        let (valid, name) = env.validate_name(&obj, "org/bukkit/util/OldEnum")?;
        if !valid {
            Err(eyre::eyre!(
                "Invalid argument passed. Expected a OldEnum object, got {}",
                name
            )
            .into())
        } else {
...
impl<'mc> Consumer<'mc> {
    ...
    pub fn accept(&self, t: jni::objects::JObject<'mc>) -> Result<(), Box<dyn std::error::Error>> {
...
impl<'mc> Into<blackboxmc_java::util::function::JavaConsumer<'mc>> for Consumer<'mc> {
    fn into(self) -> blackboxmc_java::util::function::JavaConsumer<'mc> {
        blackboxmc_java::util::function::JavaConsumer::from_raw(&self.jni_ref(), self.1)
            .expect("Error converting Consumer into blackboxmc_java::util::function::JavaConsumer")
    }
}
#[repr(C)]
...
#[repr(C)]
pub struct BiomeSearchResult<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JNIInstantiatable<'mc> for BiomeSearchResult<'mc> {
    fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate BiomeSearchResult from null object.").into(),
            );
        }
...
impl<'mc> RayTraceResult<'mc> {
    ...
    pub fn new(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        hit_position: impl Into<crate::util::Vector<'mc>>,
        hit_entity: std::option::Option<impl Into<crate::entity::Entity<'mc>>>,
        hit_block_face: std::option::Option<impl Into<crate::block::BlockFace<'mc>>>,
    ) -> Result<crate::util::RayTraceResult<'mc>, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "Lorg/bukkit/util/Vector;";
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(hit_position.into().jni_object().clone())
        });
        args.push(val_1);
...
#[repr(C)]
pub struct BlockTransformer<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JNIInstantiatable<'mc> for BlockTransformer<'mc> {
    fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate BlockTransformer from null object.").into(),
            );
        }
...
impl<'mc> BlockTransformer<'mc> {
    ...
    pub fn transform(
        ...
        y: i32,
        z: i32,
        current: impl Into<crate::block::BlockState<'mc>>,
        state: impl Into<crate::util::BlockTransformerTransformationState<'mc>>,
        ...
        let val_4 = jni::objects::JValueGen::Int(z);
        let val_5 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(current.into().jni_object().clone())
        });
...
#[repr(C)]
pub struct BlockTransformerTransformationState<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JNIInstantiatable<'mc> for BlockTransformerTransformationState<'mc> {
    fn from_raw(
        ...
        let (valid, name) =
            env.validate_name(&obj, "org/bukkit/util/BlockTransformer/TransformationState")?;
        if !valid {
            Err(eyre::eyre!(
...
impl<'mc> BlockTransformerTransformationState<'mc> {
    ...
    pub fn original(&self) -> Result<crate::block::BlockState<'mc>, Box<dyn std::error::Error>> {
        let sig = String::from("()Lorg/bukkit/block/BlockState;");
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getOriginal", sig.as_str(), vec![]);
        let res = self.jni_ref().translate_error(res)?;
        crate::block::BlockState::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    ...
    pub fn world(&self) -> Result<crate::block::BlockState<'mc>, Box<dyn std::error::Error>> {
        let sig = String::from("()Lorg/bukkit/block/BlockState;");
        let res = self
            .jni_ref()
