...
impl<'mc> Into<blackboxmc_javautil::JavaIterator<'mc>> for BlockIterator<'mc> {
    fn into(self) -> blackboxmc_javautil::JavaIterator<'mc> {
        blackboxmc_javautil::JavaIterator::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
