...
impl<'mc> SimplexOctaveGenerator<'mc> {
    ...
    pub fn new(
        ...
        rand: impl Into<blackboxmc_java::util::JavaRandom<'mc>>,
        octaves: i32,
        ...
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(rand.into().jni_object().clone())
        });
        args.push(val_1);
        sig += "I";
    ...
    pub fn set_scale(&self, scale: f64) -> Result<(), Box<dyn std::error::Error>> {
    ...
    pub fn set_wscale(&self, scale: f64) -> Result<(), Box<dyn std::error::Error>> {
        let sig = String::from("(D)V");
        let val_1 = jni::objects::JValueGen::Double(scale);
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    // SUPER CLASS: org.bukkit.util.noise.OctaveGenerator ( ['setScale', 'getWScale', 'setWScale', 'noise'])
    ...
    pub fn set_xscale(&self, scale: f64) -> Result<(), Box<dyn std::error::Error>> {
        let temp_clone = crate::util::noise::OctaveGenerator::from_raw(&self.0, unsafe {
            jni::objects::JObject::from_raw(self.1.clone())
        })?;
        let real: crate::util::noise::OctaveGenerator = temp_clone.into();
        real.set_xscale(scale)
    }
    ...
    pub fn set_yscale(&self, scale: f64) -> Result<(), Box<dyn std::error::Error>> {
        let temp_clone = crate::util::noise::OctaveGenerator::from_raw(&self.0, unsafe {
            jni::objects::JObject::from_raw(self.1.clone())
        })?;
        let real: crate::util::noise::OctaveGenerator = temp_clone.into();
        real.set_yscale(scale)
    }
    ...
    pub fn set_zscale(&self, scale: f64) -> Result<(), Box<dyn std::error::Error>> {
        let temp_clone = crate::util::noise::OctaveGenerator::from_raw(&self.0, unsafe {
            jni::objects::JObject::from_raw(self.1.clone())
        })?;
        let real: crate::util::noise::OctaveGenerator = temp_clone.into();
        real.set_zscale(scale)
    }
    ...
    pub fn octaves(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::util::noise::NoiseGenerator::from_raw(&self.jni_ref(), unsafe {
...
impl<'mc> SimplexNoiseGenerator<'mc> {
    ...
    // SUPER CLASS: org.bukkit.util.noise.PerlinNoiseGenerator ( ['getNoise', 'noise', 'getInstance'])
...
impl<'mc> PerlinOctaveGenerator<'mc> {
    ...
    // SUPER CLASS: org.bukkit.util.noise.OctaveGenerator ( [])
    ...
    pub fn noise(
        ...
        amplitude: std::option::Option<f64>,
        normalized: std::option::Option<bool>,
    ) -> Result<f64, Box<dyn std::error::Error>> {
        let temp_clone = crate::util::noise::OctaveGenerator::from_raw(&self.0, unsafe {
            jni::objects::JObject::from_raw(self.1.clone())
        ...
        let real: crate::util::noise::OctaveGenerator = temp_clone.into();
        real.noise(x, y, z, frequency, amplitude, normalized)
    }
...
impl<'mc> PerlinNoiseGenerator<'mc> {
    ...
    pub fn noise(&self, x: f64, y: f64, z: f64) -> Result<f64, Box<dyn std::error::Error>> {
    ...
    // SUPER CLASS: org.bukkit.util.noise.NoiseGenerator ( ['getNoise', 'getInstance', 'noise'])
    /// Speedy floor, faster than (int)Math.floor(x)
    pub fn floor(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        x: f64,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        crate::util::noise::NoiseGenerator::floor(jni, x)
    }
