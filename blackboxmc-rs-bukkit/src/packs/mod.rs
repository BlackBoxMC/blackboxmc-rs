...
impl<'mc> DataPack<'mc> {
    ...
    pub fn compatibility(
        ...
        let sig = String::from("()Lcrate::packs::DataPackCompatibility;");
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getCompatibility",
            sig.as_str(),
    ...
    pub fn source(&self) -> Result<crate::packs::DataPackSource<'mc>, Box<dyn std::error::Error>> {
        let sig = String::from("()Lcrate::packs::DataPackSource;");
        let res = self
            .jni_ref()
...
impl<'mc> DataPackManager<'mc> {
    ...
    pub fn get_data_pack(
        ...
        let sig = String::from("(Lorg/bukkit/NamespacedKey;)Lcrate::packs::DataPack;");
