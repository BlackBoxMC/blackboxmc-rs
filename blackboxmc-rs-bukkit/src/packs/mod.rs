...
let res = self.jni_ref().call_method(&self.jni_object(),"getEnabledDataPacks","(Lorg/bukkit/World;)Ljava/util/Collection;",&[jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getDataPack","(Lorg/bukkit/NamespacedKey;)Lorg/bukkit/packs/DataPack;",&[jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getDisabledDataPacks","(Lorg/bukkit/World;)Ljava/util/Collection;",&[jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaCollection::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"isEnabledByFeature","(Lorg/bukkit/entity/EntityType;Lorg/bukkit/World;)Z",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
}
