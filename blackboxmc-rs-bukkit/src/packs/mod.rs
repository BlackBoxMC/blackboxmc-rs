...
new_vec
	...
	pub fn get_data_pack(&self,data_pack_key: impl Into<crate::NamespacedKey<'mc>>) 
...
crate::packs::DataPack::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn get_enabled_data_packs(&self,world: impl Into<crate::World<'mc>>) 
-> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>
...
new_vec
	...
	pub fn get_disabled_data_packs(&self,world: impl Into<crate::World<'mc>>) 
-> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>
...
new_vec
	...
	pub fn is_enabled_by_feature_with_entity_type(&self,entity_type: impl Into<crate::entity::EntityType<'mc>>,world: impl Into<crate::World<'mc>>) 
...
res.i()?
	...
	pub fn min_supported_pack_format(&self) 
-> Result<i32, Box<dyn std::error::Error>>
...
res.i()?
	...
	pub fn max_supported_pack_format(&self) 
-> Result<i32, Box<dyn std::error::Error>>
...
crate::packs::DataPackCompatibility::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn requested_features(&self) 
...
crate::Keyed::from_raw(&self.jni_ref(), self.1).expect("Error converting DataPack into crate::Keyed")
