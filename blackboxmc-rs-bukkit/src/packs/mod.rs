...
pub struct DataPackCompatibility<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getSource","()Lorg/bukkit/packs/DataPack$Source;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn requested_features(&mut self) 
-> Result<blackboxmc_java::JavaSet<'mc, orgFeatureFlag>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getRequestedFeatures","()Ljava/util/Set;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn pack_format(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getPackFormat","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn is_required(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isRequired","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn compatibility(&mut self) 
-> Result<crate::packs::DataPackCompatibility<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getCompatibility","()Lorg/bukkit/packs/DataPack$Compatibility;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn get_enabled_data_packs(&mut self,arg0: impl Into<&'mc crate::World<'mc>>) 
...
let res = self.jni_ref().call_method(&self.jni_object(),"getEnabledDataPacks","(Lorg/bukkit/World;)Ljava/util/Collection;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaCollection::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn data_packs(&mut self) 
-> Result<blackboxmc_java::JavaCollection<'mc, orgDataPack>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getDataPacks","()Ljava/util/Collection;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaCollection::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn get_data_pack(&mut self,arg0: impl Into<&'mc crate::NamespacedKey<'mc>>) 
-> Result<crate::packs::DataPack<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getDataPack","(Lorg/bukkit/NamespacedKey;)Lorg/bukkit/packs/DataPack;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::packs::DataPack::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn get_disabled_data_packs(&mut self,arg0: impl Into<&'mc crate::World<'mc>>) 
-> Result<blackboxmc_java::JavaCollection<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getDisabledDataPacks","(Lorg/bukkit/World;)Ljava/util/Collection;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaCollection::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn is_enabled_by_feature_with_material(&mut self,arg0: impl Into<&'mc crate::entity::EntityType<'mc>>,arg1: std::option::Option<impl Into<&'mc crate::World<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"isEnabledByFeature","(Lorg/bukkit/entity/EntityType;Lorg/bukkit/World;)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
}
...
pub struct DataPackSource<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
