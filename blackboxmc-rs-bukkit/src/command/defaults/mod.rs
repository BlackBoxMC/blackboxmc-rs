...
impl<'mc> ReloadCommand<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,name: impl Into<String>) 
...
crate::command::defaults::ReloadCommand::from_raw(&jni,res
	...
	pub fn execute(&self,sender: impl Into<crate::command::CommandSender<'mc>>,current_alias: impl Into<String>,val_args: impl Into<String>) 
...
crate::command::defaults::BukkitCommand::from_raw(&self.jni_ref(), self.1).expect("Error converting ReloadCommand into crate::command::defaults::BukkitCommand")
...
crate::command::defaults::BukkitCommand::from_raw(&self.jni_ref(), self.1).expect("Error converting TimingsCommand into crate::command::defaults::BukkitCommand")
...
crate::command::defaults::BukkitCommand::from_raw(&self.jni_ref(), self.1).expect("Error converting PluginsCommand into crate::command::defaults::BukkitCommand")
...
crate::command::defaults::BukkitCommand::from_raw(&self.jni_ref(), self.1).expect("Error converting VersionCommand into crate::command::defaults::BukkitCommand")
...
crate::command::Command::from_raw(&self.jni_ref(), self.1).expect("Error converting BukkitCommand into crate::command::Command")
...
crate::command::defaults::BukkitCommand::from_raw(&self.jni_ref(), self.1).expect("Error converting HelpCommand into crate::command::defaults::BukkitCommand")
