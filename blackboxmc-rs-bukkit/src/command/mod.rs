...
crate::command::CommandSender::from_raw(&self.jni_ref(), self.1).expect("Error converting BlockCommandSender into crate::command::CommandSender")
...
crate::command::TabCompleter::from_raw(&self.jni_ref(), self.1).expect("Error converting TabExecutor into crate::command::TabCompleter")
...
crate::command::CommandExecutor::from_raw(&self.jni_ref(), self.1).expect("Error converting TabExecutor into crate::command::CommandExecutor")
...
crate::command::PluginCommandYamlParser::from_raw(&jni,res
	...
	pub fn parse(jni: &blackboxmc_general::SharedJNIEnv<'mc>,plugin: impl Into<crate::plugin::Plugin<'mc>>) 
...
impl<'mc> FormattedCommandAlias<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,alias: impl Into<String>,format_strings: impl Into<String>) 
...
crate::command::FormattedCommandAlias::from_raw(&jni,res
	...
	pub fn execute(&self,sender: impl Into<crate::command::CommandSender<'mc>>,command_label: impl Into<String>,val_args: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/command/CommandSender;Ljava/lang/String;Ljava/lang/String;)Lbool;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(sender.into().jni_object().clone())});
...
crate::command::Command::from_raw(&self.jni_ref(), self.1).expect("Error converting FormattedCommandAlias into crate::command::Command")
...
impl<'mc> CommandMap<'mc> {
	pub fn register_all(&self,fallback_prefix: impl Into<String>,commands: Vec<jni::objects::JObject<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn register_with_label(&self,label: impl Into<String>,fallback_prefix: impl Into<String>,command: std::option::Option<impl Into<crate::command::Command<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn dispatch(&self,sender: impl Into<crate::command::CommandSender<'mc>>,cmd_line: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/command/CommandSender;Ljava/lang/String;)Lbool;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(sender.into().jni_object().clone())});
...
crate::command::Command::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn tab_complete_with_sender(&self,sender: impl Into<crate::command::CommandSender<'mc>>,cmd_line: impl Into<String>,location: std::option::Option<impl Into<crate::Location<'mc>>>) 
-> Result<Option<Vec<jni::objects::JObject<'mc>>>, Box<dyn std::error::Error>>
...
impl<'mc> MultipleCommandAlias<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,name: impl Into<String>,commands: impl Into<crate::command::Command<'mc>>) 
...
crate::command::Command::from_raw(&self.jni_ref(), self.1).expect("Error converting MultipleCommandAlias into crate::command::Command")
...
crate::command::CommandSender::from_raw(&self.jni_ref(), self.1).expect("Error converting ConsoleCommandSender into crate::command::CommandSender")
...
crate::conversations::Conversable::from_raw(&self.jni_ref(), self.1).expect("Error converting ConsoleCommandSender into crate::conversations::Conversable")
...
crate::command::CommandSender::from_raw(&self.jni_ref(), self.1).expect("Error converting RemoteConsoleCommandSender into crate::command::CommandSender")
...
impl<'mc> Command<'mc> {
	pub fn tab_complete_with_sender(&self,sender: impl Into<crate::command::CommandSender<'mc>>,alias: impl Into<String>,val_args: impl Into<String>,location: std::option::Option<impl Into<crate::Location<'mc>>>) 
-> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>
...
()
	...
	pub fn test_permission(&self,target: impl Into<crate::command::CommandSender<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn test_permission_silent(&self,target: impl Into<crate::command::CommandSender<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string()
	...
	pub fn set_label(&self,name: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn register(&self,command_map: impl Into<crate::command::CommandMap<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn unregister(&self,command_map: impl Into<crate::command::CommandMap<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
new_vec
	...
	pub fn permission_message(&self) 
-> Result<Option<String>, Box<dyn std::error::Error>>
...
self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string()
	...
	pub fn set_aliases(&self,aliases: Vec<jni::objects::JObject<'mc>>) 
-> Result<crate::command::Command<'mc>, Box<dyn std::error::Error>>
...
crate::command::Command::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_permission_message(&self,permission_message: impl Into<String>) 
-> Result<crate::command::Command<'mc>, Box<dyn std::error::Error>>
...
crate::command::Command::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_usage(&self,usage: impl Into<String>) 
-> Result<crate::command::Command<'mc>, Box<dyn std::error::Error>>
...
crate::command::Command::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn broadcast_command_message_with_source(jni: &blackboxmc_general::SharedJNIEnv<'mc>,source: impl Into<crate::command::CommandSender<'mc>>,message: impl Into<String>,send_to_source: std::option::Option<bool>) 
-> Result<(), Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn set_executor(&self,executor: impl Into<crate::command::CommandExecutor<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::command::CommandExecutor::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_tab_completer(&self,completer: impl Into<crate::command::TabCompleter<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::plugin::Plugin::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn tab_complete(&self,sender: impl Into<crate::command::CommandSender<'mc>>,alias: impl Into<String>,val_args: impl Into<String>) 
-> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/command/CommandSender;Ljava/lang/String;Ljava/lang/String;)LVec;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(sender.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(jni::objects::JObject::from(self.jni_ref().new_string(alias.into())?));
let val_3 = jni::objects::JValueGen::Object(jni::objects::JObject::from(self.jni_ref().new_string(val_args.into())?));
...
crate::command::PluginIdentifiableCommand::from_raw(&self.jni_ref(), self.1).expect("Error converting PluginCommand into crate::command::PluginIdentifiableCommand")
...
crate::command::Command::from_raw(&self.jni_ref(), self.1).expect("Error converting PluginCommand into crate::command::Command")
...
crate::command::CommandSender::from_raw(&self.jni_ref(), self.1).expect("Error converting ProxiedCommandSender into crate::command::CommandSender")
...
impl<'mc> SimpleCommandMap<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,server: impl Into<crate::Server<'mc>>) 
...
crate::command::SimpleCommandMap::from_raw(&jni,res
	...
	pub fn set_fallback_commands(&self) 
-> Result<(), Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn dispatch(&self,sender: impl Into<crate::command::CommandSender<'mc>>,command_line: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>
...
new_vec
	...
	pub fn register_server_aliases(&self) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::command::CommandMap::from_raw(&self.jni_ref(), self.1).expect("Error converting SimpleCommandMap into crate::command::CommandMap")
...
crate::permissions::Permissible::from_raw(&self.jni_ref(), self.1).expect("Error converting CommandSender into crate::permissions::Permissible")
