...
impl<'mc> KnowledgeBookMeta<'mc> {
    ...
    pub fn add_attribute_modifier(
        ...
        let sig = String::from(
            "(Lorg/bukkit/attribute/Attribute;Lorg/bukkit/attribute/AttributeModifier;)Lbool;",
        );
        let val_1 = jni::objects::JValueGen::Object(unsafe {
            jni::objects::JObject::from_raw(attribute.into().jni_object().clone())
        });
    ...
    pub fn remove_attribute_modifier_with_slot(
        &self,
...
impl<'mc> BookMeta<'mc> {
    ...
    pub fn pages(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let sig = String::from("()LVec;");
        let res = self
            .jni_ref()
...
impl<'mc> BannerMeta<'mc> {
    ...
    pub fn patterns(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let sig = String::from("()LVec;");
        let res =
            self.jni_ref()
...
impl<'mc> BundleMeta<'mc> {
    ...
    pub fn items(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let sig = String::from("()LVec;");
        let res = self
            .jni_ref()
...
impl<'mc> ColorableArmorMeta<'mc> {
    ...
    pub fn set_display_name_with_name(
        &self,
        name: impl Into<String>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn set_localized_name_with_name(
        &self,
        name: impl Into<String>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn set_custom_model_data_with_data(
        &self,
        data: i32,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn get_enchant_level_with_ench(
        &self,
        ench: impl Into<crate::enchantments::Enchantment<'mc>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn remove_enchant_with_ench(
        &self,
        ench: impl Into<crate::enchantments::Enchantment<'mc>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn has_conflicting_enchant_with_ench(
        &self,
        ench: impl Into<crate::enchantments::Enchantment<'mc>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn add_item_flags_with_item_flags(
        &self,
        item_flags: impl Into<crate::inventory::ItemFlag<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn remove_item_flags_with_item_flags(
        &self,
        item_flags: impl Into<crate::inventory::ItemFlag<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn has_item_flag_with_flag(
        &self,
        flag: impl Into<crate::inventory::ItemFlag<'mc>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn set_unbreakable_with_unbreakable(
        &self,
        unbreakable: bool,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn get_attribute_modifiers_with_slot(
        &self,
        slot: impl Into<crate::inventory::EquipmentSlot<'mc>>,
    ...
    pub fn add_attribute_modifier_with_attribute(
        &self,
        attribute: impl Into<crate::attribute::Attribute<'mc>>,
        modifier: impl Into<crate::attribute::AttributeModifier<'mc>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
    ...
    pub fn set_attribute_modifiers_with_attribute_modifiers(
        &self,
        attribute_modifiers: jni::objects::JObject<'mc>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
    ...
    pub fn set_version_with_version(&self, version: i32) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "I";
        let val_1 = jni::objects::JValueGen::Int(version);
