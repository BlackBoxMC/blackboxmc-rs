...
crate::Keyed::from_raw(&self.jni_ref(), self.1).expect("Error converting TrimMaterial into crate::Keyed")
...
crate::Translatable::from_raw(&self.jni_ref(), self.1).expect("Error converting TrimMaterial into crate::Translatable")
...
crate::Keyed::from_raw(&self.jni_ref(), self.1).expect("Error converting TrimPattern into crate::Keyed")
...
crate::Translatable::from_raw(&self.jni_ref(), self.1).expect("Error converting TrimPattern into crate::Translatable")
...
impl<'mc> ArmorTrim<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,material: impl Into<crate::inventory::meta::trim::TrimMaterial<'mc>>,pattern: impl Into<crate::inventory::meta::trim::TrimPattern<'mc>>) 
...
{let sig = String::from("()Lcrate::inventory::meta::trim::TrimMaterial;");
...
{let sig = String::from("()Lcrate::inventory::meta::trim::TrimPattern;");
