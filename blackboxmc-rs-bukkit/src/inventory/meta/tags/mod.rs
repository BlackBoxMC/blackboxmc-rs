...
use color_eyre::eyre::Result;/*org/bukkit/inventory/meta/tags/mod.rs*/

#[repr(C)]
pub struct CustomItemTagContainer<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for CustomItemTagContainer<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/inventory/meta/tags/CustomItemTagContainer")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> CustomItemTagContainerTrait<'mc> for CustomItemTagContainer<'mc> {}
pub trait CustomItemTagContainerTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
/// value the meta may have stored under the provided key.
	fn set_custom_tag(&self,key: impl Into<crate::NamespacedKey<'mc>>,val_type: impl Into<crate::inventory::meta::tags::ItemTagType<'mc>>,value: jni::objects::JObject<'mc>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/NamespacedKey;Lorg/bukkit/inventory/meta/tags/ItemTagType;LZ;)V");
...
let res = self.jni_ref().call_method(&self.jni_object(),"setCustomTag",sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2),jni::objects::JValueGen::from(val_3)]);
...
/// using your namespace.
	fn has_custom_tag(&self,key: impl Into<crate::NamespacedKey<'mc>>,val_type: impl Into<crate::inventory::meta::tags::ItemTagType<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/NamespacedKey;Lorg/bukkit/inventory/meta/tags/ItemTagType;)Z");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(key.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(val_type.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"hasCustomTag",sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// Returns the custom tag's value that is stored on the item.
	fn get_custom_tag(&self,key: impl Into<crate::NamespacedKey<'mc>>,val_type: impl Into<crate::inventory::meta::tags::ItemTagType<'mc>>) 
-> Result<Option<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/NamespacedKey;Lorg/bukkit/inventory/meta/tags/ItemTagType;)LZ;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(key.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(val_type.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"getCustomTag",sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// Removes a custom key from the item meta.
	fn remove_custom_tag(&self,key: impl Into<crate::NamespacedKey<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/NamespacedKey;)V");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(key.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"removeCustomTag",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
let res = 
self.jni_ref().translate_error(res)?;
crate::inventory::meta::tags::ItemTagAdapterContext::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
#[repr(C)]
pub struct ItemTagTypePrimitiveTagType<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for ItemTagTypePrimitiveTagType<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/inventory/meta/tags/ItemTagType/PrimitiveTagType")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> ItemTagTypePrimitiveTagTypeTrait<'mc> for ItemTagTypePrimitiveTagType<'mc> {}
pub trait ItemTagTypePrimitiveTagTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
unsafe {jni::objects::JClass::from_raw(res.as_jni().l)}
	...
	fn to_primitive(&self,complex: jni::objects::JObject<'mc>,context: impl Into<crate::inventory::meta::tags::ItemTagAdapterContext<'mc>>) 
...
res.l()?
	...
	fn from_primitive(&self,primitive: jni::objects::JObject<'mc>,context: impl Into<crate::inventory::meta::tags::ItemTagAdapterContext<'mc>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
impl<'mc> Into<crate::inventory::meta::tags::ItemTagType<'mc>> for ItemTagTypePrimitiveTagType<'mc>{

fn into(self) -> crate::inventory::meta::tags::ItemTagType<'mc> {

crate::inventory::meta::tags::ItemTagType::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ItemTagTypePrimitiveTagType into crate::inventory::meta::tags::ItemTagType")

   }
}
impl<'mc> crate::inventory::meta::tags::ItemTagTypeTrait<'mc> for ItemTagTypePrimitiveTagType<'mc> {}
#[repr(C)]
pub struct ItemTagAdapterContext<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for ItemTagAdapterContext<'mc> {
        fn from_raw(
            ...
            let (valid, name) = env.validate_name(&obj, "org/bukkit/inventory/meta/tags/ItemTagAdapterContext")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> ItemTagAdapterContextTrait<'mc> for ItemTagAdapterContext<'mc> {}
pub trait ItemTagAdapterContextTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Creates a new and empty tag container instance.
	fn new_tag_container(&self) 
...
let res = self.jni_ref().call_method(&self.jni_object(),"newTagContainer",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
#[repr(C)]
pub struct ItemTagType<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for ItemTagType<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate ItemTagType from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/inventory/meta/tags/ItemTagType")?;
            if !valid {
                Err(eyre::eyre!(
...
impl<'mc> ItemTagTypeTrait<'mc> for ItemTagType<'mc> {}
pub trait ItemTagTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
