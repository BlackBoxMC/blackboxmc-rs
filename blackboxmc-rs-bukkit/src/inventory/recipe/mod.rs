...
use color_eyre::eyre::Result;/*org/bukkit/inventory/recipe/mod.rs*/

pub enum CraftingBookCategory<'mc> {
	Building {inner: CraftingBookCategoryStruct<'mc>},
	Redstone {inner: CraftingBookCategoryStruct<'mc>},
	Equipment {inner: CraftingBookCategoryStruct<'mc>},
	Misc {inner: CraftingBookCategoryStruct<'mc>},
}
impl<'mc> std::fmt::Display for CraftingBookCategory<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> CraftingBookCategoryTrait<'mc> for CraftingBookCategory<'mc> {}
        
        pub trait CraftingBookCategoryTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
...
"BUILDING" => Ok(CraftingBookCategory::Building { inner: CraftingBookCategoryStruct::from_raw(env,obj)?}),
"REDSTONE" => Ok(CraftingBookCategory::Redstone { inner: CraftingBookCategoryStruct::from_raw(env,obj)?}),
"EQUIPMENT" => Ok(CraftingBookCategory::Equipment { inner: CraftingBookCategoryStruct::from_raw(env,obj)?}),
"MISC" => Ok(CraftingBookCategory::Misc { inner: CraftingBookCategoryStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct CraftingBookCategoryStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::Equipment { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate CraftingBookCategory from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/inventory/recipe/CraftingBookCategory")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/inventory/recipe/CraftingBookCategory"); let cls = jni.translate_error_with_class(cls)?;
...
pub enum CookingBookCategory<'mc> {
	Food {inner: CookingBookCategoryStruct<'mc>},
	Blocks {inner: CookingBookCategoryStruct<'mc>},
	Misc {inner: CookingBookCategoryStruct<'mc>},
}
impl<'mc> std::fmt::Display for CookingBookCategory<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> CookingBookCategoryTrait<'mc> for CookingBookCategory<'mc> {}
        
        pub trait CookingBookCategoryTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"FOOD" => Ok(CookingBookCategory::Food { inner: CookingBookCategoryStruct::from_raw(env,obj)?}),
"BLOCKS" => Ok(CookingBookCategory::Blocks { inner: CookingBookCategoryStruct::from_raw(env,obj)?}),
"MISC" => Ok(CookingBookCategory::Misc { inner: CookingBookCategoryStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct CookingBookCategoryStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for CookingBookCategory<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate CookingBookCategory from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/inventory/recipe/CookingBookCategory")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/inventory/recipe/CookingBookCategory"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
