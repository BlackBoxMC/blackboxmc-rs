...
pub struct BarStyle<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>, pub BarStyleEnum);
...
"(Ljava/lang/String;)Lorg/bukkit/boss/BarStyle;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
crate::boss::BarStyle::from_raw(&jni,raw_obj
...
pub struct BarColor<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>, pub BarColorEnum);
...
let res = jni.call_static_method(cls,"valueOf",
"(Ljava/lang/String;)Lorg/bukkit/boss/BarColor;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
let raw_obj = obj;let variant = jni.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = jni    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
crate::boss::BarColor::from_raw(&jni,raw_obj
...
pub struct BarFlag<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>, pub BarFlagEnum);
...
let res = jni.call_static_method(cls,"valueOf",
"(Ljava/lang/String;)Lorg/bukkit/boss/BarFlag;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
let raw_obj = obj;let variant = jni.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = jni    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
crate::boss::BarFlag::from_raw(&jni,raw_obj
...
if !valid {
	...
	pub fn set_color(&mut self,arg0: impl Into<&'mc crate::boss::BarColor<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setColor","(Lorg/bukkit/boss/BarColor;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove_all(&mut self) 
-> Result<(), Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"removeAll","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn add_flag(&mut self,arg0: impl Into<&'mc crate::boss::BarFlag<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"addFlag","(Lorg/bukkit/boss/BarFlag;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getColor","()Lorg/bukkit/boss/BarColor;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::boss::BarColor::from_raw(&self.jni_ref(),raw_obj
, crate::boss::BarColor::from_string(variant_str).unwrap()
)}
...
-> Result<blackboxmc_java::JavaList<'mc, orgPlayer>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getPlayers","()Ljava/util/List;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaList::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn add_player(&mut self,arg0: impl Into<&'mc crate::entity::Player<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"addPlayer","(Lorg/bukkit/entity/Player;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove_player(&mut self,arg0: impl Into<&'mc crate::entity::Player<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"removePlayer","(Lorg/bukkit/entity/Player;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getStyle","()Lorg/bukkit/boss/BarStyle;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.jni_ref().call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.jni_ref()    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
crate::boss::BarStyle::from_raw(&self.jni_ref(),raw_obj
, crate::boss::BarStyle::from_string(variant_str).unwrap()
)}
	pub fn set_style(&mut self,arg0: impl Into<&'mc crate::boss::BarStyle<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setStyle","(Lorg/bukkit/boss/BarStyle;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove_flag(&mut self,arg0: impl Into<&'mc crate::boss::BarFlag<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"removeFlag","(Lorg/bukkit/boss/BarFlag;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn has_flag(&mut self,arg0: impl Into<&'mc crate::boss::BarFlag<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"hasFlag","(Lorg/bukkit/boss/BarFlag;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_progress(&mut self,arg0: f64) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Double(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setProgress","(D)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn progress(&mut self) 
-> Result<f64, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getProgress","()D",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
#[deprecated]
...
{let res = self.jni_ref().call_method(&self.jni_object(),"show","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
...
{let res = self.jni_ref().call_method(&self.jni_object(),"hide","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn key(&mut self) 
...
if !valid {
	...
	pub fn respawn_phase(&mut self) 
-> Result<crate::boss::DragonBattleRespawnPhase<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getRespawnPhase","()Lorg/bukkit/boss/DragonBattle$RespawnPhase;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::boss::DragonBattleRespawnPhase::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn boss_bar(&mut self) 
-> Result<crate::boss::BossBar<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getBossBar","()Lorg/bukkit/boss/BossBar;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::boss::BossBar::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn ender_dragon(&mut self) 
-> Result<crate::entity::EnderDragon<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getEnderDragon","()Lorg/bukkit/entity/EnderDragon;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::entity::EnderDragon::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn end_portal_location(&mut self) 
-> Result<crate::Location<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getEndPortalLocation","()Lorg/bukkit/Location;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::Location::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn generate_end_portal(&mut self,arg0: bool) 
-> Result<bool, Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"generateEndPortal","(Z)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn has_been_previously_killed(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"hasBeenPreviouslyKilled","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn initiate_respawn(&mut self) 
-> Result<(), Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"initiateRespawn","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_respawn_phase(&mut self,arg0: impl Into<&'mc crate::boss::DragonBattleRespawnPhase<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setRespawnPhase","(Lorg/bukkit/boss/DragonBattle$RespawnPhase;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn reset_crystals(&mut self) 
-> Result<(), Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"resetCrystals","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
}
...
pub struct DragonBattleRespawnPhase<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
