...
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn enchantment(&mut self) 
-> Result<crate::enchantments::Enchantment<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getEnchantment","()Lorg/bukkit/enchantments/Enchantment;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getStartLevel","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getMaxLevel","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn can_enchant_item(&mut self,arg0: impl Into<&'mc crate::inventory::ItemStack<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"canEnchantItem","(Lorg/bukkit/inventory/ItemStack;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn item_target(&mut self) 
-> Result<crate::enchantments::EnchantmentTarget<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getItemTarget","()Lorg/bukkit/enchantments/EnchantmentTarget;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::enchantments::EnchantmentTarget::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn is_treasure(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isTreasure","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn is_cursed(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isCursed","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn conflicts_with(&mut self,arg0: impl Into<&'mc crate::enchantments::Enchantment<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"conflictsWith","(Lorg/bukkit/enchantments/Enchantment;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
#[deprecated]
	pub fn get_by_name(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc String>) 
-> Result<crate::enchantments::Enchantment<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(jni.new_string(arg0.into()).unwrap());
let cls = &jni.find_class("org/bukkit/enchantments/Enchantment")?;
let res = jni.call_static_method(cls,"getByName",
"(Ljava/lang/String;)Lorg/bukkit/enchantments/Enchantment;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::enchantments::Enchantment::from_raw(&jni,obj
)}
	pub fn register_enchantment(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::enchantments::Enchantment<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"registerEnchantment",
"(Lorg/bukkit/enchantments/Enchantment;)V",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(())}
	pub fn get_by_key(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::NamespacedKey<'mc>>) 
-> Result<crate::enchantments::Enchantment<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/enchantments/Enchantment")?;
let res = jni.call_static_method(cls,"getByKey",
"(Lorg/bukkit/NamespacedKey;)Lorg/bukkit/enchantments/Enchantment;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::enchantments::Enchantment::from_raw(&jni,obj
)}
	pub fn stop_accepting_registrations(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<(), Box<dyn std::error::Error>>

{let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"stopAcceptingRegistrations",
"()V",&[])?;
Ok(())}
	pub fn is_accepting_registrations(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>

{let cls = &jni.find_class("boolean")?;
let res = jni.call_static_method(cls,"isAcceptingRegistrations",
"()Z",&[])?;
Ok(res.z().unwrap())}
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::enchantments::Enchantment<'mc>>,arg1: i32,arg2: i32) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/enchantments/Enchantment;II)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
crate::enchantments::Enchantment::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_enchantment(&mut self,arg0: impl Into<&'mc crate::enchantments::Enchantment<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setEnchantment","(Lorg/bukkit/enchantments/Enchantment;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn enchantment_level(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getEnchantmentLevel","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn set_enchantment_level(&mut self,arg0: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setEnchantmentLevel","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn cost(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getCost","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn set_cost(&mut self,arg0: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setCost","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
pub struct EnchantmentTarget<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
blackboxmc_java::JavaEnum::from_raw(&jni,obj
	...
	pub fn includes_with_item_stack(&mut self,arg0: std::option::Option<impl Into<&'mc crate::Material<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"includes","(Lorg/bukkit/Material;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn name(&mut self) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::NamespacedKey<'mc>>) 
-> Result<crate::enchantments::Enchantment<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/enchantments/Enchantment")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/NamespacedKey;)V",&[jni::objects::JValueGen::from(&val_0)])?;
