...
let res = self.jni_ref().call_method(&self.jni_object(),"canEnchantItem","(Lorg/bukkit/inventory/ItemStack;)Z",&[jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"conflictsWith","(Lorg/bukkit/enchantments/Enchantment;)Z",&[jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
"(Ljava/lang/String;)Lorg/bukkit/enchantments/Enchantment;",&[jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
...
"(Lorg/bukkit/enchantments/Enchantment;)V",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
...
"(Lorg/bukkit/NamespacedKey;)Lorg/bukkit/enchantments/Enchantment;",&[jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::enchantments::Enchantment::from_raw(&jni,obj
)}
...
let res = jni.new_object(cls,
"(Lorg/bukkit/enchantments/Enchantment;II)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
{let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setEnchantment","(Lorg/bukkit/enchantments/Enchantment;)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
let res = self.jni_ref().call_method(&self.jni_object(),"setEnchantmentLevel","(I)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_1 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setCost","(I)V",&[jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
let res = self.jni_ref().call_method(&self.jni_object(),"includes","(Lorg/bukkit/Material;)Z",&[jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn name(&mut self) 
...
let cls = &jni.find_class("org/bukkit/enchantments/Enchantment")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/NamespacedKey;)V",&[jni::objects::JValueGen::from(&val_1)])?;
