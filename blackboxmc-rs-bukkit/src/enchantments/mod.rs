...
impl<'mc> EnchantmentWrapper<'mc> {
    ...
    pub fn get_by_key(
        ...
        crate::enchantments::Enchantment::get_by_key(jni, key)
    }
    ...
    pub fn get_by_name(
        ...
        crate::enchantments::Enchantment::get_by_name(jni, name)
    }
    #[deprecated]
...
impl<'mc> Into<crate::Translatable<'mc>> for Enchantment<'mc> {
    fn into(self) -> crate::Translatable<'mc> {
        crate::Translatable::from_raw(&self.jni_ref(), self.1)
            .expect("Error converting Enchantment into crate::Translatable")
    }
}
