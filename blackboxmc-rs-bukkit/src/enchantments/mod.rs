...
use color_eyre::eyre::Result;/*org/bukkit/enchantments/mod.rs*/
...
impl<'mc> std::fmt::Display for EnchantmentTarget<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> EnchantmentTargetTrait<'mc> for EnchantmentTarget<'mc> {}
        
        pub trait EnchantmentTargetTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
...
/// Check whether this target includes the specified item.
	fn includes(&self,item: impl Into<crate::inventory::ItemStack<'mc>>) 
...
impl<'mc> EnchantmentOfferTrait<'mc> for EnchantmentOffer<'mc> {}
pub trait EnchantmentOfferTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,enchantment: impl Into<crate::enchantments::Enchantment<'mc>>,enchantment_level: i32,cost: i32) 
...
/// Sets the type of the enchantment.
	fn set_enchantment(&self,enchantment: impl Into<crate::enchantments::Enchantment<'mc>>) 
...
/// Sets the level of the enchantment.
	fn set_enchantment_level(&self,enchantment_level: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> EnchantmentWrapperTrait<'mc> for EnchantmentWrapper<'mc> {}
pub trait EnchantmentWrapperTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::enchantments::Enchantment::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting EnchantmentWrapper into crate::enchantments::Enchantment")

   }
}
impl<'mc> crate::enchantments::EnchantmentTrait<'mc> for EnchantmentWrapper<'mc> {}
#[repr(C)]
...
impl<'mc> EnchantmentTrait<'mc> for Enchantment<'mc> {}
pub trait EnchantmentTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::Keyed::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting Enchantment into crate::Keyed")

   }
}
impl<'mc> crate::KeyedTrait<'mc> for Enchantment<'mc> {}
impl<'mc> Into<crate::Translatable<'mc>> for Enchantment<'mc>{

fn into(self) -> crate::Translatable<'mc> {

crate::Translatable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting Enchantment into crate::Translatable")

   }
}
impl<'mc> crate::TranslatableTrait<'mc> for Enchantment<'mc> {}
