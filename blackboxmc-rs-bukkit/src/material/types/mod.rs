...
use color_eyre::eyre::Result;/*org/bukkit/material/types/mod.rs*/
...
impl<'mc> std::fmt::Display for MushroomBlockTexture<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> MushroomBlockTextureTrait<'mc> for MushroomBlockTexture<'mc> {}
        
        pub trait MushroomBlockTextureTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
...
/// Gets the MushroomBlockType with cap texture on the given block face.
	fn get_cap_by_face(jni: &blackboxmc_general::SharedJNIEnv<'mc>,face: impl Into<crate::block::BlockFace<'mc>>) 
-> Result<Option<crate::material::types::MushroomBlockTexture<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/block/BlockFace;)Lorg/bukkit/material/types/MushroomBlockTexture;");
