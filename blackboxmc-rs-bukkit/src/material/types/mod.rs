...
impl<'mc> std::ops::Deref for MushroomBlockTexture<'mc> {
    type Target = MushroomBlockTextureStruct<'mc>;
    fn deref(&self) -> &<MushroomBlockTexture<'mc> as std::ops::Deref>::Target {
        match self {
            MushroomBlockTexture::AllPores { inner } => inner,
            MushroomBlockTexture::CapNorthWest { inner } => inner,
            MushroomBlockTexture::CapNorth { inner } => inner,
            MushroomBlockTexture::CapNorthEast { inner } => inner,
            MushroomBlockTexture::CapWest { inner } => inner,
            MushroomBlockTexture::CapTop { inner } => inner,
            MushroomBlockTexture::CapEast { inner } => inner,
            MushroomBlockTexture::CapSouthWest { inner } => inner,
            MushroomBlockTexture::CapSouth { inner } => inner,
            MushroomBlockTexture::CapSouthEast { inner } => inner,
            MushroomBlockTexture::StemSides { inner } => inner,
            MushroomBlockTexture::AllCap { inner } => inner,
            MushroomBlockTexture::AllStem { inner } => inner,
        }
    }
}
