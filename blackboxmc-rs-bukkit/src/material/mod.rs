...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::block::BlockFace<'mc>>>) 
...
"(Lorg/bukkit/block/BlockFace;)V",&[jni::objects::JValueGen::from(&val_0)])?;
crate::material::Chest::from_raw(&jni,res
)}
#[deprecated]
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Material<'mc>>,arg1: std::option::Option<i8>) 
-> Result<crate::material::Chest<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Chest")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/Material;B)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::material::Chest::from_raw(&jni,res
)}
	pub fn clone(&mut self) 
-> Result<crate::material::Chest<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/Chest;",&[]);
let res = 
...
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn facing(&mut self) 
-> Result<crate::block::BlockFace<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getFacing","()Lorg/bukkit/block/BlockFace;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
, crate::block::BlockFace::from_string(variant_str).unwrap()
	...
	pub fn set_facing_direction(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setFacingDirection","(Lorg/bukkit/block/BlockFace;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
Ok(res.b().unwrap())}
#[deprecated]
	pub fn set_data(&mut self,arg0: i8) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Byte(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setData","(B)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
, crate::Material::from_string(variant_str).unwrap()
	...
	pub fn to_item_stack(&mut self,arg0: std::option::Option<i32>) 
-> Result<crate::inventory::ItemStack<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"toItemStack","(I)Lorg/bukkit/inventory/ItemStack;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::material::Diode::from_raw(&jni,res
	...
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>,arg1: std::option::Option<i32>) 
-> Result<crate::material::Diode<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Diode")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/block/BlockFace;I)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::material::Diode::from_raw(&jni,res
)}
	pub fn new_with_block_face(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>,arg1: i32,arg2: std::option::Option<bool>) 
-> Result<crate::material::Diode<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Diode")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/block/BlockFace;IZ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::material::Diode::from_raw(&jni,res
)}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_powered(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isPowered","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_lit(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isLit","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
#[deprecated]
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::Material<'mc>>>,arg1: std::option::Option<i8>) 
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getContents","()Lorg/bukkit/material/MaterialData;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::material::MaterialData::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn set_contents(&mut self,arg0: impl Into<&'mc crate::material::MaterialData<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setContents","(Lorg/bukkit/material/MaterialData;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/PoweredRail;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_powered(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setPowered","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_direction(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>,arg1: bool) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
// -2
let val_1 = jni::objects::JValueGen::Bool(arg1.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setDirection","(Lorg/bukkit/block/BlockFace;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_curve(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isCurve","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn to_string(&mut self) 
...
, crate::block::BlockFace::from_string(variant_str).unwrap()
	...
	pub fn is_on_slope(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isOnSlope","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/MaterialData;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::material::MaterialData::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn attached_face(&mut self) 
-> Result<crate::block::BlockFace<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getAttachedFace","()Lorg/bukkit/block/BlockFace;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
crate::block::BlockFace::from_raw(&self.jni_ref(),raw_obj
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn is_connected(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isConnected","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_connected(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setConnected","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_activated(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isActivated","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_activated(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setActivated","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn facing(&mut self) 
-> Result<crate::block::BlockFace<'mc>, Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::Material<'mc>>>,arg1: std::option::Option<impl Into<&'mc crate::block::BlockFace<'mc>>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/Material;Lorg/bukkit/block/BlockFace;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
if !valid {
	...
	pub fn is_open(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isOpen","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_open(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setOpen","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/Torch;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::material::Comparator::from_raw(&jni,res
	...
	pub fn new_with_block_face(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>,arg1: bool,arg2: std::option::Option<bool>) 
-> Result<crate::material::Comparator<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Comparator")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/block/BlockFace;ZZ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::material::Comparator::from_raw(&jni,res
)}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_subtraction_mode(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSubtractionMode","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_subtraction_mode(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isSubtractionMode","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn is_being_powered(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isBeingPowered","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::CoalType<'mc>>>) 
-> Result<crate::material::Coal<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/material/Coal")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/CoalType;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getType","()Lorg/bukkit/CoalType;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
...
, crate::CoalType::from_string(variant_str).unwrap()
	...
	pub fn set_type(&mut self,arg0: impl Into<&'mc crate::CoalType<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setType","(Lorg/bukkit/CoalType;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::TreeSpecies<'mc>>>) 
-> Result<crate::material::Tree<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/material/Tree")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/TreeSpecies;)V",&[jni::objects::JValueGen::from(&val_0)])?;
crate::material::Tree::from_raw(&jni,res
)}
	pub fn new_with_tree_species(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Material<'mc>>,arg1: std::option::Option<impl Into<&'mc crate::TreeSpecies<'mc>>>) 
-> Result<crate::material::Tree<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Tree")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/Material;Lorg/bukkit/TreeSpecies;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::material::Tree::from_raw(&jni,res
)}
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Material<'mc>>,arg1: std::option::Option<impl Into<&'mc crate::TreeSpecies<'mc>>>,arg2: std::option::Option<impl Into<&'mc crate::block::BlockFace<'mc>>>) 
-> Result<crate::material::Tree<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Tree")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/Material;Lorg/bukkit/TreeSpecies;Lorg/bukkit/block/BlockFace;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::material::Tree::from_raw(&jni,res
)}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
, crate::block::BlockFace::from_string(variant_str).unwrap()
	...
	pub fn set_direction(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setDirection","(Lorg/bukkit/block/BlockFace;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_species(&mut self,arg0: impl Into<&'mc crate::TreeSpecies<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setSpecies","(Lorg/bukkit/TreeSpecies;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn species(&mut self) 
-> Result<crate::TreeSpecies<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getSpecies","()Lorg/bukkit/TreeSpecies;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
...
#[deprecated]
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::Material<'mc>>>,arg1: std::option::Option<i8>) 
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_inverted(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isInverted","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_inverted(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setInverted","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn facing(&mut self) 
-> Result<crate::block::BlockFace<'mc>, Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::CropState<'mc>>>) 
-> Result<crate::material::Crops<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/material/Crops")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/CropState;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
crate::material::Crops::from_raw(&jni,res
	...
	pub fn set_state(&mut self,arg0: impl Into<&'mc crate::CropState<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setState","(Lorg/bukkit/CropState;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getState","()Lorg/bukkit/CropState;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
...
#[deprecated]
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<i8>) 
...
let res = jni.new_object(cls,
"(B)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getTextures","()Ljava/util/List;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
, crate::Material::from_string(variant_str).unwrap()
	...
	pub fn set_material(&mut self,arg0: impl Into<&'mc crate::Material<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setMaterial","(Lorg/bukkit/Material;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/Furnace;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::material::Sapling::from_raw(&jni,res
	...
	pub fn new_with_tree_species(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Material<'mc>>,arg1: std::option::Option<impl Into<&'mc crate::TreeSpecies<'mc>>>,arg2: std::option::Option<bool>) 
-> Result<crate::material::Sapling<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Sapling")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/Material;Lorg/bukkit/TreeSpecies;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::material::Sapling::from_raw(&jni,res
)}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
crate::material::MaterialData::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn is_instant_growable(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isInstantGrowable","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_is_instant_growable(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setIsInstantGrowable","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_species(&mut self,arg0: impl Into<&'mc crate::TreeSpecies<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/PistonExtensionMaterial;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_sticky(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSticky","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::Material<'mc>>>) 
...
crate::material::NetherWarts::from_raw(&jni,res
	...
	pub fn set_state(&mut self,arg0: impl Into<&'mc crate::NetherWartsState<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setState","(Lorg/bukkit/NetherWartsState;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/NetherWarts;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getState","()Lorg/bukkit/NetherWartsState;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::GrassSpecies<'mc>>>) 
-> Result<crate::material::LongGrass<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/material/LongGrass")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/GrassSpecies;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn set_species(&mut self,arg0: impl Into<&'mc crate::GrassSpecies<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setSpecies","(Lorg/bukkit/GrassSpecies;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn species(&mut self) 
-> Result<crate::GrassSpecies<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getSpecies","()Lorg/bukkit/GrassSpecies;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_object_triggering(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isObjectTriggering","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_object_triggering(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setObjectTriggering","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"isPressed","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/Dispenser;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn slices_eaten(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getSlicesEaten","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn slices_remaining(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getSlicesRemaining","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn set_slices_eaten(&mut self,arg0: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSlicesEaten","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_slices_remaining(&mut self,arg0: i32) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSlicesRemaining","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
crate::material::Leaves::from_raw(&jni,res
	...
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Material<'mc>>,arg1: std::option::Option<impl Into<&'mc crate::TreeSpecies<'mc>>>,arg2: std::option::Option<bool>) 
-> Result<crate::material::Leaves<'mc>, Box<dyn std::error::Error>>
...
crate::material::MaterialData::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn is_decayable(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isDecayable","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_decayable(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setDecayable","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_decaying(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isDecaying","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_decaying(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setDecaying","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_species(&mut self,arg0: impl Into<&'mc crate::TreeSpecies<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/Stairs;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn ascending_direction(&mut self) 
-> Result<crate::block::BlockFace<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getAscendingDirection","()Lorg/bukkit/block/BlockFace;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
crate::block::BlockFace::from_raw(&self.jni_ref(),raw_obj
, crate::block::BlockFace::from_string(variant_str).unwrap()
	...
	pub fn descending_direction(&mut self) 
-> Result<crate::block::BlockFace<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getDescendingDirection","()Lorg/bukkit/block/BlockFace;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
crate::block::BlockFace::from_raw(&self.jni_ref(),raw_obj
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::SandstoneType<'mc>>>) 
-> Result<crate::material::Sandstone<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/material/Sandstone")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/SandstoneType;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getType","()Lorg/bukkit/SandstoneType;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
...
, crate::SandstoneType::from_string(variant_str).unwrap()
	...
	pub fn set_type(&mut self,arg0: impl Into<&'mc crate::SandstoneType<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setType","(Lorg/bukkit/SandstoneType;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/EnderChest;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/FurnaceAndDispenser;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_head_of_bed(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isHeadOfBed","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_head_of_bed(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setHeadOfBed","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
#[deprecated]
	pub fn new_with_enum_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::Material<'mc>>>,arg1: std::option::Option<i8>) 
-> Result<crate::material::Vine<'mc>, Box<dyn std::error::Error>>
...
crate::material::MaterialData::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn is_on_face(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"isOnFace","(Lorg/bukkit/block/BlockFace;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn put_on_face(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"putOnFace","(Lorg/bukkit/block/BlockFace;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove_from_face(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"removeFromFace","(Lorg/bukkit/block/BlockFace;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
, crate::block::BlockFace::from_string(variant_str).unwrap()
	...
	pub fn is_wall_banner(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isWallBanner","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
if !valid {
	...
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Material<'mc>>,arg1: std::option::Option<impl Into<&'mc crate::block::BlockFace<'mc>>>) 
...
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn is_stem(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isStem","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
#[deprecated]
...
{let res = self.jni_ref().call_method(&self.jni_object(),"setStem","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn block_texture(&mut self) 
-> Result<crate::material::types::MushroomBlockTexture<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getBlockTexture","()Lorg/bukkit/material/types/MushroomBlockTexture;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
...
, crate::material::types::MushroomBlockTexture::from_string(variant_str).unwrap()
	...
	pub fn set_block_texture(&mut self,arg0: impl Into<&'mc crate::material::types::MushroomBlockTexture<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setBlockTexture","(Lorg/bukkit/material/types/MushroomBlockTexture;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_face_painted(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"isFacePainted","(Lorg/bukkit/block/BlockFace;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
#[deprecated]
	pub fn set_face_painted(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>,arg1: bool) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
// -2
let val_1 = jni::objects::JValueGen::Bool(arg1.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setFacePainted","(Lorg/bukkit/block/BlockFace;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn painted_faces(&mut self) 
-> Result<blackboxmc_java::JavaSet<'mc, orgBlockFace>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getPaintedFaces","()Ljava/util/Set;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/RedstoneTorch;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
pub struct CocoaPlantCocoaPlantSize<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
crate::material::CocoaPlant::from_raw(&jni,res
	...
	pub fn set_size(&mut self,arg0: impl Into<&'mc crate::material::CocoaPlantCocoaPlantSize<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setSize","(Lorg/bukkit/material/CocoaPlant$CocoaPlantSize;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getSize","()Lorg/bukkit/material/CocoaPlant$CocoaPlantSize;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::TreeSpecies<'mc>>>,arg1: std::option::Option<impl Into<&'mc crate::block::BlockFace<'mc>>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/TreeSpecies;Lorg/bukkit/block/BlockFace;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::material::Door::from_raw(&jni,res
)}
#[deprecated]
	pub fn new_with_tree_species(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Material<'mc>>,arg1: std::option::Option<i8>) 
-> Result<crate::material::Door<'mc>, Box<dyn std::error::Error>>
...
crate::material::Door::from_raw(&jni,res
	...
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::Material<'mc>>,arg1: impl Into<&'mc crate::block::BlockFace<'mc>>,arg2: std::option::Option<bool>) 
-> Result<crate::material::Door<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Door")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/Material;Lorg/bukkit/block/BlockFace;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::material::Door::from_raw(&jni,res
)}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getHinge","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_hinge(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setHinge","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_top_half(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setTopHalf","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn get_wood_door_of_species(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::TreeSpecies<'mc>>) 
-> Result<crate::Material<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/Material")?;
let res = jni.call_static_method(cls,"getWoodDoorOfSpecies",
"(Lorg/bukkit/TreeSpecies;)Lorg/bukkit/Material;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
, crate::Material::from_string(variant_str).unwrap()
	...
	pub fn is_top_half(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isTopHalf","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
#[deprecated]
	pub fn hinge_corner(&mut self) 
-> Result<crate::block::BlockFace<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getHingeCorner","()Lorg/bukkit/block/BlockFace;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
let raw_obj = unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) };let variant = self.0.call_method(&raw_obj, "toString", "()Ljava/lang/String;", &[])?;let variant_str = self.0    .get_string(unsafe { &jni::objects::JString::from_raw(variant.as_jni().l) })?    .to_string_lossy()    .to_string();
crate::block::BlockFace::from_raw(&self.jni_ref(),raw_obj
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/Ladder;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/material/DetectorRail;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_pressed(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setPressed","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_direction(&mut self,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>,arg1: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::material::Hopper::from_raw(&jni,res
	...
	pub fn new_with_material(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::block::BlockFace<'mc>>,arg1: std::option::Option<bool>) 
-> Result<crate::material::Hopper<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("org/bukkit/material/Hopper")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/block/BlockFace;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::material::Hopper::from_raw(&jni,res
)}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"isActive","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn facing(&mut self) 
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn set_active(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setActive","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
, crate::block::BlockFace::from_string(variant_str).unwrap()
	...
	pub fn is_wall_sign(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isWallSign","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::DyeColor<'mc>>>) 
-> Result<crate::material::Wool<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("org/bukkit/material/Wool")?;
let res = jni.new_object(cls,
"(Lorg/bukkit/DyeColor;)V",&[jni::objects::JValueGen::from(&val_0)])?;
