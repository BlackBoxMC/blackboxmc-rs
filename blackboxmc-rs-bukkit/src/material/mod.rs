...
impl<'mc> Vine<'mc> {
    pub fn new_with_block_faces(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<crate::block::BlockFace<'mc>>>,
