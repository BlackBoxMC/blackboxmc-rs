...
impl<'mc> Button<'mc> {
    ...
    pub fn is_powered(&self) -> Result<bool, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isPowered", sig.as_str(), args);
...
impl<'mc> TrapDoor<'mc> {
    ...
    pub fn is_open(&self) -> Result<bool, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isOpen", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
    pub fn set_open_with_is_open(&self, is_open: bool) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
        let mut sig = String::from("(");
        sig += "Z";
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "setOpen", sig.as_str(), args);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
...
impl<'mc> Gate<'mc> {
    ...
    pub fn set_facing_direction_with_face(
        &self,
        face: impl Into<crate::block::BlockFace<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let mut args = Vec::new();
...
impl<'mc> PistonExtensionMaterial<'mc> {
    ...
    pub fn attached_face(
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getAttachedFace", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        crate::block::BlockFace::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
...
impl<'mc> MonsterEggs<'mc> {
    ...
    pub fn textures(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
...
impl<'mc> Diode<'mc> {
    ...
    pub fn new_with_facing_direction(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
...
impl<'mc> DetectorRail<'mc> {
    ...
    pub fn is_pressed(&self) -> Result<bool, Box<dyn std::error::Error>> {
        ...
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isPressed", sig.as_str(), args);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z()?)
    }
...
impl<'mc> MaterialData<'mc> {
    ...
    pub fn to_item_stack_with_amount(
        &self,
...
impl<'mc> Dye<'mc> {
    pub fn new_with_color(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
        color: std::option::Option<impl Into<crate::DyeColor<'mc>>>,
