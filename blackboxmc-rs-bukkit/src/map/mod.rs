...
impl<'mc> MapFontCharacterSprite<'mc> {
	pub fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,width: i32,height: i32,data: bool) 
...
crate::map::MapFontCharacterSprite::from_raw(&jni,res
	...
	pub fn get(&self,row: i32,col: i32) 
...
impl<'mc> MapCursor<'mc> {
	pub fn new_with_x(jni: &blackboxmc_general::SharedJNIEnv<'mc>,x: i8,y: i8,direction: i8,val_type: impl Into<crate::map::MapCursorType<'mc>>,visible: bool,caption: std::option::Option<impl Into<String>>) 
...
()
	...
	pub fn set_direction(&self,direction: i8) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn set_type(&self,val_type: impl Into<crate::map::MapCursorType<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn set_raw_type(&self,val_type: i8) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::map::MapViewScale::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_scale(&self,scale: impl Into<crate::map::MapViewScale<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
res.i()?
	...
	pub fn set_center_x(&self,x: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn set_center_z(&self,z: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::World::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_world(&self,world: impl Into<crate::World<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
new_vec
	...
	pub fn add_renderer(&self,renderer: impl Into<crate::map::MapRenderer<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn remove_renderer(&self,renderer: impl Into<crate::map::MapRenderer<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn is_tracking_position(&self) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn set_tracking_position(&self,tracking_position: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn is_unlimited_tracking(&self) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn set_unlimited_tracking(&self,unlimited: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::map::MapCursorCollection::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn set_cursors(&self,cursors: impl Into<crate::map::MapCursorCollection<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn get_pixel_color(&self,x: i32,y: i32) 
...
(r, g, b)
	...
	pub fn get_base_pixel_color(&self,x: i32,y: i32) 
...
(r, g, b)
	...
	pub fn set_pixel(&self,x: i32,y: i32,color: i8) 
-> Result<(), Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn get_pixel(&self,x: i32,y: i32) 
-> Result<i8, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn get_base_pixel(&self,x: i32,y: i32) 
-> Result<i8, Box<dyn std::error::Error>>
...
res.b()?
	...
	pub fn draw_image(&self,x: i32,y: i32,image: jni::objects::JObject<'mc>) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn draw_text(&self,x: i32,y: i32,font: impl Into<crate::map::MapFont<'mc>>,text: impl Into<String>) 
-> Result<(), Box<dyn std::error::Error>>
...
pub fn from_extendable(
	...
	pub fn new_with_contextual(jni: &blackboxmc_general::SharedJNIEnv<'mc>,contextual: std::option::Option<bool>) 
...
res.z()?
	...
	pub fn initialize(&self,map: impl Into<crate::map::MapView<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
res.i()?
	...
	pub fn get_cursor(&self,index: i32) 
-> Result<crate::map::MapCursor<'mc>, Box<dyn std::error::Error>>
...
crate::map::MapCursor::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn remove_cursor(&self,cursor: impl Into<crate::map::MapCursor<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn add_cursor_with_x(&self,x: i32,y: std::option::Option<i32>,direction: std::option::Option<i8>,val_type: std::option::Option<i8>,visible: std::option::Option<bool>,caption: std::option::Option<impl Into<String>>) 
-> Result<crate::map::MapCursor<'mc>, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn by_value(jni: &blackboxmc_general::SharedJNIEnv<'mc>,value: i8) 
...
crate::map::MapFont::from_raw(&self.jni_ref(), self.1).expect("Error converting MinecraftFont into crate::map::MapFont")
...
crate::map::MapFont::from_raw(&jni,res
	...
	pub fn set_char(&self,ch: u16,sprite: impl Into<crate::map::MapFontCharacterSprite<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::map::MapFontCharacterSprite::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn get_width(&self,text: impl Into<String>) 
-> Result<i32, Box<dyn std::error::Error>>
...
res.i()?
	...
	pub fn is_valid(&self,text: impl Into<String>) 
-> Result<bool, Box<dyn std::error::Error>>
...
impl<'mc> MapPalette<'mc> {
	pub fn resize_image(jni: &blackboxmc_general::SharedJNIEnv<'mc>,image: jni::objects::JObject<'mc>) 
...
#[deprecated]
	...
	pub fn image_to_bytes(jni: &blackboxmc_general::SharedJNIEnv<'mc>,image: jni::objects::JObject<'mc>) 
-> Result<i8, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn match_color_with_r(jni: &blackboxmc_general::SharedJNIEnv<'mc>,r: i32,g: std::option::Option<i32>,b: std::option::Option<i32>) 
-> Result<i8, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn get_color(jni: &blackboxmc_general::SharedJNIEnv<'mc>,index: i8) 
-> Result<(u8, u8, u8), Box<dyn std::error::Error>>
...
(r, g, b)
	...
	pub fn set_map_color_cache(jni: &blackboxmc_general::SharedJNIEnv<'mc>,map_color_cache: impl Into<crate::map::MapPaletteMapColorCache<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
