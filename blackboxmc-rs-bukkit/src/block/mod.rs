...
impl<'mc> Block<'mc> {
    ...
    pub fn get_relative_with_mod_x(
        &self,
        mod_x: i32,
    ...
    pub fn set_block_data_with_data(
        &self,
    ...
    pub fn break_naturally_with_tool(
        &self,
...
impl<'mc> BlockState<'mc> {
    ...
    pub fn copy(&self) -> Result<crate::block::BlockState<'mc>, Box<dyn std::error::Error>> {
        let sig = String::from("()Lcrate::block::BlockState;");
        let res = self
            .jni_ref()
...
impl<'mc> DecoratedPot<'mc> {
    ...
    pub fn shards(&self) -> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>> {
        let sig = String::from("()LVec;");
        let res = self
            .jni_ref()
...
impl<'mc> Structure<'mc> {
    ...
    pub fn set_metadata_with_metadata_key(
        &self,
        metadata_key: impl Into<String>,
...
impl<'mc> CreatureSpawner<'mc> {
    ...
    pub fn add_potential_spawn_with_snapshot(
        &self,
        snapshot: impl Into<crate::entity::EntitySnapshot<'mc>>,
