...
use color_eyre::eyre::Result;/*org/bukkit/block/spawner/mod.rs*/
...
impl<'mc> SpawnerEntryTrait<'mc> for SpawnerEntry<'mc> {}
pub trait SpawnerEntryTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,snapshot: impl Into<crate::entity::EntitySnapshot<'mc>>,spawn_weight: i32,spawn_rule: impl Into<crate::block::spawner::SpawnRule<'mc>>) 
...
/// Sets the {@link EntitySnapshot} for this SpawnerEntry.
	fn set_snapshot(&self,snapshot: impl Into<crate::entity::EntitySnapshot<'mc>>) 
...
/// with higher weight will spawn more often.
	fn set_spawn_weight(&self,spawn_weight: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
/// clear the current spawn rule.
	fn set_spawn_rule(&self,spawn_rule: impl Into<crate::block::spawner::SpawnRule<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> SpawnRuleTrait<'mc> for SpawnRule<'mc> {}
pub trait SpawnRuleTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Constructs a new SpawnRule.
	fn new(jni: &blackboxmc_general::SharedJNIEnv<'mc>,min_block_light: i32,max_block_light: i32,min_sky_light: i32,max_sky_light: i32) 
...
/// succeed.
	fn set_min_block_light(&self,min_block_light: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
/// succeed.
	fn set_max_block_light(&self,max_block_light: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Sets the minimum (inclusive) sky light required for spawning to succeed.
	fn set_min_sky_light(&self,min_sky_light: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
/// Sets the maximum (inclusive) sky light required for spawning to succeed.
	fn set_max_sky_light(&self,max_sky_light: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::configuration::serialization::ConfigurationSerializable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting SpawnRule into crate::configuration::serialization::ConfigurationSerializable")

   }
}
impl<'mc> crate::configuration::serialization::ConfigurationSerializableTrait<'mc> for SpawnRule<'mc> {}
