...
use color_eyre::eyre::Result;/*org/bukkit/block/structure/mod.rs*/
...
impl<'mc> std::fmt::Display for StructureRotation<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> StructureRotationTrait<'mc> for StructureRotation<'mc> {}
        
        pub trait StructureRotationTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
...
"NONE" => Ok(StructureRotation::None { inner: StructureRotationStruct::from_raw(env,obj)?}),
"CLOCKWISE_90" => Ok(StructureRotation::Clockwise90 { inner: StructureRotationStruct::from_raw(env,obj)?}),
"CLOCKWISE_180" => Ok(StructureRotation::Clockwise180 { inner: StructureRotationStruct::from_raw(env,obj)?}),
"COUNTERCLOCKWISE_90" => Ok(StructureRotation::Counterclockwise90 { inner: StructureRotationStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct StructureRotationStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::Clockwise90 { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Clockwise180 { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::Counterclockwise90 { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
}
}
}
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate StructureRotation from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/block/structure/StructureRotation")?;
            if !valid {
                Err(eyre::eyre!(
...
let cls = jni.find_class("org/bukkit/block/structure/StructureRotation"); let cls = jni.translate_error_with_class(cls)?;
...
impl<'mc> std::fmt::Display for UsageMode<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> UsageModeTrait<'mc> for UsageMode<'mc> {}
        
        pub trait UsageModeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"SAVE" => Ok(UsageMode::Save { inner: UsageModeStruct::from_raw(env,obj)?}),
"LOAD" => Ok(UsageMode::Load { inner: UsageModeStruct::from_raw(env,obj)?}),
"CORNER" => Ok(UsageMode::Corner { inner: UsageModeStruct::from_raw(env,obj)?}),
"DATA" => Ok(UsageMode::Data { inner: UsageModeStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct UsageModeStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for UsageMode<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate UsageMode from null object.")
                .into());
            }
            ...
            if !valid {
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "SAVE" => Ok(UsageMode::Save { inner: UsageModeStruct::from_raw(env,obj)?}),"LOAD" => Ok(UsageMode::Load { inner: UsageModeStruct::from_raw(env,obj)?}),"CORNER" => Ok(UsageMode::Corner { inner: UsageModeStruct::from_raw(env,obj)?}),"DATA" => Ok(UsageMode::Data { inner: UsageModeStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
impl<'mc> JNIInstantiatable<'mc> for UsageModeStruct<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate UsageModeStruct from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/block/structure/UsageMode")?;
            if !valid {
...
let cls = jni.find_class("org/bukkit/block/structure/UsageMode"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
impl<'mc> std::fmt::Display for Mirror<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
        ...
        impl<'mc> MirrorTrait<'mc> for Mirror<'mc> {}
        
        pub trait MirrorTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"NONE" => Ok(Mirror::None { inner: MirrorStruct::from_raw(env,obj)?}),
"LEFT_RIGHT" => Ok(Mirror::LeftRight { inner: MirrorStruct::from_raw(env,obj)?}),
"FRONT_BACK" => Ok(Mirror::FrontBack { inner: MirrorStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct MirrorStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
match self {
Self::None { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::LeftRight { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::FrontBack { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
}
}
}
impl<'mc> JNIInstantiatable<'mc> for Mirror<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Mirror from null object.")
                .into());
            }
            ...
            if !valid {
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "NONE" => Ok(Mirror::None { inner: MirrorStruct::from_raw(env,obj)?}),"LEFT_RIGHT" => Ok(Mirror::LeftRight { inner: MirrorStruct::from_raw(env,obj)?}),"FRONT_BACK" => Ok(Mirror::FrontBack { inner: MirrorStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
impl<'mc> JNIInstantiatable<'mc> for MirrorStruct<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate MirrorStruct from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/block/structure/Mirror")?;
            if !valid {
...
let cls = jni.find_class("org/bukkit/block/structure/Mirror"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
