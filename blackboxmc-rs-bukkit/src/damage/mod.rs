...
use color_eyre::eyre::Result;/*org/bukkit/damage/mod.rs*/

#[repr(C)]
pub struct DamageSource<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate DamageSource from null object.")
                .into());
            }
...
impl<'mc> DamageSourceTrait<'mc> for DamageSource<'mc> {}
pub trait DamageSourceTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let res = self.jni_ref().call_method(&self.jni_object(),"getDamageType",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::damage::DamageType::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
/// receiver was damaged by a projectile, the projectile would be returned.
	fn direct_entity(&self) 
-> Result<Option<crate::entity::Entity<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/entity/Entity;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDirectEntity",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// be present if an entity did not cause the damage.
	fn damage_location(&self) 
-> Result<Option<crate::Location<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/Location;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDamageLocation",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// returned.
	fn source_location(&self) 
-> Result<Option<crate::Location<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/Location;");
let res = self.jni_ref().call_method(&self.jni_object(),"getSourceLocation",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
let res = self.jni_ref().call_method(&self.jni_object(),"isIndirect",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// Get the amount of hunger exhaustion caused by this damage.
	fn food_exhaustion(&self) 
-> Result<f32, Box<dyn std::error::Error>>

{let sig = String::from("()F");
let res = self.jni_ref().call_method(&self.jni_object(),"getFoodExhaustion",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.f()?
...
/// Gets if this source of damage scales with difficulty.
	fn scales_with_difficulty(&self) 
-> Result<bool, Box<dyn std::error::Error>>

{let sig = String::from("()Z");
let res = self.jni_ref().call_method(&self.jni_object(),"scalesWithDifficulty",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.z()?
...
/// Create a new {@link DamageSource.Builder}.
	fn builder(jni: &blackboxmc_general::SharedJNIEnv<'mc>,damage_type: impl Into<crate::damage::DamageType<'mc>>) 
...
let cls = jni.find_class("org/bukkit/damage/DamageSource"); let cls = jni.translate_error_with_class(cls)?;
...
impl<'mc> std::fmt::Display for DamageScaling<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           DamageScaling::WhenCausedByLivingNonPlayer { .. } => f.write_str("WHEN_CAUSED_BY_LIVING_NON_PLAYER"),
           DamageScaling::Always { .. } => f.write_str("ALWAYS"),
       }
   }
}

        impl<'mc> DamageScalingTrait<'mc> for DamageScaling<'mc> {}
        
        pub trait DamageScalingTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
...
"NEVER" => Ok(DamageScaling::Never { inner: DamageScalingStruct::from_raw(env,obj)?}),
"WHEN_CAUSED_BY_LIVING_NON_PLAYER" => Ok(DamageScaling::WhenCausedByLivingNonPlayer { inner: DamageScalingStruct::from_raw(env,obj)?}),
"ALWAYS" => Ok(DamageScaling::Always { inner: DamageScalingStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct DamageScalingStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::WhenCausedByLivingNonPlayer { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
...
impl<'mc> JNIInstantiatable<'mc> for DamageScaling<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate DamageScaling from null object.")
                .into());
            }
            ...
            if !valid {
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "NEVER" => Ok(DamageScaling::Never { inner: DamageScalingStruct::from_raw(env,obj)?}),"WHEN_CAUSED_BY_LIVING_NON_PLAYER" => Ok(DamageScaling::WhenCausedByLivingNonPlayer { inner: DamageScalingStruct::from_raw(env,obj)?}),"ALWAYS" => Ok(DamageScaling::Always { inner: DamageScalingStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
impl<'mc> JNIInstantiatable<'mc> for DamageScalingStruct<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate DamageScalingStruct from null object.")
                .into());
            }
            let (valid, name) = env.validate_name(&obj, "org/bukkit/damage/DamageScaling")?;
            if !valid {
...
let cls = jni.find_class("org/bukkit/damage/DamageScaling"); let cls = jni.translate_error_with_class(cls)?;
...
#[repr(C)]
pub struct DamageEffect<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for DamageEffect<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate DamageEffect from null object.")
                .into());
            }
...
impl<'mc> DamageEffectTrait<'mc> for DamageEffect<'mc> {}
pub trait DamageEffectTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn get_damage_effect(jni: &blackboxmc_general::SharedJNIEnv<'mc>,key: impl Into<String>) 
...
let cls = jni.find_class("org/bukkit/damage/DamageEffect"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"getDamageEffect",
sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
jni.translate_error(res)?;
let obj = res.l()?;
...
impl<'mc> std::fmt::Display for DeathMessageType<'mc> {
   fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
       match self {
           ...
           DeathMessageType::IntentionalGameDesign { .. } => f.write_str("INTENTIONAL_GAME_DESIGN"),
       }
   }
}

        impl<'mc> DeathMessageTypeTrait<'mc> for DeathMessageType<'mc> {}
        
        pub trait DeathMessageTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc>  {
            fn value_of(
                env: &blackboxmc_general::SharedJNIEnv<'mc>,
                arg0: impl Into<String>,
...
"DEFAULT" => Ok(DeathMessageType::Default { inner: DeathMessageTypeStruct::from_raw(env,obj)?}),
"FALL_VARIANTS" => Ok(DeathMessageType::FallVariants { inner: DeathMessageTypeStruct::from_raw(env,obj)?}),
"INTENTIONAL_GAME_DESIGN" => Ok(DeathMessageType::IntentionalGameDesign { inner: DeathMessageTypeStruct::from_raw(env,obj)?}),
...
#[repr(C)]
pub struct DeathMessageTypeStruct<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
Self::FallVariants { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
Self::IntentionalGameDesign { inner } => unsafe { jni::objects::JObject::from_raw(inner.1.clone()) },
}
}
}
impl<'mc> JNIInstantiatable<'mc> for DeathMessageType<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate DeathMessageType from null object.")
                .into());
            }
            ...
            if !valid {
                ...
                let variant_str = env
                    ...
                    .to_string();
                match variant_str.as_str() {
                    "DEFAULT" => Ok(DeathMessageType::Default { inner: DeathMessageTypeStruct::from_raw(env,obj)?}),"FALL_VARIANTS" => Ok(DeathMessageType::FallVariants { inner: DeathMessageTypeStruct::from_raw(env,obj)?}),"INTENTIONAL_GAME_DESIGN" => Ok(DeathMessageType::IntentionalGameDesign { inner: DeathMessageTypeStruct::from_raw(env,obj)?}),_ => Err(eyre::eyre!("String gaven for variant was invalid").into())}
            }
        }
    }
...
let cls = jni.find_class("org/bukkit/damage/DeathMessageType"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"values",
sig.as_str(),vec![]);
let res = 
jni.translate_error(res)?;
...
#[repr(C)]
pub struct DamageType<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for DamageType<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate DamageType from null object.")
                .into());
            }
...
impl<'mc> DamageTypeTrait<'mc> for DamageType<'mc> {}
pub trait DamageTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {

	fn get_damage_type(jni: &blackboxmc_general::SharedJNIEnv<'mc>,key: impl Into<String>) 
-> Result<crate::damage::DamageType<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/lang/String;)Lorg/bukkit/damage/DamageType;");
let val_1 = jni::objects::JValueGen::Object(jni::objects::JObject::from(jni.new_string(key.into())?));
let cls = jni.find_class("org/bukkit/damage/DamageType"); let cls = jni.translate_error_with_class(cls)?;
let res = jni.call_static_method(cls,"getDamageType",
sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
jni.translate_error(res)?;
let obj = res.l()?;
...
/// Get the {@link DamageScaling} for this damage type.
	fn damage_scaling(&self) 
-> Result<crate::damage::DamageScaling<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/damage/DamageScaling;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDamageScaling",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::damage::DamageScaling::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// Get the {@link DamageEffect} for this damage type.
	fn damage_effect(&self) 
-> Result<crate::damage::DamageEffect<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/damage/DamageEffect;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDamageEffect",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// Get the {@link DeathMessageType} for this damage type.
	fn death_message_type(&self) 
-> Result<crate::damage::DeathMessageType<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("()Lorg/bukkit/damage/DeathMessageType;");
let res = self.jni_ref().call_method(&self.jni_object(),"getDeathMessageType",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::damage::DeathMessageType::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::Keyed::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting DamageType into crate::Keyed")

   }
}
impl<'mc> crate::KeyedTrait<'mc> for DamageType<'mc> {}
impl<'mc> Into<crate::Translatable<'mc>> for DamageType<'mc>{

fn into(self) -> crate::Translatable<'mc> {

crate::Translatable::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting DamageType into crate::Translatable")

   }
}
impl<'mc> crate::TranslatableTrait<'mc> for DamageType<'mc> {}
#[repr(C)]
pub struct DamageSourceBuilder<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for DamageSourceBuilder<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate DamageSourceBuilder from null object.")
                .into());
            }
...
impl<'mc> DamageSourceBuilderTrait<'mc> for DamageSourceBuilder<'mc> {}
pub trait DamageSourceBuilderTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Set the {@link Entity} that caused the damage.
	fn with_causing_entity(&self,entity: impl Into<crate::entity::Entity<'mc>>) 
-> Result<crate::damage::DamageSourceBuilder<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;)Lorg/bukkit/damage/DamageSource/Builder;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"withCausingEntity",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
...
/// Set the {@link Entity} that directly inflicted the damage.
	fn with_direct_entity(&self,entity: impl Into<crate::entity::Entity<'mc>>) 
-> Result<crate::damage::DamageSourceBuilder<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/entity/Entity;)Lorg/bukkit/damage/DamageSource/Builder;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(entity.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"withDirectEntity",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::damage::DamageSourceBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// Set the {@link Location} of the source of damage.
	fn with_damage_location(&self,location: impl Into<crate::Location<'mc>>) 
-> Result<crate::damage::DamageSourceBuilder<'mc>, Box<dyn std::error::Error>>
...
let res = self.jni_ref().call_method(&self.jni_object(),"withDamageLocation",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::damage::DamageSourceBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
