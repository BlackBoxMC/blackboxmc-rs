...
crate::conversations::NumericPrompt::from_raw(&jni,res
	...
	pub fn blocks_for_input(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationContext<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"blocksForInput","(Lorg/bukkit/conversations/ConversationContext;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn accept_input(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationContext<'mc>>,arg1: impl Into<&'mc String>) 
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn get_prompt_text(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationContext<'mc>>) 
-> Result<String, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getPromptText","(Lorg/bukkit/conversations/ConversationContext;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
}
...
if !valid {
	...
	pub fn get_prefix(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationContext<'mc>>) 
-> Result<String, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getPrefix","(Lorg/bukkit/conversations/ConversationContext;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
}
...
let res = jni.new_object(cls,
"(Lorg/bukkit/plugin/Plugin;)V",&[jni::objects::JValueGen::from(&val_0)])?;
crate::conversations::ConversationFactory::from_raw(&jni,res
)}
	pub fn with_prefix(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationPrefix<'mc>>) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>
...
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn with_modality(&mut self,arg0: bool) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"withModality","(Z)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn with_local_echo(&mut self,arg0: bool) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"withLocalEcho","(Z)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn with_timeout(&mut self,arg0: i32) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"withTimeout","(I)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn with_conversation_canceller(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationCanceller<'mc>>) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>
...
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn with_first_prompt(&mut self,arg0: impl Into<&'mc crate::conversations::Prompt<'mc>>) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"withFirstPrompt","(Lorg/bukkit/conversations/Prompt;)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn with_initial_session_data(&mut self,arg0: impl Into<&'mc blackboxmc_java::JavaMap<'mc, javaObject, javaObject>>) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"withInitialSessionData","(Ljava/util/Map;)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn with_escape_sequence(&mut self,arg0: impl Into<&'mc String>) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"withEscapeSequence","(Ljava/lang/String;)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn that_excludes_non_players_with_message(&mut self,arg0: impl Into<&'mc String>) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"thatExcludesNonPlayersWithMessage","(Ljava/lang/String;)Lorg/bukkit/conversations/ConversationFactory;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn add_conversation_abandoned_listener(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationAbandonedListener<'mc>>) 
-> Result<crate::conversations::ConversationFactory<'mc>, Box<dyn std::error::Error>>
...
crate::conversations::ConversationFactory::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn build_conversation(&mut self,arg0: impl Into<&'mc crate::conversations::Conversable<'mc>>) 
-> Result<crate::conversations::Conversation<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"buildConversation","(Lorg/bukkit/conversations/Conversable;)Lorg/bukkit/conversations/Conversation;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::plugin::Plugin<'mc>>,arg1: i32) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/plugin/Plugin;I)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn set_conversation(&mut self,arg0: impl Into<&'mc crate::conversations::Conversation<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setConversation","(Lorg/bukkit/conversations/Conversation;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn cancel_based_on_input(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationContext<'mc>>,arg1: impl Into<&'mc String>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = jni::objects::JObject::from(self.jni_ref().new_string(arg1.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"cancelBasedOnInput","(Lorg/bukkit/conversations/ConversationContext;Ljava/lang/String;)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc String>) 
...
if !valid {
	...
	pub fn is_conversing(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isConversing","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn accept_conversation_input(&mut self,arg0: impl Into<&'mc String>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"acceptConversationInput","(Ljava/lang/String;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn begin_conversation(&mut self,arg0: impl Into<&'mc crate::conversations::Conversation<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"beginConversation","(Lorg/bukkit/conversations/Conversation;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn abandon_conversation_with_conversation(&mut self,arg0: std::option::Option<impl Into<&'mc crate::conversations::Conversation<'mc>>>,arg1: std::option::Option<impl Into<&'mc crate::conversations::ConversationAbandonedEvent<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn send_raw_message_with_string(&mut self,arg0: std::option::Option<u128>,arg1: std::option::Option<impl Into<&'mc String>>) 
-> Result<(), Box<dyn std::error::Error>>
...
let res = self.jni_ref().call_method(&self.jni_object(),"sendRawMessage","(Ljava/util/UUID;Ljava/lang/String;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
}
...
pub struct ConversationConversationState<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
if !valid {
	...
	pub fn new_with_plugin(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::plugin::Plugin<'mc>>,arg1: impl Into<&'mc crate::conversations::Conversable<'mc>>,arg2: std::option::Option<impl Into<&'mc crate::conversations::Prompt<'mc>>>,arg3: std::option::Option<impl Into<&'mc blackboxmc_java::JavaMap<'mc, javaObject, javaObject>>>) 
-> Result<crate::conversations::Conversation<'mc>, Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"begin","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn context(&mut self) 
-> Result<crate::conversations::ConversationContext<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getContext","()Lorg/bukkit/conversations/ConversationContext;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getState","()Lorg/bukkit/conversations/Conversation$ConversationState;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"getPrefix","()Lorg/bukkit/conversations/ConversationPrefix;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationPrefix::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn accept_input(&mut self,arg0: impl Into<&'mc String>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"acceptInput","(Ljava/lang/String;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_modal(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isModal","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn add_conversation_abandoned_listener(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationAbandonedListener<'mc>>) 
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"addConversationAbandonedListener","(Lorg/bukkit/conversations/ConversationAbandonedListener;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_local_echo_enabled(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>

{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setLocalEchoEnabled","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn for_whom(&mut self) 
-> Result<crate::conversations::Conversable<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getForWhom","()Lorg/bukkit/conversations/Conversable;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::Conversable::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn abandon(&mut self,arg0: std::option::Option<impl Into<&'mc crate::conversations::ConversationAbandonedEvent<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"abandon","(Lorg/bukkit/conversations/ConversationAbandonedEvent;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_local_echo_enabled(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"isLocalEchoEnabled","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn cancellers(&mut self) 
-> Result<blackboxmc_java::JavaList<'mc, orgConversationCanceller>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getCancellers","()Ljava/util/List;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaList::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn output_next_prompt(&mut self) 
-> Result<(), Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"outputNextPrompt","()V",&[]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove_conversation_abandoned_listener(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationAbandonedListener<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"removeConversationAbandonedListener","(Lorg/bukkit/conversations/ConversationAbandonedListener;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn conversation_abandoned(&mut self,arg0: impl Into<&'mc crate::conversations::ConversationAbandonedEvent<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"conversationAbandoned","(Lorg/bukkit/conversations/ConversationAbandonedEvent;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
}
...
if !valid {
	...
	pub fn new_with_pattern(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc String>>) 
...
if !valid {
	...
	pub fn new_with_plugin(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::plugin::Plugin<'mc>>>,arg1: std::option::Option<impl Into<&'mc String>>,arg2: std::option::Option<impl Into<&'mc crate::ChatColor<'mc>>>) 
...
let res = jni.new_object(cls,
"(Lorg/bukkit/plugin/Plugin;Ljava/lang/String;Lorg/bukkit/ChatColor;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
{let res = self.jni_ref().call_method(&self.jni_object(),"clone","()Lorg/bukkit/conversations/ConversationCanceller;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<impl Into<String>>) 
...
if !valid {
	...
	pub fn new_with_conversation(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::conversations::Conversation<'mc>>>,arg1: std::option::Option<impl Into<&'mc crate::conversations::ConversationCanceller<'mc>>>) 
...
crate::conversations::ConversationContext::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn canceller(&mut self) 
-> Result<crate::conversations::ConversationCanceller<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getCanceller","()Lorg/bukkit/conversations/ConversationCanceller;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::conversations::ConversationCanceller::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn graceful_exit(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"gracefulExit","()Z",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn to_string(&mut self) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::plugin::Plugin<'mc>>,arg1: impl Into<&'mc crate::conversations::Conversable<'mc>>,arg2: impl Into<&'mc blackboxmc_java::JavaMap<'mc, javaObject, javaObject>>) 
-> Result<crate::conversations::ConversationContext<'mc>, Box<dyn std::error::Error>>
...
let res = jni.new_object(cls,
"(Lorg/bukkit/plugin/Plugin;Lorg/bukkit/conversations/Conversable;Ljava/util/Map;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
crate::conversations::Conversable::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn all_session_data(&mut self) 
-> Result<blackboxmc_java::JavaMap<'mc, javaObject, javaObject>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getAllSessionData","()Ljava/util/Map;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn get_session_data(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"getSessionData","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn set_session_data(&mut self,arg0: jni::objects::JObject<'mc>,arg1: jni::objects::JObject<'mc>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = arg0;
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"setSessionData","(Ljava/lang/Object;Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
