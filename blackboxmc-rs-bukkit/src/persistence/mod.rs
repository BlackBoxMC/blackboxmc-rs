...
use color_eyre::eyre::Result;/*org/bukkit/persistence/mod.rs*/
...
impl<'mc> PersistentDataTypeTrait<'mc> for PersistentDataType<'mc> {}
pub trait PersistentDataTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Returns the primitive data type of this tag.
	fn primitive_type(&self) 
...
/// this method.
	fn to_primitive(&self,complex: jni::objects::JObject<'mc>,context: impl Into<crate::persistence::PersistentDataAdapterContext<'mc>>) 
...
/// Creates a complex object based of the passed primitive value
	fn from_primitive(&self,primitive: jni::objects::JObject<'mc>,context: impl Into<crate::persistence::PersistentDataAdapterContext<'mc>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
impl<'mc> ListPersistentDataTypeTrait<'mc> for ListPersistentDataType<'mc> {}
pub trait ListPersistentDataTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Provides the persistent data type of the elements found in the list.
	fn element_type(&self) 
...
crate::persistence::PersistentDataType::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting ListPersistentDataType into crate::persistence::PersistentDataType")

   }
}
impl<'mc> crate::persistence::PersistentDataTypeTrait<'mc> for ListPersistentDataType<'mc> {}
#[repr(C)]
...
impl<'mc> PersistentDataTypeBooleanPersistentDataTypeTrait<'mc> for PersistentDataTypeBooleanPersistentDataType<'mc> {}
pub trait PersistentDataTypeBooleanPersistentDataTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
unsafe {jni::objects::JClass::from_raw(res.as_jni().l)}
	...
	fn to_primitive(&self,complex: bool,context: impl Into<crate::persistence::PersistentDataAdapterContext<'mc>>) 
-> Result<i8, Box<dyn std::error::Error>>

{let sig = String::from("(Ljava/lang/Boolean;Lorg/bukkit/persistence/PersistentDataAdapterContext;)Ljava/lang/Byte;");
let val_1 = jni::objects::JValueGen::Object(self.jni_ref().new_object("java/lang/Boolean", "(Ljava/Lang/Object;)V", vec![complex.into()])?);
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(context.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"toPrimitive",sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
...
res.b()?
	...
	fn from_primitive(&self,primitive: i8,context: impl Into<crate::persistence::PersistentDataAdapterContext<'mc>>) 
...
crate::persistence::PersistentDataType::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PersistentDataTypeBooleanPersistentDataType into crate::persistence::PersistentDataType")

   }
}
impl<'mc> crate::persistence::PersistentDataTypeTrait<'mc> for PersistentDataTypeBooleanPersistentDataType<'mc> {}
#[repr(C)]
...
impl<'mc> ListPersistentDataTypeProviderTrait<'mc> for ListPersistentDataTypeProvider<'mc> {}
pub trait ListPersistentDataTypeProviderTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
/// for its elements.
	fn list_type_from(&self,element_type: impl Into<crate::persistence::PersistentDataType<'mc>>) 
-> Result<crate::persistence::ListPersistentDataType<'mc>, Box<dyn std::error::Error>>
...
impl<'mc> PersistentDataTypePrimitivePersistentDataTypeTrait<'mc> for PersistentDataTypePrimitivePersistentDataType<'mc> {}
pub trait PersistentDataTypePrimitivePersistentDataTypeTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
crate::persistence::PersistentDataType::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting PersistentDataTypePrimitivePersistentDataType into crate::persistence::PersistentDataType")

   }
}
impl<'mc> crate::persistence::PersistentDataTypeTrait<'mc> for PersistentDataTypePrimitivePersistentDataType<'mc> {}
#[repr(C)]
...
impl<'mc> PersistentDataHolderTrait<'mc> for PersistentDataHolder<'mc> {}
pub trait PersistentDataHolderTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
impl<'mc> PersistentDataContainerTrait<'mc> for PersistentDataContainer<'mc> {}
pub trait PersistentDataContainerTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
/// key.
	fn set(&self,key: impl Into<crate::NamespacedKey<'mc>>,val_type: impl Into<crate::persistence::PersistentDataType<'mc>>,value: jni::objects::JObject<'mc>) 
-> Result<(), Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/NamespacedKey;Lorg/bukkit/persistence/PersistentDataType;LC;)V");
...
/// using your namespace.
	fn has(&self,key: impl Into<crate::NamespacedKey<'mc>>,val_type: std::option::Option<impl Into<crate::persistence::PersistentDataType<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
/// {@link PersistentDataHolder} instance.
	fn get(&self,key: impl Into<crate::NamespacedKey<'mc>>,val_type: impl Into<crate::persistence::PersistentDataType<'mc>>) 
-> Result<Option<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/NamespacedKey;Lorg/bukkit/persistence/PersistentDataType;)LC;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(key.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(val_type.into().jni_object().clone())});
...
/// container, the default value provided is returned.
	fn get_or_default(&self,key: impl Into<crate::NamespacedKey<'mc>>,val_type: impl Into<crate::persistence::PersistentDataType<'mc>>,default_value: jni::objects::JObject<'mc>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/NamespacedKey;Lorg/bukkit/persistence/PersistentDataType;LC;)LC;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(key.into().jni_object().clone())});
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(val_type.into().jni_object().clone())});
...
/// Removes a custom key from the {@link PersistentDataHolder} instance.
	fn remove(&self,key: impl Into<crate::NamespacedKey<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
/// name, will not be copied as the values are stored using your namespace.
	fn copy_to(&self,other: impl Into<crate::persistence::PersistentDataContainer<'mc>>,replace: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc> PersistentDataAdapterContextTrait<'mc> for PersistentDataAdapterContext<'mc> {}
pub trait PersistentDataAdapterContextTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
/// Creates a new and empty meta container instance.
	fn new_persistent_data_container(&self) 
-> Result<crate::persistence::PersistentDataContainer<'mc>, Box<dyn std::error::Error>>
