...
#[deprecated]
	...
	pub fn new_with_type(jni: &blackboxmc_general::SharedJNIEnv<'mc>,val_type: impl Into<crate::potion::PotionType<'mc>>,level: std::option::Option<i32>,splash: std::option::Option<bool>,extended: std::option::Option<bool>) 
...
crate::potion::Potion::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn apply_with_to(&self,to: impl Into<crate::entity::LivingEntity<'mc>>) 
...
crate::potion::PotionType::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn has_extended_duration(&self) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn set_has_extended_duration(&self,is_extended: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn set_splash(&self,is_splash: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
()
	...
	pub fn set_type(&self,val_type: impl Into<crate::potion::PotionType<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
res.s()?
	...
	pub fn to_item_stack(&self,amount: i32) 
...
crate::inventory::ItemStack::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn from_damage(jni: &blackboxmc_general::SharedJNIEnv<'mc>,damage: i32) 
-> Result<crate::potion::Potion<'mc>, Box<dyn std::error::Error>>
...
crate::potion::Potion::from_raw(&jni,obj
	...
	pub fn from_item_stack(jni: &blackboxmc_general::SharedJNIEnv<'mc>,item: impl Into<crate::inventory::ItemStack<'mc>>) 
-> Result<crate::potion::Potion<'mc>, Box<dyn std::error::Error>>
...
crate::potion::Potion::from_raw(&jni,obj
	...
	pub fn brewer(jni: &blackboxmc_general::SharedJNIEnv<'mc>) 
...
crate::potion::PotionBrewer::from_raw(&jni,obj
	...
	pub fn set_potion_brewer(jni: &blackboxmc_general::SharedJNIEnv<'mc>,other: impl Into<crate::potion::PotionBrewer<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::potion::PotionEffectType::from_raw(&self.jni_ref(), self.1).expect("Error converting PotionEffectTypeWrapper into crate::potion::PotionEffectType")
...
impl<'mc> PotionBrewer<'mc> {
	pub fn create_effect(&self,potion: impl Into<crate::potion::PotionEffectType<'mc>>,duration: i32,amplifier: i32) 
-> Result<crate::potion::PotionEffect<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/potion/PotionEffectType;II)Lcrate::potion::PotionEffect;");
...
#[deprecated]
	...
	pub fn get_effects_from_damage(&self,damage: i32) 
-> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>
...
#[deprecated]
	...
	pub fn get_effects(&self,val_type: impl Into<crate::potion::PotionType<'mc>>,upgraded: bool,extended: bool) 
-> Result<Vec<jni::objects::JObject<'mc>>, Box<dyn std::error::Error>>
...
impl<'mc> PotionData<'mc> {
	pub fn new_with_type(jni: &blackboxmc_general::SharedJNIEnv<'mc>,val_type: impl Into<crate::potion::PotionType<'mc>>,extended: std::option::Option<bool>,upgraded: std::option::Option<bool>) 
...
#[deprecated]
	...
	pub fn get_by_effect(jni: &blackboxmc_general::SharedJNIEnv<'mc>,effect_type: impl Into<crate::potion::PotionEffectType<'mc>>) 
...
impl<'mc> PotionEffect<'mc> {
	pub fn new_with_type(jni: &blackboxmc_general::SharedJNIEnv<'mc>,val_type: impl Into<crate::potion::PotionEffectType<'mc>>,duration: std::option::Option<i32>,amplifier: std::option::Option<i32>,ambient: std::option::Option<bool>,particles: std::option::Option<bool>,icon: std::option::Option<bool>) 
-> Result<crate::potion::PotionEffect<'mc>, Box<dyn std::error::Error>>
...
blackboxmc_java::util::JavaMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn apply(&self,entity: impl Into<crate::entity::LivingEntity<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
res.z()?
	...
	pub fn is_shorter_than(&self,other: impl Into<crate::potion::PotionEffect<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
crate::Keyed::from_raw(&self.jni_ref(), self.1).expect("Error converting PotionEffectType into crate::Keyed")
...
crate::Translatable::from_raw(&self.jni_ref(), self.1).expect("Error converting PotionEffectType into crate::Translatable")
