...
blackboxmc_java::util::JavaMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn get_structure(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>) 
...
crate::structure::Structure::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn register_structure(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>,structure: impl Into<crate::structure::Structure<'mc>>) 
-> Result<Option<crate::structure::Structure<'mc>>, Box<dyn std::error::Error>>
...
crate::structure::Structure::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn unregister_structure(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>) 
-> Result<Option<crate::structure::Structure<'mc>>, Box<dyn std::error::Error>>
...
crate::structure::Structure::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn load_structure_with_structure_key(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>,register: std::option::Option<bool>) 
-> Result<Option<crate::structure::Structure<'mc>>, Box<dyn std::error::Error>>
...
crate::structure::Structure::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn delete_structure_with_structure_key(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>,unregister: std::option::Option<bool>) 
...
crate::structure::Structure::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn copy(&self,structure: impl Into<crate::structure::Structure<'mc>>) 
-> Result<crate::structure::Structure<'mc>, Box<dyn std::error::Error>>
...
res.i()?
	...
	pub fn fill_with_origin(&self,origin: impl Into<crate::Location<'mc>>,size: impl Into<crate::util::BlockVector<'mc>>,include_entities: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
crate::persistence::PersistentDataHolder::from_raw(&self.jni_ref(), self.1).expect("Error converting Structure into crate::persistence::PersistentDataHolder")
