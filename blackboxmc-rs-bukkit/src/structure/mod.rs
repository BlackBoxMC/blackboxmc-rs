...
use color_eyre::eyre::Result;/*org/bukkit/structure/mod.rs*/

#[repr(C)]
pub struct StructureManager<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
        ...
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate StructureManager from null object.")
                .into());
            }
...
impl<'mc> StructureManagerTrait<'mc> for StructureManager<'mc> {}
pub trait StructureManagerTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let res = self.jni_ref().call_method(&self.jni_object(),"getStructures",sig.as_str(),vec![]);
let res = 
...
/// Gets a registered Structure.
	fn get_structure(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>) 
...
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(structure_key.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"getStructure",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
Some(
crate::structure::Structure::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)?
)
)}
/// Registers the given structure. See {@link #getStructures()}.
	fn register_structure(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>,structure: impl Into<crate::structure::Structure<'mc>>) 
-> Result<Option<crate::structure::Structure<'mc>>, Box<dyn std::error::Error>>
...
let res = self.jni_ref().call_method(&self.jni_object(),"registerStructure",sig.as_str(),vec![jni::objects::JValueGen::from(val_1),jni::objects::JValueGen::from(val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// when it is requested by a plugin or the server itself.
	fn unregister_structure(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>) 
-> Result<Option<crate::structure::Structure<'mc>>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/NamespacedKey;)Lorg/bukkit/structure/Structure;");
let val_1 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(structure_key.into().jni_object().clone())});
let res = self.jni_ref().call_method(&self.jni_object(),"unregisterStructure",sig.as_str(),vec![jni::objects::JValueGen::from(val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// {@link #getStructureFile(NamespacedKey)}.
	fn load_structure(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>,register: std::option::Option<bool>) 
-> Result<Option<crate::structure::Structure<'mc>>, Box<dyn std::error::Error>>
...
let res = self.jni_ref().call_method(&self.jni_object(),"loadStructure",sig.as_str(),args);
let res = 
self.jni_ref().translate_error(res)?;
if unsafe { jni::objects::JObject::from_raw(res.as_jni().l) }.is_null() {return Ok(None);}
Ok(
...
/// work fine.
	fn delete_structure(&self,structure_key: impl Into<crate::NamespacedKey<'mc>>,unregister: std::option::Option<bool>) 
...
sig += ")V";
let res = self.jni_ref().call_method(&self.jni_object(),"deleteStructure",sig.as_str(),args);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"createStructure",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
crate::structure::Structure::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
/// Creates a copy of this structure.
	fn copy(&self,structure: impl Into<crate::structure::Structure<'mc>>) 
-> Result<crate::structure::Structure<'mc>, Box<dyn std::error::Error>>

{let sig = String::from("(Lorg/bukkit/structure/Structure;)Lorg/bukkit/structure/Structure;");
...
#[repr(C)]
pub struct Palette<'mc>(pub(crate) blackboxmc_general::SharedJNIEnv<'mc>, pub(crate) jni::objects::JObject<'mc>);
...
impl<'mc> JNIInstantiatable<'mc> for Palette<'mc> {
        fn from_raw(
            ...
            if obj.is_null() {
                return Err(eyre::eyre!(
                    "Tried to instantiate Palette from null object.")
                .into());
            }
...
impl<'mc> PaletteTrait<'mc> for Palette<'mc> {}
pub trait PaletteTrait<'mc>: blackboxmc_general::JNIRaw<'mc> + blackboxmc_general::JNIInstantiatable<'mc> {
...
let res = self.jni_ref().call_method(&self.jni_object(),"getBlockCount",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
{let sig = String::from("()Ljava/util/List;");
let res = self.jni_ref().call_method(&self.jni_object(),"getPalettes",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
let mut new_vec = Vec::new();
let list = blackboxmc_java::util::JavaList::from_raw(&self.jni_ref(), res.l()?)?;let iter = list.iterator()?;
...
/// Gets the number of palettes in this structure.
	fn palette_count(&self) 
-> Result<i32, Box<dyn std::error::Error>>

{let sig = String::from("()I");
let res = self.jni_ref().call_method(&self.jni_object(),"getPaletteCount",sig.as_str(),vec![]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(
res.i()?
...
/// API however will still work.
	fn fill(&self,origin: impl Into<crate::Location<'mc>>,size: impl Into<crate::util::BlockVector<'mc>>,include_entities: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
let val_2 = jni::objects::JValueGen::Object(unsafe { jni::objects::JObject::from_raw(size.into().jni_object().clone())});
args.push(val_2);
sig += "Z";
let val_3 = jni::objects::JValueGen::Bool(include_entities.into());
args.push(val_3);
sig += ")V";
let res = self.jni_ref().call_method(&self.jni_object(),"fill",sig.as_str(),args);
self.jni_ref().translate_error(res)?;
Ok(
()
)}
...
crate::persistence::PersistentDataHolder::from_raw(&self.jni_ref(), self.jni_object()).expect("Error converting Structure into crate::persistence::PersistentDataHolder")

   }
}
impl<'mc> crate::persistence::PersistentDataHolderTrait<'mc> for Structure<'mc> {}
