...
impl<'mc> JavaIntUnaryOperator<'mc> {
    ...
    pub fn and_then(
        &self,
        arg0: impl Into<crate::function::JavaIntUnaryOperator<'mc>>,
...
impl<'mc> JavaFunction<'mc> {
    ...
    ) -> Result<crate::function::JavaFunction<'mc>, Box<dyn std::error::Error>> {
...
impl<'mc> JavaUnaryOperator<'mc> {
    ...
    pub fn identity(
        jni: &blackboxmc_general::SharedJNIEnv<'mc>,
    ) -> Result<crate::function::JavaUnaryOperator<'mc>, Box<dyn std::error::Error>> {
...
impl<'mc> Into<crate::function::JavaFunction<'mc>> for JavaUnaryOperator<'mc> {
    fn into(self) -> crate::function::JavaFunction<'mc> {
        crate::function::JavaFunction::from_raw(&self.jni_ref(), self.1)
            .expect("Error converting JavaUnaryOperator into crate::function::JavaFunction")
    }
}
...
impl<'mc> JavaBinaryOperator<'mc> {
    ...
    ) -> Result<crate::function::JavaBinaryOperator<'mc>, Box<dyn std::error::Error>> {
    ...
    pub fn and_then(
        &self,
        arg0: impl Into<crate::function::JavaFunction<'mc>>,
    ) -> Result<crate::function::JavaBiFunction<'mc>, Box<dyn std::error::Error>> {
...
impl<'mc> Into<crate::function::JavaBiFunction<'mc>> for JavaBinaryOperator<'mc> {
    fn into(self) -> crate::function::JavaBiFunction<'mc> {
        crate::function::JavaBiFunction::from_raw(&self.jni_ref(), self.1)
            .expect("Error converting JavaBinaryOperator into crate::function::JavaBiFunction")
    }
}
...
impl<'mc> JavaDoubleUnaryOperator<'mc> {
    ...
    pub fn and_then(
        &self,
        arg0: impl Into<crate::function::JavaDoubleUnaryOperator<'mc>>,
...
impl<'mc> JavaIntPredicate<'mc> {
    ...
    pub fn or(
        &self,
        arg0: impl Into<crate::function::JavaIntPredicate<'mc>>,
...
impl<'mc> JavaDoublePredicate<'mc> {
    ...
    pub fn or(
        &self,
        arg0: impl Into<crate::function::JavaDoublePredicate<'mc>>,
...
impl<'mc> JavaLongPredicate<'mc> {
    ...
    pub fn or(
        &self,
        arg0: impl Into<crate::function::JavaLongPredicate<'mc>>,
...
impl<'mc> JavaLongUnaryOperator<'mc> {
    ...
    pub fn and_then(
        &self,
        arg0: impl Into<crate::function::JavaLongUnaryOperator<'mc>>,
...
impl<'mc> JavaBiConsumer<'mc> {
    ...
    ) -> Result<crate::function::JavaBiConsumer<'mc>, Box<dyn std::error::Error>> {
...
impl<'mc> JavaBiPredicate<'mc> {
    ...
    pub fn or(
        &self,
        arg0: impl Into<crate::function::JavaBiPredicate<'mc>>,
    ) -> Result<crate::function::JavaBiPredicate<'mc>, Box<dyn std::error::Error>> {
        let sig =
