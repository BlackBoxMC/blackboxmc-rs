...
let res = self.jni_ref().call_method(&self.jni_object(),"setLocale","(Ljava/util/Locale;)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
...
let res = self.jni_ref().call_method(&self.jni_object(),"setTimeOfDay","(IIII)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"setDate","(III)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setTimeZone","(Ljava/util/TimeZone;)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"setLenient","(Z)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = jni::objects::JValueGen::Int(arg2.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setWeekDate","(III)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"setInstant","(Ljava/util/Date;)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setWeekDefinition","(II)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"setCalendarType","(Ljava/lang/String;)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let res = self.jni_ref().call_method(&self.jni_object(),"set","(II)Ljava/util/Calendar$Builder;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaCalendarBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let res = jni.new_object(cls,
"(I)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"add","(ILjava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"remove","(I)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"get","(I)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"indexOf","(Ljava/lang/Object;)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"lastIndexOf","(Ljava/lang/Object;)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn replace_all(&mut self,arg0: impl Into<&'mc crate::function::JavaUnaryOperator<'mc, E>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"replaceAll","(Ljava/util/function/UnaryOperator;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let res = self.jni_ref().call_method(&self.jni_object(),"subList","(II)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"contains","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
let res = self.jni_ref().call_method(&self.jni_object(),"addAll","(ILjava/util/Collection;)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"set","(ILjava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn for_each(&mut self,arg0: impl Into<&'mc crate::function::JavaConsumer<'mc, E>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"forEach","(Ljava/util/function/Consumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"ensureCapacity","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove_if(&mut self,arg0: impl Into<&'mc crate::function::JavaPredicate<'mc, E>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"removeIf","(Ljava/util/function/Predicate;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"sort","(Ljava/util/Comparator;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove_all(&mut self,arg0: impl Into<&'mc crate::JavaCollection<'mc, dyn JNIRaw<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"removeAll","(Ljava/util/Collection;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn retain_all(&mut self,arg0: impl Into<&'mc crate::JavaCollection<'mc, dyn JNIRaw<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"retainAll","(Ljava/util/Collection;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn list_iterator(&mut self,arg0: std::option::Option<i32>) 
-> Result<crate::JavaListIterator<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"listIterator","(I)Ljava/util/ListIterator;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn contains_all(&mut self,arg0: impl Into<&'mc crate::JavaCollection<'mc, dyn JNIRaw<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"containsAll","(Ljava/util/Collection;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
-> Result<crate::stream::JavaStream<'mc, E>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"stream","()Ljava/util/stream/Stream;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn parallel_stream(&mut self) 
-> Result<crate::stream::JavaStream<'mc, E>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"parallelStream","()Ljava/util/stream/Stream;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
}
impl<'mc, E> Into<crate::JavaList<'mc>> for JavaArrayList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaList<'mc, E> {
       crate::JavaList::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaRandomAccess<'mc>> for JavaArrayList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaRandomAccess<'mc, E> {
       crate::JavaRandomAccess::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractList<'mc>> for JavaArrayList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractList<'mc> {
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"handleGetObject","(Ljava/lang/String;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn get_bundle_with_string(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc String>,arg1: impl Into<&'mc crate::JavaLocale<'mc>>,arg2: impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>,arg3: std::option::Option<impl Into<&'mc crate::JavaResourceBundleControl<'mc>>>) 
...
let res = jni.call_static_method(cls,"getBundle",
"(Ljava/lang/String;Ljava/util/Locale;Ljava/lang/ClassLoader;Ljava/util/ResourceBundle$Control;)Ljava/util/ResourceBundle;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
let mut obj = res.l()?;
crate::JavaResourceBundle::from_raw(&jni,obj
)}
	pub fn get_string(&mut self,arg0: impl Into<&'mc String>) 
-> Result<String, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"getString","(Ljava/lang/String;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn clear_cache(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"clearCache",
"(Ljava/lang/ClassLoader;)V",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(())}
	pub fn contains_key(&mut self,arg0: impl Into<&'mc String>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"containsKey","(Ljava/lang/String;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"getObject","(Ljava/lang/String;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
let val_1 = arg1.unwrap();
let res = self.jni_ref().call_method(&self.jni_object(),"remove","(Ljava/lang/Object;Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"get","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = arg0;
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"put","(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
-> Result<crate::JavaCollection<'mc, V>, Box<dyn std::error::Error>>
...
-> Result<crate::JavaSet<'mc, javaMapEntry<K, V>, Box<dyn std::error::Error>>
...
crate::JavaSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn put_all(&mut self,arg0: impl Into<&'mc crate::JavaMap<'mc, K>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"putAll","(Ljava/util/Map;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"containsKey","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn key_set(&mut self) 
-> Result<crate::JavaSet<'mc, K>, Box<dyn std::error::Error>>
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"containsValue","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
let res = self.jni_ref().call_method(&self.jni_object(),"replace","(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn replace_all(&mut self,arg0: impl Into<&'mc crate::function::JavaBiFunction<'mc, K>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"replaceAll","(Ljava/util/function/BiFunction;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn merge(&mut self,arg0: K,arg1: V,arg2: impl Into<&'mc crate::function::JavaBiFunction<'mc, V>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let val_1 = arg1;
let val_2 = unsafe { jni::objects::JObject::from_raw(arg2.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"merge","(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = arg0;
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"putIfAbsent","(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn compute(&mut self,arg0: K,arg1: impl Into<&'mc crate::function::JavaBiFunction<'mc, K>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"compute","(Ljava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn for_each(&mut self,arg0: impl Into<&'mc crate::function::JavaBiConsumer<'mc, K>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"forEach","(Ljava/util/function/BiConsumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn compute_if_absent(&mut self,arg0: K,arg1: impl Into<&'mc crate::function::JavaFunction<'mc, K>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"computeIfAbsent","(Ljava/lang/Object;Ljava/util/function/Function;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = arg0;
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"getOrDefault","(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn compute_if_present(&mut self,arg0: K,arg1: impl Into<&'mc crate::function::JavaBiFunction<'mc, K>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"computeIfPresent","(Ljava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
}
impl<'mc, K,V> Into<crate::JavaMap<'mc>> for JavaAbstractMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
...
-> Result<crate::JavaTreeSet<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/TreeSet")?;
let res = jni.new_object(cls,
"(Ljava/util/SortedSet;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let cls = &jni.find_class("java/util/TreeSet")?;
let res = jni.new_object(cls,
"(Ljava/util/Comparator;)V",&[jni::objects::JValueGen::from(&val_0)])?;
crate::JavaTreeSet::from_raw(&jni,res
)}
...
let res = 
self.jni_ref().translate_error(res)?;
E::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
let res = self.jni_ref().call_method(&self.jni_object(),"subSet","(Ljava/lang/Object;ZLjava/lang/Object;Z)Ljava/util/NavigableSet;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)]);
let res = 
self.jni_ref().translate_error(res)?;
...
// 0
let val_1 = jni::objects::JValueGen::Bool(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"headSet","(Ljava/lang/Object;Z)Ljava/util/NavigableSet;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaNavigableSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
// 0
let val_1 = jni::objects::JValueGen::Bool(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"tailSet","(Ljava/lang/Object;Z)Ljava/util/NavigableSet;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaNavigableSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"ceiling","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"higher","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"add","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"remove","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn clone(&mut self) 
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"floor","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn clear(&mut self) 
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"addAll","(Ljava/util/Collection;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"lower","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
impl<'mc, E> Into<crate::JavaNavigableSet<'mc>> for JavaTreeSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaNavigableSet<'mc, E> {
       crate::JavaNavigableSet::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractSet<'mc>> for JavaTreeSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractSet<'mc> {
...
-> Result<crate::JavaSet<'mc, javaCurrency>, Box<dyn std::error::Error>>
...
"(Ljava/util/Locale;)Ljava/util/Currency;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
-> Result<crate::JavaVector<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/Vector")?;
let res = jni.new_object(cls,
"(Ljava/util/Collection;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let cls = &jni.find_class("java/util/Vector")?;
let res = jni.new_object(cls,
"(II)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::JavaVector::from_raw(&jni,res
)}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"removeElementAt","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"removeElement","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let res = self.jni_ref().call_method(&self.jni_object(),"insertElementAt","(Ljava/lang/Object;I)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = arg0;
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setElementAt","(Ljava/lang/Object;I)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSize","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn add_with_object(&mut self,arg0: std::option::Option<i32>,arg1: std::option::Option<E>) 
-> Result<(), Box<dyn std::error::Error>>
...
{let val_0 = arg0.unwrap();
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"indexOf","(Ljava/lang/Object;I)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn clear(&mut self) 
...
{let val_0 = arg0.unwrap();
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"lastIndexOf","(Ljava/lang/Object;I)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn is_empty(&mut self) 
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"elementAt","(I)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn remove_if(&mut self,arg0: impl Into<&'mc crate::function::JavaPredicate<'mc, E>>) 
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"addElement","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaList<'mc>> for JavaVector<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaList<'mc, E> {
       crate::JavaList::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaRandomAccess<'mc>> for JavaVector<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaRandomAccess<'mc, E> {
       crate::JavaRandomAccess::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractList<'mc>> for JavaVector<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractList<'mc> {
       crate::JavaAbstractList::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
if !valid {
	...
	pub fn new_with_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaEnumMap<'mc, V>>>) 
-> Result<crate::JavaEnumMap<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/EnumMap")?;
let res = jni.new_object(cls,
"(Ljava/util/EnumMap;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let cls = &jni.find_class("java/util/EnumMap")?;
let res = jni.new_object(cls,
"(Ljava/lang/Class;)V",&[jni::objects::JValueGen::from(&val_0)])?;
crate::JavaEnumMap::from_raw(&jni,res
)}
	pub fn remove_with_object(&mut self,arg0: std::option::Option<jni::objects::JObject<'mc>>,arg1: std::option::Option<jni::objects::JObject<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
impl<'mc, K> Into<crate::JavaAbstractMap<'mc>> for JavaEnumMap<'mc, K> where K: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractMap<'mc> {
...
if !valid {
	...
	pub fn new_with_char_sequence(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc blackboxmc_java::JavaCharSequence<'mc>>>,arg1: std::option::Option<impl Into<&'mc blackboxmc_java::JavaCharSequence<'mc>>>,arg2: std::option::Option<impl Into<&'mc blackboxmc_java::JavaCharSequence<'mc>>>) 
...
let cls = &jni.find_class("java/util/StringJoiner")?;
let res = jni.new_object(cls,
"(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::JavaStringJoiner::from_raw(&jni,res
)}
	pub fn set_empty_value(&mut self,arg0: impl Into<&'mc blackboxmc_java::JavaCharSequence<'mc>>) 
-> Result<crate::JavaStringJoiner<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setEmptyValue","(Ljava/lang/CharSequence;)Ljava/util/StringJoiner;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaStringJoiner::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn add(&mut self,arg0: impl Into<&'mc blackboxmc_java::JavaCharSequence<'mc>>) 
-> Result<crate::JavaStringJoiner<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"add","(Ljava/lang/CharSequence;)Ljava/util/StringJoiner;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaStringJoiner::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"merge","(Ljava/util/StringJoiner;)Ljava/util/StringJoiner;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaStringJoiner::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn try_advance_with_consumer(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaIntConsumer<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"tryAdvance","(Ljava/util/function/IntConsumer;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0.unwrap();
let res = self.jni_ref().call_method(&self.jni_object(),"tryAdvance","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0.unwrap();
let res = self.jni_ref().call_method(&self.jni_object(),"forEachRemaining","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn for_each_remaining_with_int_consumer(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaIntConsumer<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"forEachRemaining","(Ljava/util/function/IntConsumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"hasCharacteristics","(I)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn comparator(&mut self) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaLocale<'mc>>>) 
-> Result<crate::JavaGregorianCalendar<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/GregorianCalendar")?;
let res = jni.new_object(cls,
"(Ljava/util/Locale;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let cls = &jni.find_class("java/util/GregorianCalendar")?;
let res = jni.new_object(cls,
"(III)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::JavaGregorianCalendar::from_raw(&jni,res
)}
...
let cls = &jni.find_class("java/util/GregorianCalendar")?;
let res = jni.new_object(cls,
"(IIIIII)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
crate::JavaGregorianCalendar::from_raw(&jni,res
)}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"isLeapYear","(I)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setTimeZone","(Ljava/util/TimeZone;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn roll_with_int(&mut self,arg0: i32,arg1: std::option::Option<bool>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.into());
// 1
let val_1 = jni::objects::JValueGen::Bool(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"roll","(IZ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"getGreatestMinimum","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"getLeastMaximum","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = jni::objects::JValueGen::Int(arg2.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setWeekDate","(III)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"getActualMinimum","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"getActualMaximum","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setGregorianChange","(Ljava/util/Date;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let res = self.jni_ref().call_method(&self.jni_object(),"add","(II)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"getMinimum","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"getMaximum","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setTime","(Ljava/util/Date;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = unsafe { jni::objects::JObject::from_raw(arg2.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getDisplayName","(IILjava/util/Locale;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
let res = self.jni_ref().call_method(&self.jni_object(),"setTimeInMillis","(J)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn set_lenient(&mut self,arg0: bool) 
-> Result<(), Box<dyn std::error::Error>>
...
{// -2
let val_0 = jni::objects::JValueGen::Bool(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setLenient","(Z)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = unsafe { jni::objects::JObject::from_raw(arg2.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getDisplayNames","(IILjava/util/Locale;)Ljava/util/Map;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setFirstDayOfWeek","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setMinimalDaysInFirstWeek","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"get","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn to_string(&mut self) 
...
{let val_0 = arg0.unwrap();
let res = self.jni_ref().call_method(&self.jni_object(),"compareTo","(Ljava/lang/Object;)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"clear","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
let val_4 = jni::objects::JValueGen::Int(arg4.unwrap().into());
let val_5 = jni::objects::JValueGen::Int(arg5.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"set","(IIIIII)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"isSet","(I)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"before","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"after","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
if !valid {
	...
	pub fn load_installed(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: jni::objects::JClass<'mc>) 
-> Result<crate::JavaServiceLoader<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let cls = &jni.find_class("java/util/ServiceLoader")?;
let res = jni.call_static_method(cls,"loadInstalled",
"(Ljava/lang/Class;)Ljava/util/ServiceLoader;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn load_with_class(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: jni::objects::JClass<'mc>,arg1: std::option::Option<impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>>) 
-> Result<crate::JavaServiceLoader<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/ServiceLoader")?;
let res = jni.call_static_method(cls,"load",
"(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/ServiceLoader;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaServiceLoader::from_raw(&jni,obj
)}
	pub fn iterator(&mut self) 
-> Result<crate::JavaIterator<'mc, S>, Box<dyn std::error::Error>>
...
crate::JavaIterator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn stream(&mut self) 
-> Result<crate::stream::JavaStream<'mc, javaServiceLoaderProvider<S>, Box<dyn std::error::Error>>
...
let res = jni.new_object(cls,
"(JJJJ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn accept_with_long(&mut self,arg0: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"accept","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"combine","(Ljava/util/LongSummaryStatistics;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn min(&mut self) 
-> Result<i64, Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn and_then_with_long_consumer(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaIntConsumer<'mc>>>) 
-> Result<crate::function::JavaIntConsumer<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"andThen","(Ljava/util/function/IntConsumer;)Ljava/util/function/IntConsumer;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::function::JavaIntConsumer::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
}
impl<'mc> Into<crate::function::JavaLongConsumer<'mc>> for JavaLongSummaryStatistics<'mc>{
   fn into(self) -> crate::function::JavaLongConsumer<'mc> {
       crate::function::JavaLongConsumer::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc> Into<crate::function::JavaIntConsumer<'mc>> for JavaLongSummaryStatistics<'mc>{
...
crate::JavaTimeZone::from_raw(&jni,res
	...
	pub fn get_time_zone_with_zone_id(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc String>>) 
-> Result<crate::JavaTimeZone<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(jni.new_string(arg0.unwrap().into()).unwrap());
let cls = &jni.find_class("java/util/TimeZone")?;
let res = jni.call_static_method(cls,"getTimeZone",
"(Ljava/lang/String;)Ljava/util/TimeZone;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"getDisplayName","(ZI)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = unsafe { jni::objects::JObject::from_raw(arg2.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getDisplayName","(ZILjava/util/Locale;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
"(Ljava/util/TimeZone;)V",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(())}
	pub fn id(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"hasSameRules","(Ljava/util/TimeZone;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"inDaylightTime","(Ljava/util/Date;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setID","(Ljava/lang/String;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setRawOffset","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
let val_4 = jni::objects::JValueGen::Int(arg4.unwrap().into());
let val_5 = jni::objects::JValueGen::Int(arg5.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"getOffset","(IIIIII)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
let res = jni.new_object(cls,
"(Ljava/lang/Object;Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
let res = 
self.jni_ref().translate_error(res)?;
V::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn key(&mut self) 
...
let res = 
self.jni_ref().translate_error(res)?;
K::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn set_value(&mut self,arg0: V) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"setValue","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
impl<'mc, K,V> Into<crate::JavaMapEntry<'mc>> for JavaAbstractMapSimpleImmutableEntry<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaMapEntry<'mc, K,V> {
...
{let val_0 = arg0;
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"subMap","(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/SortedMap;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"headMap","(Ljava/lang/Object;)Ljava/util/SortedMap;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaSortedMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"tailMap","(Ljava/lang/Object;)Ljava/util/SortedMap;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaSortedMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::JavaSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn comparator(&mut self) 
-> Result<crate::JavaComparator<'mc, K>, Box<dyn std::error::Error>>
...
impl<'mc, K,V> Into<crate::JavaMap<'mc>> for JavaSortedMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaMap<'mc, K,V> {
       crate::JavaMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
if !valid {
	...
	pub fn equals_with_object(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<f32>>,arg1: std::option::Option<Vec<f32>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
"(FF)Z",&[])?;
Ok(res.z().unwrap())}
	pub fn equals_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<bool>,arg1: std::option::Option<Vec<bool>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("boolean")?;
let res = jni.call_static_method(cls,"equals",
"(Ljava/lang/Object;IILjava/lang/Object;IILjava/util/Comparator;)Z",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6)])?;
Ok(res.z().unwrap())}
	pub fn equals_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: std::option::Option<Vec<i64>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
"(CC)Z",&[])?;
Ok(res.z().unwrap())}
	pub fn equals_with_booleans(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: i32,arg3: Vec<jni::objects::JObject<'mc>>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<bool, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("boolean")?;
let res = jni.call_static_method(cls,"equals",
"(Ljava/lang/Object;IILjava/lang/Object;II)Z",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.z().unwrap())}
	pub fn equals_with_floats(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i32>,arg1: i32,arg2: i32,arg3: Vec<i32>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<bool, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("boolean")?;
let res = jni.call_static_method(cls,"equals",
"(IIIIII)Z",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.z().unwrap())}
	pub fn equals_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i8>,arg1: i32,arg2: i32,arg3: Vec<i8>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<bool, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("boolean")?;
let res = jni.call_static_method(cls,"equals",
"(BIIBII)Z",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.z().unwrap())}
...
let cls = &jni.find_class("boolean")?;
let res = jni.call_static_method(cls,"equals",
"(SIISII)Z",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.z().unwrap())}
	pub fn to_string(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<bool>>) 
-> Result<String, Box<dyn std::error::Error>>
...
Ok(jni.get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn to_string_with_bytes(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<u16>>) 
-> Result<String, Box<dyn std::error::Error>>
...
"(I)Ljava/lang/String;",&[])?;
Ok(jni.get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn to_string_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<f64>>) 
-> Result<String, Box<dyn std::error::Error>>
...
"(D)Ljava/lang/String;",&[])?;
Ok(jni.get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn to_string_with_floats(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<f32>>) 
-> Result<String, Box<dyn std::error::Error>>
...
"(F)Ljava/lang/String;",&[])?;
Ok(jni.get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn hash_code(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<i8>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(B)I",&[])?;
Ok(res.i().unwrap())}
	pub fn hash_code_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<jni::objects::JObject<'mc>>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(Ljava/lang/Object;)I",&[])?;
Ok(res.i().unwrap())}
	pub fn hash_code_with_booleans(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<i64>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(J)I",&[])?;
Ok(res.i().unwrap())}
	pub fn hash_code_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<i16>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(S)I",&[])?;
Ok(res.i().unwrap())}
	pub fn hash_code_with_chars(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<u16>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(C)I",&[])?;
Ok(res.i().unwrap())}
	pub fn compare_with_bytes(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<bool>,arg1: std::option::Option<Vec<bool>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(ZZ)I",&[])?;
Ok(res.i().unwrap())}
	pub fn compare_with_comparables(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i32>,arg1: std::option::Option<Vec<i32>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(II)I",&[])?;
Ok(res.i().unwrap())}
	pub fn compare_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f32>,arg1: std::option::Option<Vec<f32>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(FF)I",&[])?;
Ok(res.i().unwrap())}
	pub fn compare_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<impl Into<blackboxmc_java::JavaComparable<'mc>>>,arg1: i32,arg2: i32,arg3: Vec<impl Into<blackboxmc_java::JavaComparable<'mc>>>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"compare",
"(Ljava/lang/Comparable;IILjava/lang/Comparable;II)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
	pub fn compare_with_shorts(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: i32,arg3: Vec<jni::objects::JObject<'mc>>,arg4: i32,arg5: std::option::Option<i32>,arg6: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"compare",
"(Ljava/lang/Object;IILjava/lang/Object;IILjava/util/Comparator;)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6)])?;
Ok(res.i().unwrap())}
	pub fn compare_with_booleans(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i8>,arg1: i32,arg2: i32,arg3: Vec<i8>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"compare",
"(BIIBII)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
	pub fn compare_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: i32,arg2: i32,arg3: Vec<i64>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"compare",
"(JIIJII)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
	pub fn compare_with_floats(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<u16>,arg1: i32,arg2: i32,arg3: Vec<u16>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"compare",
"(CIICII)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
	pub fn stream_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i32>,arg1: i32,arg2: std::option::Option<i32>) 
...
"(III)Ljava/util/stream/IntStream;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::stream::JavaIntStream::from_raw(&jni,obj
)}
	pub fn stream_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: std::option::Option<i32>) 
-> Result<crate::stream::JavaStream<'mc>, Box<dyn std::error::Error>>

{let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = jni::objects::JValueGen::Int(arg2.unwrap().into());
let cls = &jni.find_class("java/util/stream/Stream")?;
let res = jni.call_static_method(cls,"stream",
"(Ljava/lang/Object;II)Ljava/util/stream/Stream;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::stream::JavaStream::from_raw(&jni,obj
)}
	pub fn fill_with_chars(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i32>,arg1: i32,arg2: i32,arg3: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(IIII)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn fill_with_shorts(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: std::option::Option<jni::objects::JObject<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = arg1.unwrap();
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"fill",
"(Ljava/lang/Object;Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn fill_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f32>,arg1: i32,arg2: i32,arg3: std::option::Option<f32>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"fill",
"(FIIF)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn fill_with_booleans(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i8>,arg1: i32,arg2: i32,arg3: std::option::Option<i8>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = jni::objects::JValueGen::Int(arg2.into());
let val_3 = jni::objects::JValueGen::Byte(arg3.unwrap().into());
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"fill",
"(BIIB)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn fill_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i16>,arg1: std::option::Option<i32>,arg2: std::option::Option<i32>,arg3: std::option::Option<i16>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let val_2 = jni::objects::JValueGen::Int(arg2.unwrap().into());
let val_3 = jni::objects::JValueGen::Short(arg3.unwrap().into());
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"fill",
"(SIIS)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn fill_with_objects(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: i32,arg2: i32,arg3: std::option::Option<i64>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"fill",
"(JIIJ)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn spliterator_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: std::option::Option<i32>) 
...
"(Ljava/lang/Object;II)Ljava/util/Spliterator;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::JavaSpliterator::from_raw(&jni,obj
)}
	pub fn spliterator_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: i32,arg2: std::option::Option<i32>) 
...
let res = jni.call_static_method(cls,"spliterator",
"(JII)Ljava/util/Spliterator$OfLong;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::JavaSpliteratorOfLong::from_raw(&jni,obj
)}
	pub fn as_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>
...
crate::JavaList::from_raw(&jni,obj
	...
	pub fn sort_with_shorts(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: i32,arg2: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(JII)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(())}
	pub fn sort_with_chars(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<i64>>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(J)V",&[])?;
Ok(())}
	pub fn sort_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<f32>>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(F)V",&[])?;
Ok(())}
	pub fn sort_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f32>,arg1: i32,arg2: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"sort",
"(FII)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(())}
	pub fn sort_with_objects(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: std::option::Option<i32>,arg3: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"sort",
"(Ljava/lang/Object;IILjava/util/Comparator;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn sort_with_bytes(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f64>,arg1: i32,arg2: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"sort",
"(DII)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(())}
	pub fn compare_unsigned_with_shorts(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i8>,arg1: std::option::Option<Vec<i8>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(BB)I",&[])?;
Ok(res.i().unwrap())}
	pub fn compare_unsigned_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i16>,arg1: i32,arg2: i32,arg3: Vec<i16>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"compareUnsigned",
"(SIISII)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"compareUnsigned",
"(IIIIII)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
...
Ok(res.z().unwrap())}
	pub fn mismatch_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: std::option::Option<Vec<i64>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(JJ)I",&[])?;
Ok(res.i().unwrap())}
	pub fn mismatch_with_booleans(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i8>,arg1: std::option::Option<Vec<i8>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(BB)I",&[])?;
Ok(res.i().unwrap())}
	pub fn mismatch_with_chars(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i16>,arg1: std::option::Option<Vec<i16>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(SS)I",&[])?;
Ok(res.i().unwrap())}
	pub fn mismatch_with_objects(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f32>,arg1: i32,arg2: i32,arg3: Vec<f32>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"mismatch",
"(FIIFII)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
	pub fn mismatch_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: i32,arg3: Vec<jni::objects::JObject<'mc>>,arg4: i32,arg5: std::option::Option<i32>,arg6: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(Ljava/lang/Object;IILjava/lang/Object;IILjava/util/Comparator;)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6)])?;
Ok(res.i().unwrap())}
	pub fn mismatch_with_shorts(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<bool>,arg1: i32,arg2: i32,arg3: Vec<bool>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"mismatch",
"(ZIIZII)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
	pub fn mismatch_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i32>,arg1: i32,arg2: i32,arg3: Vec<i32>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(IIIIII)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.i().unwrap())}
	pub fn mismatch_with_bytes(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<u16>,arg1: i32,arg2: i32,arg3: Vec<u16>,arg4: i32,arg5: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
Ok(jni.get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn parallel_sort_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i16>,arg1: i32,arg2: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(SII)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(())}
	pub fn parallel_sort_with_comparables(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<i32>>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(I)V",&[])?;
Ok(())}
	pub fn parallel_sort_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<Vec<i8>>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(B)V",&[])?;
Ok(())}
	pub fn parallel_sort_with_chars(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: std::option::Option<i32>,arg3: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(Ljava/lang/Object;IILjava/util/Comparator;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn parallel_sort_with_objects(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f32>,arg1: std::option::Option<i32>,arg2: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(FII)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(())}
	pub fn parallel_sort_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: i32,arg2: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(JII)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(())}
	pub fn parallel_sort_with_bytes(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<impl Into<blackboxmc_java::JavaComparable<'mc>>>,arg1: i32,arg2: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"parallelSort",
"(Ljava/lang/Comparable;II)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(())}
	pub fn parallel_prefix_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f64>,arg1: std::option::Option<impl Into<&'mc crate::function::JavaDoubleBinaryOperator<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"parallelPrefix",
"(DLjava/util/function/DoubleBinaryOperator;)V",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn parallel_prefix_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: std::option::Option<impl Into<&'mc crate::function::JavaBinaryOperator<'mc, T>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"parallelPrefix",
"(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)V",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn parallel_prefix_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i32>,arg1: i32,arg2: i32,arg3: std::option::Option<impl Into<&'mc crate::function::JavaIntBinaryOperator<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"parallelPrefix",
"(IIILjava/util/function/IntBinaryOperator;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn parallel_prefix_with_objects(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: i32,arg2: i32,arg3: std::option::Option<impl Into<&'mc crate::function::JavaLongBinaryOperator<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"parallelPrefix",
"(JIILjava/util/function/LongBinaryOperator;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(())}
	pub fn binary_search_with_objects(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f32>,arg1: i32,arg2: std::option::Option<i32>,arg3: std::option::Option<f32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(FIIF)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(res.i().unwrap())}
	pub fn binary_search_with_longs(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i16>,arg1: i32,arg2: i32,arg3: std::option::Option<i16>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"binarySearch",
"(SIIS)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(res.i().unwrap())}
	pub fn binary_search_with_shorts(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f64>,arg1: std::option::Option<f64>) 
-> Result<i32, Box<dyn std::error::Error>>

{let val_1 = jni::objects::JValueGen::Double(arg1.unwrap().into());
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"binarySearch",
"(DD)I",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(res.i().unwrap())}
	pub fn binary_search_with_bytes(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<u16>,arg1: std::option::Option<u16>) 
-> Result<i32, Box<dyn std::error::Error>>

{let val_1 = jni::objects::JValueGen::Char(arg1.unwrap().into());
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"binarySearch",
"(CC)I",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(res.i().unwrap())}
	pub fn binary_search_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: i32,arg3: std::option::Option<jni::objects::JObject<'mc>>) 
-> Result<i32, Box<dyn std::error::Error>>

{let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = jni::objects::JValueGen::Int(arg2.into());
let val_3 = arg3.unwrap();
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"binarySearch",
"(Ljava/lang/Object;IILjava/lang/Object;)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(res.i().unwrap())}
	pub fn binary_search_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i8>,arg1: i32,arg2: i32,arg3: std::option::Option<i8>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"binarySearch",
"(BIIB)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
Ok(res.i().unwrap())}
	pub fn binary_search_with_chars(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: i32,arg3: std::option::Option<T>,arg4: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"binarySearch",
"(Ljava/lang/Object;IILjava/lang/Object;Ljava/util/Comparator;)I",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
Ok(res.i().unwrap())}
	pub fn set_all_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i32>,arg1: std::option::Option<impl Into<&'mc crate::function::JavaIntUnaryOperator<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"setAll",
"(ILjava/util/function/IntUnaryOperator;)V",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn set_all_with_objects(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: std::option::Option<impl Into<&'mc crate::function::JavaIntToLongFunction<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"setAll",
"(JLjava/util/function/IntToLongFunction;)V",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn parallel_set_all_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f64>,arg1: std::option::Option<impl Into<&'mc crate::function::JavaIntToDoubleFunction<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"parallelSetAll",
"(DLjava/util/function/IntToDoubleFunction;)V",&[jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn parallel_set_all_with_objects(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: std::option::Option<impl Into<&'mc crate::function::JavaIntToLongFunction<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn copy_of(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaMap<'mc, K>>) 
-> Result<crate::JavaMap<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Map")?;
let res = jni.call_static_method(cls,"copyOf",
"(Ljava/util/Map;)Ljava/util/Map;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
let val_5 = arg5.unwrap();
let val_6 = arg6.unwrap();
let val_7 = arg7.unwrap();
let val_8 = arg8.unwrap();
let val_9 = arg9.unwrap();
let val_10 = arg10.unwrap();
let val_11 = arg11.unwrap();
let val_12 = arg12.unwrap();
let val_13 = arg13.unwrap();
let val_14 = arg14.unwrap();
let val_15 = arg15.unwrap();
let val_16 = arg16.unwrap();
let val_17 = arg17.unwrap();
let val_18 = arg18.unwrap();
let val_19 = arg19.unwrap();
let cls = &jni.find_class("java/util/Map")?;
let res = jni.call_static_method(cls,"of",
"(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6),jni::objects::JValueGen::from(&val_7),jni::objects::JValueGen::from(&val_8),jni::objects::JValueGen::from(&val_9),jni::objects::JValueGen::from(&val_10),jni::objects::JValueGen::from(&val_11),jni::objects::JValueGen::from(&val_12),jni::objects::JValueGen::from(&val_13),jni::objects::JValueGen::from(&val_14),jni::objects::JValueGen::from(&val_15),jni::objects::JValueGen::from(&val_16),jni::objects::JValueGen::from(&val_17),jni::objects::JValueGen::from(&val_18),jni::objects::JValueGen::from(&val_19)])?;
let mut obj = res.l()?;
crate::JavaMap::from_raw(&jni,obj
)}
	pub fn merge(&mut self,arg0: K,arg1: V,arg2: impl Into<&'mc crate::function::JavaBiFunction<'mc, V>>) 
...
"(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map$Entry;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
...
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn of_entries(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<impl Into<crate::JavaMapEntry<'mc, K>>>) 
-> Result<crate::JavaMap<'mc>, Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<i32>) 
-> Result<crate::JavaWeakHashMap<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("java/util/WeakHashMap")?;
let res = jni.new_object(cls,
"(IF)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::JavaWeakHashMap::from_raw(&jni,res
)}
	pub fn remove_with_object(&mut self,arg0: std::option::Option<jni::objects::JObject<'mc>>,arg1: std::option::Option<jni::objects::JObject<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
impl<'mc, K,V> Into<crate::JavaMap<'mc>> for JavaWeakHashMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaMap<'mc, K,V> {
       crate::JavaMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, K,V> Into<crate::JavaAbstractMap<'mc>> for JavaWeakHashMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractMap<'mc> {
       crate::JavaAbstractMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
let cls = &jni.find_class("java/util/Set")?;
let res = jni.call_static_method(cls,"copyOf",
"(Ljava/util/Collection;)Ljava/util/Set;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaSet::from_raw(&jni,obj
)}
	pub fn clear(&mut self) 
...
let cls = &jni.find_class("java/util/Set")?;
let res = jni.call_static_method(cls,"of",
"(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Set;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6),jni::objects::JValueGen::from(&val_7),jni::objects::JValueGen::from(&val_8),jni::objects::JValueGen::from(&val_9)])?;
let mut obj = res.l()?;
crate::JavaSet::from_raw(&jni,obj
)}
	pub fn contains(&mut self,arg0: jni::objects::JObject<'mc>) 
...
impl<'mc, E> Into<crate::JavaCollection<'mc>> for JavaSet<'mc, E> where E: JNIRaw<'mc>{
...
crate::JavaBase64Encoder::from_raw(&jni,obj
	...
	pub fn mime_encoder(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaBase64Encoder<'mc>, Box<dyn std::error::Error>>
...
let res = jni.new_object(cls,
"(Ljava/lang/String;Ljava/lang/String;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"checkGuard","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaCollection<'mc>> for JavaAbstractCollection<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaCollection<'mc, E> {
       crate::JavaCollection::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
{let val_0 = arg0;
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"subSet","(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/SortedSet;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"headSet","(Ljava/lang/Object;)Ljava/util/SortedSet;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaSortedSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"tailSet","(Ljava/lang/Object;)Ljava/util/SortedSet;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaSortedSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
impl<'mc, E> Into<crate::JavaSet<'mc>> for JavaSortedSet<'mc, E> where E: JNIRaw<'mc>{
...
let res = jni.new_object(cls,
"(JIIJ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"combine","(Ljava/util/IntSummaryStatistics;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn min(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>
...
impl<'mc> Into<crate::function::JavaIntConsumer<'mc>> for JavaIntSummaryStatistics<'mc>{
   fn into(self) -> crate::function::JavaIntConsumer<'mc> {
       crate::function::JavaIntConsumer::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"offer","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
impl<'mc, E> Into<crate::JavaQueue<'mc>> for JavaAbstractQueue<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaQueue<'mc, E> {
       crate::JavaQueue::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractCollection<'mc>> for JavaAbstractQueue<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractCollection<'mc> {
...
let val_8 = jni::objects::JValueGen::Int(arg8.unwrap().into());
let val_9 = jni::objects::JValueGen::Int(arg9.unwrap().into());
let val_10 = jni::objects::JValueGen::Int(arg10.unwrap().into());
let val_11 = jni::objects::JValueGen::Int(arg11.unwrap().into());
let val_12 = jni::objects::JValueGen::Int(arg12.unwrap().into());
let cls = &jni.find_class("java/util/SimpleTimeZone")?;
let res = jni.new_object(cls,
"(ILjava/lang/String;IIIIIIIIIII)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6),jni::objects::JValueGen::from(&val_7),jni::objects::JValueGen::from(&val_8),jni::objects::JValueGen::from(&val_9),jni::objects::JValueGen::from(&val_10),jni::objects::JValueGen::from(&val_11),jni::objects::JValueGen::from(&val_12)])?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"setStartRule","(IIIIZ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
// 2
let val_4 = jni::objects::JValueGen::Bool(arg4.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"setEndRule","(IIIIZ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setStartYear","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setDSTSavings","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn raw_offset(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>
...
impl<'mc, K,V> Into<crate::JavaMapEntry<'mc>> for JavaAbstractMapSimpleEntry<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaMapEntry<'mc, K,V> {
       crate::JavaMapEntry::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"update","(Ljava/util/Observable;Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
}
...
impl<'mc, E> Into<crate::JavaCollection<'mc>> for JavaQueue<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaCollection<'mc, E> {
       crate::JavaCollection::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
if !valid {
	...
	pub fn try_advance(&mut self,arg0: impl Into<&'mc crate::function::JavaConsumer<'mc, T>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"tryAdvance","(Ljava/util/function/Consumer;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn estimate_size(&mut self) 
...
crate::JavaComparator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn for_each_remaining(&mut self,arg0: impl Into<&'mc crate::function::JavaConsumer<'mc, T>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"forEachRemaining","(Ljava/util/function/Consumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn characteristics(&mut self) 
-> Result<i32, Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<i32>) 
-> Result<crate::JavaHashtable<'mc>, Box<dyn std::error::Error>>
...
Ok(res.z().unwrap())}
	pub fn elements(&mut self) 
-> Result<crate::JavaEnumeration<'mc, V>, Box<dyn std::error::Error>>
...
Ok(res.l().unwrap())}
	pub fn keys(&mut self) 
-> Result<crate::JavaEnumeration<'mc, K>, Box<dyn std::error::Error>>
...
impl<'mc, K,V> Into<crate::JavaMap<'mc>> for JavaHashtable<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaMap<'mc, K,V> {
       crate::JavaMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, K,V> Into<crate::JavaDictionary<'mc>> for JavaHashtable<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaDictionary<'mc> {
...
impl<'mc, E> Into<crate::JavaSet<'mc>> for JavaAbstractSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaSet<'mc, E> {
       crate::JavaSet::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractCollection<'mc>> for JavaAbstractSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractCollection<'mc> {
       crate::JavaAbstractCollection::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
if !valid {
	...
	pub fn if_present_or_else(&mut self,arg0: impl Into<&'mc crate::function::JavaIntConsumer<'mc>>,arg1: impl Into<&'mc blackboxmc_java::JavaRunnable<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"ifPresentOrElse","(Ljava/util/function/IntConsumer;Ljava/lang/Runnable;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn or_else_get(&mut self,arg0: impl Into<&'mc crate::function::JavaIntSupplier<'mc>>) 
-> Result<i32, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"orElseGet","(Ljava/util/function/IntSupplier;)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn if_present(&mut self,arg0: impl Into<&'mc crate::function::JavaIntConsumer<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"ifPresent","(Ljava/util/function/IntConsumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"stream","()Ljava/util/stream/IntStream;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
let res = jni.call_static_method(cls,"of",
"(I)Ljava/util/OptionalInt;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn or_else(&mut self,arg0: i32) 
-> Result<i32, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"orElse","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn or_else_throw(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaSupplier<'mc, X>>>) 
-> Result<i32, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"orElseThrow","(Ljava/util/function/Supplier;)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaMap<'mc, K>>>) 
-> Result<crate::JavaTreeMap<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/TreeMap")?;
let res = jni.new_object(cls,
"(Ljava/util/Map;)V",&[jni::objects::JValueGen::from(&val_0)])?;
crate::JavaTreeMap::from_raw(&jni,res
)}
	pub fn new_with_sorted_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaSortedMap<'mc, V>>>) 
-> Result<crate::JavaTreeMap<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/TreeMap")?;
let res = jni.new_object(cls,
"(Ljava/util/SortedMap;)V",&[jni::objects::JValueGen::from(&val_0)])?;
crate::JavaTreeMap::from_raw(&jni,res
)}
	pub fn first_entry(&mut self) 
-> Result<crate::JavaMapEntry<'mc, K, V>, Box<dyn std::error::Error>>
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"lowerEntry","(Ljava/lang/Object;)Ljava/util/Map$Entry;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaMapEntry::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"floorEntry","(Ljava/lang/Object;)Ljava/util/Map$Entry;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaMapEntry::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"ceilingEntry","(Ljava/lang/Object;)Ljava/util/Map$Entry;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaMapEntry::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"higherEntry","(Ljava/lang/Object;)Ljava/util/Map$Entry;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaMapEntry::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
-> Result<crate::JavaNavigableSet<'mc, K>, Box<dyn std::error::Error>>
...
// 1
let val_3 = jni::objects::JValueGen::Bool(arg3.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"subMap","(Ljava/lang/Object;ZLjava/lang/Object;Z)Ljava/util/NavigableMap;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaNavigableMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
// 0
let val_1 = jni::objects::JValueGen::Bool(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"headMap","(Ljava/lang/Object;Z)Ljava/util/NavigableMap;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaNavigableMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
// 0
let val_1 = jni::objects::JValueGen::Bool(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"tailMap","(Ljava/lang/Object;Z)Ljava/util/NavigableMap;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaNavigableMap::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"lowerKey","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"floorKey","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"ceilingKey","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"higherKey","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
impl<'mc, K,V> Into<crate::JavaNavigableMap<'mc>> for JavaTreeMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaNavigableMap<'mc, K,V> {
       crate::JavaNavigableMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, K,V> Into<crate::JavaAbstractMap<'mc>> for JavaTreeMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractMap<'mc> {
       crate::JavaAbstractMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
let res = jni.new_object(cls,
"(JDDD)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
...
let res = self.jni_ref().call_method(&self.jni_object(),"accept","(D)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"combine","(Ljava/util/DoubleSummaryStatistics;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn min(&mut self) 
-> Result<f64, Box<dyn std::error::Error>>
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"andThen","(Ljava/util/function/DoubleConsumer;)Ljava/util/function/DoubleConsumer;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::function::JavaDoubleConsumer::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
}
impl<'mc> Into<crate::function::JavaDoubleConsumer<'mc>> for JavaDoubleSummaryStatistics<'mc>{
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"push","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn pop(&mut self) 
-> Result<E, Box<dyn std::error::Error>>
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"addFirst","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"addLast","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn poll_first(&mut self) 
-> Result<E, Box<dyn std::error::Error>>
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"offerLast","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"removeFirstOccurrence","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"offerFirst","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"removeLastOccurrence","(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn offer(&mut self,arg0: E) 
...
impl<'mc, E> Into<crate::JavaQueue<'mc>> for JavaDeque<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaQueue<'mc, E> {
       crate::JavaQueue::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
if !valid {
	...
	pub fn if_present_or_else(&mut self,arg0: impl Into<&'mc crate::function::JavaDoubleConsumer<'mc>>,arg1: impl Into<&'mc blackboxmc_java::JavaRunnable<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"ifPresentOrElse","(Ljava/util/function/DoubleConsumer;Ljava/lang/Runnable;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn or_else_get(&mut self,arg0: impl Into<&'mc crate::function::JavaDoubleSupplier<'mc>>) 
-> Result<f64, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"orElseGet","(Ljava/util/function/DoubleSupplier;)D",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
	pub fn if_present(&mut self,arg0: impl Into<&'mc crate::function::JavaDoubleConsumer<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"ifPresent","(Ljava/util/function/DoubleConsumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"stream","()Ljava/util/stream/DoubleStream;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
let res = jni.call_static_method(cls,"of",
"(D)Ljava/util/OptionalDouble;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn or_else(&mut self,arg0: f64) 
-> Result<f64, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Double(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"orElse","(D)D",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
	pub fn or_else_throw(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaSupplier<'mc, X>>>) 
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"orElseThrow","(Ljava/util/function/Supplier;)D",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
let val_2 = jni::objects::JValueGen::Int(arg2.into());
let val_3 = jni::objects::JValueGen::Int(arg3.into());
let res = self.jni_ref().call_method(&self.jni_object(),"formatTo","(Ljava/util/Formatter;III)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)]);
self.jni_ref().translate_error(res)?;
Ok(())}
}
...
{let val_0 = arg0.unwrap();
let res = self.jni_ref().call_method(&self.jni_object(),"notifyObservers","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"addObserver","(Ljava/util/Observer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"deleteObserver","(Ljava/util/Observer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
let res = jni.new_object(cls,
"(Ljava/lang/String;Ljava/lang/String;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.unwrap().into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"nextToken","(Ljava/lang/String;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn next_element(&mut self) 
...
if !valid {
	...
	pub fn if_present_or_else(&mut self,arg0: impl Into<&'mc crate::function::JavaLongConsumer<'mc>>,arg1: impl Into<&'mc blackboxmc_java::JavaRunnable<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"ifPresentOrElse","(Ljava/util/function/LongConsumer;Ljava/lang/Runnable;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn or_else_get(&mut self,arg0: impl Into<&'mc crate::function::JavaLongSupplier<'mc>>) 
-> Result<i64, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"orElseGet","(Ljava/util/function/LongSupplier;)J",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
	pub fn if_present(&mut self,arg0: impl Into<&'mc crate::function::JavaLongConsumer<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"ifPresent","(Ljava/util/function/LongConsumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let res = self.jni_ref().call_method(&self.jni_object(),"stream","()Ljava/util/stream/LongStream;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
...
let res = jni.call_static_method(cls,"of",
"(J)Ljava/util/OptionalLong;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn or_else(&mut self,arg0: i64) 
-> Result<i64, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"orElse","(J)J",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
	pub fn or_else_throw(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaSupplier<'mc, X>>>) 
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"orElseThrow","(Ljava/util/function/Supplier;)J",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
let res = jni.new_object(cls,
"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"setDefault",
"(Ljava/util/Locale$Category;Ljava/util/Locale;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"getUnicodeLocaleType","(Ljava/lang/String;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
let cls = &jni.find_class("java/util/Locale")?;
let res = jni.call_static_method(cls,"getDefault",
"(Ljava/util/Locale$Category;)Ljava/util/Locale;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaLocale::from_raw(&jni,obj
)}
	pub fn lookup(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, javaLocaleLanguageRange>>,arg1: impl Into<&'mc crate::JavaCollection<'mc, javaLocale>>) 
-> Result<crate::JavaLocale<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/util/Collection;)Ljava/util/Locale;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaLocale::from_raw(&jni,obj
)}
	pub fn filter_with_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, javaLocaleLanguageRange>>,arg1: std::option::Option<impl Into<&'mc crate::JavaCollection<'mc, javaLocale>>>,arg2: std::option::Option<impl Into<&'mc crate::JavaLocaleFilteringMode<'mc>>>) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/util/Collection;Ljava/util/Locale$FilteringMode;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn display_language(&mut self) 
-> Result<String, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getDisplayLanguage","()Ljava/lang/String;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn display_script(&mut self) 
-> Result<String, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getDisplayScript","()Ljava/lang/String;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn display_country(&mut self) 
-> Result<String, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"getDisplayCountry","()Ljava/lang/String;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getDisplayVariant","(Ljava/util/Locale;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn filter_tags_with_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, javaLocaleLanguageRange>>,arg1: std::option::Option<impl Into<&'mc crate::JavaCollection<'mc, String>>>,arg2: std::option::Option<impl Into<&'mc crate::JavaLocaleFilteringMode<'mc>>>) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>
...
crate::JavaList::from_raw(&jni,obj
	...
	pub fn lookup_tag(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, javaLocaleLanguageRange>>,arg1: impl Into<&'mc crate::JavaCollection<'mc, String>>) 
-> Result<String, Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/util/Collection;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(jni.get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
let res = self.jni_ref().call_method(&self.jni_object(),"getExtension","(C)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn extension_keys(&mut self) 
-> Result<crate::JavaSet<'mc, javaCharacter>, Box<dyn std::error::Error>>
...
"(Ljava/lang/String;)Ljava/util/Locale;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaLocale::from_raw(&jni,obj
)}
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<i32>) 
-> Result<crate::JavaLinkedHashSet<'mc>, Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaSet<'mc>> for JavaLinkedHashSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaSet<'mc, E> {
       crate::JavaSet::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaHashSet<'mc>> for JavaLinkedHashSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaHashSet<'mc> {
...
impl<'mc, K,V> Into<crate::JavaMap<'mc>> for JavaHashMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaMap<'mc, K,V> {
       crate::JavaMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, K,V> Into<crate::JavaAbstractMap<'mc>> for JavaHashMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractMap<'mc> {
       crate::JavaAbstractMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
impl<'mc, K,V> Into<crate::JavaMap<'mc>> for JavaIdentityHashMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaMap<'mc, K,V> {
       crate::JavaMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, K,V> Into<crate::JavaAbstractMap<'mc>> for JavaIdentityHashMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractMap<'mc> {
       crate::JavaAbstractMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
if !valid {
	...
	pub fn try_advance_with_object(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaConsumer<'mc, T>>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
crate::JavaSpliteratorOfPrimitive::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn for_each_remaining_with_object(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaConsumer<'mc, T>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("java/util/LinkedHashMap")?;
let res = jni.new_object(cls,
"(IFZ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::JavaLinkedHashMap::from_raw(&jni,res
)}
	pub fn get(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
impl<'mc, K,V> Into<crate::JavaMap<'mc>> for JavaLinkedHashMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaMap<'mc, K,V> {
       crate::JavaMap::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, K,V> Into<crate::JavaHashMap<'mc>> for JavaLinkedHashMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
   fn into(self) -> crate::JavaHashMap<'mc> {
...
{let val_0 = arg0;
let val_1 = arg1;
let res = self.jni_ref().call_method(&self.jni_object(),"compare","(Ljava/lang/Object;Ljava/lang/Object;)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
crate::JavaComparator::from_raw(&jni,obj
	...
	pub fn comparing_with_function(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::function::JavaFunction<'mc, T>>>,arg1: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, U>>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/Comparator")?;
let res = jni.call_static_method(cls,"comparing",
"(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaComparator::from_raw(&jni,obj
)}
	pub fn then_comparing_with_comparator(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaFunction<'mc, T>>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"thenComparing","(Ljava/util/function/Function;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaComparator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn then_comparing_with_function(&mut self,arg0: impl Into<&'mc crate::function::JavaFunction<'mc, T>>,arg1: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, U>>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"thenComparing","(Ljava/util/function/Function;Ljava/util/Comparator;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaComparator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn comparing_int(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::function::JavaToIntFunction<'mc, T>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Comparator")?;
let res = jni.call_static_method(cls,"comparingInt",
"(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaComparator::from_raw(&jni,obj
)}
	pub fn comparing_long(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::function::JavaToLongFunction<'mc, T>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Comparator")?;
let res = jni.call_static_method(cls,"comparingLong",
"(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaComparator::from_raw(&jni,obj
)}
	pub fn comparing_double(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::function::JavaToDoubleFunction<'mc, T>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Comparator")?;
let res = jni.call_static_method(cls,"comparingDouble",
"(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaComparator::from_raw(&jni,obj
)}
...
crate::JavaComparator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn then_comparing_int(&mut self,arg0: impl Into<&'mc crate::function::JavaToIntFunction<'mc, T>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"thenComparingInt","(Ljava/util/function/ToIntFunction;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaComparator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn then_comparing_long(&mut self,arg0: impl Into<&'mc crate::function::JavaToLongFunction<'mc, T>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"thenComparingLong","(Ljava/util/function/ToLongFunction;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaComparator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn then_comparing_double(&mut self,arg0: impl Into<&'mc crate::function::JavaToDoubleFunction<'mc, T>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"thenComparingDouble","(Ljava/util/function/ToDoubleFunction;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaComparator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::JavaComparator::from_raw(&jni,obj
	...
	pub fn nulls_first(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaComparator<'mc, T>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Comparator")?;
let res = jni.call_static_method(cls,"nullsFirst",
"(Ljava/util/Comparator;)Ljava/util/Comparator;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaComparator::from_raw(&jni,obj
)}
	pub fn nulls_last(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaComparator<'mc, T>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaAbstractList<'mc>> for JavaAbstractSequentialList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractList<'mc> {
       crate::JavaAbstractList::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
let res = jni.new_object(cls,
"(J)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
{let val_0 = jni::objects::JValueGen::Long(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Long(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextLong","(JJ)J",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
...
let val_1 = jni::objects::JValueGen::Float(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextFloat","(FF)F",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.f().unwrap())}
	pub fn ints(&mut self,arg0: std::option::Option<i32>,arg1: std::option::Option<i32>) 
-> Result<crate::stream::JavaIntStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"ints","(II)Ljava/util/stream/IntStream;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaIntStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn ints_with_long(&mut self,arg0: i64,arg1: i32,arg2: std::option::Option<i32>) 
-> Result<crate::stream::JavaIntStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.into());
let val_1 = jni::objects::JValueGen::Int(arg1.into());
let val_2 = jni::objects::JValueGen::Int(arg2.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"ints","(JII)Ljava/util/stream/IntStream;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaIntStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn longs(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i64>,arg2: std::option::Option<i64>) 
-> Result<crate::stream::JavaLongStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Long(arg1.unwrap().into());
let val_2 = jni::objects::JValueGen::Long(arg2.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"longs","(JJJ)Ljava/util/stream/LongStream;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaLongStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn doubles(&mut self,arg0: std::option::Option<f64>,arg1: std::option::Option<f64>) 
-> Result<crate::stream::JavaDoubleStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Double(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Double(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"doubles","(DD)Ljava/util/stream/DoubleStream;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaDoubleStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn doubles_with_long(&mut self,arg0: i64,arg1: f64,arg2: std::option::Option<f64>) 
-> Result<crate::stream::JavaDoubleStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.into());
let val_1 = jni::objects::JValueGen::Double(arg1.into());
let val_2 = jni::objects::JValueGen::Double(arg2.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"doubles","(JDD)Ljava/util/stream/DoubleStream;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaDoubleStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JValueGen::Long(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSeed","(J)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Double(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Double(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextGaussian","(DD)D",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Double(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Double(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextDouble","(DD)D",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextInt","(II)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
let cls = &jni.find_class("java/util/List")?;
let res = jni.call_static_method(cls,"copyOf",
"(Ljava/util/Collection;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
	pub fn index_of(&mut self,arg0: jni::objects::JObject<'mc>) 
...
let cls = &jni.find_class("java/util/List")?;
let res = jni.call_static_method(cls,"of",
"(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6),jni::objects::JValueGen::from(&val_7),jni::objects::JValueGen::from(&val_8),jni::objects::JValueGen::from(&val_9)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
	pub fn contains(&mut self,arg0: jni::objects::JObject<'mc>) 
...
impl<'mc, E> Into<crate::JavaCollection<'mc>> for JavaList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaCollection<'mc, E> {
       crate::JavaCollection::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
let val_0 = jni::objects::JValueGen::Object(self.jni_ref().new_object("java/util/UUID", "(JJ)V", &[upper.into(), lower.into()]).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"compareTo","(Ljava/util/UUID;)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
if !valid {
	...
	pub fn min_with_collection(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaCollection<'mc, T>>>,arg1: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.l().unwrap())}
	pub fn max_with_collection(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaCollection<'mc, T>>>,arg1: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.l().unwrap())}
	pub fn replace_all(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, T>>,arg1: T,arg2: T) 
-> Result<bool, Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/lang/Object;Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(res.z().unwrap())}
	pub fn fill(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, T>>,arg1: T) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"fill",
"(Ljava/util/List;Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaEnumeration<'mc, T>>) 
-> Result<crate::JavaArrayList<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/ArrayList")?;
let res = jni.call_static_method(cls,"list",
"(Ljava/util/Enumeration;)Ljava/util/ArrayList;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaArrayList::from_raw(&jni,obj
)}
	pub fn add_all(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaCollection<'mc, T>>,arg1: Vec<jni::objects::JObject<'mc>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("boolean")?;
let res = jni.call_static_method(cls,"addAll",
"(Ljava/util/Collection;Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(res.z().unwrap())}
	pub fn empty_enumeration(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaEnumeration<'mc, T>, Box<dyn std::error::Error>>
...
crate::JavaEnumeration::from_raw(&jni,obj
	...
	pub fn new_set_from_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaMap<'mc, E, javaBoolean>>) 
-> Result<crate::JavaSet<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Set")?;
let res = jni.call_static_method(cls,"newSetFromMap",
"(Ljava/util/Map;)Ljava/util/Set;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaSet::from_raw(&jni,obj
)}
	pub fn empty_list(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
...
crate::JavaList::from_raw(&jni,obj
	...
	pub fn unmodifiable_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSet<'mc, T>>) 
-> Result<crate::JavaSet<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Set")?;
let res = jni.call_static_method(cls,"unmodifiableSet",
"(Ljava/util/Set;)Ljava/util/Set;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaSet::from_raw(&jni,obj
)}
	pub fn enumeration(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaCollection<'mc, T>>) 
-> Result<crate::JavaEnumeration<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Enumeration")?;
let res = jni.call_static_method(cls,"enumeration",
"(Ljava/util/Collection;)Ljava/util/Enumeration;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaEnumeration::from_raw(&jni,obj
)}
	pub fn synchronized_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSet<'mc, T>>) 
-> Result<crate::JavaSet<'mc>, Box<dyn std::error::Error>>
...
crate::JavaSet::from_raw(&jni,obj
	...
	pub fn synchronized_collection(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaCollection<'mc, T>>) 
...
"(Ljava/util/Collection;)Ljava/util/Collection;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaCollection::from_raw(&jni,obj
)}
	pub fn empty_iterator(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
...
crate::JavaIterator::from_raw(&jni,obj
	...
	pub fn copy(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, T>>,arg1: impl Into<&'mc crate::JavaList<'mc, T>>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn n_copies(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: i32,arg1: T) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>
...
"(ILjava/lang/Object;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
	pub fn unmodifiable_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, T>>) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/List")?;
let res = jni.call_static_method(cls,"unmodifiableList",
"(Ljava/util/List;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
	pub fn reverse(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, dyn JNIRaw<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"reverse",
"(Ljava/util/List;)V",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(())}
	pub fn sort_with_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaList<'mc, T>>>,arg1: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
let cls = &jni.find_class("void")?;
let res = jni.call_static_method(cls,"sort",
"(Ljava/util/List;Ljava/util/Comparator;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn reverse_order(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>
...
crate::JavaComparator::from_raw(&jni,obj
	...
	pub fn shuffle_with_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaList<'mc, dyn JNIRaw<'mc>>>>,arg1: std::option::Option<impl Into<&'mc crate::JavaRandom<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/util/Random;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn rotate(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, dyn JNIRaw<'mc>>>,arg1: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
"(Ljava/util/List;I)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(())}
	pub fn index_of_sub_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, dyn JNIRaw<'mc>>>,arg1: impl Into<&'mc crate::JavaList<'mc, dyn JNIRaw<'mc>>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/util/List;)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.i().unwrap())}
	pub fn last_index_of_sub_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, dyn JNIRaw<'mc>>>,arg1: impl Into<&'mc crate::JavaList<'mc, dyn JNIRaw<'mc>>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/util/List;)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.i().unwrap())}
	pub fn unmodifiable_collection(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaCollection<'mc, T>>) 
-> Result<crate::JavaCollection<'mc>, Box<dyn std::error::Error>>
...
crate::JavaCollection::from_raw(&jni,obj
	...
	pub fn unmodifiable_sorted_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSortedSet<'mc, T>>) 
-> Result<crate::JavaSortedSet<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/SortedSet")?;
let res = jni.call_static_method(cls,"unmodifiableSortedSet",
"(Ljava/util/SortedSet;)Ljava/util/SortedSet;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaSortedSet::from_raw(&jni,obj
)}
	pub fn unmodifiable_navigable_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaNavigableSet<'mc, T>>) 
-> Result<crate::JavaNavigableSet<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/NavigableSet")?;
let res = jni.call_static_method(cls,"unmodifiableNavigableSet",
"(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaNavigableSet::from_raw(&jni,obj
)}
	pub fn unmodifiable_sorted_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSortedMap<'mc, V>>) 
-> Result<crate::JavaSortedMap<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/SortedMap")?;
let res = jni.call_static_method(cls,"unmodifiableSortedMap",
"(Ljava/util/SortedMap;)Ljava/util/SortedMap;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaSortedMap::from_raw(&jni,obj
)}
	pub fn unmodifiable_navigable_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaNavigableMap<'mc, V>>) 
-> Result<crate::JavaNavigableMap<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/NavigableMap")?;
let res = jni.call_static_method(cls,"unmodifiableNavigableMap",
"(Ljava/util/NavigableMap;)Ljava/util/NavigableMap;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaNavigableMap::from_raw(&jni,obj
)}
	pub fn synchronized_sorted_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSortedSet<'mc, T>>) 
-> Result<crate::JavaSortedSet<'mc>, Box<dyn std::error::Error>>
...
crate::JavaSortedSet::from_raw(&jni,obj
	...
	pub fn synchronized_navigable_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaNavigableSet<'mc, T>>) 
-> Result<crate::JavaNavigableSet<'mc>, Box<dyn std::error::Error>>
...
crate::JavaNavigableSet::from_raw(&jni,obj
	...
	pub fn synchronized_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, T>>) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>
...
crate::JavaList::from_raw(&jni,obj
	...
	pub fn synchronized_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaMap<'mc, K, V>>) 
-> Result<crate::JavaMap<'mc>, Box<dyn std::error::Error>>
...
crate::JavaMap::from_raw(&jni,obj
	...
	pub fn synchronized_sorted_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSortedMap<'mc, K, V>>) 
-> Result<crate::JavaSortedMap<'mc>, Box<dyn std::error::Error>>
...
crate::JavaSortedMap::from_raw(&jni,obj
	...
	pub fn synchronized_navigable_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaNavigableMap<'mc, K, V>>) 
-> Result<crate::JavaNavigableMap<'mc>, Box<dyn std::error::Error>>
...
crate::JavaNavigableMap::from_raw(&jni,obj
	...
	pub fn checked_collection(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaCollection<'mc, E>>,arg1: jni::objects::JClass<'mc>) 
-> Result<crate::JavaCollection<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/Collection;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaCollection::from_raw(&jni,obj
)}
	pub fn checked_queue(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaQueue<'mc, E>>,arg1: jni::objects::JClass<'mc>) 
...
"(Ljava/util/Queue;Ljava/lang/Class;)Ljava/util/Queue;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaQueue::from_raw(&jni,obj
)}
	pub fn checked_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSet<'mc, E>>,arg1: jni::objects::JClass<'mc>) 
-> Result<crate::JavaSet<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/Set;Ljava/lang/Class;)Ljava/util/Set;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaSet::from_raw(&jni,obj
)}
	pub fn checked_sorted_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSortedSet<'mc, E>>,arg1: jni::objects::JClass<'mc>) 
-> Result<crate::JavaSortedSet<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/SortedSet;Ljava/lang/Class;)Ljava/util/SortedSet;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaSortedSet::from_raw(&jni,obj
)}
	pub fn checked_navigable_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaNavigableSet<'mc, E>>,arg1: jni::objects::JClass<'mc>) 
-> Result<crate::JavaNavigableSet<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/NavigableSet;Ljava/lang/Class;)Ljava/util/NavigableSet;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaNavigableSet::from_raw(&jni,obj
)}
	pub fn checked_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, E>>,arg1: jni::objects::JClass<'mc>) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/lang/Class;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
	pub fn checked_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaMap<'mc, K, V>>,arg1: jni::objects::JClass<'mc>,arg2: jni::objects::JClass<'mc>) 
-> Result<crate::JavaMap<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/Map;Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/Map;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::JavaMap::from_raw(&jni,obj
)}
	pub fn checked_sorted_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaSortedMap<'mc, K, V>>,arg1: jni::objects::JClass<'mc>,arg2: jni::objects::JClass<'mc>) 
-> Result<crate::JavaSortedMap<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/SortedMap;Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/SortedMap;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::JavaSortedMap::from_raw(&jni,obj
)}
	pub fn checked_navigable_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaNavigableMap<'mc, K, V>>,arg1: jni::objects::JClass<'mc>,arg2: jni::objects::JClass<'mc>) 
-> Result<crate::JavaNavigableMap<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/NavigableMap;Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/NavigableMap;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::JavaNavigableMap::from_raw(&jni,obj
)}
	pub fn empty_list_iterator(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaListIterator<'mc, T>, Box<dyn std::error::Error>>
...
crate::JavaListIterator::from_raw(&jni,obj
	...
	pub fn empty_set(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaSet<'mc, T>, Box<dyn std::error::Error>>
...
crate::JavaSet::from_raw(&jni,obj
	...
	pub fn empty_sorted_set(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
...
crate::JavaSortedSet::from_raw(&jni,obj
	...
	pub fn empty_navigable_set(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaNavigableSet<'mc, E>, Box<dyn std::error::Error>>
...
crate::JavaNavigableSet::from_raw(&jni,obj
	...
	pub fn empty_map(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
...
crate::JavaMap::from_raw(&jni,obj
	...
	pub fn empty_sorted_map(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
...
crate::JavaSortedMap::from_raw(&jni,obj
	...
	pub fn empty_navigable_map(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaNavigableMap<'mc, K, V>, Box<dyn std::error::Error>>
...
crate::JavaNavigableMap::from_raw(&jni,obj
	...
	pub fn singleton(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: T) 
-> Result<crate::JavaSet<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let cls = &jni.find_class("java/util/Set")?;
let res = jni.call_static_method(cls,"singleton",
"(Ljava/lang/Object;)Ljava/util/Set;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaSet::from_raw(&jni,obj
)}
	pub fn singleton_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: T) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let cls = &jni.find_class("java/util/List")?;
let res = jni.call_static_method(cls,"singletonList",
"(Ljava/lang/Object;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
	pub fn singleton_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: K,arg1: V) 
-> Result<crate::JavaMap<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaMap::from_raw(&jni,obj
)}
	pub fn frequency(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaCollection<'mc, dyn JNIRaw<'mc>>>,arg1: jni::objects::JObject<'mc>) 
-> Result<i32, Box<dyn std::error::Error>>
...
"(Ljava/util/Collection;Ljava/lang/Object;)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.i().unwrap())}
	pub fn disjoint(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaCollection<'mc, dyn JNIRaw<'mc>>>,arg1: impl Into<&'mc crate::JavaCollection<'mc, dyn JNIRaw<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>
...
"(Ljava/util/Collection;Ljava/util/Collection;)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.z().unwrap())}
	pub fn as_lifo_queue(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaDeque<'mc, T>>) 
-> Result<crate::JavaQueue<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Queue")?;
let res = jni.call_static_method(cls,"asLifoQueue",
"(Ljava/util/Deque;)Ljava/util/Queue;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaQueue::from_raw(&jni,obj
)}
	pub fn unmodifiable_map(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaMap<'mc, K>>) 
-> Result<crate::JavaMap<'mc>, Box<dyn std::error::Error>>
...
crate::JavaMap::from_raw(&jni,obj
	...
	pub fn swap(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, dyn JNIRaw<'mc>>>,arg1: i32,arg2: i32) 
-> Result<(), Box<dyn std::error::Error>>
...
"(Ljava/util/List;II)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(())}
	pub fn binary_search_with_list(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, T>>,arg1: std::option::Option<T>,arg2: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, T>>>) 
-> Result<i32, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"binarySearch",
"(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(res.i().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaCollection<'mc, E>>>) 
-> Result<crate::JavaHashSet<'mc>, Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaSet<'mc>> for JavaHashSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaSet<'mc, E> {
       crate::JavaSet::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractSet<'mc>> for JavaHashSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractSet<'mc> {
       crate::JavaAbstractSet::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
impl<'mc, E> Into<crate::JavaList<'mc>> for JavaAbstractList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaList<'mc, E> {
       crate::JavaList::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractCollection<'mc>> for JavaAbstractList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractCollection<'mc> {
       crate::JavaAbstractCollection::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
if !valid {
	...
	pub fn if_present_or_else(&mut self,arg0: impl Into<&'mc crate::function::JavaConsumer<'mc, T>>,arg1: impl Into<&'mc blackboxmc_java::JavaRunnable<'mc>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"ifPresentOrElse","(Ljava/util/function/Consumer;Ljava/lang/Runnable;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn or(&mut self,arg0: impl Into<&'mc crate::function::JavaSupplier<'mc, j>>) 
-> Result<crate::JavaOptional<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"or","(Ljava/util/function/Supplier;)Ljava/util/Optional;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaOptional::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn or_else_get(&mut self,arg0: impl Into<&'mc crate::function::JavaSupplier<'mc, T>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"orElseGet","(Ljava/util/function/Supplier;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn if_present(&mut self,arg0: impl Into<&'mc crate::function::JavaConsumer<'mc, T>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"ifPresent","(Ljava/util/function/Consumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn get(&mut self) 
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"map","(Ljava/util/function/Function;)Ljava/util/Optional;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaOptional::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::stream::JavaStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn of(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: T) 
-> Result<crate::JavaOptional<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let cls = &jni.find_class("java/util/Optional")?;
let res = jni.call_static_method(cls,"of",
"(Ljava/lang/Object;)Ljava/util/Optional;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"filter","(Ljava/util/function/Predicate;)Ljava/util/Optional;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaOptional::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"flatMap","(Ljava/util/function/Function;)Ljava/util/Optional;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaOptional::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"orElse","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn or_else_throw(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaSupplier<'mc, X>>>) 
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"orElseThrow","(Ljava/util/function/Supplier;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"or","(Ljava/util/BitSet;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextSetBit","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"previousSetBit","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"previousClearBit","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"intersects","(Ljava/util/BitSet;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"xor","(Ljava/util/BitSet;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"andNot","(Ljava/util/BitSet;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"get","(II)Ljava/util/BitSet;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"clear","(II)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn is_empty(&mut self) 
-> Result<bool, Box<dyn std::error::Error>>
...
// 2
let val_2 = jni::objects::JValueGen::Bool(arg2.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"set","(IIZ)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"flip","(II)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextClearBit","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"and","(Ljava/util/BitSet;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"add","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"set","(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
E::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn for_each_remaining(&mut self,arg0: impl Into<&'mc crate::function::JavaConsumer<'mc, E>>) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaIterator<'mc>> for JavaListIterator<'mc, E> where E: JNIRaw<'mc>{
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaCollection<'mc, E>>>) 
-> Result<crate::JavaPriorityQueue<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("java/util/PriorityQueue")?;
let res = jni.new_object(cls,
"(ILjava/util/Comparator;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::JavaPriorityQueue::from_raw(&jni,res
)}
	pub fn offer(&mut self,arg0: E) 
-> Result<bool, Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaAbstractQueue<'mc>> for JavaPriorityQueue<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractQueue<'mc> {
...
let res = jni.new_object(cls,
"(Ljava/lang/Object;)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaCollection<'mc, E>>>) 
-> Result<crate::JavaLinkedList<'mc>, Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn remove(&mut self,arg0: std::option::Option<i32>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaList<'mc>> for JavaLinkedList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaList<'mc, E> {
       crate::JavaList::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaDeque<'mc>> for JavaLinkedList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaDeque<'mc, E> {
       crate::JavaDeque::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractSequentialList<'mc>> for JavaLinkedList<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractSequentialList<'mc> {
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaStack<'mc>, Box<dyn std::error::Error>>
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"push","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn pop(&mut self) 
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"search","(Ljava/lang/Object;)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn copy_into(&mut self,arg0: Vec<jni::objects::JObject<'mc>>) 
...
impl<'mc, E> Into<crate::JavaVector<'mc>> for JavaStack<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaVector<'mc> {
...
crate::JavaSpliteratorOfDouble::from_raw(&jni,obj
	...
	pub fn iterator_with_spliteratorof_int(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaSpliteratorOfLong<'mc>>>) 
...
"(Ljava/util/Spliterator$OfLong;)Ljava/util/PrimitiveIterator$OfLong;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaPrimitiveIteratorOfLong::from_raw(&jni,obj
)}
	pub fn iterator_with_spliteratorof_double(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaSpliterator<'mc, T>>>) 
-> Result<crate::JavaIterator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/Iterator")?;
let res = jni.call_static_method(cls,"iterator",
"(Ljava/util/Spliterator;)Ljava/util/Iterator;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaIterator::from_raw(&jni,obj
)}
	pub fn spliterator_unknown_size_with_iterator(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaPrimitiveIteratorOfLong<'mc>>,arg1: std::option::Option<i32>) 
-> Result<crate::JavaSpliteratorOfLong<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/PrimitiveIterator$OfLong;I)Ljava/util/Spliterator$OfLong;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaSpliteratorOfLong::from_raw(&jni,obj
)}
	pub fn spliterator_unknown_size_with_primitive_iteratorof_double(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaPrimitiveIteratorOfInt<'mc>>,arg1: std::option::Option<i32>) 
-> Result<crate::JavaSpliteratorOfInt<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("java/util/Spliterator$OfInt")?;
let res = jni.call_static_method(cls,"spliteratorUnknownSize",
"(Ljava/util/PrimitiveIterator$OfInt;I)Ljava/util/Spliterator$OfInt;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaSpliteratorOfInt::from_raw(&jni,obj
)}
	pub fn spliterator_with_collection(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: std::option::Option<i32>) 
-> Result<crate::JavaSpliteratorOfLong<'mc>, Box<dyn std::error::Error>>

{let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let cls = &jni.find_class("java/util/Spliterator$OfLong")?;
let res = jni.call_static_method(cls,"spliterator",
"(JI)Ljava/util/Spliterator$OfLong;",&[jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaSpliteratorOfLong::from_raw(&jni,obj
)}
	pub fn spliterator_with_ints(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<jni::objects::JObject<'mc>>,arg1: i32,arg2: i32,arg3: std::option::Option<i32>) 
-> Result<crate::JavaSpliterator<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("java/util/Spliterator")?;
let res = jni.call_static_method(cls,"spliterator",
"(Ljava/lang/Object;III)Ljava/util/Spliterator;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
let mut obj = res.l()?;
crate::JavaSpliterator::from_raw(&jni,obj
)}
	pub fn spliterator_with_doubles(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<f64>,arg1: i32,arg2: i32,arg3: std::option::Option<i32>) 
-> Result<crate::JavaSpliteratorOfDouble<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("java/util/Spliterator$OfDouble")?;
let res = jni.call_static_method(cls,"spliterator",
"(DIII)Ljava/util/Spliterator$OfDouble;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
let mut obj = res.l()?;
crate::JavaSpliteratorOfDouble::from_raw(&jni,obj
)}
	pub fn spliterator_with_primitive_iteratorof_long(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaPrimitiveIteratorOfDouble<'mc>>,arg1: i64,arg2: std::option::Option<i32>) 
-> Result<crate::JavaSpliteratorOfDouble<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("java/util/Spliterator$OfDouble")?;
let res = jni.call_static_method(cls,"spliterator",
"(Ljava/util/PrimitiveIterator$OfDouble;JI)Ljava/util/Spliterator$OfDouble;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
let mut obj = res.l()?;
crate::JavaSpliteratorOfDouble::from_raw(&jni,obj
)}
	pub fn spliterator_with_iterator(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: Vec<i64>,arg1: i32,arg2: std::option::Option<i32>,arg3: std::option::Option<i32>) 
-> Result<crate::JavaSpliteratorOfLong<'mc>, Box<dyn std::error::Error>>
...
let cls = &jni.find_class("java/util/Spliterator$OfLong")?;
let res = jni.call_static_method(cls,"spliterator",
"(JIII)Ljava/util/Spliterator$OfLong;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
let mut obj = res.l()?;
crate::JavaSpliteratorOfLong::from_raw(&jni,obj
)}
	pub fn empty_spliterator(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaSpliterator<'mc, T>, Box<dyn std::error::Error>>
...
let res = jni.new_object(cls,
"(Ljava/lang/String;D)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn map_equivalents(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, javaLocaleLanguageRange>>,arg1: impl Into<&'mc crate::JavaMap<'mc, javaString, javaList<javaString>>) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/util/List;Ljava/util/Map;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
...
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
	pub fn parse_with_string(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc String>>,arg1: std::option::Option<impl Into<&'mc crate::JavaMap<'mc, javaString, javaList<javaString>>>) 
-> Result<crate::JavaList<'mc>, Box<dyn std::error::Error>>
...
"(Ljava/lang/String;Ljava/util/Map;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
let mut obj = res.l()?;
crate::JavaList::from_raw(&jni,obj
)}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
if !valid {
	...
	pub fn try_advance_with_consumer(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaDoubleConsumer<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"tryAdvance","(Ljava/util/function/DoubleConsumer;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn try_advance_with_object(&mut self,arg0: std::option::Option<jni::objects::JObject<'mc>>) 
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn for_each_remaining_with_double_consumer(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaDoubleConsumer<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"forEachRemaining","(Ljava/util/function/DoubleConsumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn estimate_size(&mut self) 
-> Result<i64, Box<dyn std::error::Error>>
...
impl<'mc, T> Into<crate::JavaEventListener<'mc>> for JavaEventListenerProxy<'mc, T> where T: JNIRaw<'mc>{
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"toBundleName","(Ljava/lang/String;Ljava/util/Locale;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn get_no_fallback_control(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, String>>) 
...
"(Ljava/util/List;)Ljava/util/ResourceBundle$Control;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaResourceBundleControl::from_raw(&jni,obj
)}
	pub fn get_control(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaList<'mc, String>>) 
-> Result<crate::JavaResourceBundleControl<'mc>, Box<dyn std::error::Error>>
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"getFormats","(Ljava/lang/String;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaList::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getCandidateLocales","(Ljava/lang/String;Ljava/util/Locale;)Ljava/util/List;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaList::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getFallbackLocale","(Ljava/lang/String;Ljava/util/Locale;)Ljava/util/Locale;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocale::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn new_bundle(&mut self,arg0: impl Into<&'mc String>,arg1: impl Into<&'mc crate::JavaLocale<'mc>>,arg2: impl Into<&'mc String>,arg3: impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>,arg4: bool) 
-> Result<crate::JavaResourceBundle<'mc>, Box<dyn std::error::Error>>
...
let res = self.jni_ref().call_method(&self.jni_object(),"newBundle","(Ljava/lang/String;Ljava/util/Locale;Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/util/ResourceBundle;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaResourceBundle::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn needs_reload(&mut self,arg0: impl Into<&'mc String>,arg1: impl Into<&'mc crate::JavaLocale<'mc>>,arg2: impl Into<&'mc String>,arg3: impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>,arg4: impl Into<&'mc crate::JavaResourceBundle<'mc>>,arg5: i64) 
-> Result<bool, Box<dyn std::error::Error>>
...
let val_5 = jni::objects::JValueGen::Long(arg5.into());
let res = self.jni_ref().call_method(&self.jni_object(),"needsReload","(Ljava/lang/String;Ljava/util/Locale;Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/util/ResourceBundle;J)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"getTimeToLive","(Ljava/lang/String;Ljava/util/Locale;)J",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
...
let res = self.jni_ref().call_method(&self.jni_object(),"toResourceName","(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
let cls = &jni.find_class("boolean")?;
let res = jni.call_static_method(cls,"equals",
"(Ljava/lang/Object;Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.z().unwrap())}
...
let cls = &jni.find_class("java/lang/String")?;
let res = jni.call_static_method(cls,"toString",
"(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(jni.get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"hashCode",
"(Ljava/lang/Object;)I",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(res.i().unwrap())}
...
"(II)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.i().unwrap())}
...
let cls = &jni.find_class("int")?;
let res = jni.call_static_method(cls,"compare",
"(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/Comparator;)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(res.i().unwrap())}
...
"(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.l().unwrap())}
...
"(JJJ)J",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(res.j().unwrap())}
...
"(III)I",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
Ok(res.i().unwrap())}
...
"(Ljava/lang/Object;)Z",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(res.z().unwrap())}
...
"(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.l().unwrap())}
	pub fn require_non_null_else_get(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: T,arg1: impl Into<&'mc crate::function::JavaSupplier<'mc, T>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>

{let val_0 = arg0;
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let cls = &jni.find_class("java/lang/Object")?;
let res = jni.call_static_method(cls,"requireNonNullElseGet",
"(Ljava/lang/Object;Ljava/util/function/Supplier;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
Ok(res.l().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
-> Result<(), Box<dyn std::error::Error>>
...
if !valid {
	...
	pub fn for_each_remaining_with_object(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaIntConsumer<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn for_each_remaining_with_consumer(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaConsumer<'mc, j>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"next","()I",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"useLocale","(Ljava/util/Locale;)Ljava/util/Scanner;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = jni::objects::JValueGen::Int(arg1.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"findWithinHorizon","(Ljava/util/regex/Pattern;I)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn find_in_line_with_string(&mut self,arg0: std::option::Option<impl Into<&'mc crate::regex::JavaPattern<'mc>>>) 
-> Result<String, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"findInLine","(Ljava/util/regex/Pattern;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"hasNextByte","(I)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"hasNextShort","(I)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextShort","(I)S",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.s().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"hasNextInt","(I)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"hasNextLong","(I)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"hasNextBigInteger","(I)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"useRadix","(I)Ljava/util/Scanner;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaScanner::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"useDelimiter","(Ljava/util/regex/Pattern;)Ljava/util/Scanner;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaScanner::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextLong","(I)J",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
...
self.jni_ref().translate_error(res)?;
Ok(res.f().unwrap())}
	pub fn tokens(&mut self) 
-> Result<crate::stream::JavaStream<'mc, String>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"tokens","()Ljava/util/stream/Stream;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextByte","(I)B",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.b().unwrap())}
	pub fn remove(&mut self) 
...
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn has_next(&mut self,arg0: std::option::Option<impl Into<&'mc crate::regex::JavaPattern<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"hasNext","(Ljava/util/regex/Pattern;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.unwrap().into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"next","(Ljava/lang/String;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn skip_with_string(&mut self,arg0: std::option::Option<impl Into<&'mc crate::regex::JavaPattern<'mc>>>) 
-> Result<crate::JavaScanner<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"skip","(Ljava/util/regex/Pattern;)Ljava/util/Scanner;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaScanner::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"nextInt","(I)I",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn find_all_with_pattern(&mut self,arg0: std::option::Option<impl Into<&'mc String>>) 
-> Result<crate::stream::JavaStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.unwrap().into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"findAll","(Ljava/lang/String;)Ljava/util/stream/Stream;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>) 
-> Result<crate::JavaDictionary<'mc>, Box<dyn std::error::Error>>
...
{let val_0 = arg0;
let res = self.jni_ref().call_method(&self.jni_object(),"remove","(Ljava/lang/Object;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn get(&mut self,arg0: jni::objects::JObject<'mc>) 
...
self.jni_ref().translate_error(res)?;
Ok(res.j().unwrap())}
	pub fn for_each_remaining_with_object(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaConsumer<'mc, j>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn for_each_remaining_with_long_consumer(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaLongConsumer<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"forEachRemaining","(Ljava/util/function/LongConsumer;)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn next(&mut self) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaSortedSet<'mc>> for JavaNavigableSet<'mc, E> where E: JNIRaw<'mc>{
...
impl<'mc, K,V> Into<crate::JavaSortedMap<'mc>> for JavaNavigableMap<'mc, K,V> where K: JNIRaw<'mc>,V: JNIRaw<'mc>{
...
if !valid {
	...
	pub fn new_with_appendable(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc String>>) 
...
let cls = &jni.find_class("java/util/Formatter")?;
let res = jni.new_object(cls,
"(Ljava/lang/String;Ljava/lang/String;Ljava/util/Locale;)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
crate::JavaFormatter::from_raw(&jni,res
)}
	pub fn to_string(&mut self) 
-> Result<String, Box<dyn std::error::Error>>
...
let res = self.jni_ref().call_method(&self.jni_object(),"format","(Ljava/util/Locale;Ljava/lang/String;Ljava/lang/Object;)Ljava/util/Formatter;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
...
crate::JavaLocale::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn out(&mut self) 
-> Result<blackboxmc_java::JavaAppendable<'mc>, Box<dyn std::error::Error>>

{let res = self.jni_ref().call_method(&self.jni_object(),"out","()Ljava/lang/Appendable;",&[]);
let res = 
self.jni_ref().translate_error(res)?;
blackboxmc_java::JavaAppendable::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn close(&mut self) 
-> Result<(), Box<dyn std::error::Error>>
...
impl<'mc, T> Into<crate::JavaSpliterator<'mc>> for JavaSpliteratorsAbstractSpliterator<'mc, T> where T: JNIRaw<'mc>{
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.unwrap().into()).unwrap());
let val_1 = jni::objects::JObject::from(self.jni_ref().new_string(arg1.unwrap().into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"getProperty","(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
Ok(self.jni_ref().get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?.to_string_lossy().to_string())}
	pub fn values(&mut self) 
-> Result<crate::JavaCollection<'mc, javaObject>, Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn replace_all(&mut self,arg0: impl Into<&'mc crate::function::JavaBiFunction<'mc, j>>) 
-> Result<(), Box<dyn std::error::Error>>
...
Ok(res.z().unwrap())}
	pub fn elements(&mut self) 
-> Result<crate::JavaEnumeration<'mc, javaObject>, Box<dyn std::error::Error>>
...
crate::JavaEnumeration::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn merge(&mut self,arg0: jni::objects::JObject<'mc>,arg1: jni::objects::JObject<'mc>,arg2: impl Into<&'mc crate::function::JavaBiFunction<'mc, j>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
Ok(res.l().unwrap())}
	pub fn entry_set(&mut self) 
-> Result<crate::JavaSet<'mc, javaMapEntry<javaObject, javaObject>, Box<dyn std::error::Error>>
...
crate::JavaSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn put_all(&mut self,arg0: impl Into<&'mc crate::JavaMap<'mc, dyn JNIRaw<'mc>, dyn JNIRaw<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn compute(&mut self,arg0: jni::objects::JObject<'mc>,arg1: impl Into<&'mc crate::function::JavaBiFunction<'mc, j>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let val_1 = jni::objects::JObject::from(self.jni_ref().new_string(arg1.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setProperty","(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn for_each(&mut self,arg0: impl Into<&'mc crate::function::JavaBiConsumer<'mc, j>>) 
-> Result<(), Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn compute_if_absent(&mut self,arg0: jni::objects::JObject<'mc>,arg1: impl Into<&'mc crate::function::JavaFunction<'mc, j>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
crate::JavaEnumeration::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn key_set(&mut self) 
-> Result<crate::JavaSet<'mc, javaObject>, Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn compute_if_present(&mut self,arg0: jni::objects::JObject<'mc>,arg1: impl Into<&'mc crate::function::JavaBiFunction<'mc, j>>) 
-> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
...
-> Result<crate::JavaEnumeration<'mc, dyn JNIRaw<'mc>>, Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn try_advance_with_consumer(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaLongConsumer<'mc>>>) 
-> Result<bool, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"tryAdvance","(Ljava/util/function/LongConsumer;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn try_advance_with_object(&mut self,arg0: std::option::Option<jni::objects::JObject<'mc>>) 
...
if !valid {
	...
	pub fn for_each_remaining_with_object(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaConsumer<'mc, E>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(res.i().unwrap())}
	pub fn copy_of(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: impl Into<&'mc crate::JavaMapEntry<'mc, K>>) 
-> Result<crate::JavaMapEntry<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let cls = &jni.find_class("java/util/Map$Entry")?;
let res = jni.call_static_method(cls,"copyOf",
"(Ljava/util/Map$Entry;)Ljava/util/Map$Entry;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaMapEntry::from_raw(&jni,obj
)}
	pub fn value(&mut self) 
...
self.jni_ref().translate_error(res)?;
Ok(res.l().unwrap())}
	pub fn comparing_by_key(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, K>>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>
...
crate::JavaComparator::from_raw(&jni,obj
	...
	pub fn comparing_by_value(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaComparator<'mc, V>>>) 
-> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>>
...
crate::JavaEnumSet::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
	...
	pub fn copy_of_with_enum_set(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<impl Into<&'mc crate::JavaCollection<'mc, E>>>) 
-> Result<crate::JavaEnumSet<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let cls = &jni.find_class("java/util/EnumSet")?;
let res = jni.call_static_method(cls,"copyOf",
"(Ljava/util/Collection;)Ljava/util/EnumSet;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
...
"(Ljava/lang/Class;)Ljava/util/EnumSet;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaEnumSet::from_raw(&jni,obj
)}
...
"(Ljava/util/EnumSet;)Ljava/util/EnumSet;",&[jni::objects::JValueGen::from(&val_0)])?;
let mut obj = res.l()?;
crate::JavaEnumSet::from_raw(&jni,obj
)}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
...
impl<'mc, E> Into<crate::JavaAbstractSet<'mc>> for JavaEnumSet<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractSet<'mc> {
       crate::JavaAbstractSet::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setDate","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setMonth","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setHours","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setMinutes","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setSeconds","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
...
{let val_0 = jni::objects::JValueGen::Int(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setYear","(I)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
	pub fn day(&mut self) 
...
"(IIIIII)J",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
Ok(res.j().unwrap())}
	pub fn set_time(&mut self,arg0: i64) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.into());
let res = self.jni_ref().call_method(&self.jni_object(),"setTime","(J)V",&[jni::objects::JValueGen::from(&val_0)]);
self.jni_ref().translate_error(res)?;
Ok(())}
#[deprecated]
...
let cls = &jni.find_class("long")?;
let res = jni.call_static_method(cls,"parse",
"(Ljava/lang/String;)J",&[jni::objects::JValueGen::from(&val_0)])?;
Ok(res.j().unwrap())}
	pub fn equals(&mut self,arg0: jni::objects::JObject<'mc>) 
-> Result<bool, Box<dyn std::error::Error>>
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"before","(Ljava/util/Date;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"after","(Ljava/util/Date;)Z",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.z().unwrap())}
	pub fn wait(&mut self,arg0: std::option::Option<i64>,arg1: std::option::Option<i32>) 
...
if !valid {
	...
	pub fn new(jni: blackboxmc_general::SharedJNIEnv<'mc>,arg0: std::option::Option<i32>) 
-> Result<crate::JavaArrayDeque<'mc>, Box<dyn std::error::Error>>
...
impl<'mc, E> Into<crate::JavaDeque<'mc>> for JavaArrayDeque<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaDeque<'mc, E> {
       crate::JavaDeque::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
impl<'mc, E> Into<crate::JavaAbstractCollection<'mc>> for JavaArrayDeque<'mc, E> where E: JNIRaw<'mc>{
   fn into(self) -> crate::JavaAbstractCollection<'mc> {
       crate::JavaAbstractCollection::from_raw(&self.jni_ref(), self.1).unwrap()
   }
}
...
if !valid {
	...
	pub fn for_each_remaining_with_object(&mut self,arg0: std::option::Option<impl Into<&'mc crate::function::JavaDoubleConsumer<'mc>>>) 
-> Result<(), Box<dyn std::error::Error>>
...
{let res = self.jni_ref().call_method(&self.jni_object(),"next","()D",&[]);
let res = 
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
	pub fn next_double(&mut self) 
...
let res = jni.new_object(cls,
"(Z)V",&[jni::objects::JValueGen::from(&val_0)])?;
...
let cls = &jni.find_class("java/util/Timer")?;
let res = jni.new_object(cls,
"(Ljava/lang/String;Z)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)])?;
crate::JavaTimer::from_raw(&jni,res
)}
...
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let val_2 = jni::objects::JValueGen::Long(arg2.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"schedule","(Ljava/util/TimerTask;Ljava/util/Date;J)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
self.jni_ref().translate_error(res)?;
Ok(())}
	pub fn schedule_at_fixed_rate_with_timer_task(&mut self,arg0: impl Into<&'mc crate::JavaTimerTask<'mc>>,arg1: impl Into<&'mc crate::JavaDate<'mc>>,arg2: std::option::Option<i64>) 
-> Result<(), Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone())};
let val_2 = jni::objects::JValueGen::Long(arg2.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"scheduleAtFixedRate","(Ljava/util/TimerTask;Ljava/util/Date;J)V",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)]);
self.jni_ref().translate_error(res)?;
Ok(())}
...
{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"setLocale","(Ljava/util/Locale;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setLanguage","(Ljava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setScript","(Ljava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JValueGen::Char(arg0.into());
let val_1 = jni::objects::JObject::from(self.jni_ref().new_string(arg1.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setExtension","(CLjava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let val_1 = jni::objects::JObject::from(self.jni_ref().new_string(arg1.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setUnicodeLocaleKeyword","(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"addUnicodeLocaleAttribute","(Ljava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"removeUnicodeLocaleAttribute","(Ljava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setLanguageTag","(Ljava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setVariant","(Ljava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
{let val_0 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
let res = self.jni_ref().call_method(&self.jni_object(),"setRegion","(Ljava/lang/String;)Ljava/util/Locale$Builder;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::JavaLocaleBuilder::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
crate::JavaSplittableRandom::from_raw(&jni,res
	...
	pub fn splits(&mut self,arg0: std::option::Option<i64>) 
-> Result<crate::stream::JavaStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"splits","(J)Ljava/util/stream/Stream;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn splits_with_long(&mut self,arg0: i64,arg1: std::option::Option<impl Into<&'mc crate::random::JavaRandomGeneratorSplittableGenerator<'mc>>>) 
-> Result<crate::stream::JavaStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.into());
let val_1 = unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"splits","(JLjava/util/random/RandomGenerator$SplittableGenerator;)Ljava/util/stream/Stream;",&[jni::objects::JValueGen::from(&val_0),jni::objects::JValueGen::from(&val_1)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
...
-> Result<crate::random::JavaRandomGeneratorSplittableGenerator<'mc>, Box<dyn std::error::Error>>

{let val_0 = unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone())};
let res = self.jni_ref().call_method(&self.jni_object(),"split","(Ljava/util/random/RandomGenerator$SplittableGenerator;)Ljava/util/random/RandomGenerator$SplittableGenerator;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::random::JavaRandomGeneratorSplittableGenerator::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
	pub fn next_int(&mut self,arg0: std::option::Option<i32>,arg1: std::option::Option<i32>) 
-> Result<i32, Box<dyn std::error::Error>>
...
self.jni_ref().translate_error(res)?;
Ok(res.d().unwrap())}
	pub fn rngs(&mut self,arg0: std::option::Option<i64>) 
-> Result<crate::stream::JavaStream<'mc>, Box<dyn std::error::Error>>

{let val_0 = jni::objects::JValueGen::Long(arg0.unwrap().into());
let res = self.jni_ref().call_method(&self.jni_object(),"rngs","(J)Ljava/util/stream/Stream;",&[jni::objects::JValueGen::from(&val_0)]);
let res = 
self.jni_ref().translate_error(res)?;
crate::stream::JavaStream::from_raw(&self.jni_ref(),unsafe { jni::objects::JObject::from_raw(res.l()?.clone()) }
)}
