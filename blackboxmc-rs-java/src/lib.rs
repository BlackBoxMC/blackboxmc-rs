...
pub struct JavaCalendarBuilder<'mc>(
...
impl<'mc> JavaCalendarBuilder<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaCalendarBuilder from null object.").into(),
            );
        }
    ...
    pub fn set_time_zone(
        &mut self,
        arg0: impl Into<&'mc crate::JavaTimeZone<'mc>>,
    ) -> Result<crate::JavaCalendarBuilder<'mc>, Box<dyn std::error::Error>> {
        ...
        crate::JavaCalendarBuilder::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn set_week_date(
        &mut self,
        arg0: i32,
        arg1: i32,
        arg2: i32,
    ...
    pub fn set_time_of_day_with_int(
        &mut self,
        arg0: i32,
        arg1: i32,
    ...
    pub fn set_locale(
        &mut self,
        arg0: impl Into<&'mc crate::JavaLocale<'mc>>,
    ) -> Result<crate::JavaCalendarBuilder<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn build(&mut self) -> Result<crate::JavaCalendar<'mc>, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "build", "()Ljava/util/Calendar;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaCalendar::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn set(
    ...
    E: JNIRaw<'mc>,
{
    ...
    pub fn spliterator(
        &mut self,
    ) -> Result<crate::JavaSpliterator<'mc, /*3*/ E>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "spliterator",
...
pub struct JavaPropertyResourceBundle<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaPropertyResourceBundle<'mc> {
    ...
    pub fn locale(&mut self) -> Result<crate::JavaLocale<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getLocale",
            "()Ljava/util/Locale;",
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaLocale::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn base_bundle_name(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getBaseBundleName",
            "()Ljava/lang/String;",
    ...
    pub fn get_bundle_with_string(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc String>,
        arg1: impl Into<&'mc crate::JavaLocale<'mc>>,
        arg2: impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>,
        arg3: std::option::Option<impl Into<&'mc crate::JavaResourceBundleControl<'mc>>>,
...
"(Ljava/lang/String;Ljava/util/Locale;Ljava/lang/ClassLoader;Ljava/util/ResourceBundle$Control;)Ljava/util/ResourceBundle;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
    ...
    pub fn clear_cache(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 =
    ...
    E: JNIRaw<'mc>,
{
    ...
    pub fn sub_set_with_object(
        ...
        arg2: std::option::Option<E>,
        arg3: std::option::Option<bool>,
    ) -> Result<crate::JavaNavigableSet<'mc, /*3*/ E>, Box<dyn std::error::Error>> {
        let val_1 = arg0.unwrap().jni_object();
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "subSet",
            "(LE;ZLE;Z)Ljava/util/NavigableSet;",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
                jni::objects::JValueGen::from(&val_3),
...
impl<'mc, E> Into<crate::JavaNavigableSet<'mc /* parse_into_impl */, E>> for JavaTreeSet<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn into(self) -> crate::JavaNavigableSet<'mc /* parse_into_impl */, E> {
...
impl<'mc> JavaCurrency<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaCurrency from null object.").into());
        }
    ...
    pub fn symbol(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getSymbol",
            "()Ljava/lang/String;",
    ...
    pub fn currency_code(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getCurrencyCode",
            "()Ljava/lang/String;",
    ...
    pub fn default_fraction_digits(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getDefaultFractionDigits", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn numeric_code(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getNumericCode", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn numeric_code_as_string(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn get_instance_with_string(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::JavaLocale<'mc>>>,
...
pub struct JavaEnumMap<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
impl<'mc> blackboxmc_general::JNIRaw<'mc> for JavaEnumMap<'mc> {
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
        self.0.clone()
    }
...
impl<'mc> JavaEnumMap<'mc> {
    pub fn from_raw(
        env: &blackboxmc_general::SharedJNIEnv<'mc>,
        obj: jni::objects::JObject<'mc>,
    ) -> Result<Self, Box<dyn std::error::Error>> {
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaEnumMap from null object.").into());
        }
    ...
    pub fn put_with_object(
        &mut self,
        arg0: impl Into<&'mc blackboxmc_java::JavaEnum<'mc>>,
        arg1: std::option::Option<V>,
    ) -> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>> {
        let val_1 =
            unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone()) };
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "put",
            "(Ljava/lang/Enum;LV;)Ljava/lang/Object;",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
            ],
    ...
    pub fn clone<K, V>(&mut self) -> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>>
    where
        K: JNIRaw<'mc>,
        V: JNIRaw<'mc>,
    {
...
pub struct JavaSpliteratorsAbstractIntSpliterator<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaSpliteratorsAbstractIntSpliterator<'mc> {
    ...
    pub fn estimate_size(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "estimateSize", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
    pub fn try_split(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaSpliteratorOfInt::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn characteristics(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "characteristics", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn wait(
    ...
    pub fn try_advance_with_object(
        &mut self,
        arg0: std::option::Option<jni::objects::JObject<'mc>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let val_1 = arg0.unwrap();
    ...
    pub fn exact_size_if_known(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getExactSizeIfKnown", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
    pub fn has_characteristics(&mut self, arg0: i32) -> Result<bool, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "hasCharacteristics",
    ...
    pub fn comparator(&mut self) -> Result<crate::JavaComparator<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getComparator",
            "()Ljava/util/Comparator;",
...
pub struct JavaStringJoiner<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaStringJoiner<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaStringJoiner from null object.").into(),
            );
        }
    ...
    pub fn new_with_char_sequence(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc blackboxmc_java::JavaCharSequence<'mc>>>,
        arg1: std::option::Option<impl Into<&'mc blackboxmc_java::JavaCharSequence<'mc>>>,
        arg2: std::option::Option<impl Into<&'mc blackboxmc_java::JavaCharSequence<'mc>>>,
    ...
    pub fn set_empty_value(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaStringJoiner::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn add(
    ...
    pub fn merge(
        &mut self,
        arg0: impl Into<&'mc crate::JavaStringJoiner<'mc>>,
    ) -> Result<crate::JavaStringJoiner<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
...
pub struct JavaGregorianCalendar<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaGregorianCalendar<'mc> {
    ...
    pub fn new(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::JavaTimeZone<'mc>>>,
    ...
    pub fn calendar_type(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getCalendarType",
            "()Ljava/lang/String;",
    ...
    pub fn get_greatest_minimum(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getGreatestMinimum",
    ...
    pub fn get_minimum(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getMinimum",
    ...
    pub fn get_least_maximum(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getLeastMaximum",
    ...
    pub fn get_maximum(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getMaximum",
    ...
    pub fn is_week_date_supported(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isWeekDateSupported", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn week_year(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getWeekYear", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn set_week_date(
    ...
    pub fn weeks_in_week_year(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getWeeksInWeekYear", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn get_actual_minimum(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getActualMinimum",
    ...
    pub fn get_actual_maximum(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getActualMaximum",
    ...
    pub fn time_zone(&mut self) -> Result<crate::JavaTimeZone<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getTimeZone",
            "()Ljava/util/TimeZone;",
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaTimeZone::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn is_leap_year(&mut self, arg0: i32) -> Result<bool, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "isLeapYear",
    ...
    pub fn gregorian_change(&mut self) -> Result<crate::JavaDate<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getGregorianChange",
            "()Ljava/util/Date;",
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaDate::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn add(&mut self, arg0: i32, arg1: i32) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let val_2 = jni::objects::JValueGen::Int(arg1.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn get_display_names(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaMap::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    ...
    pub fn is_lenient(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isLenient", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn set_first_day_of_week(&mut self, arg0: i32) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "setFirstDayOfWeek",
    ...
    pub fn first_day_of_week(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getFirstDayOfWeek", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn set_minimal_days_in_first_week(
        &mut self,
        arg0: i32,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
    ...
    pub fn minimal_days_in_first_week(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getMinimalDaysInFirstWeek", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn time(&mut self) -> Result<crate::JavaDate<'mc>, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getTime", "()Ljava/util/Date;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaDate::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    ...
    pub fn set_time_in_millis(&mut self, arg0: i64) -> Result<(), Box<dyn std::error::Error>> {
    ...
    pub fn set_lenient(&mut self, arg0: bool) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Bool(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "setLenient",
    ...
    pub fn time_in_millis(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getTimeInMillis", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
    pub fn before(
    ...
    pub fn compare_to_with_calendar(
        &mut self,
        arg0: std::option::Option<jni::objects::JObject<'mc>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = arg0.unwrap();
    ...
    pub fn instance(
        ...
        let res = jni.call_static_method(cls, "getInstance", "()Ljava/util/Calendar;", &[])?;
        let mut obj = res.l()?;
    ...
    pub fn is_set(&mut self, arg0: i32) -> Result<bool, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "isSet",
...
pub struct JavaServiceLoader<'mc, S>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    S: JNIRaw<'mc>;
impl<'mc, S> blackboxmc_general::JNIRaw<'mc> for JavaServiceLoader<'mc, S>
where
    S: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
...
impl<'mc, S> JavaServiceLoader<'mc, S>
where
    S: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaServiceLoader from null object.").into(),
            );
        }
    ...
    ) -> Result<crate::JavaServiceLoader<'mc, /*3*/ S>, Box<dyn std::error::Error>> {
        let val_1 = arg0;
    ...
    pub fn load_with_class(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: jni::objects::JClass<'mc>,
        arg1: std::option::Option<impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>>,
    ) -> Result<crate::JavaServiceLoader<'mc, /*3*/ S>, Box<dyn std::error::Error>> {
        let val_1 = arg0.unwrap();
        let val_2 =
            unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone()) };
    ...
    pub fn iterator(
        &mut self,
    ) -> Result<crate::JavaIterator<'mc, /*3*/ S>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "iterator",
            "()Ljava/util/Iterator;",
    ...
    pub fn find_first(
        &mut self,
    ) -> Result<crate::JavaOptional<'mc, /*3*/ S>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "findFirst",
            "()Ljava/util/Optional;",
    ...
    pub fn spliterator(
        &mut self,
    ) -> Result<crate::JavaSpliterator<'mc, /*3*/ S>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "spliterator",
            "()Ljava/util/Spliterator;",
...
pub struct JavaLongSummaryStatistics<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaLongSummaryStatistics<'mc> {
    ...
    pub fn count(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getCount", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
    pub fn sum(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getSum", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
    pub fn min(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getMin", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
    pub fn average(&mut self) -> Result<f64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getAverage", "()D", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.d().unwrap())
    }
    pub fn max(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getMax", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
    pub fn to_string(&mut self) -> Result<String, Box<dyn std::error::Error>> {
    ...
    pub fn combine(
        &mut self,
        arg0: impl Into<&'mc crate::JavaLongSummaryStatistics<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
...
impl<'mc> JavaTimeZone<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaTimeZone from null object.").into());
        }
    ...
    pub fn raw_offset(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getRawOffset", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    ...
    pub fn dstsavings(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getDSTSavings", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn use_daylight_time(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "useDaylightTime", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn set_id(
    ...
    pub fn set_raw_offset(&mut self, arg0: i32) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "setRawOffset",
    ...
    pub fn observes_daylight_time(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "observesDaylightTime", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn get_time_zone_with_zone_id(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
    ...
    pub fn get_display_name_with_locale(
        &mut self,
    ...
    pub fn get_display_name_with_boolean(
        &mut self,
        arg0: bool,
        arg1: i32,
        arg2: std::option::Option<impl Into<&'mc crate::JavaLocale<'mc>>>,
    ) -> Result<String, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Bool(arg0.into());
        let val_2 = jni::objects::JValueGen::Int(arg1.unwrap().into());
        let val_3 =
    ...
    pub fn id(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getID", "()Ljava/lang/String;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(self
            .jni_ref()
            .get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?
    ...
    pub fn default(
        ...
        let cls = &jni.find_class("java/util/TimeZone")?;
        let res = jni.call_static_method(cls, "getDefault", "()Ljava/util/TimeZone;", &[])?;
        let mut obj = res.l()?;
        crate::JavaTimeZone::from_raw(&jni, obj)
    }
    pub fn get_offset_with_long(
        &mut self,
        arg0: std::option::Option<i32>,
        arg1: std::option::Option<i32>,
        arg2: std::option::Option<i32>,
...
pub struct JavaSortedMap<'mc, K, V>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>;
impl<'mc, K, V> JavaSortedMap<'mc, K, V>
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaSortedMap from null object.").into());
        }
    ...
    pub fn sub_map(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaSortedMap::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn head_map(
...
impl<'mc, K, V> JNIRaw<'mc> for JavaSortedMap<'mc, K, V>
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>,
{
...
impl<'mc> JavaArrays<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaArrays from null object.").into());
        }
    ...
    pub fn mismatch_with_doubles(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i64>,
        arg1: std::option::Option<Vec<i64>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "mismatch", "(JJ)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn mismatch_with_objects(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<f32>,
        arg1: std::option::Option<Vec<f32>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "mismatch", "(FF)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn mismatch_with_chars(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<jni::objects::JObject<'mc>>,
        arg1: i32,
        arg2: i32,
        ...
        let res = jni.call_static_method(
            cls,
            "mismatch",
            "(Ljava/lang/Object;IILjava/lang/Object;II)I",
            &[
                jni::objects::JValueGen::from(&val_2),
                jni::objects::JValueGen::from(&val_3),
                jni::objects::JValueGen::from(&val_5),
    ...
    pub fn deep_hash_code(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<jni::objects::JObject<'mc>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "deepHashCode", "(Ljava/lang/Object;)I", &[])?;
        Ok(res.i().unwrap())
    }
    ...
    pub fn parallel_sort_with_floats(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<f64>,
        arg1: i32,
        arg2: std::option::Option<i32>,
    ...
    pub fn parallel_sort_with_comparables(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<f64>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let cls = &jni.find_class("void")?;
        let res = jni.call_static_method(cls, "parallelSort", "(D)V", &[])?;
        Ok(())
    }
    pub fn parallel_sort_with_longs(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<u16>,
        arg1: i32,
        arg2: std::option::Option<i32>,
    ...
    pub fn parallel_sort_with_objects(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<impl Into<&'mc blackboxmc_java::JavaComparable<'mc>>>,
        arg1: std::option::Option<i32>,
        arg2: std::option::Option<i32>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_2 = jni::objects::JValueGen::Int(arg1.unwrap().into());
    ...
    pub fn parallel_sort_with_bytes(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i32>,
        arg1: i32,
        arg2: std::option::Option<i32>,
    ...
    pub fn binary_search_with_objects(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<u16>,
        arg1: i32,
        arg2: i32,
        arg3: std::option::Option<u16>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let val_2 = jni::objects::JValueGen::Int(arg1.into());
        let val_3 = jni::objects::JValueGen::Int(arg2.unwrap().into());
    ...
    pub fn binary_search_with_ints(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i16>,
        arg1: i32,
        arg2: i32,
        arg3: std::option::Option<i16>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let val_2 = jni::objects::JValueGen::Int(arg1.into());
        let val_3 = jni::objects::JValueGen::Int(arg2.unwrap().into());
    ...
    pub fn binary_search_with_shorts(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i64>,
        arg1: std::option::Option<i64>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
    ...
    pub fn binary_search_with_doubles(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i8>,
        arg1: i32,
        arg2: i32,
    ...
    pub fn equals_with_object(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<f64>>,
        arg1: std::option::Option<Vec<f64>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("boolean")?;
        let res = jni.call_static_method(cls, "equals", "(DD)Z", &[])?;
        Ok(res.z().unwrap())
    }
    pub fn equals_with_booleans(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i8>,
        arg1: i32,
        arg2: i32,
    ...
    pub fn equals_with_floats(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i16>,
        arg1: std::option::Option<Vec<i16>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("boolean")?;
        let res = jni.call_static_method(cls, "equals", "(SS)Z", &[])?;
        Ok(res.z().unwrap())
    }
    pub fn equals_with_ints(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i64>,
        arg1: i32,
        arg2: i32,
    ...
    pub fn equals_with_bytes(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<u16>,
        arg1: std::option::Option<Vec<u16>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("boolean")?;
        let res = jni.call_static_method(cls, "equals", "(CC)Z", &[])?;
        Ok(res.z().unwrap())
    }
    pub fn equals_with_chars(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i16>,
        arg1: i32,
        arg2: i32,
    ...
    pub fn to_string(
        ...
        let cls = &jni.find_class("java/lang/String")?;
        let res = jni.call_static_method(cls, "toString", "(C)Ljava/lang/String;", &[])?;
        Ok(jni
            .get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?
            .to_string_lossy()
            .to_string())
    }
    pub fn to_string_with_shorts(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<i32>>,
    ) -> Result<String, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("java/lang/String")?;
        let res = jni.call_static_method(cls, "toString", "(I)Ljava/lang/String;", &[])?;
        Ok(jni
            .get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?
            .to_string_lossy()
            .to_string())
    }
    pub fn to_string_with_longs(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
    ...
    pub fn to_string_with_doubles(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<f32>>,
    ) -> Result<String, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("java/lang/String")?;
        let res = jni.call_static_method(cls, "toString", "(F)Ljava/lang/String;", &[])?;
        Ok(jni
            .get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?
            .to_string_lossy()
            .to_string())
    }
    pub fn to_string_with_booleans(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<bool>>,
    ) -> Result<String, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("java/lang/String")?;
        let res = jni.call_static_method(cls, "toString", "(Z)Ljava/lang/String;", &[])?;
        Ok(jni
            .get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?
            .to_string_lossy()
            .to_string())
    ...
    pub fn hash_code(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<i16>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "hashCode", "(S)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn hash_code_with_bytes(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<i32>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "hashCode", "(I)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn hash_code_with_longs(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<jni::objects::JObject<'mc>>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "hashCode", "(Ljava/lang/Object;)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn hash_code_with_doubles(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<f32>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "hashCode", "(F)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn hash_code_with_booleans(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<bool>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "hashCode", "(Z)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn compare_with_ints(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<u16>,
        arg1: std::option::Option<Vec<u16>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "compare", "(CC)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn compare_with_longs(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i8>,
        arg1: i32,
        arg2: i32,
    ...
    pub fn compare_with_comparables(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<f32>,
        arg1: i32,
        arg2: i32,
    ...
    pub fn spliterator_with_objects<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<i32>>,
    ) -> Result<crate::JavaSpliteratorOfInt<'mc>, Box<dyn std::error::Error>>
    where
        T: JNIRaw<'mc>,
    {
        ...
        let res =
            jni.call_static_method(cls, "spliterator", "(I)Ljava/util/Spliterator$OfInt;", &[])?;
        let mut obj = res.l()?;
        crate::JavaSpliteratorOfInt::from_raw(&jni, obj)
    }
    pub fn spliterator_with_longs<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<f64>>,
    ...
    pub fn spliterator_with_doubles<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<jni::objects::JObject<'mc>>,
        arg1: i32,
        arg2: std::option::Option<i32>,
    ...
    pub fn spliterator_with_ints<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i64>,
        arg1: i32,
        arg2: std::option::Option<i32>,
        ...
        T: JNIRaw<'mc>,
    {
        ...
        let res =
            jni.call_static_method(cls, "asList", "(Ljava/lang/Object;)Ljava/util/List;", &[])?;
        let mut obj = res.l()?;
        crate::JavaList::from_raw(&jni, obj)
    }
    pub fn sort_with_objects(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<u16>,
        arg1: i32,
        arg2: std::option::Option<i32>,
    ...
    pub fn sort_with_floats(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<f64>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let cls = &jni.find_class("void")?;
        let res = jni.call_static_method(cls, "sort", "(D)V", &[])?;
        Ok(())
    }
    pub fn sort_with_longs(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i32>,
        arg1: i32,
        arg2: std::option::Option<i32>,
    ...
    pub fn sort_with_chars(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<i16>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let cls = &jni.find_class("void")?;
        let res = jni.call_static_method(cls, "sort", "(S)V", &[])?;
        Ok(())
    }
    pub fn sort_with_doubles(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i8>,
        arg1: i32,
        arg2: std::option::Option<i32>,
    ...
    pub fn compare_unsigned_with_shorts(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i64>,
        arg1: i32,
        arg2: i32,
    ...
    pub fn compare_unsigned_with_longs(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i8>,
        arg1: std::option::Option<Vec<i8>>,
    ) -> Result<i32, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "compareUnsigned", "(BB)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn compare_unsigned_with_bytes(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i32>,
        arg1: i32,
        arg2: i32,
    ...
    V: JNIRaw<'mc>,
{
    ...
    pub fn of_entries(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<Javacrate::JavaMapEntry<K, V, 'mc>>,
    ) -> Result<crate::JavaMap<'mc>, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("java/util/Map")?;
        let res = jni.call_static_method(
            cls,
...
pub struct JavaPropertyPermission<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
pub struct JavaSortedSet<'mc, E>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    E: JNIRaw<'mc>;
impl<'mc, E> JavaSortedSet<'mc, E>
where
    E: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaSortedSet from null object.").into());
        }
    ...
    pub fn sub_set(
        ...
        arg0: E,
        arg1: E,
    ) -> Result<crate::JavaSortedSet<'mc, /*3*/ E>, Box<dyn std::error::Error>> {
        let val_1 = arg0.jni_object();
        let val_2 = arg1.jni_object();
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "subSet",
            "(LE;LE;)Ljava/util/SortedSet;",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
            ],
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaSortedSet::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn head_set(
...
impl<'mc, E> JNIRaw<'mc> for JavaSortedSet<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
...
impl<'mc, E> Into<crate::JavaSet<'mc /* parse_into_impl */, E>> for JavaSortedSet<'mc, E>
where
    E: JNIRaw<'mc>,
{
...
pub struct JavaIntSummaryStatistics<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaIntSummaryStatistics<'mc> {
    ...
    pub fn min(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getMin", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn average(&mut self) -> Result<f64, Box<dyn std::error::Error>> {
    ...
    pub fn max(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getMax", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn to_string(&mut self) -> Result<String, Box<dyn std::error::Error>> {
    ...
    pub fn combine(
        &mut self,
        arg0: impl Into<&'mc crate::JavaIntSummaryStatistics<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
...
pub struct JavaSimpleTimeZone<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaSimpleTimeZone<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaSimpleTimeZone from null object.").into(),
            );
        }
    ...
    pub fn new_with_int(
        ...
        arg8: std::option::Option<i32>,
        arg9: std::option::Option<i32>,
        arg10: std::option::Option<i32>,
        arg11: std::option::Option<i32>,
        arg12: std::option::Option<i32>,
    ...
    pub fn set_start_rule_with_int(
        &mut self,
        arg0: i32,
        arg1: i32,
        arg2: std::option::Option<i32>,
    ...
    pub fn set_start_year(&mut self, arg0: i32) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "setStartYear",
    ...
    pub fn set_dstsavings(&mut self, arg0: i32) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "setDSTSavings",
...
pub struct JavaListResourceBundle<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaObserver<'mc> {
    ...
    pub fn update(
        &mut self,
        arg0: impl Into<&'mc crate::JavaObservable<'mc>>,
...
pub struct JavaSpliterator<'mc, T>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    T: JNIRaw<'mc>;
impl<'mc, T> JavaSpliterator<'mc, T>
where
    T: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaSpliterator from null object.").into(),
            );
        }
    ...
    pub fn try_split(
        &mut self,
    ) -> Result<crate::JavaSpliterator<'mc, /*3*/ T>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "trySplit",
            "()Ljava/util/Spliterator;",
...
impl<'mc, T> JNIRaw<'mc> for JavaSpliterator<'mc, T>
where
    T: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
    ...
    V: JNIRaw<'mc>,
{
    ...
    pub fn elements(&mut self) -> Result<crate::JavaEnumeration<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "elements",
            "()Ljava/util/Enumeration;",
    ...
    pub fn keys(&mut self) -> Result<crate::JavaEnumeration<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "keys",
            "()Ljava/util/Enumeration;",
...
impl<'mc> JavaCalendar<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaCalendar from null object.").into());
        }
...
impl<'mc> JavaOptionalInt<'mc> {
    ...
    pub fn or_else<X>(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>>
    where
        X: Into<crate::JavaThrowable<'mc>>,
    {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
...
pub struct JavaDoubleSummaryStatistics<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaDoubleSummaryStatistics<'mc> {
    ...
    pub fn sum(&mut self) -> Result<f64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getSum", "()D", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.d().unwrap())
    }
    pub fn min(&mut self) -> Result<f64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getMin", "()D", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.d().unwrap())
    }
    pub fn average(&mut self) -> Result<f64, Box<dyn std::error::Error>> {
    ...
    pub fn max(&mut self) -> Result<f64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getMax", "()D", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.d().unwrap())
    }
    pub fn to_string(&mut self) -> Result<String, Box<dyn std::error::Error>> {
    ...
    pub fn combine(
        &mut self,
        arg0: impl Into<&'mc crate::JavaDoubleSummaryStatistics<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    V: JNIRaw<'mc>,
{
    ...
    pub fn sub_map_with_object(
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "subMap",
            "(LK;ZLK;Z)Ljava/util/NavigableMap;",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
                jni::objects::JValueGen::from(&val_3),
...
impl<'mc> JavaFormattable<'mc> {
    ...
    pub fn format_to(
        &mut self,
        arg0: impl Into<&'mc crate::JavaFormatter<'mc>>,
        arg1: i32,
        arg2: i32,
        arg3: i32,
    ) -> Result<(), Box<dyn std::error::Error>> {
...
impl<'mc> JavaOptionalDouble<'mc> {
    ...
    pub fn or_else<X>(&mut self, arg0: f64) -> Result<f64, Box<dyn std::error::Error>>
    where
        X: Into<crate::JavaThrowable<'mc>>,
    {
        let val_1 = jni::objects::JValueGen::Double(arg0.into());
...
impl<'mc> JavaObservable<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaObservable from null object.").into(),
            );
        }
    ...
    pub fn add_observer(
        &mut self,
        arg0: impl Into<&'mc crate::JavaObserver<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn delete_observers(&mut self) -> Result<(), Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "deleteObservers", "()V", &[]);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    pub fn has_changed(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "hasChanged", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn count_observers(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "countObservers", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn wait(
...
pub struct JavaStringTokenizer<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaStringTokenizer<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaStringTokenizer from null object.").into(),
            );
        }
    ...
    pub fn has_more_tokens(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "hasMoreTokens", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn count_tokens(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "countTokens", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn has_more_elements(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
    ...
    pub fn as_iterator(&mut self) -> Result<crate::JavaIterator<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "asIterator",
            "()Ljava/util/Iterator;",
...
impl<'mc> JavaOptionalLong<'mc> {
    ...
    pub fn or_else<X>(&mut self, arg0: i64) -> Result<i64, Box<dyn std::error::Error>>
    where
        X: Into<crate::JavaThrowable<'mc>>,
    {
        let val_1 = jni::objects::JValueGen::Long(arg0.into());
...
impl<'mc> JavaLocale<'mc> {
    ...
    pub fn display_script(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getDisplayScript",
            "()Ljava/lang/String;",
    ...
    pub fn get_extension(&mut self, arg0: u16) -> Result<String, Box<dyn std::error::Error>> {
    ...
    pub fn to_language_tag(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "toLanguageTag",
            "()Ljava/lang/String;",
    ...
    pub fn iso3language(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getISO3Language",
            "()Ljava/lang/String;",
    ...
    pub fn iso3country(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getISO3Country",
            "()Ljava/lang/String;",
    ...
    pub fn language(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getLanguage",
            "()Ljava/lang/String;",
    ...
    pub fn script(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getScript",
            "()Ljava/lang/String;",
    ...
    pub fn country(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getCountry",
            "()Ljava/lang/String;",
    ...
    pub fn variant(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getVariant",
            "()Ljava/lang/String;",
    ...
    pub fn set_default_with_locale(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::JavaLocaleCategory<'mc>>>,
        arg1: std::option::Option<impl Into<&'mc crate::JavaLocale<'mc>>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 =
            unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone()) };
        let val_2 =
    ...
    pub fn has_extensions(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "hasExtensions", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    ...
    pub fn default(
        ...
        let cls = &jni.find_class("java/util/Locale")?;
        let res = jni.call_static_method(cls, "getDefault", "()Ljava/util/Locale;", &[])?;
        let mut obj = res.l()?;
        crate::JavaLocale::from_raw(&jni, obj)
    }
    pub fn wait(
...
pub struct JavaSpliteratorOfPrimitive<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
impl<'mc> JavaSpliteratorOfPrimitive<'mc> {
    ...
    pub fn try_split(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaSpliteratorOfPrimitive::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn estimate_size(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
...
impl<'mc> JavaBase64Encoder<'mc> {
    ...
    pub fn without_padding(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaBase64Encoder::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
...
impl<'mc> JavaCollections<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaCollections from null object.").into(),
            );
        }
        ...
        T: JNIRaw<'mc>,
    {
        ...
        let res =
            jni.call_static_method(cls, "emptyListIterator", "()Ljava/util/ListIterator;", &[])?;
        let mut obj = res.l()?;
    ...
    {
        let cls = &jni.find_class("java/util/Set")?;
        let res = jni.call_static_method(cls, "emptySet", "()Ljava/util/Set;", &[])?;
        let mut obj = res.l()?;
        crate::JavaSet::from_raw(&jni, obj)
    }
    pub fn empty_sorted_set<E>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        ...
        E: JNIRaw<'mc>,
    {
        ...
        let res = jni.call_static_method(cls, "emptySortedSet", "()Ljava/util/SortedSet;", &[])?;
        let mut obj = res.l()?;
        crate::JavaSortedSet::from_raw(&jni, obj)
    }
    pub fn empty_navigable_set<E>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
    ) -> Result<crate::JavaNavigableSet<'mc>, Box<dyn std::error::Error>>
    where
        E: JNIRaw<'mc>,
    {
        ...
        let res =
            jni.call_static_method(cls, "emptyNavigableSet", "()Ljava/util/NavigableSet;", &[])?;
        let mut obj = res.l()?;
        crate::JavaNavigableSet::from_raw(&jni, obj)
    }
    pub fn empty_map<K, V>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
    ) -> Result<crate::JavaMap<'mc>, Box<dyn std::error::Error>>
    where
        K: JNIRaw<'mc>,
    ...
    {
        let cls = &jni.find_class("java/util/Map")?;
        let res = jni.call_static_method(cls, "emptyMap", "()Ljava/util/Map;", &[])?;
        let mut obj = res.l()?;
        crate::JavaMap::from_raw(&jni, obj)
    }
    pub fn empty_sorted_map<K, V>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
    ) -> Result<crate::JavaSortedMap<'mc>, Box<dyn std::error::Error>>
    where
        K: JNIRaw<'mc>,
        V: JNIRaw<'mc>,
    {
        ...
        let res = jni.call_static_method(cls, "emptySortedMap", "()Ljava/util/SortedMap;", &[])?;
        let mut obj = res.l()?;
        crate::JavaSortedMap::from_raw(&jni, obj)
    }
    pub fn empty_navigable_map<K, V>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
    ) -> Result<crate::JavaNavigableMap<'mc>, Box<dyn std::error::Error>>
    where
        K: JNIRaw<'mc>,
        V: JNIRaw<'mc>,
    {
        ...
        let res =
            jni.call_static_method(cls, "emptyNavigableMap", "()Ljava/util/NavigableMap;", &[])?;
        let mut obj = res.l()?;
        ...
        T: JNIRaw<'mc>,
    {
        ...
        let res =
            jni.call_static_method(cls, "emptyEnumeration", "()Ljava/util/Enumeration;", &[])?;
        let mut obj = res.l()?;
    ...
    {
        let cls = &jni.find_class("java/util/List")?;
        let res = jni.call_static_method(cls, "emptyList", "()Ljava/util/List;", &[])?;
        let mut obj = res.l()?;
        crate::JavaList::from_raw(&jni, obj)
    }
    pub fn empty_iterator<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        ...
        T: JNIRaw<'mc>,
    {
        ...
        let res = jni.call_static_method(cls, "emptyIterator", "()Ljava/util/Iterator;", &[])?;
        let mut obj = res.l()?;
...
impl<'mc> JavaBitSet<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaBitSet from null object.").into());
        }
    ...
    pub fn cardinality(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "cardinality", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn next_set_bit(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "nextSetBit",
    ...
    pub fn previous_set_bit(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "previousSetBit",
    ...
    pub fn previous_clear_bit(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "previousClearBit",
    ...
    pub fn intersects(
        &mut self,
        arg0: impl Into<&'mc crate::JavaBitSet<'mc>>,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn get_with_int(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaBitSet::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn equals(
    ...
    pub fn value_of_with_byte_buffer(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<Vec<i64>>,
    ) -> Result<crate::JavaBitSet<'mc>, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("java/util/BitSet")?;
        let res = jni.call_static_method(cls, "valueOf", "(J)Ljava/util/BitSet;", &[])?;
        let mut obj = res.l()?;
    ...
    pub fn next_clear_bit(&mut self, arg0: i32) -> Result<i32, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "nextClearBit",
...
pub struct JavaPriorityQueue<'mc, E>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    E: JNIRaw<'mc>;
impl<'mc, E> blackboxmc_general::JNIRaw<'mc> for JavaPriorityQueue<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
...
impl<'mc, E> JavaPriorityQueue<'mc, E>
where
    E: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaPriorityQueue from null object.").into(),
            );
        }
...
impl<'mc, E> Into<crate::JavaAbstractQueue<'mc /* parse_into_impl */, E>>
    for JavaPriorityQueue<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn into(self) -> crate::JavaAbstractQueue<'mc /* parse_into_impl */, E> {
        crate::JavaAbstractQueue::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
pub struct JavaEventObject<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaEventObject<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaEventObject from null object.").into(),
            );
        }
...
pub struct JavaStack<'mc, E>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    E: JNIRaw<'mc>;
impl<'mc, E> blackboxmc_general::JNIRaw<'mc> for JavaStack<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
    ...
    E: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaStack from null object.").into());
        }
    ...
    pub fn new(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
    ) -> Result<crate::JavaStack<'mc, /*3*/ E>, Box<dyn std::error::Error>> {
    ...
    pub fn empty(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "empty", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn peek(&mut self) -> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>> {
...
impl<'mc, E> Into<crate::JavaVector<'mc /* parse_into_impl */, E>> for JavaStack<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn into(self) -> crate::JavaVector<'mc /* parse_into_impl */, E> {
        crate::JavaVector::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
pub struct JavaSpliterators<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaSpliterators<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaSpliterators from null object.").into(),
            );
        }
    ...
    pub fn empty_double_spliterator(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
    ) -> Result<crate::JavaSpliteratorOfDouble<'mc>, Box<dyn std::error::Error>> {
        let cls = &jni.find_class("java/util/Spliterator$OfDouble")?;
        let res = jni.call_static_method(
        ...
        T: JNIRaw<'mc>,
    {
        let cls = &jni.find_class("java/util/Spliterator")?;
        let res =
            jni.call_static_method(cls, "emptySpliterator", "()Ljava/util/Spliterator;", &[])?;
        let mut obj = res.l()?;
        crate::JavaSpliterator::from_raw(&jni, obj)
    }
    pub fn iterator_with_spliterator<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::JavaSpliteratorOfLong<'mc>>>,
    ...
    pub fn iterator_with_spliteratorof_double<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::JavaSpliteratorOfInt<'mc>>>,
    ...
    pub fn spliterator_unknown_size_with_primitive_iteratorof_int<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::JavaPrimitiveIteratorOfDouble<'mc>>,
        arg1: std::option::Option<i32>,
    ) -> Result<crate::JavaSpliteratorOfDouble<'mc>, Box<dyn std::error::Error>>
    where
        T: JNIRaw<'mc>,
    {
        ...
        let res = jni.call_static_method(
            ...
            "(Ljava/util/PrimitiveIterator$OfDouble;I)Ljava/util/Spliterator$OfDouble;",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
            ],
    ...
    pub fn spliterator_with_collection<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<f64>,
        arg1: std::option::Option<i32>,
    ) -> Result<crate::JavaSpliteratorOfDouble<'mc>, Box<dyn std::error::Error>>
    ...
    pub fn spliterator_with_objects<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::JavaPrimitiveIteratorOfLong<'mc>>,
        arg1: std::option::Option<i64>,
        arg2: std::option::Option<i32>,
    ) -> Result<crate::JavaSpliteratorOfLong<'mc>, Box<dyn std::error::Error>>
    where
        T: JNIRaw<'mc>,
    {
        ...
        let res = jni.call_static_method(
            cls,
            "spliterator",
            "(Ljava/util/PrimitiveIterator$OfLong;JI)Ljava/util/Spliterator$OfLong;",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
                jni::objects::JValueGen::from(&val_3),
    ...
    pub fn spliterator_with_primitive_iteratorof_double<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::JavaPrimitiveIteratorOfInt<'mc>>,
        arg1: i64,
        arg2: std::option::Option<i32>,
    ) -> Result<crate::JavaSpliteratorOfInt<'mc>, Box<dyn std::error::Error>>
    where
    ...
    pub fn spliterator_with_iterator<T>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: Vec<i64>,
        arg1: i32,
        arg2: std::option::Option<i32>,
...
impl<'mc> JavaLocaleLanguageRange<'mc> {
    ...
    pub fn range(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "getRange", "()Ljava/lang/String;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(self
            .jni_ref()
            .get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?
    ...
    pub fn weight(&mut self) -> Result<f64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "getWeight", "()D", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.d().unwrap())
    }
    pub fn equals(
...
pub struct JavaSpliteratorOfDouble<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
impl<'mc> JavaSpliteratorOfDouble<'mc> {
    ...
    pub fn try_split(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaSpliteratorOfDouble::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn for_each_remaining_with_consumer(
...
pub struct JavaEventListenerProxy<'mc, T>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    T: Into<crate::JavaEventListener<'mc>>;
impl<'mc, T> blackboxmc_general::JNIRaw<'mc> for JavaEventListenerProxy<'mc, T>
where
    T: Into<crate::JavaEventListener<'mc>>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
...
impl<'mc, T> JavaEventListenerProxy<'mc, T>
where
    T: Into<crate::JavaEventListener<'mc>>,
{
    pub fn from_raw(
    ...
    pub fn new(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::JavaEventListener<'mc>>,
    ) -> Result<crate::JavaEventListenerProxy<'mc, /*3*/ T>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
    ...
    pub fn listener(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaEventListener::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn wait(
...
pub struct JavaResourceBundleControl<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaResourceBundleControl<'mc> {
    ...
    pub fn new_bundle(
        ...
        arg3: impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>,
        arg4: bool,
    ) -> Result<crate::JavaResourceBundle<'mc>, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
    ...
    pub fn needs_reload(
        ...
        arg2: impl Into<&'mc String>,
        arg3: impl Into<&'mc blackboxmc_java::JavaClassLoader<'mc>>,
        arg4: impl Into<&'mc crate::JavaResourceBundle<'mc>>,
        arg5: i64,
    ) -> Result<bool, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JObject::from(self.jni_ref().new_string(arg0.into()).unwrap());
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
...
impl<'mc> JavaObjects<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaObjects from null object.").into());
        }
    ...
    pub fn hash(
        ...
        let cls = &jni.find_class("int")?;
        let res = jni.call_static_method(cls, "hash", "(Ljava/lang/Object;)I", &[])?;
        Ok(res.i().unwrap())
    }
    pub fn require_non_null_with_object(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        ...
        let res = jni.call_static_method(
            cls,
            "requireNonNull",
            "(LT;Ljava/lang/String;)Ljava/lang/Object;",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
            ],
    ...
    pub fn check_from_index_size_with_int(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: i64,
        arg1: i64,
        arg2: std::option::Option<i64>,
    ...
    pub fn check_from_to_index_with_long(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: i32,
        arg1: i32,
        arg2: std::option::Option<i32>,
...
pub struct JavaResourceBundle<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaResourceBundle<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaResourceBundle from null object.").into(),
            );
        }
...
pub struct JavaSpliteratorOfInt<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
impl<'mc> JavaSpliteratorOfInt<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaSpliteratorOfInt from null object.").into(),
            );
        }
...
pub struct JavaDictionary<'mc, K, V>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>;
impl<'mc, K, V> blackboxmc_general::JNIRaw<'mc> for JavaDictionary<'mc, K, V>
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>,
{
...
impl<'mc, K, V> JavaDictionary<'mc, K, V>
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaDictionary from null object.").into(),
            );
        }
...
impl<'mc> JavaScanner<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaScanner from null object.").into());
        }
    ...
    pub fn next_float(&mut self) -> Result<f32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "nextFloat", "()F", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.f().unwrap())
    }
    pub fn use_locale(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaScanner::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn find_within_horizon_with_string(
        &mut self,
    ...
    pub fn find_in_line_with_string(
        &mut self,
        arg0: std::option::Option<impl Into<&'mc crate::regex::JavaPattern<'mc>>>,
    ) -> Result<String, Box<dyn std::error::Error>> {
        let val_1 =
            unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
    ...
    pub fn use_delimiter_with_string(
        &mut self,
        arg0: std::option::Option<impl Into<&'mc crate::regex::JavaPattern<'mc>>>,
    ) -> Result<crate::JavaScanner<'mc>, Box<dyn std::error::Error>> {
        let val_1 =
    ...
    pub fn has_next_line(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "hasNextLine", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn next_line(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "nextLine", "()Ljava/lang/String;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(self
            .jni_ref()
            .get_string(unsafe { &jni::objects::JString::from_raw(res.as_jni().l) })?
    ...
    pub fn has_next_boolean(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "hasNextBoolean", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn has_next_float(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "hasNextFloat", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn has_next_double(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "hasNextDouble", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn has_next_big_decimal(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "hasNextBigDecimal", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    ...
    pub fn locale(&mut self) -> Result<crate::JavaLocale<'mc>, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "locale", "()Ljava/util/Locale;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaLocale::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    ...
    pub fn reset(&mut self) -> Result<crate::JavaScanner<'mc>, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "reset", "()Ljava/util/Scanner;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaScanner::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn radix(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "radix", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn wait(
...
pub struct JavaNavigableSet<'mc, E>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    E: JNIRaw<'mc>;
impl<'mc, E> JavaNavigableSet<'mc, E>
where
    E: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaNavigableSet from null object.").into(),
            );
        }
...
impl<'mc, E> JNIRaw<'mc> for JavaNavigableSet<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
...
impl<'mc, E> Into<crate::JavaSortedSet<'mc /* parse_into_impl */, E>> for JavaNavigableSet<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn into(self) -> crate::JavaSortedSet<'mc /* parse_into_impl */, E> {
        crate::JavaSortedSet::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
pub struct JavaFormattableFlags<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaFormattableFlags<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaFormattableFlags from null object.").into(),
            );
        }
...
pub struct JavaNavigableMap<'mc, K, V>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>;
impl<'mc, K, V> JavaNavigableMap<'mc, K, V>
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>,
{
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaNavigableMap from null object.").into(),
            );
        }
...
impl<'mc, K, V> JNIRaw<'mc> for JavaNavigableMap<'mc, K, V>
where
    K: JNIRaw<'mc>,
    V: JNIRaw<'mc>,
{
...
impl<'mc> JavaFormatter<'mc> {
    ...
    pub fn new_with_locale(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc blackboxmc_java::JavaAppendable<'mc>>>,
    ...
    pub fn format_with_string(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaFormatter::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn locale(&mut self) -> Result<crate::JavaLocale<'mc>, Box<dyn std::error::Error>> {
    ...
    pub fn out(
        ...
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "out", "()Ljava/lang/Appendable;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        blackboxmc_java::JavaAppendable::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn close(&mut self) -> Result<(), Box<dyn std::error::Error>> {
...
pub struct JavaSpliteratorsAbstractSpliterator<'mc, T>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    T: JNIRaw<'mc>;
impl<'mc, T> blackboxmc_general::JNIRaw<'mc> for JavaSpliteratorsAbstractSpliterator<'mc, T>
where
    T: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
...
impl<'mc, T> JavaSpliteratorsAbstractSpliterator<'mc, T>
where
    T: JNIRaw<'mc>,
{
    pub fn from_raw(
...
impl<'mc, T> Into<crate::JavaSpliterator<'mc /* parse_into_impl */, T>>
    for JavaSpliteratorsAbstractSpliterator<'mc, T>
where
    T: JNIRaw<'mc>,
{
    fn into(self) -> crate::JavaSpliterator<'mc /* parse_into_impl */, T> {
        crate::JavaSpliterator::from_raw(&self.jni_ref(), self.1).unwrap()
    }
}
pub struct JavaProperties<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaProperties<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaProperties from null object.").into(),
            );
        }
    ...
    pub fn get_property_with_string(
        &mut self,
        arg0: std::option::Option<impl Into<&'mc String>>,
        arg1: std::option::Option<impl Into<&'mc String>>,
    ) -> Result<String, Box<dyn std::error::Error>> {
...
pub struct JavaSpliteratorsAbstractLongSpliterator<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaSpliteratorsAbstractLongSpliterator<'mc> {
    ...
    pub fn try_split(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaSpliteratorOfLong::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn characteristics(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
...
impl<'mc> JavaTimerTask<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaTimerTask from null object.").into());
        }
    ...
    pub fn cancel(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "cancel", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
    pub fn scheduled_execution_time(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "scheduledExecutionTime", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
...
pub struct JavaSpliteratorOfLong<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaEnumSet<'mc> {
    ...
    pub fn range<E>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc blackboxmc_java::JavaEnum<'mc>>,
        arg1: impl Into<&'mc blackboxmc_java::JavaEnum<'mc>>,
    ) -> Result<crate::JavaEnumSet<'mc>, Box<dyn std::error::Error>>
    where
        E: JNIRaw<'mc>,
    {
    ...
    pub fn clone<E>(&mut self) -> Result<crate::JavaEnumSet<'mc>, Box<dyn std::error::Error>>
    where
        E: JNIRaw<'mc>,
    {
        let res =
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaEnumSet::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn of_with_enum<E>(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc blackboxmc_java::JavaEnum<'mc>>,
        arg1: impl Into<&'mc blackboxmc_java::JavaEnum<'mc>>,
        arg2: impl Into<&'mc blackboxmc_java::JavaEnum<'mc>>,
        arg3: impl Into<&'mc blackboxmc_java::JavaEnum<'mc>>,
        arg4: std::option::Option<impl Into<&'mc blackboxmc_java::JavaEnum<'mc>>>,
    ) -> Result<crate::JavaEnumSet<'mc>, Box<dyn std::error::Error>>
    where
        E: JNIRaw<'mc>,
    {
...
"(Ljava/lang/Enum;Ljava/lang/Enum;Ljava/lang/Enum;Ljava/lang/Enum;Ljava/lang/Enum;)Ljava/util/EnumSet;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5)])?;
    ...
    pub fn iterator(&mut self) -> Result<crate::JavaIterator<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "iterator",
            "()Ljava/util/Iterator;",
    ...
    E: JNIRaw<'mc>,
{
    ...
    pub fn clone(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaArrayDeque::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn clear(&mut self) -> Result<(), Box<dyn std::error::Error>> {
...
impl<'mc> JavaTimer<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaTimer from null object.").into());
        }
    ...
    pub fn schedule_with_timer_task(
        &mut self,
        arg0: impl Into<&'mc crate::JavaTimerTask<'mc>>,
        arg1: impl Into<&'mc crate::JavaDate<'mc>>,
        arg2: std::option::Option<i64>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 =
    ...
    pub fn schedule_at_fixed_rate_with_timer_task(
        &mut self,
        arg0: impl Into<&'mc crate::JavaTimerTask<'mc>>,
        arg1: i64,
        arg2: std::option::Option<i64>,
    ...
    pub fn purge(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "purge", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn wait(
...
impl<'mc> JavaLocaleBuilder<'mc> {
    ...
    pub fn set_language(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaLocaleBuilder::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn set_script(
    ...
    pub fn build(&mut self) -> Result<crate::JavaLocale<'mc>, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "build", "()Ljava/util/Locale;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaLocale::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    ...
    pub fn clear(&mut self) -> Result<crate::JavaLocaleBuilder<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "clear",
            "()Ljava/util/Locale$Builder;",
...
pub struct JavaSplittableRandom<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
impl<'mc> JavaSplittableRandom<'mc> {
    pub fn from_raw(
        ...
        if obj.is_null() {
            return Err(
                eyre::eyre!("Tried to instantiate JavaSplittableRandom from null object.").into(),
            );
        }
    ...
    pub fn split(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaSplittableRandom::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn wait(
...
pub struct JavaSpliteratorsAbstractDoubleSpliterator<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
...
pub mod random;
pub mod regex;
pub struct JavaThrowable<'mc>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
);
impl<'mc> blackboxmc_general::JNIRaw<'mc> for JavaThrowable<'mc> {
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
        self.0.clone()
    }
...
impl<'mc> JavaThrowable<'mc> {
    pub fn from_raw(
        env: &blackboxmc_general::SharedJNIEnv<'mc>,
        obj: jni::objects::JObject<'mc>,
    ) -> Result<Self, Box<dyn std::error::Error>> {
        if obj.is_null() {
            return Err(eyre::eyre!("Tried to instantiate JavaThrowable from null object.").into());
        }
        let (valid, name) = env.validate_name(&obj, "JavaThrowable")?;
        if !valid {
            Err(eyre::eyre!(
                "Invalid argument passed. Expected a JavaThrowable object, got {}",
                name
            )
            .into())
        } else {
    ...
    pub fn new(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc String>>,
    ) -> Result<crate::JavaThrowable<'mc>, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JObject::from(jni.new_string(arg0.unwrap().into()).unwrap());
        let cls = &jni.find_class("java/lang/Throwable")?;
        let res = jni.new_object(
            cls,
            "(Ljava/lang/String;)V",
            &[jni::objects::JValueGen::from(&val_1)],
        )?;
        crate::JavaThrowable::from_raw(&jni, res)
    }
    pub fn new_with_string(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc String>,
        arg1: std::option::Option<impl Into<&'mc crate::JavaThrowable<'mc>>>,
    ) -> Result<crate::JavaThrowable<'mc>, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JObject::from(jni.new_string(arg0.unwrap().into()).unwrap());
        let val_2 =
            unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone()) };
    ...
    pub fn fill_in_stack_trace(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaThrowable::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn cause(&mut self) -> Result<crate::JavaThrowable<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getCause",
            "()Ljava/lang/Throwable;",
    ...
    pub fn init_cause(
        &mut self,
        arg0: impl Into<&'mc crate::JavaThrowable<'mc>>,
    ) -> Result<crate::JavaThrowable<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn localized_message(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "getLocalizedMessage",
            "()Ljava/lang/String;",
    ...
    pub fn set_stack_trace(
        &mut self,
        arg0: Vec<impl Into<&'mc crate::JavaStackTraceElement<'mc>>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "setStackTrace",
