...
impl<'mc, E> Into<crate::JavaRandomAccess<'mc>> for JavaArrayList<'mc, E>
where
    E: JNIRaw<'mc>,
{
...
impl<'mc, E> Into<crate::JavaRandomAccess<'mc>> for JavaVector<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn into(self) -> crate::JavaRandomAccess<'mc> {
...
pub struct JavaEnumMap<'mc, K>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    K: JNIRaw<'mc>;
impl<'mc, K> blackboxmc_general::JNIRaw<'mc> for JavaEnumMap<'mc, K>
where
    K: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
...
impl<'mc, T> Into<crate::JavaEventListener<'mc>> for JavaEventListenerProxy<'mc, T>
where
    T: JNIRaw<'mc>,
{
...
pub struct JavaEnumSet<'mc, E>(
    pub(crate) blackboxmc_general::SharedJNIEnv<'mc>,
    pub(crate) jni::objects::JObject<'mc>,
)
where
    E: JNIRaw<'mc>;
impl<'mc, E> blackboxmc_general::JNIRaw<'mc> for JavaEnumSet<'mc, E>
where
    E: JNIRaw<'mc>,
{
    fn jni_ref(&self) -> blackboxmc_general::SharedJNIEnv<'mc> {
...
impl<'mc> Into<crate::random::JavaRandomGeneratorSplittableGenerator<'mc>>
    for JavaSplittableRandom<'mc>
{
    fn into(self) -> crate::random::JavaRandomGeneratorSplittableGenerator<'mc> {
        crate::random::JavaRandomGeneratorSplittableGenerator::from_raw(&self.jni_ref(), self.1)
            .unwrap()
    }
}
...
impl<'mc> Into<crate::JavaSpliteratorOfDouble<'mc>>
    for JavaSpliteratorsAbstractDoubleSpliterator<'mc>
{
