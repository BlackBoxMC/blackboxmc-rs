...
impl<'mc> JavaLongStreamLongMapMultiConsumer<'mc> {
    ...
    pub fn accept(
        &mut self,
        arg0: i64,
        arg1: impl Into<&'mc crate::function::JavaLongConsumer<'mc>>,
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "accept",
            "(JLjava/util/function/LongConsumer;)V",
            &[
...
impl<'mc> JavaCollectors<'mc> {
    ...
    pub fn summing_long(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaToLongFunction<'mc, T>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/Collector")?;
        let res = jni.call_static_method(
    ...
    pub fn reducing_with_binary_operator(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<jni::objects::JObject<'mc>>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaBinaryOperator<'mc, T>>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
    ...
    pub fn reducing_with_object(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: jni::objects::JObject<'mc>,
        arg1: impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>,
        arg2: std::option::Option<impl Into<&'mc crate::function::JavaBinaryOperator<'mc, T>>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 = arg0;
        let val_2 =
            unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone()) };
...
"(Ljava/lang/Object;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
    ...
    pub fn grouping_by_concurrent_with_function(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaSupplier<'mc, T>>>,
        arg2: std::option::Option<impl Into<&'mc crate::stream::JavaCollector<'mc, T, A, R>>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 =
...
"(Ljava/util/function/Function;Ljava/util/function/Supplier;Ljava/util/stream/Collector;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
    ...
    pub fn partitioning_by_with_predicate(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::function::JavaPredicate<'mc, T>>>,
        arg1: std::option::Option<impl Into<&'mc crate::stream::JavaCollector<'mc, T, A, R>>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 =
            unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone()) };
        let val_2 =
...
"(Ljava/util/function/Predicate;Ljava/util/stream/Collector;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
    ...
    pub fn collecting_and_then(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::stream::JavaCollector<'mc, T, A, R>>,
        arg1: impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
...
"(Ljava/util/stream/Collector;Ljava/util/function/Function;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
    ...
    pub fn to_concurrent_map_with_function(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        ...
        arg2: std::option::Option<impl Into<&'mc crate::function::JavaBinaryOperator<'mc, T>>>,
        arg3: std::option::Option<impl Into<&'mc crate::function::JavaSupplier<'mc, T>>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 =
            unsafe { jni::objects::JObject::from_raw(arg0.unwrap().into().jni_object().clone()) };
        let val_2 =
...
"(Ljava/util/function/Function;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;Ljava/util/function/Supplier;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
    ...
    pub fn flat_mapping(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>,
        arg1: impl Into<&'mc crate::stream::JavaCollector<'mc, T, A, R>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/Collector")?;
...
"(Ljava/util/function/Predicate;Ljava/util/stream/Collector;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
    ...
    pub fn counting(
        ...
        let cls = &jni.find_class("java/util/stream/Collector")?;
        let res = jni.call_static_method(cls, "counting", "()Ljava/util/stream/Collector;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaCollector::from_raw(&jni, obj)
    }
    pub fn summing_int(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaToIntFunction<'mc, T>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/Collector")?;
        let res = jni.call_static_method(
    ...
    pub fn summing_double(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaToDoubleFunction<'mc, T>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/Collector")?;
        let res = jni.call_static_method(
    ...
    pub fn to_unmodifiable_map_with_function(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>>,
        arg2: std::option::Option<impl Into<&'mc crate::function::JavaBinaryOperator<'mc, T>>>,
...
"(Ljava/util/function/Function;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
    ...
    pub fn teeing(
        ...
        arg0: impl Into<&'mc crate::stream::JavaCollector<'mc, T, A, R>>,
        arg1: impl Into<&'mc crate::stream::JavaCollector<'mc, T, A, R>>,
        arg2: impl Into<&'mc crate::function::JavaBiFunction<'mc, T, U, R>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
...
"(Ljava/util/stream/Collector;Ljava/util/stream/Collector;Ljava/util/function/BiFunction;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
    ...
    pub fn to_list(
        ...
        let cls = &jni.find_class("java/util/stream/Collector")?;
        let res = jni.call_static_method(cls, "toList", "()Ljava/util/stream/Collector;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaCollector::from_raw(&jni, obj)
    }
    pub fn to_map_with_function(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>>,
        arg2: std::option::Option<impl Into<&'mc crate::function::JavaBinaryOperator<'mc, T>>>,
...
"(Ljava/util/function/Function;Ljava/util/function/Function;Ljava/util/function/BinaryOperator;Ljava/util/function/Supplier;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4)])?;
    ...
    pub fn to_set(
        ...
        let cls = &jni.find_class("java/util/stream/Collector")?;
        let res = jni.call_static_method(cls, "toSet", "()Ljava/util/stream/Collector;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaCollector::from_raw(&jni, obj)
    }
    pub fn to_collection(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaSupplier<'mc, T>>,
    ) -> Result<crate::stream::JavaCollector<'mc, T, A, R>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/Collector")?;
        let res = jni.call_static_method(
...
"(Ljava/util/function/Function;Ljava/util/stream/Collector;)Ljava/util/stream/Collector;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
    ...
    pub fn grouping_by_with_function(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: std::option::Option<impl Into<&'mc crate::function::JavaFunction<'mc, T, R>>>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaSupplier<'mc, T>>>,
        arg2: std::option::Option<impl Into<&'mc crate::stream::JavaCollector<'mc, T, A, R>>>,
    ...
    S: JNIRaw<'mc>,
{
    ...
    pub fn sequential(
        &mut self,
    ) -> Result<crate::stream::JavaBaseStream<'mc, T, S>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "sequential",
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::stream::JavaBaseStream::from_raw(&self.jni_ref(), unsafe {
    ...
    pub fn is_parallel(&mut self) -> Result<bool, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "isParallel", "()Z", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.z().unwrap())
    }
}
...
impl<'mc> JavaIntStreamBuilder<'mc> {
    ...
    pub fn add(
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "add",
            "(I)Ljava/util/stream/IntStream$Builder;",
            &[jni::objects::JValueGen::from(&val_1)],
        );
        let res = self.jni_ref().translate_error(res)?;
        crate::stream::JavaIntStreamBuilder::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
...
impl<'mc> JavaStreamSupport<'mc> {
    ...
    pub fn stream_with_spliterator(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaSupplier<'mc, T>>,
        arg1: std::option::Option<i32>,
    ...
    pub fn int_stream_with_spliteratorof_int(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaSupplier<'mc, T>>,
        arg1: std::option::Option<i32>,
        arg2: std::option::Option<bool>,
    ...
    pub fn long_stream_with_spliteratorof_long(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaSupplier<'mc, T>>,
        arg1: std::option::Option<i32>,
        arg2: std::option::Option<bool>,
    ...
    pub fn double_stream_with_spliteratorof_double(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaSupplier<'mc, T>>,
        arg1: std::option::Option<i32>,
        arg2: std::option::Option<bool>,
...
impl<'mc> JavaLongStream<'mc> {
    ...
    pub fn generate(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaLongSupplier<'mc>>,
    ) -> Result<crate::stream::JavaLongStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/LongStream")?;
        let res = jni.call_static_method(
            cls,
            "generate",
            "(Ljava/util/function/LongSupplier;)Ljava/util/stream/LongStream;",
            &[jni::objects::JValueGen::from(&val_1)],
        )?;
        let mut obj = res.l()?;
        crate::stream::JavaLongStream::from_raw(&jni, obj)
    ...
    pub fn map_to_int(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaLongToIntFunction<'mc>>,
    ) -> Result<crate::stream::JavaIntStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn map_to_double(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaLongToDoubleFunction<'mc>>,
    ) -> Result<crate::stream::JavaDoubleStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn map_multi(
        &mut self,
        arg0: impl Into<&'mc crate::stream::JavaLongStreamLongMapMultiConsumer<'mc>>,
    ) -> Result<crate::stream::JavaLongStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn average(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaOptionalDouble::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn summary_statistics(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaLongSummaryStatistics::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn range_closed(
    ...
    pub fn map_to_obj(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaLongFunction<'mc, R>>,
    ) -> Result<crate::stream::JavaStream<'mc, T>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn min(&mut self) -> Result<crate::JavaOptionalLong<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "min",
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaOptionalLong::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn max(&mut self) -> Result<crate::JavaOptionalLong<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "max",
            "()Ljava/util/OptionalLong;",
    ...
    pub fn of_with_long(
        ...
        let cls = &jni.find_class("java/util/stream/LongStream")?;
        let res = jni.call_static_method(cls, "of", "(J)Ljava/util/stream/LongStream;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaLongStream::from_raw(&jni, obj)
    }
    pub fn count(&mut self) -> Result<i64, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "count", "()J", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.j().unwrap())
    }
    pub fn builder(
    ...
    pub fn concat(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::stream::JavaLongStream<'mc>>,
        arg1: impl Into<&'mc crate::stream::JavaLongStream<'mc>>,
    ) -> Result<crate::stream::JavaLongStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/LongStream")?;
...
"(Ljava/util/stream/LongStream;Ljava/util/stream/LongStream;)Ljava/util/stream/LongStream;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
    ...
    pub fn empty(
        ...
        let cls = &jni.find_class("java/util/stream/LongStream")?;
        let res = jni.call_static_method(cls, "empty", "()Ljava/util/stream/LongStream;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaLongStream::from_raw(&jni, obj)
    }
    pub fn any_match(
    ...
    pub fn find_any(&mut self) -> Result<crate::JavaOptionalLong<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "findAny",
            "()Ljava/util/OptionalLong;",
    ...
    pub fn reduce_with_long_binary_operator(
        &mut self,
        arg0: std::option::Option<i64>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaLongBinaryOperator<'mc>>>,
    ...
    pub fn iterate_with_long(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: i64,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaLongPredicate<'mc>>>,
        arg2: std::option::Option<impl Into<&'mc crate::function::JavaLongUnaryOperator<'mc>>>,
    ) -> Result<crate::stream::JavaLongStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Long(arg0.unwrap().into());
        let val_2 =
            unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone()) };
    ...
    T: JNIRaw<'mc>,
{
    ...
    pub fn add(
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "add",
            "(Ljava/lang/Object;)Ljava/util/stream/Stream$Builder;",
            &[jni::objects::JValueGen::from(&val_1)],
        );
        let res = self.jni_ref().translate_error(res)?;
        crate::stream::JavaStreamBuilder::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn accept(
...
impl<'mc, T> Into<crate::function::JavaConsumer<'mc, T>> for JavaStreamBuilder<'mc, T>
where
    T: JNIRaw<'mc>,
{
...
impl<'mc> JavaDoubleStreamBuilder<'mc> {
    ...
    pub fn add(
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "add",
            "(D)Ljava/util/stream/DoubleStream$Builder;",
            &[jni::objects::JValueGen::from(&val_1)],
        );
        let res = self.jni_ref().translate_error(res)?;
        crate::stream::JavaDoubleStreamBuilder::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
...
impl<'mc> JavaDoubleStreamDoubleMapMultiConsumer<'mc> {
    ...
    pub fn accept(
        &mut self,
        arg0: f64,
        arg1: impl Into<&'mc crate::function::JavaDoubleConsumer<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Double(arg0.into());
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "accept",
            "(DLjava/util/function/DoubleConsumer;)V",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
            ],
...
impl<'mc> JavaIntStreamIntMapMultiConsumer<'mc> {
    ...
    pub fn accept(
        &mut self,
        arg0: i32,
        arg1: impl Into<&'mc crate::function::JavaIntConsumer<'mc>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.into());
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "accept",
            "(ILjava/util/function/IntConsumer;)V",
            &[
                jni::objects::JValueGen::from(&val_1),
                jni::objects::JValueGen::from(&val_2),
            ],
...
impl<'mc> JavaLongStreamBuilder<'mc> {
    ...
    pub fn add(
        ...
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "add",
            "(J)Ljava/util/stream/LongStream$Builder;",
            &[jni::objects::JValueGen::from(&val_1)],
        );
        let res = self.jni_ref().translate_error(res)?;
        crate::stream::JavaLongStreamBuilder::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    ...
    R: JNIRaw<'mc>,
{
    ...
    pub fn combiner(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::function::JavaBinaryOperator::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn supplier(
        &mut self,
    ) -> Result<crate::function::JavaSupplier<'mc, T>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "supplier",
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::function::JavaSupplier::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
}
    ...
    T: JNIRaw<'mc>,
{
    ...
    pub fn to_list(&mut self) -> Result<crate::JavaList<'mc, E>, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "toList", "()Ljava/util/List;", &[]);
        let res = self.jni_ref().translate_error(res)?;
    ...
    pub fn builder(
        ...
        let res =
            jni.call_static_method(cls, "builder", "()Ljava/util/stream/Stream$Builder;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaStreamBuilder::from_raw(&jni, obj)
    }
    pub fn concat(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::stream::JavaStream<'mc, T>>,
        arg1: impl Into<&'mc crate::stream::JavaStream<'mc, T>>,
    ) -> Result<crate::stream::JavaStream<'mc, T>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/Stream")?;
    ...
    pub fn empty(
        ...
        let cls = &jni.find_class("java/util/stream/Stream")?;
        let res = jni.call_static_method(cls, "empty", "()Ljava/util/stream/Stream;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaStream::from_raw(&jni, obj)
    }
    pub fn any_match(
    ...
    pub fn find_any(&mut self) -> Result<crate::JavaOptional<'mc, T>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "findAny",
            "()Ljava/util/Optional;",
    ...
    pub fn reduce_with_binary_operator(
        &mut self,
    ...
    pub fn reduce_with_object(
        &mut self,
        arg0: U,
        arg1: U,
        arg2: std::option::Option<U>,
    ) -> Result<jni::objects::JObject<'mc>, Box<dyn std::error::Error>> {
        let val_1 = arg0;
        let val_2 = arg1.unwrap().jni_object();
    ...
    pub fn iterate_with_object(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: jni::objects::JObject<'mc>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaPredicate<'mc, T>>>,
        arg2: std::option::Option<impl Into<&'mc crate::function::JavaUnaryOperator<'mc, T>>>,
    ) -> Result<crate::stream::JavaStream<'mc, T>, Box<dyn std::error::Error>> {
        let val_1 = arg0.unwrap();
        let val_2 =
            unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone()) };
...
impl<'mc, T> Into<crate::stream::JavaBaseStream<'mc, T>> for JavaStream<'mc, T>
where
    T: JNIRaw<'mc>,
{
...
impl<'mc> JavaDoubleStream<'mc> {
    ...
    pub fn generate(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaDoubleSupplier<'mc>>,
    ) -> Result<crate::stream::JavaDoubleStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/DoubleStream")?;
        let res = jni.call_static_method(
            cls,
            "generate",
            "(Ljava/util/function/DoubleSupplier;)Ljava/util/stream/DoubleStream;",
            &[jni::objects::JValueGen::from(&val_1)],
        )?;
        let mut obj = res.l()?;
        crate::stream::JavaDoubleStream::from_raw(&jni, obj)
    ...
    pub fn map_to_int(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaDoubleToIntFunction<'mc>>,
    ) -> Result<crate::stream::JavaIntStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn map_multi(
        &mut self,
        arg0: impl Into<&'mc crate::stream::JavaDoubleStreamDoubleMapMultiConsumer<'mc>>,
    ) -> Result<crate::stream::JavaDoubleStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
    ...
    pub fn summary_statistics(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaDoubleSummaryStatistics::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn for_each_ordered(
    ...
    pub fn map_to_obj(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaDoubleFunction<'mc, R>>,
    ) -> Result<crate::stream::JavaStream<'mc, T>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn min(&mut self) -> Result<crate::JavaOptionalDouble<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "min",
            "()Ljava/util/OptionalDouble;",
    ...
    pub fn max(&mut self) -> Result<crate::JavaOptionalDouble<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "max",
            "()Ljava/util/OptionalDouble;",
    ...
    pub fn iterator(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaPrimitiveIteratorOfDouble::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn map(
    ...
    pub fn concat(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::stream::JavaDoubleStream<'mc>>,
        arg1: impl Into<&'mc crate::stream::JavaDoubleStream<'mc>>,
    ) -> Result<crate::stream::JavaDoubleStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/DoubleStream")?;
...
"(Ljava/util/stream/DoubleStream;Ljava/util/stream/DoubleStream;)Ljava/util/stream/DoubleStream;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
    ...
    pub fn empty(
        ...
        let cls = &jni.find_class("java/util/stream/DoubleStream")?;
        let res = jni.call_static_method(cls, "empty", "()Ljava/util/stream/DoubleStream;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaDoubleStream::from_raw(&jni, obj)
    }
    pub fn any_match(
    ...
    pub fn reduce_with_double_binary_operator(
        &mut self,
        arg0: std::option::Option<f64>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaDoubleBinaryOperator<'mc>>>,
    ...
    pub fn iterate_with_double(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: f64,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaDoublePredicate<'mc>>>,
        arg2: std::option::Option<impl Into<&'mc crate::function::JavaDoubleUnaryOperator<'mc>>>,
    ) -> Result<crate::stream::JavaDoubleStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Double(arg0.unwrap().into());
        let val_2 =
            unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone()) };
...
"(DLjava/util/function/DoublePredicate;Ljava/util/function/DoubleUnaryOperator;)Ljava/util/stream/DoubleStream;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
    ...
    pub fn map_to_long(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaDoubleToLongFunction<'mc>>,
    ) -> Result<crate::stream::JavaLongStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
...
impl<'mc> JavaIntStream<'mc> {
    ...
    pub fn generate(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::function::JavaIntSupplier<'mc>>,
    ) -> Result<crate::stream::JavaIntStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/IntStream")?;
        let res = jni.call_static_method(
            cls,
            "generate",
            "(Ljava/util/function/IntSupplier;)Ljava/util/stream/IntStream;",
            &[jni::objects::JValueGen::from(&val_1)],
        )?;
        let mut obj = res.l()?;
        crate::stream::JavaIntStream::from_raw(&jni, obj)
    ...
    pub fn map_to_double(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaIntToDoubleFunction<'mc>>,
    ) -> Result<crate::stream::JavaDoubleStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn map_multi(
        &mut self,
        arg0: impl Into<&'mc crate::stream::JavaIntStreamIntMapMultiConsumer<'mc>>,
    ) -> Result<crate::stream::JavaIntStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn summary_statistics(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaIntSummaryStatistics::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn range_closed(
    ...
    pub fn map_to_obj(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaIntFunction<'mc, R>>,
    ) -> Result<crate::stream::JavaStream<'mc, T>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
    ...
    pub fn min(&mut self) -> Result<crate::JavaOptionalInt<'mc>, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "min", "()Ljava/util/OptionalInt;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaOptionalInt::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn max(&mut self) -> Result<crate::JavaOptionalInt<'mc>, Box<dyn std::error::Error>> {
        let res =
            self.jni_ref()
                .call_method(&self.jni_object(), "max", "()Ljava/util/OptionalInt;", &[]);
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaOptionalInt::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    ...
    pub fn iterator(
        ...
        let res = self.jni_ref().translate_error(res)?;
        crate::JavaPrimitiveIteratorOfInt::from_raw(&self.jni_ref(), unsafe {
            jni::objects::JObject::from_raw(res.l()?.clone())
        })
    }
    pub fn map(
    ...
    pub fn concat(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::stream::JavaIntStream<'mc>>,
        arg1: impl Into<&'mc crate::stream::JavaIntStream<'mc>>,
    ) -> Result<crate::stream::JavaIntStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 = unsafe { jni::objects::JObject::from_raw(arg1.into().jni_object().clone()) };
        let cls = &jni.find_class("java/util/stream/IntStream")?;
...
"(Ljava/util/stream/IntStream;Ljava/util/stream/IntStream;)Ljava/util/stream/IntStream;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2)])?;
    ...
    pub fn empty(
        ...
        let cls = &jni.find_class("java/util/stream/IntStream")?;
        let res = jni.call_static_method(cls, "empty", "()Ljava/util/stream/IntStream;", &[])?;
        let mut obj = res.l()?;
        crate::stream::JavaIntStream::from_raw(&jni, obj)
    }
    pub fn any_match(
    ...
    pub fn find_any(&mut self) -> Result<crate::JavaOptionalInt<'mc>, Box<dyn std::error::Error>> {
        let res = self.jni_ref().call_method(
            &self.jni_object(),
            "findAny",
    ...
    pub fn sum(&mut self) -> Result<i32, Box<dyn std::error::Error>> {
        let res = self
            .jni_ref()
            .call_method(&self.jni_object(), "sum", "()I", &[]);
        let res = self.jni_ref().translate_error(res)?;
        Ok(res.i().unwrap())
    }
    pub fn reduce_with_int_binary_operator(
        &mut self,
        arg0: std::option::Option<i32>,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaIntBinaryOperator<'mc>>>,
    ...
    pub fn iterate_with_int(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: i32,
        arg1: std::option::Option<impl Into<&'mc crate::function::JavaIntPredicate<'mc>>>,
        arg2: std::option::Option<impl Into<&'mc crate::function::JavaIntUnaryOperator<'mc>>>,
    ) -> Result<crate::stream::JavaIntStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = jni::objects::JValueGen::Int(arg0.unwrap().into());
        let val_2 =
            unsafe { jni::objects::JObject::from_raw(arg1.unwrap().into().jni_object().clone()) };
...
"(ILjava/util/function/IntPredicate;Ljava/util/function/IntUnaryOperator;)Ljava/util/stream/IntStream;",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3)])?;
    ...
    pub fn map_to_long(
        &mut self,
        arg0: impl Into<&'mc crate::function::JavaIntToLongFunction<'mc>>,
    ) -> Result<crate::stream::JavaLongStream<'mc>, Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let res = self.jni_ref().call_method(
            &self.jni_object(),
