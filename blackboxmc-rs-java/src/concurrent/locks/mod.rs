...
impl<'mc> JavaAbstractQueuedLongSynchronizerConditionObject<'mc> {
    ...
    pub fn new(
        jni: blackboxmc_general::SharedJNIEnv<'mc>,
        arg0: impl Into<&'mc crate::concurrent::locks::JavaAbstractQueuedLongSynchronizer<'mc>>,
    ) -> Result<
        crate::concurrent::locks::JavaAbstractQueuedLongSynchronizerConditionObject<'mc>,
        Box<dyn std::error::Error>,
    > {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        ...
        crate::concurrent::locks::JavaAbstractQueuedLongSynchronizerConditionObject::from_raw(
            &jni, res,
        )
    }
    pub fn signal(&mut self) -> Result<(), Box<dyn std::error::Error>> {
...
impl<'mc> JavaLockSupport<'mc> {
    ...
    pub fn unpark(
        ...
        let cls = &jni.find_class("void")?;
        let res = jni.call_static_method(cls, "unpark", "(Ljava/lang/Thread;)V", &[])?;
        Ok(())
    }
