...
impl<'mc> JavaLogger<'mc> {
    ...
    pub fn logrb_with_level(
        ...
        arg5: std::option::Option<impl Into<&'mc blackboxmc_java::JavaThrowable<'mc>>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 = jni::objects::JObject::from(self.jni_ref().new_string(arg1.into()).unwrap());
        let val_3 = jni::objects::JObject::from(self.jni_ref().new_string(arg2.into()).unwrap());
        ...
        let res = self.jni_ref().call_method(&self.jni_object(),"logrb","(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V",&[jni::objects::JValueGen::from(&val_1),jni::objects::JValueGen::from(&val_2),jni::objects::JValueGen::from(&val_3),jni::objects::JValueGen::from(&val_4),jni::objects::JValueGen::from(&val_5),jni::objects::JValueGen::from(&val_6)]);
        self.jni_ref().translate_error(res)?;
        Ok(())
    }
    ...
    pub fn log_with_level(
        ...
        arg0: impl Into<&'mc crate::logging::JavaLevel<'mc>>,
        arg1: impl Into<&'mc String>,
        arg2: std::option::Option<impl Into<&'mc blackboxmc_java::JavaThrowable<'mc>>>,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let val_1 = unsafe { jni::objects::JObject::from_raw(arg0.into().jni_object().clone()) };
        let val_2 =
            jni::objects::JObject::from(self.jni_ref().new_string(arg1.unwrap().into()).unwrap());
